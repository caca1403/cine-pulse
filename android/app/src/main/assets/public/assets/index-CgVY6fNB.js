const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./PlayerModal-DKeTdtQY.js","./hls-BuERnqCp.js"])))=>i.map(i=>d[i]);
(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function i(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(r){if(r.ep)return;r.ep=!0;const a=i(r);fetch(r.href,a)}})();function V(e=document){const t=window.lucide;if(!t?.icons||!t?.createElement||!e)return;const i="[data-lucide]:not(svg)",n=e.matches?.(i)?[e,...e.querySelectorAll(i)]:e.querySelectorAll(i);for(const r of n){const a=r.getAttribute("data-lucide"),o=a.replace(/(^|-)(\w)/g,(d,p,h)=>h.toUpperCase()),s=t.icons[o];if(!s)continue;const l=t.createElement(s);for(const{name:d,value:p}of r.attributes)d!=="class"&&l.setAttribute(d,p);l.classList.add("lucide",`lucide-${a}`);for(const d of r.classList)d!=="lucide"&&!d.startsWith("lucide-")&&l.classList.add(d);r.replaceWith(l)}}const ue={WATCH_HISTORY:"sineflix_watch_history_v1",FAVORITES:"sineflix_favorites_v1",WATCHLIST:"sineflix_watchlist_v1",USER_SETTINGS:"sineflix_user_settings_v1",ANIME_IDS:"sineflix_anime_ids_v1"};let wt=null;function kl(){if(wt)return wt;try{if(typeof window>"u"||!window.localStorage)return wt=new Set,wt;const e=localStorage.getItem(ue.ANIME_IDS);if(!e)return wt=new Set,wt;const t=JSON.parse(e);return wt=new Set(Array.isArray(t)?t.map(String):[]),wt}catch{return wt=new Set,wt}}function Se(e){if(e)try{const t=kl(),i=String(e);t.has(i)||(t.add(i),typeof window<"u"&&window.localStorage&&localStorage.setItem(ue.ANIME_IDS,JSON.stringify(Array.from(t))))}catch{}}function Fe(e){return e?kl().has(String(e)):!1}let nt=null,Qe=null,ot=null,an=null,oi=null,sn=null,on=null,Wt=null,zi=null,Ei=null,sr=null,ut=null,ui=null,Yt=null,xt=null;function Ot(){an=null,oi=null,sn=null,on=null}function Ir(){nt=null,Qe=null,ot=null,Ot(),Wt=null,zi=null,Ei=null,sr=null,wt=null,ut=null,ui=null,Yt=null,xt=null}function Jt(){if(ut)return ut;const e=[{id:"prof_1",name:"Profilim",avatar:"user-circle",isKid:!1,color:"#f59e0b"},{id:"prof_kids",name:"Çocuk Modu 🎈",avatar:"baby",isKid:!0,color:"#38bdf8"}];try{if(typeof window>"u"||!window.localStorage)return ut=e,ut;const t=localStorage.getItem("sineflix_profiles_list_v1");if(!t)return ut=e,ut;let i=JSON.parse(t);return i.some(r=>r.id==="prof_cinema")&&(i=i.filter(r=>r.id!=="prof_cinema"),localStorage.setItem("sineflix_profiles_list_v1",JSON.stringify(i))),ut=i,ut}catch{return ut=e,ut}}function ps(e){try{if(ut=e,ui=null,typeof window>"u"||!window.localStorage)return;localStorage.setItem("sineflix_profiles_list_v1",JSON.stringify(e)),window.dispatchEvent(new CustomEvent("sineflix_profiles_updated"))}catch{}}function _l(){try{return typeof window>"u"||!window.localStorage?!0:localStorage.getItem("cinepulse_onboarding_completed")==="true"}catch{return!0}}function ad(){try{return typeof window>"u"||!window.localStorage?!0:localStorage.getItem("cinepulse_product_tour_completed")==="true"}catch{return!0}}function sd(){try{if(typeof window>"u"||!window.localStorage)return;localStorage.setItem("cinepulse_product_tour_completed","true")}catch{}}function od({name:e,avatar:t="user-circle",color:i="#f59e0b",isKid:n=!1}){try{if(typeof window>"u"||!window.localStorage)return;const r=(e||"").trim()||(n?"Çocuk":"Profilim");let a=Jt();const o=a.findIndex(l=>l.id==="prof_1"),s={id:"prof_1",name:r,avatar:t,color:i,isKid:!!n};return o!==-1?a[o]=s:a.unshift(s),ps(a),or("prof_1"),localStorage.setItem("cinepulse_onboarding_completed","true"),window.dispatchEvent(new CustomEvent("sineflix_profile_changed",{detail:{profileId:"prof_1"}})),s}catch{return null}}const ia="1403";function ld(){try{return typeof window>"u"||!window.localStorage?ia:localStorage.getItem("cinepulse_admin_pin")||ia}catch{return ia}}function cd(e){try{return typeof window>"u"||!window.localStorage||!e||String(e).length<4?!1:(localStorage.setItem("cinepulse_admin_pin",String(e)),!0)}catch{return!1}}function dd(e){return String(e).trim()===ld().trim()}function Rr(){if(xt)return xt;const e=["clitoris","le clitoris","erotik","porn"];try{if(typeof window>"u"||!window.localStorage)return xt=e,e;const t=localStorage.getItem("cinepulse_blocked_content");return t?(xt=JSON.parse(t),xt):(xt=e,e)}catch{return xt=e,e}}function ud(e){if(!e)return;const t=Rr(),i=String(e).trim().toLowerCase();if(!t.includes(i)){t.push(i),xt=t;try{localStorage.setItem("cinepulse_blocked_content",JSON.stringify(t))}catch{}}}function pd(e){if(!e)return;let t=Rr();const i=String(e).trim().toLowerCase();t=t.filter(n=>String(n).toLowerCase()!==i),xt=t;try{localStorage.setItem("cinepulse_blocked_content",JSON.stringify(t))}catch{}}function hd(e){if(!e)return!1;const t=Rr(),i=String(e.id||""),n=`${e.title||""} ${e.name||""} ${e.original_title||""} ${e.original_name||""}`.toLowerCase();return t.some(r=>{const a=String(r).toLowerCase().trim();return a?i===a?!0:n.includes(a):!1})}function En(){if(ui)return ui;try{const e=Jt(),t=typeof window<"u"&&window.localStorage&&localStorage.getItem("sineflix_active_profile_id")||"prof_1";return ui=e.find(i=>i.id===t)||e[0],ui}catch{return{id:"prof_1",name:"Profilim",avatar:"user-circle",isKid:!1,color:"#f59e0b"}}}function or(e){try{if(typeof window>"u"||!window.localStorage)return;localStorage.setItem("sineflix_active_profile_id",e),ui=null,Ir(),window.dispatchEvent(new CustomEvent("sineflix_profile_changed",{detail:{profileId:e}}))}catch{}}function Ct(){return En()?.isKid===!0}function Zt(e){if(!e||e.adult===!0||hd(e))return!1;const t=[27,80,10752,10768,53,18],i=e.genre_ids||(Array.isArray(e.genres)?e.genres.map(s=>typeof s=="object"?s.id:s):[]);if(i.some(s=>t.includes(Number(s))))return!1;const n=`${e.title||""} ${e.name||""} ${e.overview||""}`.toLowerCase();if(["cinayet","katil","vahşet","kanlı","erotik","dehşet","intikam","mafya","uyuşturucu","şiddet","tecavüz","seri katil","katliam","korku","kan donduran","murder","killer","horror","bloody","psychopath","terror","revenge","savaş","war","battle","death","ölüm"].some(s=>n.includes(s)))return!1;const a=[16,10751,10762];return i.some(s=>a.includes(Number(s)))}function Gs(e=[]){return Array.isArray(e)?Ct()?e.filter(Zt):e:[]}function fd({name:e,isKid:t=!1,avatar:i="user-circle",color:n="#f59e0b"}){const r=Jt(),a={id:`prof_${Date.now()}`,name:e.trim()||"Yeni Profil",avatar:i,isKid:!!t,color:n};return r.push(a),ps(r),a}function md(e){if(e==="prof_1")return!1;let t=Jt();return t=t.filter(i=>i.id!==e),ps(t),En()?.id===e&&or("prof_1"),!0}function Mt(e){if(e===ue.WATCH_HISTORY||e===ue.FAVORITES||e===ue.WATCHLIST){const t=En();if(t&&t.id&&t.id!=="prof_1")return`${e}_${t.id}`}return e}function ft(e,t=[]){try{if(typeof window>"u"||!window.localStorage)return t;const i=Mt(e),n=localStorage.getItem(i);return n?JSON.parse(n):t}catch{return t}}const gd="cinepulse_storage_v1",Oi="keyval_store";let Mn=null;function Sl(){return Mn||(typeof window>"u"||!window.indexedDB?Promise.resolve(null):(Mn=new Promise(e=>{try{const t=window.indexedDB.open(gd,1);t.onupgradeneeded=()=>{const i=t.result;i.objectStoreNames.contains(Oi)||i.createObjectStore(Oi)},t.onsuccess=()=>e(t.result),t.onerror=()=>e(null)}catch{e(null)}}),Mn))}async function yd(e){try{const t=await Sl();return t?new Promise(i=>{try{const a=t.transaction(Oi,"readonly").objectStore(Oi).get(e);a.onsuccess=()=>i(a.result!==void 0?a.result:null),a.onerror=()=>i(null)}catch{i(null)}}):null}catch{return null}}async function dn(e,t){try{const i=await Sl();return i?new Promise(n=>{try{const r=i.transaction(Oi,"readwrite");r.objectStore(Oi).put(t,e),r.oncomplete=()=>n(!0),r.onerror=()=>n(!1)}catch{n(!1)}}):!1}catch{return!1}}async function vd(){if(!(typeof window>"u"||!window.indexedDB))try{const e=Mt(ue.WATCH_HISTORY),t=await yd(e);if(Array.isArray(t)&&t.length>0){const i=nt&&nt.length||0;t.length>=i&&(nt=t.sort((n,r)=>(r.lastWatchedAt||0)-(n.lastWatchedAt||0)),Qe=null,ot=null,Ot(),window.dispatchEvent(new CustomEvent("sineflix_data_changed",{detail:{key:e,value:nt}})))}}catch{}}typeof window<"u"&&setTimeout(vd,80);const $t=new Map;function Js(){if(!(typeof window>"u")){for(const[e,t]of $t.entries())try{t.timer&&clearTimeout(t.timer),dn(e,t.value),window.localStorage&&localStorage.setItem(e,JSON.stringify(t.value))}catch{}$t.clear()}}typeof window<"u"&&(window.addEventListener("beforeunload",Js),window.addEventListener("pagehide",Js));function Me(e,t,i={}){try{if(typeof window>"u")return;const n=Mt(e);if(dn(n,t),window.localStorage)if(i.isProgressUpdate){$t.has(n)&&clearTimeout($t.get(n).timer);const r=setTimeout(()=>{try{localStorage.setItem(n,JSON.stringify(t))}catch{}$t.delete(n)},2500);$t.set(n,{timer:r,value:t})}else{$t.has(n)&&(clearTimeout($t.get(n).timer),$t.delete(n));try{localStorage.setItem(n,JSON.stringify(t))}catch{}}window.dispatchEvent(new CustomEvent("sineflix_data_changed",{detail:{key:n,value:t,...i}}))}catch{}}const xl=["anime","kimetsu","yaiba","iblis keser","demon slayer","naruto","boruto","shingeki","titan","titana saldırı","jujutsu","kaisen","one piece","death note","bleach","dragon ball","hunter x hunter","chainsaw man","tokyo ghoul","my hero academia","boku no hero","kahramanlık akademim","fullmetal","alchemist","simyacı","sword art online","solo leveling","black clover","vinland saga","spy x family","cyberpunk: edgerunners","haikyuu","one punch","berserk","mob psycho","overlord","evangelion","cowboy bebop","code geass","frieren","dr. stone","blue lock","steins;gate","jojo","kaiju no. 8","gintama","fairy tail","violet evergarden","hell's paradise","jigokuraku","dandadan","wind breaker","mushoku tensei","re:zero","delicious in dungeon","dungeon meshi","mashle","baki","hajime no ippo","slamdunk","slam dunk","kuroko","initial d","great teacher onizuka","monster","dororo","fire force","soul eater","noragami","erased","parasyte","psycho-pass","fate/zero","fate/stay","made in abyss","your lie in april","shigatsu wa kimi","anohana","toradora","clannad","classroom of the elite","elite sınıfı","no game no life","konosuba","slime datta ken","shield hero","kalkan kahramanı","goblin slayer","akame ga kill","kill la kill","gurren lagann","darling in the franxx","promised neverland","seven deadly sins","nanatsu no taizai","yedi ölümcül günah","tokyo revengers","blue exorcist","ao no exorcist","d.gray-man","inuyasha","yu yu hakusho","sailor moon","pokemon","digimon","yu-gi-oh","beyblade","captain tsubasa","tsubasa","record of ragnarok","shuumatsu no valkyrie","golden kamuy","dorohedoro","pluto","trigun","hellsing","elfen lied","rurouni kenshin","samurai champloo","fruits basket","horimiya","my dress-up darling","komi can't communicate","rent-a-girlfriend","kaguya-sama","lycoris recoil","zom 100","undead unluck","dead mount death play","seraph of the end","owari no seraph","bungo stray dogs","bungou stray dogs","assassination classroom","suikast sınıfı","black butler","kuroshitsuji","spirited away","ruhların kaçışı","howl's moving castle","yürüyen şato","my neighbor totoro","komşum totoro","princess mononoke","prenses mononoke","your name","kimi no na wa","senin adın","weathering with you","suzume","a silent voice","sessizliğin sesi","koe no katachi","akira","shangri-la frontier","oshi no ko","the eminence in shadow","bocchi the rock"];function bd(e){return e?/[\u3040-\u30ff\u3400-\u4dbf\u4e00-\u9fff]/.test(e):!1}function dt(e){if(!e)return!1;if(e.isAnime===!0||e.type==="anime"||e.media_type==="anime"||e.id&&Fe(e.id))return!0;const i=(e.genre_ids||(Array.isArray(e.genres)?e.genres.map(a=>typeof a=="object"?a.id:a):[])).some(a=>Number(a)===16),n=e.original_language==="ja"||Array.isArray(e.origin_country)&&e.origin_country.includes("JP");if(i&&n||i&&(e.origin_country?.includes("JP")||e.original_language==="ja")||e.original_language==="ja"&&(i||bd(e.original_name||e.original_title||e.title||e.name))||Array.isArray(e.genres)&&e.genres.map(o=>typeof o=="object"?o.name:String(o)).filter(Boolean).some(o=>/anime/i.test(o)))return e.id&&Se(e.id),!0;if(typeof e.id=="string"&&(e.id.startsWith("ta_")||e.id.startsWith("acx_")||e.id.startsWith("tra_")))return Se(e.id),!0;const r=(e.title||e.name||e.original_title||e.original_name||"").toLowerCase();for(const a of xl)if(r.includes(a))return e.id&&Se(e.id),!0;return!1}function hs(e){return e?e.isSeries===!0||e.type==="tv"||e.media_type==="tv"?!1:e.type==="movie"||e.media_type==="movie"?!0:e.first_air_date||e.number_of_seasons||e.episodesCount||Array.isArray(e.seasons)&&e.seasons.length>0||e.season>1||e.episode>1?!1:!!(e.release_date&&!e.first_air_date):!0}function Be(){return nt||(nt=ft(ue.WATCH_HISTORY,[]).sort((t,i)=>(i.lastWatchedAt||0)-(t.lastWatchedAt||0)),nt)}async function wd(){const e=Be();let t=!1;const i="4e44d9029b1270a757cddc766a1bcb63";let n=0;for(let r=0;r<e.length;r++){const a=e[r];if(a.isAnime||a.type==="anime"){a.id&&Se(a.id);continue}if(!(a.isAnime===!1&&a.type!=="anime")){if(Fe(a.id)||dt(a)){a.isAnime=!0,a.type="anime",Se(a.id),t=!0;continue}if(n<5&&a.id&&!isNaN(Number(a.id))){n++;try{const o=await fetch(`https://api.themoviedb.org/3/tv/${a.id}?api_key=${i}&language=tr-TR`);if(o.ok){const s=await o.json(),l=s.original_language==="ja"||Array.isArray(s.origin_country)&&s.origin_country.includes("JP"),d=Array.isArray(s.genres)&&s.genres.some(p=>p.id===16||/anim/i.test(p.name));l&&d&&(a.isAnime=!0,a.type="anime",a.isSeries=!0,a.original_language="ja",Se(a.id),t=!0)}}catch{}}}}t&&(Ot(),Me(ue.WATCH_HISTORY,e))}function $r(){if(Qe)return Qe;const e=Be();Qe=new Map,ot=new Map;for(let t=0;t<e.length;t++){const i=e[t],n=`${i.id}_${i.season||1}_${i.episode||1}`;Qe.has(n)||Qe.set(n,i);const r=String(i.id);ot.has(r)||ot.set(r,i)}return Qe}function lr(e){if(!e||typeof e!="string")return"";let t=e.replace(/^(undefined|null|\/undefined|\/null)$/i,"");if(!t||t.startsWith("data:")||t.startsWith("http"))return t;try{for(;t.includes("%");){const i=decodeURIComponent(t);if(i===t)break;t=i}}catch{}return t=t.replace(/^\/+/,"/"),t.startsWith("/")||(t=`/${t}`),t==="/"||t==="/null"||t==="/undefined"?"":t}function Tn(e,t,i,n=[]){const r=n.find(d=>d.id==e&&(d.posterPath||d.poster_path));let a=t||(r?r.posterPath||r.poster_path:""),o=i||(r?r.backdropPath||r.backdrop_path:"");const s=lr(a),l=lr(o);return{resolvedPoster:s||"",resolvedBackdrop:l||""}}function fs({id:e,title:t,posterPath:i,poster_path:n,backdropPath:r,backdrop_path:a,type:o,isAnime:s=!1,isSeries:l=!1,season:d=1,episode:p=1,currentTime:h=0,duration:m=0,completed:b=!1,genres:y=[],genre_ids:w=[],original_language:k="",origin_country:f=[],...v}){if(!e)return;const x=Be(),A=x.findIndex(W=>W.id==e&&W.season==d&&W.episode==p),S=x.find(W=>W.id==e),T=!!(s||o==="anime"||Fe(e)||A>=0&&(x[A].isAnime||x[A].type==="anime")||S&&(S.isAnime||S.type==="anime")||dt({id:e,title:t,type:o,genres:y,genre_ids:w,original_language:k,origin_country:f,...v}));T&&Se(e);const I=!!(l||o==="tv"||v.first_air_date||v.number_of_seasons||v.episodesCount||Array.isArray(v.seasons)&&v.seasons.length>0||d>1||p>1||A>=0&&(x[A].isSeries||x[A].type==="tv"||x[A].season>1||x[A].episode>1)||S&&(S.isSeries||S.type==="tv"||S.season>1||S.episode>1));let L=T?"anime":I?"tv":"movie";const{resolvedPoster:z,resolvedBackdrop:O}=Tn(e,i||n,r||a,x),Y=m>0?m:L==="movie"?6600:3e3,j=Y>0?Math.min(100,Math.round(h/Y*100)):0,D=b||j>=90,B={...v,id:e,title:t||(A>=0?x[A].title:S?S.title:"İçerik"),posterPath:z,poster_path:z,backdropPath:O,backdrop_path:O,type:L,isAnime:T,isSeries:I,genres:y&&y.length>0?y:A>=0?x[A].genres:S?S.genres:[],genre_ids:w&&w.length>0?w:A>=0?x[A].genre_ids:S?S.genre_ids:[],original_language:k||(A>=0?x[A].original_language:S?S.original_language:""),origin_country:f&&f.length>0?f:A>=0?x[A].origin_country:S?S.origin_country:[],season:Number(d),episode:Number(p),currentTime:Math.round(h),duration:Math.round(Y),progressPercent:j,completed:D,lastWatchedAt:v.lastWatchedAt?Number(v.lastWatchedAt):Date.now()};A>=0?x[A]=B:x.unshift(B),x.sort((W,ie)=>(ie.lastWatchedAt||0)-(W.lastWatchedAt||0)),nt=x,Qe&&Qe.set(`${e}_${d}_${p}`,B),ot&&ot.set(String(e),B),Ot(),Me(ue.WATCH_HISTORY,x,{isProgressUpdate:!0})}function El(e=[]){if(!Array.isArray(e)||e.length===0)return;const t=Be(),i=new Map;for(let o=0;o<t.length;o++){const s=t[o],l=`${s.id}_${s.season||1}_${s.episode||1}`;i.set(l,s)}for(const o of e){if(!o||!o.id)continue;const s=Number(o.season||1),l=Number(o.episode||1),d=`${o.id}_${s}_${l}`,p=i.get(d);if(p&&p.lastWatchedAt&&o.lastWatchedAt&&p.lastWatchedAt>o.lastWatchedAt&&p.completed&&o.completed)continue;const h=!!(o.isAnime||o.type==="anime"||Fe(o.id)||p&&(p.isAnime||p.type==="anime")||dt(o));h&&Se(o.id);const m=!!(o.isSeries||o.type==="tv"||o.first_air_date||s>1||l>1||p&&(p.isSeries||p.type==="tv")),b=h?"anime":m?"tv":"movie",{resolvedPoster:y,resolvedBackdrop:w}=Tn(o.id,o.posterPath||o.poster_path,o.backdropPath||o.backdrop_path,t),k=o.duration>0?o.duration:b==="movie"?6600:3e3,f=o.currentTime!==void 0?o.currentTime:o.completed?k:0,v=o.progressPercent!==void 0?o.progressPercent:k>0?Math.min(100,Math.round(f/k*100)):0,x=o.completed===!1?!1:o.completed||v>=90,A={...p||{},...o,id:o.id,title:o.title||p?.title||"İçerik",posterPath:y,poster_path:y,backdropPath:w,backdrop_path:w,type:b,isAnime:h,isSeries:m,season:s,episode:l,currentTime:Math.round(f),duration:Math.round(k),progressPercent:v,completed:x,lastWatchedAt:o.lastWatchedAt?Number(o.lastWatchedAt):p?.lastWatchedAt||Date.now()};i.set(d,A)}const n=Array.from(i.values()).sort((o,s)=>(s.lastWatchedAt||0)-(o.lastWatchedAt||0));nt=n,Qe=null,ot=null,Ot();const r=n.filter(o=>!o.completed).length,a=n.filter(o=>o.completed).length;r>0,Me(ue.WATCH_HISTORY,n)}function kd(e,t=1,i=1){let n=Be();n=n.filter(r=>!(r.id==e&&r.season==t&&r.episode==i)),nt=n,Qe&&Qe.delete(`${e}_${t}_${i}`),Ot(),Me(ue.WATCH_HISTORY,n)}function Da(e){let t=Be();t=t.filter(i=>i.id!=e),nt=t,Qe=null,Ot(),Me(ue.WATCH_HISTORY,t)}function Xs(){let e=Be();e=e.filter(t=>!t.completed&&t.progressPercent<90),Me(ue.WATCH_HISTORY,e)}function _d(){let e=Be();const t=e.length;return e=e.filter(i=>!(i.currentTime===1e3&&i.duration===1e3)),nt=e,Qe=null,Ot(),Me(ue.WATCH_HISTORY,e),t-e.length}function Xt(e,t=1,i=1){return $r().get(`${e}_${t}_${i}`)||null}function bn(e,t=1,i=1){const n=Xt(e,t,i);return!!(n&&(n.completed||n.progressPercent>=90))}function Tl(e,t=1,i=1,n=!0,r={}){const a=Be(),o=a.findIndex(y=>y.id==e&&y.season==t&&y.episode==i),s=a.find(y=>y.id==e),l=!!(r.isAnime||r.type==="anime"||Fe(e)||o>=0&&(a[o].isAnime||a[o].type==="anime")||s&&(s.isAnime||s.type==="anime")||dt({id:e,title:r.title,...r}));l&&Se(e);const d=r.type==="movie"&&!l,p=r.duration||(d?6600:3e3),{resolvedPoster:h,resolvedBackdrop:m}=Tn(e,r.posterPath||r.poster_path,r.backdropPath||r.backdrop_path,a),b={id:e,title:r.title||(o>=0?a[o].title:"İçerik"),posterPath:h,poster_path:h,backdropPath:m,backdrop_path:m,type:l?"anime":d?"movie":"tv",isAnime:l,isSeries:!d,season:Number(t),episode:Number(i),currentTime:n?p:0,duration:p,progressPercent:n?100:0,completed:!!n,lastWatchedAt:Date.now()};o>=0?a[o]=b:a.push(b),Me(ue.WATCH_HISTORY,a)}function _m(e,t=!0,i={}){Tl(e,1,1,t,{...i,type:i.type||"movie"})}function Al(e,t=1,i=1,n={}){const r=bn(e,t,i);return Tl(e,t,i,!r,n),{completed:!r}}function Sd(e,t=[],i=!0,n={}){const r=Be(),a=n.title||"Dizi",o=!!(n.isAnime||n.type==="anime"||Fe(e)||dt({id:e,title:a}));o&&Se(e);const s=o?"anime":"tv",l=n.duration||3e3,{resolvedPoster:d,resolvedBackdrop:p}=Tn(e,n.posterPath||n.poster_path,n.backdropPath||n.backdrop_path,r);for(const h of t){const m=h.season_number;if(m===0&&t.length>1)continue;const b=h.episode_count||10;for(let y=1;y<=b;y++){const w=r.findIndex(f=>f.id==e&&f.season==m&&f.episode==y),k={id:e,title:a,posterPath:d,poster_path:d,backdropPath:p,backdrop_path:p,type:s,isAnime:o,isSeries:!0,season:Number(m),episode:y,currentTime:i?l:0,duration:l,progressPercent:i?100:0,completed:!!i,lastWatchedAt:Date.now()};w>=0?r[w]=k:r.push(k)}}Me(ue.WATCH_HISTORY,r)}function xd(e,t,i=10,n=!0,r={}){const a=Be(),o=r.title||"Dizi",s=!!(r.isAnime||r.type==="anime"||Fe(e)||dt({id:e,title:o}));s&&Se(e);const l=s?"anime":"tv",d=r.duration||3e3,{resolvedPoster:p,resolvedBackdrop:h}=Tn(e,r.posterPath||r.poster_path,r.backdropPath||r.backdrop_path,a);for(let m=1;m<=i;m++){const b=a.findIndex(w=>w.id==e&&w.season==t&&w.episode==m),y={id:e,title:o,posterPath:p,poster_path:p,backdropPath:h,backdrop_path:h,type:l,isAnime:s,isSeries:!0,season:Number(t),episode:m,currentTime:n?d:0,duration:d,progressPercent:n?100:0,completed:!!n,lastWatchedAt:Date.now()};b>=0?a[b]=y:a.push(y)}Me(ue.WATCH_HISTORY,a)}function na(e,t=[]){if(!t||t.length===0)return bn(e,1,1);const i=$r();for(const n of t){const r=n.season_number;if(r===0&&t.length>1)continue;const a=n.episode_count||1;for(let o=1;o<=a;o++){const s=i.get(`${e}_${r}_${o}`);if(!s||!s.completed&&s.progressPercent<90)return!1}}return!0}function ra(e,t,i=10){const n=$r();for(let r=1;r<=i;r++){const a=n.get(`${e}_${t}_${r}`);if(!a||!a.completed&&a.progressPercent<90)return!1}return!0}function za(e,t=1,i=1,n=1500,r={}){const a=!!(r.isAnime||r.type==="anime"||Fe(e)||dt({id:e,title:r.title,...r}));a&&Se(e);const o=r.type==="movie"&&!a,s=r.duration||(o?6600:3e3),l=n||Math.round(s*.5);return fs({id:e,title:r.title||"İçerik",posterPath:r.posterPath||r.poster_path||"",backdropPath:r.backdropPath||r.backdrop_path||"",type:a?"anime":o?"movie":"tv",isAnime:a,isSeries:!o,season:t,episode:i,currentTime:l,duration:s,completed:!1})}function aa(e){return e?(ot||$r(),ot&&ot.has(String(e))?ot.get(String(e)):Be().find(i=>i.id==e)||null):null}function li(e){if(!e||e<=0)return"";const t=Math.floor(e/60),i=Math.floor(e%60);if(t>=60){const n=Math.floor(t/60),r=t%60;return`${n}sa ${r>0?r+"dk":""}`}return`${t}:${i<10?"0":""}${i}`}function Zs(e,t){(!t||t<=0)&&(t=3e3);const i=Math.max(0,t-(e||0)),n=Math.round(i/60);if(n<=0)return"Bitti";if(n>=60){const r=Math.floor(n/60),a=n%60;return`${r}sa ${a>0?a+"dk":""} kaldı`}return`${n} dk kaldı`}function Ed(e){if(!e||e<=0)return"0 dakika";const t=Math.floor(e/86400),i=Math.floor(e%86400/3600),n=Math.floor(e%3600/60),r=[];return t>0&&r.push(`${t} gün`),i>0&&r.push(`${i} saat`),(n>0||r.length===0)&&r.push(`${n} dk`),r.join(" ")}function Qs(){if(on)return on;const e=Be();let t=0,i=0,n=0;for(const a of e){const o=hs(a),s=a.duration&&a.duration>0?a.duration:o?6600:3e3;a.completed?t+=s:a.currentTime>0?t+=a.currentTime:a.progressPercent&&a.progressPercent>0?t+=Math.round(a.progressPercent/100*s):t+=s,o?i++:n++}const r=Ed(t);return on={totalSeconds:t,totalMinutes:Math.floor(t/60),totalHours:(t/3600).toFixed(1),formattedTotalTime:r,formattedTotal:r,moviesCount:i,totalMovies:i,episodesCount:n,totalEpisodes:n,totalEntries:e.length},on}function Gn(){if(oi)return oi;const e=Be();if(!e||e.length===0)return oi=[],oi;const t=new Map;for(const n of e){const r=n.id;t.has(r)||t.set(r,[]),t.get(r).push(n)}const i=[];for(const[n,r]of t.entries()){r.sort((l,d)=>(d.lastWatchedAt||0)-(l.lastWatchedAt||0));const a=r[0],o=!!(a.isAnime||a.type==="anime"||Fe(a.id)||dt(a));if(o&&Se(a.id),r.some(l=>l.isSeries===!0||l.type==="tv"||l.type==="anime"||l.first_air_date||l.number_of_seasons||l.season&&l.season>1||l.episode&&l.episode>1||Array.isArray(l.seasons)&&l.seasons.length>0)){if(r.every(L=>L.completed||L.progressPercent>=85))continue;const l=r.find(L=>!L.completed&&L.currentTime>0&&L.progressPercent<100);let d=l?l.season||1:a.season||1;const p=new Set;for(const L of r)L.season===d&&(L.completed||L.progressPercent>=90)&&p.add(L.episode);let h=1,m=!1,b=0,y=a;if(l&&l.season===d)h=l.episode||1,m=!0,b=l.currentTime||0,y=l;else{for(;p.has(h)&&h<=999;)h++;const L=r.find(z=>z.season===d&&z.episode===h);L&&!L.completed&&L.currentTime>0&&(m=!0,b=L.currentTime,y=L)}const w=r.find(L=>L.number_of_seasons||L.status||Array.isArray(L.seasons)&&L.seasons.length>0)||a,k=w.status==="Ended"||w.status==="Canceled",v=(Array.isArray(w.seasons)?w.seasons.find(L=>L.season_number===d):null)?.episode_count||w.season_episodes_count,x=w.number_of_seasons||(Array.isArray(w.seasons)?w.seasons.filter(L=>L.season_number>0).length:0);if(v&&h>v){if(x&&d<x)d++,h=1,m=!1,b=0;else if(k&&!m)continue}if(k&&w.number_of_episodes&&!m&&r.filter(z=>z.completed||z.progressPercent>=90).length>=w.number_of_episodes||p.size===0&&!m&&a.currentTime<=0)continue;const A=y.duration||3e3,S=Zs(b,A),T=o?"Anime Dizisi • ":"";let I="";m&&b>0?I=`${T}S${d} B${h} • Kaldığın: ${li(b)} • ${S}`:p.size>0||h>1?I=`${T}S${d} B${h} • Sıradaki Bölüm`:I=`${T}S${d} B${h} • Sıradaki Bölüm`,i.push({...a,...y,id:a.id,title:a.title||y.title,posterPath:a.posterPath||y.posterPath,poster_path:a.poster_path||y.poster_path,backdropPath:a.backdropPath||y.backdropPath,backdrop_path:a.backdrop_path||y.backdrop_path,type:o?"anime":"tv",isAnime:o,isSeries:!0,season:d,episode:h,currentTime:m?b:0,subtitle:I})}else{if(a.completed||a.progressPercent>=90)continue;if(a.currentTime>0){const d=a.duration||6600,p=Zs(a.currentTime,d),h=o?"Anime Filmi • ":"";i.push({...a,type:o?"anime":"movie",isAnime:o,isSeries:!1,subtitle:`${h}Kaldığın: ${li(a.currentTime)} • ${p}`})}}}return i.sort((n,r)=>(r.lastWatchedAt||0)-(n.lastWatchedAt||0)),oi=i,oi}function sa(){if(sn)return sn;const e=Be(),t=new Map;for(const n of e){const r=n.id;t.has(r)||t.set(r,[]),t.get(r).push(n)}const i=[];for(const[n,r]of t.entries()){r.sort((l,d)=>(d.lastWatchedAt||0)-(l.lastWatchedAt||0));const a=r[0],o=!!(a.isAnime||a.type==="anime"||Fe(a.id)||dt(a));o&&Se(a.id),hs(a)?(a.completed||a.progressPercent>=90)&&i.push({...a,type:o?"anime":"movie",isAnime:o,isSeries:!1,completed:!0,subtitle:o?"✓ Anime Filmi İzlendi":"✓ Film İzlendi"}):r.every(d=>d.completed||d.progressPercent>=85)&&r.length>0&&i.push({...a,type:o?"anime":"tv",isAnime:o,isSeries:!0,completed:!0,subtitle:o?`✓ ${r.length} Bölüm Anime İzlendi`:`✓ ${r.length} Bölüm İzlendi`})}return i.sort((n,r)=>(r.lastWatchedAt||0)-(n.lastWatchedAt||0)),sn=i,sn}function eo(){if(an)return an;const e=Be(),t=new Map;for(const n of e){const r=n.id;t.has(r)||t.set(r,[]),t.get(r).push(n)}const i=[];for(const[n,r]of t.entries()){r.sort((d,p)=>(p.lastWatchedAt||0)-(d.lastWatchedAt||0));const a=r[0],o=!!(a.isAnime||a.type==="anime"||Fe(a.id)||dt(a));o&&Se(a.id);const s=hs(a),l=o?"anime":s?"movie":"tv";if(s){const d=o?"Anime Filmi • ":"";i.push({...a,type:l,isAnime:o,isSeries:!1,subtitle:a.completed?`✓ ${d}İzlendi`:a.progressPercent>0?`${d}%${a.progressPercent} İzlendi`:d.replace(" • ","")})}else{const d=r.filter(h=>h.completed||h.progressPercent>=85).length,p=o?"Anime Dizisi • ":"";i.push({...a,type:l,isAnime:o,isSeries:!0,subtitle:d>0?`${p}${d} Bölüm İzlendi`:`${p}S${a.season||1} B${a.episode||1}`})}}return i.sort((n,r)=>(r.lastWatchedAt||0)-(n.lastWatchedAt||0)),an=i,an}function to(){return Gn()}function Cl(e){if(!e)return e;let t=e.type;const i=!!(e.isAnime||e.type==="anime"||Fe(e.id)||dt(e));i?(t="anime",e.id&&Se(e.id)):(!t||t==="movie")&&(e.isSeries||e.first_air_date||e.media_type==="tv"||e.number_of_seasons||e.episodesCount||!e.title&&e.name?t="tv":t=t||"movie");const n=!!(e.isSeries!==void 0?e.isSeries:t==="tv"||e.first_air_date||e.number_of_seasons||e.episodesCount||e.season&&e.season>1||e.episode&&e.episode>1),r=lr(e.poster_path||e.posterPath||e.poster||""),a=lr(e.backdrop_path||e.backdropPath||e.backdrop||"");return{...e,type:t,isAnime:i,isSeries:n,poster_path:r,posterPath:r,backdrop_path:a,backdropPath:a}}function Vt(){return Wt||(Wt=ft(ue.FAVORITES,[]).map(Cl),zi=new Set(Wt.map(t=>String(t.id))),Wt)}function Td(e){return e?(zi||Vt(),zi.has(String(e))):!1}function Ad(e){if(!e||!e.id)return!1;let t=Vt();const i=t.findIndex(r=>r.id==e.id);let n=!1;if(i>=0)t.splice(i,1);else{const r=!!(e.isAnime||e.type==="anime"||Fe(e.id)||dt(e));r&&Se(e.id);let a=r?"anime":e.type;a||(a=e.first_air_date||e.media_type==="tv"||e.number_of_seasons||!e.title&&e.name?"tv":"movie");const o=e.poster_path||e.posterPath||e.poster||"",s=e.backdrop_path||e.backdropPath||e.backdrop||"";t.unshift({id:e.id,title:e.title||e.name||"İsimsiz",poster_path:o,posterPath:o,backdrop_path:s,backdropPath:s,vote_average:e.vote_average||e.voteAverage||8,release_date:e.release_date||e.first_air_date||"",first_air_date:e.first_air_date||"",genre_ids:e.genre_ids||(Array.isArray(e.genres)?e.genres.map(l=>typeof l=="object"?l.id:l):[]),genres:e.genres||[],original_language:e.original_language||"",origin_country:e.origin_country||[],isAnime:r,type:a,addedAt:Date.now()}),n=!0}return Wt=t,zi=new Set(t.map(r=>String(r.id))),Me(ue.FAVORITES,t),n}function Cd(e){let t=Vt();return t=t.filter(i=>i.id!=e),Wt=t,zi=new Set(t.map(i=>String(i.id))),Me(ue.FAVORITES,t),t}function Gt(){return Ei||(Ei=ft(ue.WATCHLIST,[]).map(Cl),sr=new Set(Ei.map(t=>String(t.id))),Ei)}function ms(e){return e?(sr||Gt(),sr.has(String(e))):!1}function Ll(e){if(!e||!e.id)return!1;let t=Gt();const i=t.findIndex(r=>r.id==e.id);let n=!1;if(i>=0)t.splice(i,1);else{const r=!!(e.isAnime||e.type==="anime"||Fe(e.id)||dt(e));r&&Se(e.id);let a=r?"anime":e.type;a||(a=e.first_air_date||e.media_type==="tv"||e.number_of_seasons||!e.title&&e.name?"tv":"movie");const o=e.poster_path||e.posterPath||e.poster||"",s=e.backdrop_path||e.backdropPath||e.backdrop||"";t.unshift({id:e.id,title:e.title||e.name||"İsimsiz",poster_path:o,posterPath:o,backdrop_path:s,backdropPath:s,vote_average:e.vote_average||e.voteAverage||8,release_date:e.release_date||e.first_air_date||"",first_air_date:e.first_air_date||"",genre_ids:e.genre_ids||(Array.isArray(e.genres)?e.genres.map(l=>typeof l=="object"?l.id:l):[]),genres:e.genres||[],original_language:e.original_language||"",origin_country:e.origin_country||[],isAnime:r,type:a,addedAt:Date.now()}),n=!0}return Me(ue.WATCHLIST,t),n}function Ld(e){let t=Gt();return t=t.filter(i=>i.id!=e),Me(ue.WATCHLIST,t),t}function Id(){nt=[],Qe=new Map,ot=new Map,Ot(),Me(ue.WATCH_HISTORY,[])}function Rd(e,t=1,i=1){return kd(e,t,i)}function Lt(){return Yt||(Yt=ft(ue.USER_SETTINGS,{autoplayNext:!0,preferredResolution:"1080p",theme:"dark",subtitlesEnabled:!0,cardLayout:"portrait",hoverPreviewsEnabled:!0,trailersEnabled:!0}),Yt)}function Il(e){Yt={...Lt(),...e},Me(ue.USER_SETTINGS,Yt),typeof window<"u"&&window.dispatchEvent(new CustomEvent("cinepulse_settings_changed",{detail:Yt}))}function Rl(){const e=ft(ue.WATCH_HISTORY,[]),t=ft(ue.FAVORITES,[]),i=ft(ue.WATCHLIST,[]),n=ft(ue.USER_SETTINGS,{}),r={version:"1.0.0",exportDate:new Date().toISOString(),appName:"CinePulse Studio",watchHistory:e,favorites:t,watchlist:i,userSettings:n,data:{watchHistory:e,favorites:t,watchlist:i,userSettings:n}},a=JSON.stringify(r,null,2),o=new Blob([a],{type:"application/json;charset=utf-8"}),s=URL.createObjectURL(o),l=document.createElement("a");l.href=s,l.download=`cinepulse_yedek_${new Date().toISOString().split("T")[0]}.json`,document.body.appendChild(l),l.click(),setTimeout(()=>{document.body.removeChild(l),URL.revokeObjectURL(s)},1e3)}function $l(e,t="merge"){try{let i=null;if(typeof e=="string"?i=JSON.parse(e.trim()):typeof e=="object"&&e!==null&&(i=e),!i)throw new Error("Geçersiz veya boş yedek dosyası.");let n=[],r=[],a=[],o={};if(Array.isArray(i)?n=i:typeof i=="object"&&(n=i.watchHistory||i.data?.watchHistory||i.sineflix_watch_history_v1||i.history||[],r=i.favorites||i.data?.favorites||i.sineflix_favorites_v1||[],a=i.watchlist||i.data?.watchlist||i.sineflix_watchlist_v1||[],o=i.userSettings||i.data?.userSettings||i.sineflix_user_settings_v1||{}),Array.isArray(n)||(n=[]),Array.isArray(r)||(r=[]),Array.isArray(a)||(a=[]),t==="replace")Me(ue.WATCH_HISTORY,n),Me(ue.FAVORITES,r),Me(ue.WATCHLIST,a),o&&typeof o=="object"&&Me(ue.USER_SETTINGS,o);else{const s=ft(ue.WATCH_HISTORY,[]),l=new Map;s.forEach(w=>{const k=`${w.id}_${w.season||1}_${w.episode||1}`;l.set(k,w)}),n.forEach(w=>{const k=`${w.id}_${w.season||1}_${w.episode||1}`;if(!l.has(k))l.set(k,w);else{const f=l.get(k);((w.lastWatchedAt||0)>=(f.lastWatchedAt||0)||w.completed)&&l.set(k,{...f,...w})}});const d=Array.from(l.values()).sort((w,k)=>(k.lastWatchedAt||0)-(w.lastWatchedAt||0));Me(ue.WATCH_HISTORY,d);const p=ft(ue.FAVORITES,[]),h=new Map;p.forEach(w=>h.set(String(w.id),w)),r.forEach(w=>{h.has(String(w.id))||h.set(String(w.id),w)}),Me(ue.FAVORITES,Array.from(h.values()));const m=ft(ue.WATCHLIST,[]),b=new Map;m.forEach(w=>b.set(String(w.id),w)),a.forEach(w=>{b.has(String(w.id))||b.set(String(w.id),w)}),Me(ue.WATCHLIST,Array.from(b.values()));const y=ft(ue.USER_SETTINGS,{});Me(ue.USER_SETTINGS,{...y,...o})}return Ir(),window.dispatchEvent(new CustomEvent("sineflix_data_changed",{detail:{action:"import"}})),window.dispatchEvent(new CustomEvent("cinepulse_data_changed",{detail:{action:"import"}})),{success:!0,countHistory:n.length,countFavs:r.length,countWatchlist:a.length,message:`${n.length} izleme kaydı ve ${r.length} favori başarıyla aktarıldı.`}}catch(i){return{success:!1,error:i.message,message:"Yedek dosyası okunamadı: "+i.message}}}function $d(){const e=Be(),t=Vt(),i=Gt(),n=JSON.stringify({history:e,favorites:t,watchlist:i}),r=new Blob([n]).size,a=(r/1024).toFixed(1);return{historyCount:e.length,favoritesCount:t.length,watchlistCount:i.length,bytes:r,kb:a}}function Md(){Ir();try{dn(Mt(ue.WATCH_HISTORY),[]),dn(Mt(ue.FAVORITES),[]),dn(Mt(ue.WATCHLIST),[])}catch{}typeof window<"u"&&window.localStorage&&(localStorage.removeItem(Mt(ue.WATCH_HISTORY)),localStorage.removeItem(Mt(ue.FAVORITES)),localStorage.removeItem(Mt(ue.WATCHLIST))),window.dispatchEvent(new CustomEvent("sineflix_data_changed",{detail:{cleared:!0}}))}function Pd(){if(!(typeof window>"u"||!window.localStorage))try{localStorage.removeItem("cinepulse_epg_live_cache"),localStorage.removeItem("sineflix_epg_cache_v2");for(let t=0;t<localStorage.length;t++){const i=localStorage.key(t);i&&(i.startsWith("cinepulse_home_fast_")||i.startsWith("sineflix_home_fast_"))&&localStorage.removeItem(i)}const e=localStorage.getItem("sineflix_notifications_v1");if(e)try{const t=JSON.parse(e);Array.isArray(t)&&t.length>25&&localStorage.setItem("sineflix_notifications_v1",JSON.stringify(t.slice(0,25)))}catch{}}catch{}}Pd();const Bd="https://api.themoviedb.org/3",gs=["4e44d9029b1270a757cddc766a1bcb63","844dba0bfd8f3a4f3799f6130ef9e335"];let Oa=0;function Dd(){return gs[Oa]}function io(){Oa=(Oa+1)%gs.length}const et={POSTER_SMALL:"https://image.tmdb.org/t/p/w185",POSTER_MEDIUM:"https://image.tmdb.org/t/p/w342",BACKDROP_LARGE:"https://image.tmdb.org/t/p/w780",BACKDROP_XLARGE:"https://image.tmdb.org/t/p/w1280",BACKDROP_ORIGINAL:"https://image.tmdb.org/t/p/original",STILL_MEDIUM:"https://image.tmdb.org/t/p/w300"},zd='<svg xmlns="http://www.w3.org/2000/svg" width="500" height="750" viewBox="0 0 500 750"><rect width="500" height="750" fill="#0b0f19"/><circle cx="250" cy="300" r="160" fill="#f59e0b" opacity="0.25"/><g transform="translate(190, 230) scale(2.5)" fill="none" stroke="#f59e0b" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/></g><text x="250" y="430" font-family="sans-serif" font-weight="800" font-size="30" fill="#ffffff" text-anchor="middle">Cine<tspan fill="#f59e0b">Pulse</tspan></text><text x="250" y="470" font-family="sans-serif" font-weight="500" font-size="16" fill="#64748b" text-anchor="middle">Görsel Yüklenemedi</text></svg>',wn=`data:image/svg+xml,${encodeURIComponent(zd)}`,Od='<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><circle cx="50" cy="50" r="50" fill="#1e293b"/><circle cx="50" cy="40" r="18" fill="#64748b"/><path d="M 20 85 C 20 65, 80 65, 80 85 Z" fill="#64748b"/></svg>',cr=`data:image/svg+xml,${encodeURIComponent(Od)}`;function lt(e,t=et.POSTER_MEDIUM){if(!e||e==="null"||e==="undefined"||e==="")return wn;if(e.startsWith("http")||e.startsWith("data:"))return e;let i=e;try{for(;i.includes("%");){const n=decodeURIComponent(i);if(n===i)break;i=n}}catch{}return i=i.replace(/^\/+/,"/"),i.startsWith("/")||(i=`/${i}`),i==="/"||i==="/null"||i==="/undefined"?wn:`${t}${i}`}const oa={};async function ys(e){if(!e||e.trim().length===0)return"";if(oa[e])return oa[e];try{const t=`https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=tr&dt=t&q=${encodeURIComponent(e)}`,i=await fetch(t,{signal:AbortSignal.timeout(1200)});if(i.ok){const n=await i.json();if(n&&n[0]){const r=n[0].map(a=>a[0]).join("");return oa[e]=r,r}}}catch{}return e}const la=new Map;async function me(e,t={}){const i=`${e}_${JSON.stringify(t)}`;if(la.has(i))return la.get(i);for(let n=0;n<gs.length;n++)try{const r=new URL(`${Bd}${e}`);r.searchParams.append("api_key",Dd());for(let o in t)t[o]!==void 0&&t[o]!==null&&r.searchParams.append(o,t[o]);const a=await fetch(r.toString(),{signal:AbortSignal.timeout(6e3)});if(a.ok){const o=await a.json();return la.set(i,o),o}else io()}catch{io()}return null}const Nd=new Set([64,84,4370]),Hd=new Set([10764]),qd=["hayalet hikayeleri","a haunting","altin pesinde","gold rush","olumcul av","deadliest catch","hurda avcilari","salvage hunters","tamirat tadilat","wheeler dealers","agir yasamlar","my 600-lb life","evlilige 90 gun","90 day fiance","pasta ustalari","cake boss","agac ev ustalari","treehouse masters","alaska yi kurtarmak","alaskayi kurtarmak","alaska: the last frontier","oto kurtarma kulubu","fast n loud","nehir canavarlari","river monsters","kupon delileri","extreme couponing","temizlik bagimlilari","obsessive compulsive cleaners","asiri cimriler","extreme cheapskates","restoran kurtarma","depo savaslari","storage wars","gumruk kontrol","border security","nasil yapilir","how it's made","how its made","dmax","tlc"],Fd=new Set([3072,34634,3126,45814,1356,45598,61498,59792,29849,23067,44383,44372]);function Je(e){if(!e||e.id&&Fd.has(Number(e.id))||(e.genre_ids||(Array.isArray(e.genres)?e.genres.map(r=>typeof r=="object"?r.id:r):[])).some(r=>Hd.has(Number(r))))return!0;const i=e.networks||[];if(Array.isArray(i)&&i.some(r=>Nd.has(Number(r.id||r))))return!0;const n=(e.title||e.name||e.original_title||e.original_name||"").toLowerCase().replace(/ğ/g,"g").replace(/ü/g,"u").replace(/ş/g,"s").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ç/g,"c");for(const r of qd)if(n.includes(r))return!0;return!!(Ct()&&!Zt(e))}const vs=[[180,["rafadan tayfa","kral sakir","niloya","pepee"]],[225,["miraculous","gumball","adventure time","regular show","teen titans go","ben 10","spongebob","sunger bob"]],[130,["masha and the bear","masa ile koca ayi","winx","scooby doo","ninjago","paw patrol","pijamaskeliler"]],[150,["samurai jack","johnny test","johnny bravo","dexter laboratory","powerpuff girls","courage cowardly dog"]],[110,["avatar the last airbender","avatar son hava bukucu","gravity falls","steven universe","the owl house","amphibia"]]],no=[[180,["naruto","one piece","attack on titan","shingeki no kyojin","demon slayer","kimetsu no yaiba"]],[160,["jujutsu kaisen","death note","solo leveling","bleach","dragon ball"]],[140,["pokemon","beyblade","captain tsubasa","yu gi oh","bakugan","my hero academia","boku no hero"]],[120,["hunter x hunter","tokyo ghoul","fullmetal alchemist","vinland saga","monster","jojo","haikyuu","blue lock"]],[105,["chainsaw man","one punch man","spy x family","black clover","frieren","kaiju no 8","dandadan"]]],Ud=[[320,["rick and morty","invincible","arcane","bojack horseman"]],[280,["south park","family guy","american dad","futurama","the simpsons"]],[250,["love death robots","harley quinn","archer","solar opposites"]],[220,["castlevania","blue eye samurai","the legend of vox machina","spawn","primal"]],[200,["big mouth","f is for family","disenchantment","inside job","smiling friends","hazbin hotel","helluva boss"]],[180,["boondocks","paradise pd","brickleberry","final space","scavengers reign","pantheon","undone","creature commandos"]]];function Mr(e=""){return String(e).toLocaleLowerCase("tr-TR").normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/ı/g,"i").replace(/[^a-z0-9]+/g," ").trim()}function bs(e){const t=String(e?.original_language||"").toLowerCase(),i=Array.isArray(e?.origin_country)?e.origin_country.map(n=>String(n).toUpperCase()):[];return["ja","zh","ko"].includes(t)||i.some(n=>["JP","CN","KR"].includes(n))}function jd(e,t=!1){const i=Mr([e.name,e.title,e.original_name,e.original_title].filter(Boolean).join(" ")),n=t?no:[...vs,...no];for(const[r,a]of n)if(a.some(o=>i.includes(o)))return r;return 0}function ro(e){const t=Mr([e.name,e.title,e.original_name,e.original_title].filter(Boolean).join(" "));for(const[i,n]of Ud)if(n.some(r=>t.includes(r)))return i;return 0}function Ml(e){const t=Mr([e.name,e.title,e.original_name,e.original_title].filter(Boolean).join(" "));return vs.some(([,i])=>i.some(n=>t.includes(n)))}function Kd(e){const t=Mr([e.name,e.title,e.original_name,e.original_title].filter(Boolean).join(" "));for(const[i,n]of vs)if(n.some(r=>t.includes(r)))return i;return 0}function Pr(e,{animeOnly:t=!1}={}){return e.map(i=>{const n=Math.min(220,Number(i.popularity)||0),r=Math.min(95,Math.log10((Number(i.vote_count)||0)+1)*22),a=Math.max(0,(Number(i.vote_average)||0)-5)*5,o=!t&&i.origin_country?.includes("TR")?115:0,s=n+r+a+o+jd(i,t);return{...i,_turkeyPopularityScore:Math.round(s*100)/100}}).sort((i,n)=>n._turkeyPopularityScore-i._turkeyPopularityScore)}async function Na(e=1){const[t,i,n,r,a]=await Promise.all([me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"16",without_genres:"27,80,53,10752,18","vote_count.gte":10,include_adult:!1}),me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"10762",without_genres:"27,80,53","vote_count.gte":5,include_adult:!1}),me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"16",with_origin_country:"TR",without_genres:"27,80,53,10752,18",include_adult:!1}),me("/discover/tv",{sort_by:"vote_count.desc",page:e+2,language:"tr-TR",with_genres:"16",without_genres:"27,80,53,10752,18","vote_count.gte":10,include_adult:!1}),e===1?me("/trending/tv/week",{language:"tr-TR"}):Promise.resolve(null)]),o=(a?.results||[]).filter(d=>(d.genre_ids||[]).includes(16)),s=[...t?.results||[],...i?.results||[],...n?.results||[],...r?.results||[],...o],l=new Map;for(const d of s)d&&d.id&&!l.has(d.id)&&l.set(d.id,d);return Pr(Array.from(l.values()).filter(d=>(d.poster_path||d.backdrop_path)&&!Je(d)).map(d=>({...d,type:"tv",media_type:"tv",isSeries:!0,overview:(d.overview||"").trim()||qe(d,"tv")})))}function Wd(e){const t=new Map;for(const i of e)i?.id&&!t.has(i.id)&&t.set(i.id,i);return Pr(Array.from(t.values()).filter(i=>{const n=(i.genre_ids||[]).map(Number);return(i.poster_path||i.backdrop_path)&&n.includes(16)&&(n.includes(10751)||n.includes(10762)||Ml(i))&&!bs(i)&&Zt(i)&&!Je(i)}).map(i=>({...i,type:"tv",media_type:"tv",isSeries:!0,overview:(i.overview||"").trim()||qe(i,"tv")})))}async function Pl(e,t,i){const n=await Promise.all(t.map(([r,a])=>me("/discover/tv",{sort_by:i,page:e,language:"tr-TR",with_genres:"16",without_genres:"18,27,53,80,99,10752,10764,10766,10767","first_air_date.gte":r,"first_air_date.lte":a,include_adult:!1})));return Wd(n.flatMap(r=>r?.results||[]))}async function ao(e=1){return Pl(e,[["2020-01-01","2099-12-31"],["2015-01-01","2019-12-31"]],"popularity.desc")}async function so(e=1){return Pl(e,[["2010-01-01","2014-12-31"],["2000-01-01","2009-12-31"],["1990-01-01","1999-12-31"],["1900-01-01","1989-12-31"]],"vote_count.desc")}async function Ha(e=1){const[t,i,n]=await Promise.all([me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"16",without_genres:"10751,10762","vote_count.gte":80,include_adult:!1}),me("/discover/tv",{sort_by:"vote_count.desc",page:e,language:"tr-TR",with_genres:"16",without_genres:"10751,10762","vote_average.gte":6.5,"vote_count.gte":150,include_adult:!1}),e===1?me("/trending/tv/week",{language:"tr-TR"}):Promise.resolve(null)]),r=(n?.results||[]).filter(o=>(o.genre_ids||[]).includes(16)),a=new Map;for(const o of[...t?.results||[],...i?.results||[],...r])o?.id&&!a.has(o.id)&&a.set(o.id,o);return Array.from(a.values()).filter(o=>{const s=(o.genre_ids||[]).map(Number);return(o.poster_path||o.backdrop_path)&&s.includes(16)&&!s.includes(10751)&&!s.includes(10762)&&!bs(o)&&!Ml(o)&&(e===1?ro(o)>0:!0)&&!Je(o)}).map(o=>{const s=Math.min(250,Number(o.popularity)||0),l=Math.min(130,Math.log10((Number(o.vote_count)||0)+1)*30),d=Math.max(0,(Number(o.vote_average)||0)-5)*8;return{...o,type:"tv",media_type:"tv",isSeries:!0,overview:(o.overview||"").trim()||qe(o,"tv"),_adultAnimationScore:s+l+d+ro(o)}}).sort((o,s)=>s._adultAnimationScore-o._adultAnimationScore)}async function dr(e=1){const t=[["2020-01-01","2099-12-31"],["2015-01-01","2019-12-31"],["2010-01-01","2014-12-31"],["2000-01-01","2009-12-31"],["1990-01-01","1999-12-31"],["1980-01-01","1989-12-31"],["1900-01-01","1979-12-31"]],i=await Promise.all(t.map(([r,a])=>me("/discover/tv",{sort_by:"vote_count.desc",page:e,language:"tr-TR",with_genres:"16",without_genres:"27,80,53,99,10764,10766,10767","first_air_date.gte":r,"first_air_date.lte":a,include_adult:!1}))),n=new Map;for(const r of i)for(const a of r?.results||[])a?.id&&!n.has(a.id)&&n.set(a.id,a);return Array.from(n.values()).filter(r=>{const a=(r.genre_ids||[]).map(Number);return(r.poster_path||r.backdrop_path)&&a.includes(16)&&!a.includes(99)&&!bs(r)&&!Br(r.name||r.title||"")&&!Je(r)}).map(r=>{const a=parseInt(String(r.first_air_date||"").slice(0,4),10)||9999,o=Math.min(220,Number(r.popularity)||0),s=Math.min(115,Math.log10((Number(r.vote_count)||0)+1)*27),l=a<=2018?35:0;return{...r,type:"tv",media_type:"tv",isSeries:!0,overview:(r.overview||"").trim()||qe(r,"tv"),_cartoonScore:o+s+l+Kd(r)}}).sort((r,a)=>a._cartoonScore-r._cartoonScore)}async function qa(e=1){const t=await me("/discover/movie",{sort_by:"vote_count.desc",page:e,language:"tr-TR",with_genres:"16,10751",without_genres:"27,80,53,10752","vote_count.gte":40});return!t||!t.results?[]:t.results.filter(i=>(i.poster_path||i.backdrop_path)&&!Je(i)).map(i=>({...i,type:"movie",media_type:"movie",overview:(i.overview||"").trim()||qe(i,"movie")}))}async function oo(e=1){const t=await me("/discover/movie",{sort_by:"vote_average.desc",page:e,language:"tr-TR",with_genres:"12,14,10751","vote_count.gte":150,without_genres:"27,80,53"});return!t||!t.results?[]:t.results.filter(i=>(i.poster_path||i.backdrop_path)&&!Je(i)).map(i=>({...i,type:"movie",media_type:"movie",overview:(i.overview||"").trim()||qe(i,"movie")}))}async function Bl(e="all",t="week",i=1){const[n,r]=await Promise.all([me(`/trending/${e}/${t}`,{page:i,language:"tr-TR"}),me(`/trending/${e}/${t}`,{page:i,language:"en-US"})]);if(!n||!n.results)return[];const a=new Map((r?.results||[]).map(o=>[o.id,o.overview]));return n.results.filter(o=>(o.poster_path||o.backdrop_path)&&!Je(o)).map(o=>{const l=o.media_type==="tv"||!!o.first_air_date?"tv":"movie",d=(o.overview||"").trim(),p=(a.get(o.id)||"").trim();return{...o,type:l,media_type:l,overview:d||p||qe(o,l)}})}async function ur(e=1){const t=await me("/discover/tv",{sort_by:"vote_count.desc",page:e,language:"tr-TR","vote_count.gte":300,without_genres:"16"});return!t||!t.results?[]:t.results.filter(i=>(i.poster_path||i.backdrop_path)&&!Je(i)).map(i=>{const n=(i.overview||"").trim();return{...i,type:"tv",media_type:"tv",overview:n||qe(i,"tv")}})}async function pr(e=1){const t=await me("/discover/movie",{sort_by:"vote_count.desc",page:e,language:"tr-TR","vote_count.gte":500});return!t||!t.results?[]:t.results.filter(i=>(i.poster_path||i.backdrop_path)&&!Je(i)).map(i=>{const n=(i.overview||"").trim();return{...i,type:"movie",media_type:"movie",overview:n||qe(i,"movie")}})}function Br(e){return e?/[\u3040-\u30ff\u3400-\u4dbf\u4e00-\u9fff\uf900-\ufaff\uff66-\uff9f\u1100-\u11ff\u3130-\u318f\ua960-\ua97f\ud7b0-\ud7ff\u0600-\u06ff\u0400-\u04ff\u0e00-\u0e7f]/.test(e):!1}async function hr(e=1){const[t,i,n,r]=await Promise.all([me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"16",with_original_language:"ja","vote_count.gte":50}),me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"en-US",with_genres:"16",with_original_language:"ja","vote_count.gte":50}),me("/discover/tv",{sort_by:"vote_count.desc",page:e,language:"tr-TR",with_genres:"16",with_original_language:"ja","vote_count.gte":100}),e===1?me("/trending/tv/week",{language:"tr-TR"}):Promise.resolve(null)]);if(!t||!t.results)return[];const a=new Map((i?.results||[]).map(s=>[s.id,s.name||s.title])),o=new Map([...t.results||[],...n?.results||[],...(r?.results||[]).filter(s=>s.original_language==="ja"&&(s.genre_ids||[]).includes(16))].map(s=>[s.id,s]));return Pr(Array.from(o.values()).filter(s=>(s.poster_path||s.backdrop_path)&&!Je(s)).map(s=>{let l=s.name||s.title||"";return(!l||Br(l))&&(l=a.get(s.id)||s.original_name||s.original_title||l),s.id&&Se(s.id),{...s,name:l,title:l,type:"anime",media_type:"anime",isAnime:!0,isSeries:!0,overview:s.overview||qe(s,"tv")}}),{animeOnly:!0})}async function Fa(e=1){const[t,i]=await Promise.all([me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"16,10762",with_original_language:"ja",without_genres:"27,80,53,10752,18","vote_count.gte":10}),me("/discover/tv",{sort_by:"popularity.desc",page:e,language:"en-US",with_genres:"16,10762",with_original_language:"ja",without_genres:"27,80,53,10752,18","vote_count.gte":10})]);if(!t||!t.results)return[];const n=new Map((i?.results||[]).map(r=>[r.id,r.name||r.title]));return Pr(t.results.filter(r=>(r.poster_path||r.backdrop_path)&&!Je(r)).map(r=>{let a=r.name||r.title||"";return(!a||Br(a))&&(a=n.get(r.id)||r.original_name||r.original_title||a),r.id&&Se(r.id),{...r,name:a,title:a,type:"anime",media_type:"anime",isAnime:!0,isSeries:!0,overview:r.overview||qe(r,"tv")}}),{animeOnly:!0})}async function fr(e=1){const[t,i]=await Promise.all([me("/discover/movie",{sort_by:"vote_count.desc",page:e,language:"tr-TR",with_genres:"99","vote_count.gte":40}),me("/discover/tv",{sort_by:"vote_count.desc",page:e,language:"tr-TR",with_genres:"99","vote_count.gte":30})]),n=(t?.results||[]).filter(a=>(a.poster_path||a.backdrop_path)&&!Je(a)).map(a=>({...a,type:"movie",media_type:"movie",overview:(a.overview||"").trim()||qe(a,"movie")})),r=(i?.results||[]).filter(a=>(a.poster_path||a.backdrop_path)&&!Je(a)).map(a=>({...a,type:"tv",media_type:"tv",overview:(a.overview||"").trim()||qe(a,"tv")}));return[...n,...r].sort((a,o)=>(o.vote_count||0)-(a.vote_count||0))}async function Yd(e=1){const t=await me("/discover/movie",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"99,10751",without_genres:"27,80,53,10752","vote_count.gte":10}),i=await me("/discover/movie",{sort_by:"popularity.desc",page:e,language:"tr-TR",with_genres:"99,16",without_genres:"27,80,53","vote_count.gte":5}),n=t?.results||[],r=i?.results||[],a=new Set,o=[];for(const l of[...n,...r])l&&l.id&&!a.has(l.id)&&(a.add(l.id),o.push(l));const s=["jackass","murder","killer","war","drug","crime","sex","violent","savaş","cinayet","uyuşturucu"];return o.filter(l=>{if(!(l.poster_path||l.backdrop_path)||Je(l))return!1;const d=`${l.title||""} ${l.name||""} ${l.overview||""}`.toLowerCase();return!s.some(p=>d.includes(p))}).map(l=>({...l,type:"movie",media_type:"movie",overview:l.overview||qe(l,"movie")}))}async function Ci(e="tv",t=1){const[i,n]=await Promise.all([me(`/${e}/top_rated`,{page:t,language:"tr-TR"}),me(`/${e}/top_rated`,{page:t,language:"en-US"})]);if(!i||!i.results)return[];const r=new Map((n?.results||[]).map(a=>[a.id,a.overview]));return Promise.all(i.results.filter(a=>(a.poster_path||a.backdrop_path)&&!Je(a)).map(async a=>{let o=(a.overview||"").trim();const s=(r.get(a.id)||"").trim();return(!o||o.length<15)&&s&&s.length>10&&(o=await ys(s)),{...a,type:e,media_type:e,overview:o||s||qe(a,e)}}))}async function Dl({type:e="tv",genreId:t=null,page:i=1,sortBy:n="popularity.desc",minRating:r=0,isAnime:a=!1,isDoc:o=!1,yearMin:s=null,yearMax:l=null,withNetworks:d=null,withProviders:p=null}){const h={sort_by:n,page:i,language:"tr-TR"};return a?(h.with_genres=t?`16,${t}`:"16",h.with_original_language="ja"):o?h.with_genres=t?`99,${t}`:"99":t&&(h.with_genres=t),r>0&&(h["vote_average.gte"]=r,h["vote_count.gte"]=40),s&&(e==="movie"?h["primary_release_date.gte"]=`${s}-01-01`:h["first_air_date.gte"]=`${s}-01-01`),l&&(e==="movie"?h["primary_release_date.lte"]=`${l}-12-31`:h["first_air_date.lte"]=`${l}-12-31`),d&&(e==="tv"?h.with_networks=d:(h.with_watch_providers=p||d,h.watch_region="TR")),((await me(e==="movie"?"/discover/movie":"/discover/tv",h))?.results||[]).filter(w=>(w.poster_path||w.backdrop_path)&&!Je(w)).map(w=>(a&&w.id&&Se(w.id),{...w,type:a?"anime":e,media_type:a?"anime":e,isAnime:a,isSeries:e==="tv"}))}function qe(e,t="tv"){if(!e)return"Sürükleyici atmosferi ve zengin hikaye örgüsüyle izleyicileri ekran başına kilitleyen etkileyici bir yapım.";const i=e.title||e.name||"Bu yapım",n=t==="tv"||e.media_type==="tv"||!!e.first_air_date||e.seasons&&e.seasons.length>0||!!e.number_of_seasons,r=n?"dizi":"film";let a=[];Array.isArray(e.genres)&&e.genres.length>0&&(a=e.genres.map(v=>typeof v=="string"?v:v.name).filter(Boolean));const o=a.length>0?a.slice(0,3).join(", "):n?"Dram ve Gerilim":"Sinema",s=e.release_date||e.first_air_date||(e.year?String(e.year):""),l=s?` ${s.slice(0,4)} yılında izleyiciyle buluşan ve`:"",d=Number(e.vote_average||e.rating||0),p=d>0?`IMDb'de ${d.toFixed(1)}/10 gibi başarılı bir puana sahip olan`:"Eleştirmenler ve izleyiciler tarafından büyük beğeni toplayan";let h="";const m=e.credits?.cast||[];if(m.length>0){const v=m.slice(0,3).map(x=>x.name).filter(Boolean).join(", ");v&&(h=` Başrollerinde ${v} gibi başarılı isimlerin yer aldığı`)}let b="";const y=e.credits?.crew?.filter(v=>v.job==="Director").map(v=>v.name)||[],w=e.created_by?.map(v=>v.name)||[],k=y[0]||w[0];k&&(b=` ${k} imzalı`);let f="";return e.tagline&&e.tagline.trim().length>6&&(f=` "${e.tagline.trim()}" temasıyla dikkat çeken yapım,`),`${i}, ${o} türünde öne çıkan${l}${b}${h} etkileyici bir ${r} deneyimi sunuyor.${f} ${p} yapım, beklenmedik ters köşeleri, derin karakter gelişimleri ve soluksuz temposuyla izleyenlere unutulmaz anlar vadediyor.`}async function lo(e="tv",t){const i=await me(`/${e}/${t}`,{append_to_response:"credits,similar,recommendations,videos,external_ids",language:"tr-TR"});if(!i)return null;(i.original_language==="ja"||Array.isArray(i.origin_country)&&i.origin_country.includes("JP"))&&Array.isArray(i.genres)&&i.genres.some(s=>s.id===16||/anim/i.test(s.name))&&i.id&&Se(i.id);let r=(i.overview||"").trim();if(!r||r.length<15)try{const s=await me(`/${e}/${t}`,{language:"en-US"});if(s&&s.overview&&s.overview.trim().length>10){const l=await ys(s.overview.trim());l&&l.length>15&&(i.overview=l)}}catch{}(!i.overview||i.overview.trim().length<15)&&(i.overview=qe(i,e));let a=i.videos?.results||[];if(!a.some(s=>s.site==="YouTube"&&(s.type==="Trailer"||s.type==="Teaser")))try{const l=(await me(`/${e}/${t}/videos`,{language:"en-US"}))?.results||[];l.length>0&&(i.videos=i.videos||{},i.videos.results=[...a,...l])}catch{}return i}const Pn=new Map;function ca(e,t){if(!e||e.site!=="YouTube"||!e.key)return-1;let n={Trailer:500,Teaser:360,Promo:280,"Opening Credits":240,Clip:160,Featurette:100}[e.type]||50;return e.official===!0&&(n+=1e3),t==="tr"?n+=50:t==="en"?n+=25:t==="ja"&&(n+=15),/official|resmi|final trailer|main trailer|tanıtım|fragman/i.test(e.name||"")&&(n+=80),/fan|concept|reaction|breakdown/i.test(e.name||"")&&(n-=800),n}function kn(e="tv",t,i=""){if(Lt().trailersEnabled===!1)return Promise.resolve(null);const n=`${e}:${t}`;if(Pn.has(n))return Pn.get(n);const r=(async()=>{try{const[a,o,s]=await Promise.all([me(`/${e}/${t}/videos`,{language:"tr-TR"}).catch(()=>null),me(`/${e}/${t}/videos`,{language:"en-US"}).catch(()=>null),me(`/${e}/${t}/videos`,{include_video_language:"tr,en,ja,ko,null"}).catch(()=>null)]),l=new Set,d=[],p=(m,b)=>{if(Array.isArray(m))for(const y of m)y&&y.key&&!l.has(y.key)&&(l.add(y.key),d.push({video:y,language:b||y.iso_639_1||"en"}))};p(a?.results,"tr"),p(o?.results,"en"),p(s?.results,""),d.sort((m,b)=>ca(b.video,b.language)-ca(m.video,m.language));const h=d.find(m=>ca(m.video,m.language)>=0)?.video;if(h?.key){const m=h.key.trim(),b=encodeURIComponent(m);return{key:m,name:h.name||"Resmi Fragman",site:h.site,type:h.type,embedUrl:`https://www.youtube.com/embed/${b}?autoplay=1&rel=0&modestbranding=1&playsinline=1`,watchUrl:`https://www.youtube.com/watch?v=${b}`}}if(i&&typeof i=="string"&&i.trim().length>1){const m=i.trim(),b=`${m} Fragman`;return{key:"",name:`${m} Tanıtım`,site:"YouTube",type:"Trailer",embedUrl:`https://www.youtube.com/embed?listType=search&list=${encodeURIComponent(b)}&autoplay=1&rel=0`,watchUrl:`https://www.youtube.com/results?search_query=${encodeURIComponent(b)}`}}}catch{}return null})();return Pn.set(n,r),r.then(a=>{a||Pn.delete(n)}),r}async function Vd(e,t=1){const i=await me(`/tv/${e}/season/${t}`,{language:"tr-TR"});if(!i||!i.episodes)return i;const n=await me(`/tv/${e}/season/${t}`,{language:"en-US"});return await Promise.all(i.episodes.map(async(r,a)=>{let o=r.overview?r.overview.trim():"";(!o||o.length<5)&&n&&n.episodes&&n.episodes[a]&&n.episodes[a].overview&&(o=n.episodes[a].overview),o&&(!r.overview||r.overview.length<5)&&(r.overview=await ys(o))})),i}async function ws(e,t=1){if(!e||!e.trim())return[];const i=e.trim().toLowerCase(),[n,r,a]=await Promise.all([me("/search/multi",{query:i,page:t,language:"tr-TR",include_adult:!1}),me("/search/multi",{query:i,page:t,language:"en-US",include_adult:!1}),me("/search/tv",{query:i,page:t,language:"tr-TR",include_adult:!1})]),o=new Map,s=d=>{if(Array.isArray(d)){for(const p of d)if(!(!p||!p.id)&&!(!p.poster_path&&!p.backdrop_path)&&!Je(p)&&!o.has(p.id)){const h=p.media_type==="tv"||!!p.first_air_date||p.name&&!p.title;o.set(p.id,{...p,type:h?"tv":"movie",media_type:h?"tv":"movie"})}}};s(n?.results),s(r?.results),s(a?.results);const l=Array.from(o.values());return l.sort((d,p)=>{const h=(d.title||d.name||d.original_title||d.original_name||"").toLowerCase(),m=(p.title||p.name||p.original_title||p.original_name||"").toLowerCase(),b=h===i?100:h.startsWith(i)?50:0,y=m===i?100:m.startsWith(i)?50:0,w=b+Math.min(100,(d.vote_count||0)/50)+(d.popularity||0)*.5;return y+Math.min(100,(p.vote_count||0)/50)+(p.popularity||0)*.5-w}),l}const vt={ACTION_ADVENTURE:10759,ANIMATION:16,COMEDY:35,CRIME:80,DOCUMENTARY:99,DRAMA:18,FAMILY:10751,MYSTERY:9648,SCI_FI_FANTASY:10765,WAR_POLITICS:10768,WESTERN:37},Ge={ACTION:28,ADVENTURE:12,ANIMATION:16,COMEDY:35,CRIME:80,DOCUMENTARY:99,DRAMA:18,FAMILY:10751,FANTASY:14,HISTORY:36,HORROR:27,MUSIC:10402,MYSTERY:9648,ROMANCE:10749,SCI_FI:878,THRILLER:53,WESTERN:37};async function Gd(e){if(!e)return null;const t=await me(`/person/${e}`,{language:"tr-TR",append_to_response:"combined_credits"});if(!t||!t.biography||t.biography.trim().length===0){const i=await me(`/person/${e}`,{language:"en-US",append_to_response:"combined_credits"});if(i)if(t)t.biography=i.biography,!t.combined_credits&&i.combined_credits&&(t.combined_credits=i.combined_credits);else return i}return t}function Z(e,t="info",i=3500){const n=document.getElementById("toast-container");if(!n)return;const r=document.createElement("div");r.className=`toast toast-${t}`;let a="info";t==="success"&&(a="check-circle"),t==="error"&&(a="alert-circle"),r.innerHTML=`
    <i data-lucide="${a}"></i>
    <span>${e}</span>
  `,n.appendChild(r),V(),setTimeout(()=>{r.style.opacity="0",r.style.transform="translateX(100%)",r.style.transition="all 0.3s ease-out",setTimeout(()=>{r.parentNode&&r.parentNode.removeChild(r)},300)},i)}const gt="https://api.trakt.tv",Jd="AsVFyJXykTMViLCXPMAvFGtk7B_npj5Y3STpzljYnwY",Xd="4b6l8YaAG-GzyY6cSPFR5ea66xrXYEqrrHhn3FiWa7k",ct={TOKEN:"cinepulse_trakt_token",USER:"cinepulse_trakt_user",SETTINGS:"cinepulse_trakt_settings",LAST_SYNC:"cinepulse_trakt_last_sync"};let pi=null,mr=null,gr=0;function Dr(){return localStorage.getItem("cinepulse_trakt_custom_client_id")||Jd}function zl(){return localStorage.getItem("cinepulse_trakt_custom_client_secret")||Xd}function Wi(){try{const e=localStorage.getItem(ct.SETTINGS);if(e)return JSON.parse(e)}catch{}return{autoScrobble:!0,scrobbleThreshold:80,autoSyncOnLaunch:!0}}function co(e){const i={...Wi(),...e};return localStorage.setItem(ct.SETTINGS,JSON.stringify(i)),i}const uo=15*60*1e3;let po=!1,da=!1,Ol=0;function Nl(e){if(po){ei()&&ho(e);return}po=!0;const t=()=>{document.visibilityState!=="hidden"&&(Date.now()-Ol<uo||ho(e))};window.setTimeout(t,4e3),window.setInterval(t,uo),document.addEventListener("visibilitychange",t)}async function ho(e){if(!(!Wi().autoSyncOnLaunch||!ei()||da)){da=!0,Ol=Date.now();try{(await ql(e)).errors.length}catch{}finally{da=!1}}}function Hl(){try{const e=localStorage.getItem(ct.TOKEN);return e?JSON.parse(e):null}catch{return null}}function ei(){const e=Hl();return!!(e&&e.access_token)}function Zd(){try{const e=localStorage.getItem(ct.USER);return e?JSON.parse(e):null}catch{return null}}function Qd(){const e=localStorage.getItem(ct.LAST_SYNC);return e?Number(e):null}async function gi(){const e=Hl();if(!e||!e.access_token)return null;const t=Math.floor(Date.now()/1e3);if((e.created_at||0)+(e.expires_in||0)-t<86400&&e.refresh_token)try{const n=await iu(e.refresh_token);if(n?.access_token)return n.access_token}catch{}return e.access_token}async function eu(){const e=Dr(),t=await fetch(`${gt}/oauth/device/code`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({client_id:e})});if(!t.ok){const i=await t.text();throw new Error(`Device code error (${t.status}): ${i}`)}return await t.json()}function tu(e,t=5,i=()=>{}){pi&&pi.abort(),pi=new AbortController;const{signal:n}=pi;return new Promise((r,a)=>{const o=Dr(),s=zl();let l=Math.max(t,5)*1e3;const d=async()=>{if(n.aborted){a(new Error("Auth polling cancelled"));return}try{const p=await fetch(`${gt}/oauth/device/token`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({code:e,client_id:o,client_secret:s}),signal:n});if(p.status===200){const m=await p.json();localStorage.setItem(ct.TOKEN,JSON.stringify(m));let b=null;try{b=await ru(m.access_token),b&&localStorage.setItem(ct.USER,JSON.stringify(b))}catch{}window.dispatchEvent(new CustomEvent("cinepulse_trakt_auth_changed",{detail:{connected:!0,user:b}})),r(m);return}if(p.status===400){i({status:"pending",message:"Kullanıcı onayı bekleniyor..."}),n.aborted||setTimeout(d,l);return}if(p.status===404)throw new Error("Geçersiz cihaz kodu.");if(p.status===409)throw new Error("Bu kod zaten kullanılmış.");if(p.status===410)throw new Error("Kodun süresi doldu. Lütfen tekrar deneyin.");if(p.status===429){l+=2e3,n.aborted||setTimeout(d,l);return}const h=await p.text();throw new Error(`Trakt auth failed: ${h}`)}catch(p){if(n.aborted)return;a(p)}};setTimeout(d,l)})}function Ua(){pi&&(pi.abort(),pi=null)}async function iu(e){const t=Dr(),i=zl(),n=await fetch(`${gt}/oauth/token`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({refresh_token:e,client_id:t,client_secret:i,grant_type:"refresh_token"})});if(!n.ok)throw new Error("Token refresh failed");const r=await n.json();return localStorage.setItem(ct.TOKEN,JSON.stringify(r)),r}function nu(){Ua(),localStorage.removeItem(ct.TOKEN),localStorage.removeItem(ct.USER),localStorage.removeItem(ct.LAST_SYNC),window.dispatchEvent(new CustomEvent("cinepulse_trakt_auth_changed",{detail:{connected:!1}}))}function Bt(e){return{"Content-Type":"application/json","trakt-api-version":"2","trakt-api-key":Dr(),Authorization:`Bearer ${e}`}}async function ru(e=null){const t=e||await gi();if(!t)return null;const i=await fetch(`${gt}/users/me?extended=full`,{headers:Bt(t)});if(!i.ok)return null;const n=await i.json();return localStorage.setItem(ct.USER,JSON.stringify(n)),n}function ks(e,t=0){const i=Math.min(100,Math.max(0,Math.round(t))),n=e.tmdbId||e.id;return(e.isSeries===!0?!0:e.isSeries===!1||e.type==="movie"?!1:!!(e.type==="tv"||e.season&&Number(e.season)>0&&e.type!=="movie"))?{show:{title:e.seriesTitle||e.title||"",ids:{tmdb:Number(n)||void 0}},episode:{season:Math.max(1,Number(e.season)||1),number:Math.max(1,Number(e.episode)||1)},progress:i,app_version:"2.0.0",app_date:"2026-09-25"}:{movie:{title:e.title||"",ids:{tmdb:Number(n)||void 0}},progress:i,app_version:"2.0.0",app_date:"2026-09-25"}}async function Sm(e,t=0){if(!Wi().autoScrobble||!ei())return null;const n=Date.now();if(mr==="start"&&n-gr<8e3)return null;const r=await gi();if(!r)return null;try{const a=ks(e,t),o=await fetch(`${gt}/scrobble/start`,{method:"POST",headers:Bt(r),body:JSON.stringify(a)});if(o.ok)return mr="start",gr=n,await o.json()}catch{}return null}async function xm(e,t=0){if(!Wi().autoScrobble||!ei())return null;const n=await gi();if(!n)return null;try{const r=ks(e,t),a=await fetch(`${gt}/scrobble/pause`,{method:"POST",headers:Bt(n),body:JSON.stringify(r),keepalive:!0});if(a.ok)return mr="pause",gr=Date.now(),await a.json()}catch{}return null}async function Em(e,t=100){if(!Wi().autoScrobble||!ei())return null;const n=await gi();if(!n)return null;try{const r=ks(e,t),a=await fetch(`${gt}/scrobble/stop`,{method:"POST",headers:Bt(n),body:JSON.stringify(r),keepalive:!0});if(a.ok)return mr="stop",gr=Date.now(),await a.json()}catch{}return null}async function au(e){const t=await gi();if(!t||!e||!e.length)return null;const i=[],n=new Map;for(const s of e){const l=s.tmdbId||s.id,d=Number(l);if(!d||isNaN(d))continue;const p=new Date(Number(s.lastWatchedAt)||s.lastWatchedAt||Date.now()),h=Number.isNaN(p.getTime())?new Date().toISOString():p.toISOString();if(s.type==="movie"?!1:!!(s.isSeries||s.type==="tv"||s.type==="anime")){const b=Math.max(1,Number(s.season)||1),y=Math.max(1,Number(s.episode)||1);n.has(d)||n.set(d,{title:s.title||"",ids:{tmdb:d},seasonsMap:new Map});const w=n.get(d);w.seasonsMap.has(b)||w.seasonsMap.set(b,[]),w.seasonsMap.get(b).push({number:y,watched_at:h})}else i.push({title:s.title||"",watched_at:h,ids:{tmdb:d}})}const r=Array.from(n.values()).map(s=>({title:s.title,ids:s.ids,seasons:Array.from(s.seasonsMap.entries()).map(([l,d])=>({number:l,episodes:d}))}));if(i.length===0&&r.length===0)return null;const a={};i.length>0&&(a.movies=i),r.length>0&&(a.shows=r);const o=await fetch(`${gt}/sync/history`,{method:"POST",headers:Bt(t),body:JSON.stringify(a)});if(!o.ok){const s=await o.text();throw new Error(`Trakt API Hatası (${o.status}): ${s}`)}return await o.json()}const su="4e44d9029b1270a757cddc766a1bcb63",ua=new Map;async function pa(e,t=!1){const i=`${t?"tv":"movie"}_${e}`;if(ua.has(i))return ua.get(i);try{const r=await fetch(`https://api.themoviedb.org/3/${t?"tv":"movie"}/${e}?api_key=${su}&language=tr-TR`);if(r.ok){const a=await r.json();return ua.set(i,a),a}}catch{}return null}async function fo(e,t){const i=[],n=new Set,r=e==="shows"?100:250;for(let a=1;;a++){const o=new URLSearchParams({page:String(a),limit:String(r)});e==="shows"&&o.set("extended","progress");const s=await fetch(`${gt}/sync/watched/${e}?${o}`,{headers:Bt(t)});if(!s.ok)throw new Error(`İzlenen ${e==="shows"?"diziler":"filmler"} alınamadı (${s.status})`);const l=await s.json();if(!Array.isArray(l))throw new Error("Trakt izlenenler yanıtı geçersiz");if(l.length===0)break;let d=0;for(const h of l){const m=h[e==="shows"?"show":"movie"]?.ids?.trakt;m&&n.has(m)||(m&&n.add(m),i.push(h),d++)}if(!d)break;const p=Number(s.headers?.get("X-Pagination-Page-Count"));if(p&&a>=p||!p&&l.length<r)break}return i}async function ou(e){const t=await gi();if(!t)return{importedPlaybackCount:0,importedHistoryCount:0};const{saveWatchProgress:i,saveBatchWatchProgress:n,getWatchHistory:r}=e;if(!i&&!n)return{importedPlaybackCount:0,importedHistoryCount:0};let a=0,o=0;const s=[],l=[],d=r?r():[],p=new Map;for(const h of d){const m=`${h.id}_${h.season||1}_${h.episode||1}`;p.set(m,h)}try{const h=await fetch(`${gt}/sync/playback?extended=full&limit=50`,{headers:Bt(t),signal:AbortSignal.timeout(8e3)});if(h.ok){const m=await h.json();if(Array.isArray(m)){for(const b of m){const y=b.type==="movie",w=y?b.movie:b.show||b.episode,k=y?b.movie?.ids?.tmdb||w?.ids?.tmdb:b.show?.ids?.tmdb||b.episode?.ids?.tmdb||w?.ids?.tmdb;if(!k)continue;const f=y?1:b.episode?.season||1,v=y?1:b.episode?.number||1,x=Math.min(99,Math.max(1,Math.round(b.progress||0))),A=b.paused_at?new Date(b.paused_at).getTime():Date.now(),S=`${k}_${f}_${v}`,T=p.get(S);let I=T?.poster_path||T?.posterPath||"",L=T?.backdrop_path||T?.backdropPath||"",z=T?.title||b.show?.title||w?.title||"",O=y?6600:3e3,Y={};if(!I||!z){const D=await pa(k,!y);D&&(I=D.poster_path||"",L=D.backdrop_path||"",z=D.title||D.name||z,D.runtime?O=D.runtime*60:D.episode_run_time?.[0]&&(O=D.episode_run_time[0]*60),y||(Y={number_of_episodes:D.number_of_episodes,number_of_seasons:D.number_of_seasons,status:D.status,seasons:D.seasons}))}const j=Math.max(60,Math.round(x/100*O));l.push({id:k,title:z,posterPath:I,backdropPath:L,type:y?"movie":"tv",isSeries:!y,season:y?void 0:f,episode:y?void 0:v,currentTime:j,duration:O,progressPercent:x,completed:!1,traktImported:!0,lastWatchedAt:A,...Y}),a++}l.length>0&&(n?n(l):i&&l.forEach(b=>i(b)),window.dispatchEvent(new CustomEvent("sineflix_data_changed",{detail:{action:"playback_import",source:"trakt"}})))}}}catch(h){s.push(h.message)}try{{const h=await fo("movies",t);if(Array.isArray(h))for(let m=0;m<h.length;m+=5){const b=h.slice(m,m+5);await Promise.all(b.map(async y=>{const w=y.movie?.ids?.tmdb;if(!w)return;const k=`${w}_1_1`,f=p.get(k);if(f&&f.completed)return;const v=y.last_watched_at?new Date(y.last_watched_at).getTime():Date.now();let x=f?.poster_path||f?.posterPath||"",A=f?.backdrop_path||f?.backdropPath||"",S=f?.title||y.movie?.title||"",T=6600;if(!x||!S){const I=await pa(w,!1);I&&(x=I.poster_path||"",A=I.backdrop_path||"",S=I.title||S,I.runtime&&(T=I.runtime*60))}l.push({id:w,title:S,posterPath:x,backdropPath:A,type:"movie",isSeries:!1,currentTime:T,duration:T,progressPercent:100,completed:!0,traktImported:!0,lastWatchedAt:v}),o++}))}}}catch(h){s.push(h.message)}try{{const h=await fo("shows",t);if(Array.isArray(h))for(let m=0;m<h.length;m+=4){const b=h.slice(m,m+4);await Promise.all(b.map(async y=>{const w=y.show?.ids?.tmdb;if(!w)return;const k=y.show?.title||"",f=await pa(w,!0),v=f?.poster_path||"",x=f?.backdrop_path||"",A=f?.name||f?.title||k,S=f?.episode_run_time?.[0]?f.episode_run_time[0]*60:3e3,T={number_of_episodes:f?.number_of_episodes,number_of_seasons:f?.number_of_seasons,status:f?.status,seasons:f?.seasons},I=Array.isArray(y.seasons)?y.seasons:[];for(const L of I){const z=L.number,O=Array.isArray(L.episodes)?L.episodes:[];for(const Y of O){const j=Y.number,D=`${w}_${z}_${j}`,B=p.get(D);if(B&&B.completed)continue;const W=Y.last_watched_at?new Date(Y.last_watched_at).getTime():Date.now();l.push({id:w,title:A,posterPath:v,backdropPath:x,type:"tv",isSeries:!0,season:z,episode:j,currentTime:S,duration:S,progressPercent:100,completed:!0,traktImported:!0,lastWatchedAt:W,...T}),o++}}}))}}}catch(h){s.push(h.message)}if(l.length>0){if(n)n(l);else if(i)for(const h of l)i(h)}return window.dispatchEvent(new CustomEvent("cinepulse_data_changed",{detail:{action:"import",source:"trakt"}})),window.dispatchEvent(new CustomEvent("sineflix_data_changed",{detail:{action:"import",source:"trakt"}})),{importedPlaybackCount:a,importedHistoryCount:o,errors:s}}async function ql(e){if(!ei())throw new Error("Trakt hesabı bağlı değil");const{getWatchHistory:t,saveWatchProgress:i,saveBatchWatchProgress:n}=e,r={pushedMoviesCount:0,pushedEpisodesCount:0,importedPlaybackCount:0,importedHistoryCount:0,errors:[]};if(i||n)try{const a=await ou(e);r.importedPlaybackCount=a.importedPlaybackCount||0,r.importedHistoryCount=a.importedHistoryCount||0,r.errors.push(...a.errors||[])}catch(a){r.errors.push(`Trakt'tan aktarma: ${a.message}`)}try{const o=(t?t():[]).filter(s=>s.completed&&!s.traktImported);if(o.length>0){const s=await au(o);if(s&&s.added){r.pushedMoviesCount=s.added.movies||0,r.pushedEpisodesCount=s.added.episodes||0;const l=Object.values(s.not_found||{}).reduce((d,p)=>d+(Array.isArray(p)?p.length:0),0);l&&r.errors.push(`Trakt ${l} içeriği katalogunda bulamadı`)}}}catch(a){r.errors.push(`Trakt'a gönderme: ${a.message||"Senkronizasyon hatası"}`)}return r.errors.length===0&&localStorage.setItem(ct.LAST_SYNC,String(Date.now())),r}async function lu(){const e=await gi();if(!e)throw new Error("Trakt hesabı bağlı değil");const t=await fetch(`${gt}/sync/history?limit=1000`,{headers:Bt(e)});if(!t.ok)throw new Error("Trakt geçmişi alınamadı");const i=await t.json();if(!Array.isArray(i)||i.length===0)return 0;const n=i.map(o=>o.id).filter(Boolean);if(n.length===0)return 0;const r=await fetch(`${gt}/sync/history/remove`,{method:"POST",headers:Bt(e),body:JSON.stringify({ids:n})});if(!r.ok){const o=await r.text();throw new Error(`Trakt geçmişi silinemedi: ${o}`)}const a=await r.json();return(a.deleted?.movies||0)+(a.deleted?.episodes||0)}let ai=null;function yr(){let e=document.getElementById("trakt-modal");e||(e=document.createElement("div"),e.id="trakt-modal",e.className="modal-backdrop",document.body.appendChild(e));const t=(r="main",a={})=>{const o=ei(),s=Zd(),l=Wi(),d=Qd();let p="Henüz yapılmadı";if(d){const h=new Date(d);p=`${h.toLocaleDateString("tr-TR")} ${h.toLocaleTimeString("tr-TR",{hour:"2-digit",minute:"2-digit"})}`}if(r==="connecting"){const{userCode:h,verificationUrl:m,expiresIn:b}=a;e.innerHTML=`
      ...
      `;e.classList.remove("hidden"),document.body.style.overflow="hidden",V(e),n(r)},i=()=>{Ua(),e.classList.add("hidden"),e.innerHTML="",document.body.style.overflow="",ai&&(window.removeEventListener("keydown",ai),ai=null)},n=r=>{const a=document.getElementById("trakt-close-btn"),o=document.getElementById("trakt-close-footer-btn");if(a&&(a.onclick=i),o&&(o.onclick=i),e.onclick=s=>{s.target===e&&i()},ai&&window.removeEventListener("keydown",ai),ai=s=>{s.key==="Escape"&&i()},window.addEventListener("keydown",ai),r==="connecting"){const s=document.getElementById("btn-copy-trakt-code");s&&(s.onclick=()=>{const d=s.querySelector(".trakt-code-text")?.textContent;d&&navigator.clipboard.writeText(d).then(()=>{Z("Aktivasyon kodu kopyalandı!","success")}).catch(()=>{Z(`Kod: ${d}`,"info")})});const l=document.getElementById("btn-cancel-trakt-poll");l&&(l.onclick=()=>{Ua(),t("main")})}else{const s=document.getElementById("btn-start-trakt-connect");s&&(s.onclick=async()=>{s.disabled=!0,s.innerHTML="<span>Kod alınıyor...</span>";try{const y=await eu();t("connecting",{userCode:y.user_code,verificationUrl:y.verification_url,expiresIn:y.expires_in}),tu(y.device_code,y.interval,w=>{const k=document.getElementById("trakt-poll-status-text");k&&(k.textContent=w.message)}).then(()=>{Z("Trakt.tv başarıyla bağlandı!","success"),t("main")}).catch(w=>{w.message!=="Auth polling cancelled"&&(Z(`Bağlantı hatası: ${w.message}`,"error"),t("main"))})}catch(y){Z(`Trakt bağlantı başlatılamadı: ${y.message}`,"error"),t("main")}});const l=document.getElementById("btn-trakt-sync-now");l&&(l.onclick=async()=>{const y=document.getElementById("trakt-sync-icon"),w=document.getElementById("trakt-sync-result");l.disabled=!0,y&&y.classList.add("trakt-spin");try{const k=await ql({getWatchHistory:Be,saveWatchProgress:fs,saveBatchWatchProgress:El});w&&(w.style.display="block",w.innerHTML=`
              ...
              `),k.errors.length?Z(`Trakt senkronizasyon uyarısı: ${k.errors.join("; ")}`,"error"):(Z("CinePulse ve Trakt başarıyla karşılıklı eşitlendi!","success"),setTimeout(()=>t("main"),2500))}catch(k){Z(`Aktarım hatası: ${k.message}`,"error")}finally{l.disabled=!1,y&&y.classList.remove("trakt-spin")}});const d=document.getElementById("btn-clean-trakt-history");d&&(d.onclick=()=>{const y=_d();Z(`${y} adet hatalı Trakt kaydı geçmişten temizlendi!`,"success"),t("main")});const p=document.getElementById("btn-wipe-trakt-history");p&&(p.onclick=async()=>{if(confirm("Trakt.tv hesabınızdaki tüm izleme geçmişini silmek istediğinize emin misiniz? Bu işlem geri alınamaz.")){p.disabled=!0,p.innerHTML="<span>Sıfırlanıyor...</span>";try{const y=await lu();Z(`Trakt hesabından ${y} adet kayıt tamamen silindi!`,"success"),t("main")}catch(y){Z(`Hata: ${y.message}`,"error"),p.disabled=!1,t("main")}}});const h=document.getElementById("trakt-toggle-autosync");h&&(h.onchange=y=>{co({autoSyncOnLaunch:y.target.checked}),Z(y.target.checked?"Açılışta otomatik eşitleme açıldı":"Açılışta otomatik eşitleme kapatıldı","info")});const m=document.getElementById("trakt-toggle-scrobble");m&&(m.onchange=y=>{co({autoScrobble:y.target.checked}),Z(y.target.checked?"Otomatik Scrobble açıldı":"Otomatik Scrobble kapatıldı","info")});const b=document.getElementById("btn-trakt-disconnect");b&&(b.onclick=()=>{confirm("Trakt.tv bağlantısını kesmek istediğinize emin misiniz?")&&(nu(),Z("Trakt.tv bağlantısı kesildi","info"),t("main"))})}};t("main")}function Fl(){const e=document.getElementById("data-modal");if(!e)return;const t=$d();e.innerHTML=`
  ...
  `,e.classList.remove("hidden"),document.body.style.overflow="hidden",V();const i=document.getElementById("data-close-btn"),n=document.getElementById("data-close-footer-btn");let r=null;const a=()=>{e.classList.add("hidden"),e.innerHTML="",document.body.style.overflow="",r&&(window.removeEventListener("keydown",r),r=null)};i&&i.addEventListener("click",a),n&&n.addEventListener("click",a),e.onclick=m=>{m.target===e&&a()},r=m=>{m.key==="Escape"&&a()},window.addEventListener("keydown",r);const o=document.getElementById("btn-export-json");o&&o.addEventListener("click",()=>{Rl(),Z("JSON yedek dosyası indirildi!","success")});const s=document.getElementById("btn-open-trakt-from-data");s&&s.addEventListener("click",()=>{a(),yr()});const l=document.getElementById("json-dropzone"),d=document.getElementById("json-file-input");l&&d&&(l.addEventListener("click",()=>d.click()),l.addEventListener("dragover",m=>{m.preventDefault(),l.style.borderColor="var(--accent-green)"}),l.addEventListener("dragleave",()=>{l.style.borderColor="rgba(99, 102, 241, 0.4)"}),l.addEventListener("drop",m=>{m.preventDefault(),l.style.borderColor="rgba(99, 102, 241, 0.4)",m.dataTransfer.files.length>0&&p(m.dataTransfer.files[0])}),d.addEventListener("change",m=>{m.target.files.length>0&&p(m.target.files[0])}));function p(m){if(!m)return;const b=new FileReader;b.onload=y=>{try{const w=document.querySelector('input[name="import-mode"]:checked'),k=w?w.value:"merge",f=$l(y.target.result,k);f.success?(Z(`✓ Yedek yüklendi! (${f.countHistory} izleme kaydı, ${f.countFavs} favori aktarıldı)`,"success"),a()):Z(`Yükleme hatası: ${f.message||f.error}`,"error")}catch(w){Z(`Yedek dosyası işlenirken hata oluştu: ${w.message}`,"error")}},b.onerror=()=>{Z("Dosya okunamadı.","error")},b.readAsText(m)}const h=document.getElementById("btn-clear-all-data");h&&h.addEventListener("click",()=>{confirm("Tüm izleme geçmişinizi silmek istediğinizden emin misiniz? Bu işlem geri alınamaz!")&&(Md(),Z("Tüm yerel veriler temizlendi.","info"),a())})}let Li=null,un=!1;function vr(){return window.matchMedia("(display-mode: standalone)").matches||window.navigator.standalone===!0||document.referrer.includes("android-app://")}function cu(){if(vr()){un=!0,Ji(!1);return}window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),Li=t,Ji(!0)}),window.addEventListener("appinstalled",()=>{Li=null,un=!0,Ji(!1),Z("CinePulse başarıyla cihazınıza yüklendi!","success")}),window.matchMedia("(display-mode: standalone)").addEventListener("change",t=>{t.matches&&(un=!0,Ji(!1))}),/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream&&!vr()&&setTimeout(()=>{Ji(!0)},1e3)}function Ji(e){document.querySelectorAll(".btn-pwa-install").forEach(i=>{e&&!un&&!vr()?i.classList.remove("hidden"):i.classList.add("hidden")})}async function du(){if(vr()||un){Z("CinePulse zaten bir uygulama olarak yüklü.","info");return}if(Li){try{Li.prompt(),(await Li.userChoice).outcome==="accepted"?Z("Yükleme başlatıldı...","success"):Z("Yükleme iptal edildi.","info"),Li=null}catch{}return}/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream?uu():pu()}function uu(){let e=document.getElementById("pwa-ios-modal");e||(e=document.createElement("div"),e.id="pwa-ios-modal",e.className="modal-backdrop pwa-guide-modal",e.innerHTML=`
...
`).filter(Boolean).map(d=>`<li style="margin-bottom: 0.45rem;">${go(d.replace(/^[•\-\*]\s*/,""))}</li>`).join("");n.innerHTML=`
  ...
  `,document.body.appendChild(n),V(n);const a=n.querySelector("#btn-update-later");a&&a.addEventListener("click",()=>{try{localStorage.setItem(Ul,String(Date.now()+12*60*60*1e3))}catch{}n.remove()});const o=d=>{if(Z("APK indirmesi başlatılıyor...","info"),Ni())try{window.open(d,"_system")||(window.location.href=d)}catch{window.location.href=d}else window.location.assign(d);setTimeout(()=>{try{n.remove()}catch{}},2e3)},s=n.querySelector("#btn-update-download");s&&s.addEventListener("click",d=>{d.preventDefault(),o(t)});const l=n.querySelector("#btn-update-github");l&&l.addEventListener("click",d=>{Ni()&&(d.preventDefault(),o(i))})}function go(e=""){return String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}async function jl({manual:e=!1}={}){if(!e)try{const t=parseInt(localStorage.getItem(Ul)||"0",10);if(Date.now()<t)return null}catch{}try{const t=await fetch(`${hu}?_t=${Date.now()}`,{signal:AbortSignal.timeout(6e3),cache:"no-store"});if(!t.ok)throw new Error(`HTTP ${t.status}`);const i=await t.json();if(i&&fu(i.version,mo))return mu(i),i;if(e)return Z(`✓ CinePulse güncel (v${mo})`,"success"),null}catch{return e&&Z("Güncelleme sunucusuna erişilemedi.","error"),null}}function gu(){typeof window>"u"||window.setTimeout(()=>{jl({manual:!1}).catch(()=>{})},4e3)}let Jn=null;function yu(){qt();const e=document.createElement("div");e.id="profile-modal-root",e.className="profile-backdrop",document.body.appendChild(e),Jn=e;const t=(n="select")=>{const r=Jt(),a=En();n==="select"?e.innerHTML=`
        <div class="profile-dialog">
          ...
          <div class="profile-cards-grid">
            ${r.map(w=>{const k=w.id===a.id,f=w.id!=="prof_1";return`
      ...
      `),V(e);const o=e.querySelector("#btn-close-profile-modal");o&&(o.onclick=()=>qt());const s=e.querySelector("#btn-show-add-profile");s&&(s.onclick=()=>t("add")),e.querySelectorAll(".btn-delete-profile").forEach(w=>{w.onclick=k=>{k.stopPropagation();const f=w.getAttribute("data-delete-id"),v=Jt().find(A=>A.id===f);if(!v||!confirm(`"${v.name}" profilini silmek istediğinize emin misiniz?`))return;md(f)?(Z(`"${v.name}" profili silindi.`,"info"),t("select")):Z("Bu profil silinemez.","error")}});const l=e.querySelector("#btn-modal-open-trakt");l&&(l.onclick=()=>{qt(),yr()});const d=e.querySelector("#btn-modal-open-backup");d&&(d.onclick=()=>{qt(),Fl()});const p=e.querySelector("#btn-modal-pwa-install");p&&(p.onclick=()=>{du()});const h=e.querySelector("#btn-modal-check-update");h&&(h.onclick=()=>{jl({manual:!0})}),e.querySelectorAll(".profile-card[data-profile-id]").forEach(w=>{w.onclick=()=>{const k=w.getAttribute("data-profile-id");if(k){const f=Jt().find(v=>v.id===k);or(k),qt(),yo(f)}}});const m=e.querySelector("#btn-cancel-add-profile");m&&(m.onclick=()=>t("select"));const b=e.querySelector("#btn-back-to-profiles");b&&(b.onclick=()=>t("select"));const y=e.querySelector("#form-add-profile");if(y){let w="#f59e0b";y.querySelectorAll(".color-dot").forEach(k=>{k.onclick=()=>{y.querySelectorAll(".color-dot").forEach(f=>f.classList.remove("active")),k.classList.add("active"),w=k.getAttribute("data-color")}}),y.onsubmit=k=>{k.preventDefault();const f=y.querySelector("#new-profile-name"),v=y.querySelector("#new-profile-kid-check"),x=f?f.value.trim():"",A=v?v.checked:!1;if(x){const S=fd({name:x,isKid:A,avatar:A?"smile":"user",color:w});or(S.id),qt(),yo(S)}}}};t("select"),e.onclick=n=>{n.target===e&&qt()};const i=n=>{n.key==="Escape"&&(qt(),window.removeEventListener("keydown",i))};window.addEventListener("keydown",i)}function qt(){if(Jn){try{Jn.remove()}catch{}Jn=null}}function yo(e){const t=document.getElementById("profile-switch-curtain");t&&t.remove();const i=document.createElement("div");i.id="profile-switch-curtain",i.className="profile-switch-curtain is-entering",i.innerHTML=`
  ...
  `,document.body.appendChild(i),V(i),window.dispatchEvent(new CustomEvent("sineflix_profile_changed",{detail:{profile:e}})),setTimeout(()=>{i.classList.remove("is-entering"),i.classList.add("is-leaving"),setTimeout(()=>{i.remove()},450)},600)}const vu="modulepreload",bu=function(e,t){return new URL(e,t).href},vo={},_s=function(t,i,n){let r=Promise.resolve();if(i&&i.length>0){const o=document.getElementsByTagName("link"),s=document.querySelector("meta[property=csp-nonce]"),l=s?.nonce||s?.getAttribute("nonce");r=Promise.allSettled(i.map(d=>{if(d=bu(d,n),d in vo)return;vo[d]=!0;const p=d.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(!!n)for(let y=o.length-1;y>=0;y--){const w=o[y];if(w.href===d&&(!p||w.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${d}"]${h}`))return;const b=document.createElement("link");if(b.rel=p?"stylesheet":vu,p||(b.as="script"),b.crossOrigin="",b.href=d,l&&b.setAttribute("nonce",l),document.head.appendChild(b),p)return new Promise((y,w)=>{b.addEventListener("load",y),b.addEventListener("error",()=>w(new Error(`Unable to preload CSS for ${d}`)))})}))}function a(o){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=o,window.dispatchEvent(s),!s.defaultPrevented)throw o}return r.then(o=>{for(const s of o||[])s.status==="rejected"&&a(s.reason);return t().catch(a)})};async function Qt(e){return(await _s(()=>import("./PlayerModal-DKeTdtQY.js"),__vite__mapDeps([0,1]),import.meta.url)).openPlayerModal(e)}let Ri=null,ja=null;const Xi=e=>String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]),bo=[{label:"🎲 Karışık / Farketmez",id:null},{label:"💥 Aksiyon",movie:28,tv:10759},{label:"🚀 Bilim Kurgu & Fantastik",movie:878,tv:10765},{label:"😂 Komedi",movie:35,tv:35},{label:"🩸 Korku & Gerilim",movie:27,tv:9648},{label:"🎭 Dram",movie:18,tv:18},{label:"🕵️ Suç & Gizem",movie:80,tv:9648},{label:"🎌 Animasyon & Anime",movie:16,tv:16},{label:"💖 Romantik",movie:10749,tv:10749},{label:"🌍 Belgesel",movie:99,tv:99}];function wo({type:e="all"}={}){ki();const t=document.createElement("div");t.id="random-picker-modal-root",t.className="random-picker-backdrop",document.body.appendChild(t),Ri=t;let i=e==="tv"?"tv":"all",n=0,r=7;t.innerHTML=`
      ...
      <div class="random-picker-filters">
        ...
        <div class="random-filter-row">
          ...
          <div class="random-pills-wrap" id="random-genre-pills">
            ${bo.map((b,y)=>`
              <button class="random-pill-btn ${y===0?"active":""}" data-genre-idx="${y}">${b.label}</button>
            `).join("")}
          </div>
        </div>
      </div>
  ...
  `,V(t);const a=t.querySelector("#btn-close-random-picker");a&&(a.onclick=()=>ki()),t.onclick=b=>{b.target===t&&ki()};const o=b=>{b.key==="Escape"&&ki()};window.addEventListener("keydown",o),ja=()=>window.removeEventListener("keydown",o);const s=t.querySelectorAll("#random-type-pills .random-pill-btn");s.forEach(b=>{b.onclick=()=>{s.forEach(y=>y.classList.remove("active")),b.classList.add("active"),i=b.getAttribute("data-type")}});const l=t.querySelectorAll("#random-rating-pills .random-pill-btn");l.forEach(b=>{b.onclick=()=>{l.forEach(y=>y.classList.remove("active")),b.classList.add("active"),r=parseFloat(b.getAttribute("data-rating")||"0")}});const d=t.querySelectorAll("#random-genre-pills .random-pill-btn");d.forEach(b=>{b.onclick=()=>{d.forEach(y=>y.classList.remove("active")),b.classList.add("active"),n=parseInt(b.getAttribute("data-genre-idx"),10)}});const p=t.querySelector("#btn-spin-wheel"),h=t.querySelector("#random-spin-stage"),m=async()=>{p&&(p.disabled=!0,p.classList.add("is-spinning")),h.innerHTML=`
    ...
    `;let b=i;b==="all"&&(b=Math.random()>.5?"movie":"tv");let y=null;const w=bo[n];w&&(y=b==="movie"?w.movie:w.tv);const k=Math.floor(Math.random()*3)+1;let f;try{f=await Dl({type:b,genreId:y,minRating:r,page:k,sortBy:"popularity.desc"})}catch{f=[]}if(Ri!==t)return;const v=(f||[]).filter(ie=>ie&&(ie.title||ie.name)&&(ie.poster_path||ie.backdrop_path));if(!v||v.length===0){h.innerHTML=`
        <div class="random-idle-placeholder">
      ...
      `,V(h),p&&(p.disabled=!1,p.classList.remove("is-spinning"));return}const x=h.querySelector("#roulette-roller"),A=8;for(let ie=0;ie<A;ie++){const te=v[Math.floor(Math.random()*v.length)],re=te.title||te.name||"Öneri Aranıyor";if(x&&(x.innerHTML=`<div class="roulette-reel-text animate-pulse">${Xi(re)}</div>`),await new Promise(N=>setTimeout(N,120+ie*25)),Ri!==t)return}const S=v[Math.floor(Math.random()*v.length)],T=S.title||S.name||"Seçilen Yapım",I=S.original_title||S.original_name||T,L=lt(S.poster_path,et.POSTER_MEDIUM),z=S.vote_average?Number(S.vote_average).toFixed(1):"—",O=(S.release_date||S.first_air_date||"").substring(0,4),Y=S.overview&&S.overview.trim().length>10?S.overview:"Harika bir izleme deneyimi sunan sürpriz bir öneri!",j=b==="movie"?"movie":"tv";h.innerHTML=`
      <div class="random-winner-card">
        <div class="winner-poster-wrap">
          <img src="${L}" alt="${Xi(T)}" class="winner-poster" />
          <div class="winner-rating-pill">⭐ ${z}</div>
        </div>
        <div class="winner-details-wrap">
          <div class="winner-badge-row">
            <span class="winner-tag-type">${j==="movie"?"FİLM":"DİZİ"}</span>
            ${O?`<span class="winner-tag-year">${Xi(O)}</span>`:""}
            <span class="winner-tag-match">Popüler öneri</span>
          </div>
          <h3 class="winner-title">${Xi(T)}</h3>
          <p class="winner-overview">${Xi(Y)}</p>
...
Use Chrome, Firefox or Internet Explorer 11`)}var Wu=sc.Buffer,br=globalThis.crypto||globalThis.msCrypto;br&&br.getRandomValues?Wa.exports=Yu:Wa.exports=Ku;function Yu(e,t){if(e>ju)throw new RangeError("requested too many random bytes");var i=Wu.allocUnsafe(e);if(e>0)if(e>ga)for(var n=0;n<e;n+=ga)br.getRandomValues(i.slice(n,n+ga));else br.getRandomValues(i);return typeof t=="function"?process.nextTick(function(){t(null,i)}):i}var Ts=Wa.exports,Va={exports:{}},oc=Nr.EventEmitter;const Vu={},Gu=Object.freeze(Object.defineProperty({__proto__:null,default:Vu},Symbol.toStringTag,{value:"Module"})),vi=ku(Gu);var ya,Ao;function Ju(){if(Ao)return ya;Ao=1;function e(y,w){var k=Object.keys(y);if(Object.getOwnPropertySymbols){var f=Object.getOwnPropertySymbols(y);w&&(f=f.filter(function(v){return Object.getOwnPropertyDescriptor(y,v).enumerable})),k.push.apply(k,f)}return k}function t(y){for(var w=1;w<arguments.length;w++){var k=arguments[w]!=null?arguments[w]:{};w%2?e(Object(k),!0).forEach(function(f){i(y,f,k[f])}):Object.getOwnPropertyDescriptors?Object.defineProperties(y,Object.getOwnPropertyDescriptors(k)):e(Object(k)).forEach(function(f){Object.defineProperty(y,f,Object.getOwnPropertyDescriptor(k,f))})}return y}function i(y,w,k){return w=o(w),w in y?Object.defineProperty(y,w,{value:k,enumerable:!0,configurable:!0,writable:!0}):y[w]=k,y}function n(y,w){if(!(y instanceof w))throw new TypeError("Cannot call a class as a function")}function r(y,w){for(var k=0;k<w.length;k++){var f=w[k];f.enumerable=f.enumerable||!1,f.configurable=!0,"value"in f&&(f.writable=!0),Object.defineProperty(y,o(f.key),f)}}function a(y,w,k){return w&&r(y.prototype,w),Object.defineProperty(y,"prototype",{writable:!1}),y}function o(y){var w=s(y,"string");return typeof w=="symbol"?w:String(w)}function s(y,w){if(typeof y!="object"||y===null)return y;var k=y[Symbol.toPrimitive];if(k!==void 0){var f=k.call(y,w);if(typeof f!="object")return f;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(y)}var l=yi,d=l.Buffer,p=vi,h=p.inspect,m=h&&h.custom||"inspect";function b(y,w,k){d.prototype.copy.call(y,w,k)}return ya=function(){function y(){n(this,y),this.head=null,this.tail=null,this.length=0}return a(y,[{key:"push",value:function(k){var f={data:k,next:null};this.length>0?this.tail.next=f:this.head=f,this.tail=f,++this.length}},{key:"unshift",value:function(k){var f={data:k,next:this.head};this.length===0&&(this.tail=f),this.head=f,++this.length}},{key:"shift",value:function(){if(this.length!==0){var k=this.head.data;return this.length===1?this.head=this.tail=null:this.head=this.head.next,--this.length,k}}},{key:"clear",value:function(){this.head=this.tail=null,this.length=0}},{key:"join",value:function(k){if(this.length===0)return"";for(var f=this.head,v=""+f.data;f=f.next;)v+=k+f.data;return v}},{key:"concat",value:function(k){if(this.length===0)return d.alloc(0);for(var f=d.allocUnsafe(k>>>0),v=this.head,x=0;v;)b(v.data,f,x),x+=v.data.length,v=v.next;return f}},{key:"consume",value:function(k,f){var v;return k<this.head.data.length?(v=this.head.data.slice(0,k),this.head.data=this.head.data.slice(k)):k===this.head.data.length?v=this.shift():v=f?this._getString(k):this._getBuffer(k),v}},{key:"first",value:function(){return this.head.data}},{key:"_getString",value:function(k){var f=this.head,v=1,x=f.data;for(k-=x.length;f=f.next;){var A=f.data,S=k>A.length?A.length:k;if(S===A.length?x+=A:x+=A.slice(0,k),k-=S,k===0){S===A.length?(++v,f.next?this.head=f.next:this.head=this.tail=null):(this.head=f,f.data=A.slice(S));break}++v}return this.length-=v,x}},{key:"_getBuffer",value:function(k){var f=d.allocUnsafe(k),v=this.head,x=1;for(v.data.copy(f),k-=v.data.length;v=v.next;){var A=v.data,S=k>A.length?A.length:k;if(A.copy(f,f.length-k,0,S),k-=S,k===0){S===A.length?(++x,v.next?this.head=v.next:this.head=this.tail=null):(this.head=v,v.data=A.slice(S));break}++x}return this.length-=x,f}},{key:m,value:function(k,f){return h(this,t(t({},f),{},{depth:0,customInspect:!1}))}}]),y}(),ya}function Xu(e,t){var i=this,n=this._readableState&&this._readableState.destroyed,r=this._writableState&&this._writableState.destroyed;return n||r?(t?t(e):e&&(this._writableState?this._writableState.errorEmitted||(this._writableState.errorEmitted=!0,process.nextTick(Ga,this,e)):process.nextTick(Ga,this,e)),this):(this._readableState&&(this._readableState.destroyed=!0),this._writableState&&(this._writableState.destroyed=!0),this._destroy(e||null,function(a){!t&&a?i._writableState?i._writableState.errorEmitted?process.nextTick(er,i):(i._writableState.errorEmitted=!0,process.nextTick(Co,i,a)):process.nextTick(Co,i,a):t?(process.nextTick(er,i),t(a)):process.nextTick(er,i)}),this)}function Co(e,t){Ga(e,t),er(e)}function er(e){e._writableState&&!e._writableState.emitClose||e._readableState&&!e._readableState.emitClose||e.emit("close")}function Zu(){this._readableState&&(this._readableState.destroyed=!1,this._readableState.reading=!1,this._readableState.ended=!1,this._readableState.endEmitted=!1),this._writableState&&(this._writableState.destroyed=!1,this._writableState.ended=!1,this._writableState.ending=!1,this._writableState.finalCalled=!1,this._writableState.prefinished=!1,this._writableState.finished=!1,this._writableState.errorEmitted=!1)}function Ga(e,t){e.emit("error",t)}function Qu(e,t){var i=e._readableState,n=e._writableState;i&&i.autoDestroy||n&&n.autoDestroy?e.destroy(t):e.emit("error",t)}var lc={destroy:Xu,undestroy:Zu,errorOrDestroy:Qu},bi={};function ep(e,t){e.prototype=Object.create(t.prototype),e.prototype.constructor=e,e.__proto__=t}var cc={};function yt(e,t,i){i||(i=Error);function n(a,o,s){return typeof t=="string"?t:t(a,o,s)}var r=function(a){ep(o,a);function o(s,l,d){return a.call(this,n(s,l,d))||this}return o}(i);r.prototype.name=i.name,r.prototype.code=e,cc[e]=r}function Lo(e,t){if(Array.isArray(e)){var i=e.length;return e=e.map(function(n){return String(n)}),i>2?"one of ".concat(t," ").concat(e.slice(0,i-1).join(", "),", or ")+e[i-1]:i===2?"one of ".concat(t," ").concat(e[0]," or ").concat(e[1]):"of ".concat(t," ").concat(e[0])}else return"of ".concat(t," ").concat(String(e))}function tp(e,t,i){return e.substr(0,t.length)===t}function ip(e,t,i){return(i===void 0||i>e.length)&&(i=e.length),e.substring(i-t.length,i)===t}function np(e,t,i){return typeof i!="number"&&(i=0),i+t.length>e.length?!1:e.indexOf(t,i)!==-1}yt("ERR_INVALID_OPT_VALUE",function(e,t){return'The value "'+t+'" is invalid for option "'+e+'"'},TypeError);yt("ERR_INVALID_ARG_TYPE",function(e,t,i){var n;typeof t=="string"&&tp(t,"not ")?(n="must not be",t=t.replace(/^not /,"")):n="must be";var r;if(ip(e," argument"))r="The ".concat(e," ").concat(n," ").concat(Lo(t,"type"));else{var a=np(e,".")?"property":"argument";r='The "'.concat(e,'" ').concat(a," ").concat(n," ").concat(Lo(t,"type"))}return r+=". Received type ".concat(typeof i),r},TypeError);yt("ERR_STREAM_PUSH_AFTER_EOF","stream.push() after EOF");yt("ERR_METHOD_NOT_IMPLEMENTED",function(e){return"The "+e+" method is not implemented"});yt("ERR_STREAM_PREMATURE_CLOSE","Premature close");yt("ERR_STREAM_DESTROYED",function(e){return"Cannot call "+e+" after a stream was destroyed"});yt("ERR_MULTIPLE_CALLBACK","Callback called multiple times");yt("ERR_STREAM_CANNOT_PIPE","Cannot pipe, not readable");yt("ERR_STREAM_WRITE_AFTER_END","write after end");yt("ERR_STREAM_NULL_VALUES","May not write null values to stream",TypeError);yt("ERR_UNKNOWN_ENCODING",function(e){return"Unknown encoding: "+e},TypeError);yt("ERR_STREAM_UNSHIFT_AFTER_END_EVENT","stream.unshift() after end event");bi.codes=cc;var rp=bi.codes.ERR_INVALID_OPT_VALUE;function ap(e,t,i){return e.highWaterMark!=null?e.highWaterMark:t?e[i]:null}function sp(e,t,i,n){var r=ap(t,n,i);if(r!=null){if(!(isFinite(r)&&Math.floor(r)===r)||r<0){var a=n?i:"highWaterMark";throw new rp(a,r)}return Math.floor(r)}return e.objectMode?16:16*1024}var dc={getHighWaterMark:sp},Ja={exports:{}};typeof Object.create=="function"?Ja.exports=function(t,i){i&&(t.super_=i,t.prototype=Object.create(i.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}))}:Ja.exports=function(t,i){if(i){t.super_=i;var n=function(){};n.prototype=i.prototype,t.prototype=new n,t.prototype.constructor=t}};var An=Ja.exports,op=lp;function lp(e,t){if(va("noDeprecation"))return e;var i=!1;function n(){if(!i){if(va("throwDeprecation"))throw new Error(t);va("traceDeprecation"),i=!0}return e.apply(this,arguments)}return n}function va(e){try{if(!globalThis.localStorage)return!1}catch{return!1}var t=globalThis.localStorage[e];return t==null?!1:String(t).toLowerCase()==="true"}var ba,Io;function uc(){if(Io)return ba;Io=1,ba=L;function e($){var M=this;this.next=null,this.entry=null,this.finish=function(){G(M,$)}}var t;L.WritableState=T;var i={deprecate:op},n=oc,r=yi.Buffer,a=(typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof self<"u"?self:{}).Uint8Array||function(){};function o($){return r.from($)}function s($){return r.isBuffer($)||$ instanceof a}var l=lc,d=dc,p=d.getHighWaterMark,h=bi.codes,m=h.ERR_INVALID_ARG_TYPE,b=h.ERR_METHOD_NOT_IMPLEMENTED,y=h.ERR_MULTIPLE_CALLBACK,w=h.ERR_STREAM_CANNOT_PIPE,k=h.ERR_STREAM_DESTROYED,f=h.ERR_STREAM_NULL_VALUES,v=h.ERR_STREAM_WRITE_AFTER_END,x=h.ERR_UNKNOWN_ENCODING,A=l.errorOrDestroy;An(L,n);function S(){}function T($,M,H){t=t||Hi(),$=$||{},typeof H!="boolean"&&(H=M instanceof t),this.objectMode=!!$.objectMode,H&&(this.objectMode=this.objectMode||!!$.writableObjectMode),this.highWaterMark=p(this,$,"writableHighWaterMark",H),this.finalCalled=!1,this.needDrain=!1,this.ending=!1,this.ended=!1,this.finished=!1,this.destroyed=!1;var Q=$.decodeStrings===!1;this.decodeStrings=!Q,this.defaultEncoding=$.defaultEncoding||"utf8",this.length=0,this.writing=!1,this.corked=0,this.sync=!0,this.bufferProcessing=!1,this.onwrite=function(se){ie(M,se)},this.writecb=null,this.writelen=0,this.bufferedRequest=null,this.lastBufferedRequest=null,this.pendingcb=0,this.prefinished=!1,this.errorEmitted=!1,this.emitClose=$.emitClose!==!1,this.autoDestroy=!!$.autoDestroy,this.bufferedRequestCount=0,this.corkedRequestsFree=new e(this)}T.prototype.getBuffer=function(){for(var M=this.bufferedRequest,H=[];M;)H.push(M),M=M.next;return H},function(){try{Object.defineProperty(T.prototype,"buffer",{get:i.deprecate(function(){return this.getBuffer()},"_writableState.buffer is deprecated. Use _writableState.getBuffer instead.","DEP0003")})}catch{}}();var I;typeof Symbol=="function"&&Symbol.hasInstance&&typeof Function.prototype[Symbol.hasInstance]=="function"?(I=Function.prototype[Symbol.hasInstance],Object.defineProperty(L,Symbol.hasInstance,{value:function(M){return I.call(this,M)?!0:this!==L?!1:M&&M._writableState instanceof T}})):I=function(M){return M instanceof this};function L($){t=t||Hi();var M=this instanceof t;if(!M&&!I.call(L,this))return new L($);this._writableState=new T($,this,M),this.writable=!0,$&&(typeof $.write=="function"&&(this._write=$.write),typeof $.writev=="function"&&(this._writev=$.writev),typeof $.destroy=="function"&&(this._destroy=$.destroy),typeof $.final=="function"&&(this._final=$.final)),n.call(this)}L.prototype.pipe=function(){A(this,new w)};function z($,M){var H=new v;A($,H),process.nextTick(M,H)}function O($,M,H,Q){var se;return H===null?se=new f:typeof H!="string"&&!M.objectMode&&(se=new m("chunk",["string","Buffer"],H)),se?(A($,se),process.nextTick(Q,se),!1):!0}L.prototype.write=function($,M,H){var Q=this._writableState,se=!1,E=!Q.objectMode&&s($);return E&&!r.isBuffer($)&&($=o($)),typeof M=="function"&&(H=M,M=null),E?M="buffer":M||(M=Q.defaultEncoding),typeof H!="function"&&(H=S),Q.ending?z(this,H):(E||O(this,Q,$,H))&&(Q.pendingcb++,se=j(this,Q,E,$,M,H)),se},L.prototype.cork=function(){this._writableState.corked++},L.prototype.uncork=function(){var $=this._writableState;$.corked&&($.corked--,!$.writing&&!$.corked&&!$.bufferProcessing&&$.bufferedRequest&&N(this,$))},L.prototype.setDefaultEncoding=function(M){if(typeof M=="string"&&(M=M.toLowerCase()),!(["hex","utf8","utf-8","ascii","binary","base64","ucs2","ucs-2","utf16le","utf-16le","raw"].indexOf((M+"").toLowerCase())>-1))throw new x(M);return this._writableState.defaultEncoding=M,this},Object.defineProperty(L.prototype,"writableBuffer",{enumerable:!1,get:function(){return this._writableState&&this._writableState.getBuffer()}});function Y($,M,H){return!$.objectMode&&$.decodeStrings!==!1&&typeof M=="string"&&(M=r.from(M,H)),M}Object.defineProperty(L.prototype,"writableHighWaterMark",{enumerable:!1,get:function(){return this._writableState.highWaterMark}});function j($,M,H,Q,se,E){if(!H){var C=Y(M,Q,se);Q!==C&&(H=!0,se="buffer",Q=C)}var q=M.objectMode?1:Q.length;M.length+=q;var ee=M.length<M.highWaterMark;if(ee||(M.needDrain=!0),M.writing||M.corked){var ke=M.lastBufferedRequest;M.lastBufferedRequest={chunk:Q,encoding:se,isBuf:H,callback:E,next:null},ke?ke.next=M.lastBufferedRequest:M.bufferedRequest=M.lastBufferedRequest,M.bufferedRequestCount+=1}else D($,M,!1,q,Q,se,E);return ee}function D($,M,H,Q,se,E,C){M.writelen=Q,M.writecb=C,M.writing=!0,M.sync=!0,M.destroyed?M.onwrite(new k("write")):H?$._writev(se,M.onwrite):$._write(se,E,M.onwrite),M.sync=!1}function B($,M,H,Q,se){--M.pendingcb,H?(process.nextTick(se,Q),process.nextTick(ne,$,M),$._writableState.errorEmitted=!0,A($,Q)):(se(Q),$._writableState.errorEmitted=!0,A($,Q),ne($,M))}function W($){$.writing=!1,$.writecb=null,$.length-=$.writelen,$.writelen=0}function ie($,M){var H=$._writableState,Q=H.sync,se=H.writecb;if(typeof se!="function")throw new y;if(W(H),M)B($,H,Q,M,se);else{var E=ae(H)||$.destroyed;!E&&!H.corked&&!H.bufferProcessing&&H.bufferedRequest&&N($,H),Q?process.nextTick(te,$,H,E,se):te($,H,E,se)}}function te($,M,H,Q){H||re($,M),M.pendingcb--,Q(),ne($,M)}function re($,M){M.length===0&&M.needDrain&&(M.needDrain=!1,$.emit("drain"))}function N($,M){M.bufferProcessing=!0;var H=M.bufferedRequest;if($._writev&&H&&H.next){var Q=M.bufferedRequestCount,se=new Array(Q),E=M.corkedRequestsFree;E.entry=H;for(var C=0,q=!0;H;)se[C]=H,H.isBuf||(q=!1),H=H.next,C+=1;se.allBuffers=q,D($,M,!0,M.length,se,"",E.finish),M.pendingcb++,M.lastBufferedRequest=null,E.next?(M.corkedRequestsFree=E.next,E.next=null):M.corkedRequestsFree=new e(M),M.bufferedRequestCount=0}else{for(;H;){var ee=H.chunk,ke=H.encoding,le=H.callback,fe=M.objectMode?1:ee.length;if(D($,M,!1,fe,ee,ke,le),H=H.next,M.bufferedRequestCount--,M.writing)break}H===null&&(M.lastBufferedRequest=null)}M.bufferedRequest=H,M.bufferProcessing=!1}L.prototype._write=function($,M,H){H(new b("_write()"))},L.prototype._writev=null,L.prototype.end=function($,M,H){var Q=this._writableState;return typeof $=="function"?(H=$,$=null,M=null):typeof M=="function"&&(H=M,M=null),$!=null&&this.write($,M),Q.corked&&(Q.corked=1,this.uncork()),Q.ending||de(this,Q,H),this},Object.defineProperty(L.prototype,"writableLength",{enumerable:!1,get:function(){return this._writableState.length}});function ae($){return $.ending&&$.length===0&&$.bufferedRequest===null&&!$.finished&&!$.writing}function J($,M){$._final(function(H){M.pendingcb--,H&&A($,H),M.prefinished=!0,$.emit("prefinish"),ne($,M)})}function K($,M){!M.prefinished&&!M.finalCalled&&(typeof $._final=="function"&&!M.destroyed?(M.pendingcb++,M.finalCalled=!0,process.nextTick(J,$,M)):(M.prefinished=!0,$.emit("prefinish")))}function ne($,M){var H=ae(M);if(H&&(K($,M),M.pendingcb===0&&(M.finished=!0,$.emit("finish"),M.autoDestroy))){var Q=$._readableState;(!Q||Q.autoDestroy&&Q.endEmitted)&&$.destroy()}return H}function de($,M,H){M.ending=!0,ne($,M),H&&(M.finished?process.nextTick(H):$.once("finish",H)),M.ended=!0,$.writable=!1}function G($,M,H){var Q=$.entry;for($.entry=null;Q;){var se=Q.callback;M.pendingcb--,se(H),Q=Q.next}M.corkedRequestsFree.next=$}return Object.defineProperty(L.prototype,"destroyed",{enumerable:!1,get:function(){return this._writableState===void 0?!1:this._writableState.destroyed},set:function(M){this._writableState&&(this._writableState.destroyed=M)}}),L.prototype.destroy=l.destroy,L.prototype._undestroy=l.undestroy,L.prototype._destroy=function($,M){M($)},ba}var wa,Ro;function Hi(){if(Ro)return wa;Ro=1;var e=Object.keys||function(d){var p=[];for(var h in d)p.push(h);return p};wa=o;var t=hc(),i=uc();An(o,t);for(var n=e(i.prototype),r=0;r<n.length;r++){var a=n[r];o.prototype[a]||(o.prototype[a]=i.prototype[a])}function o(d){if(!(this instanceof o))return new o(d);t.call(this,d),i.call(this,d),this.allowHalfOpen=!0,d&&(d.readable===!1&&(this.readable=!1),d.writable===!1&&(this.writable=!1),d.allowHalfOpen===!1&&(this.allowHalfOpen=!1,this.once("end",s)))}Object.defineProperty(o.prototype,"writableHighWaterMark",{enumerable:!1,get:function(){return this._writableState.highWaterMark}}),Object.defineProperty(o.prototype,"writableBuffer",{enumerable:!1,get:function(){return this._writableState&&this._writableState.getBuffer()}}),Object.defineProperty(o.prototype,"writableLength",{enumerable:!1,get:function(){return this._writableState.length}});function s(){this._writableState.ended||process.nextTick(l,this)}function l(d){d.end()}return Object.defineProperty(o.prototype,"destroyed",{enumerable:!1,get:function(){return this._readableState===void 0||this._writableState===void 0?!1:this._readableState.destroyed&&this._writableState.destroyed},set:function(p){this._readableState===void 0||this._writableState===void 0||(this._readableState.destroyed=p,this._writableState.destroyed=p)}}),wa}var ka={},$o;function Mo(){if($o)return ka;$o=1;var e=sc.Buffer,t=e.isEncoding||function(f){switch(f=""+f,f&&f.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function i(f){if(!f)return"utf8";for(var v;;)switch(f){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return f;default:if(v)return;f=(""+f).toLowerCase(),v=!0}}function n(f){var v=i(f);if(typeof v!="string"&&(e.isEncoding===t||!t(f)))throw new Error("Unknown encoding: "+f);return v||f}ka.StringDecoder=r;function r(f){this.encoding=n(f);var v;switch(this.encoding){case"utf16le":this.text=h,this.end=m,v=4;break;case"utf8":this.fillLast=l,v=4;break;case"base64":this.text=b,this.end=y,v=3;break;default:this.write=w,this.end=k;return}this.lastNeed=0,this.lastTotal=0,this.lastChar=e.allocUnsafe(v)}r.prototype.write=function(f){if(f.length===0)return"";var v,x;if(this.lastNeed){if(v=this.fillLast(f),v===void 0)return"";x=this.lastNeed,this.lastNeed=0}else x=0;return x<f.length?v?v+this.text(f,x):this.text(f,x):v||""},r.prototype.end=p,r.prototype.text=d,r.prototype.fillLast=function(f){if(this.lastNeed<=f.length)return f.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);f.copy(this.lastChar,this.lastTotal-this.lastNeed,0,f.length),this.lastNeed-=f.length};function a(f){return f<=127?0:f>>5===6?2:f>>4===14?3:f>>3===30?4:f>>6===2?-1:-2}function o(f,v,x){var A=v.length-1;if(A<x)return 0;var S=a(v[A]);return S>=0?(S>0&&(f.lastNeed=S-1),S):--A<x||S===-2?0:(S=a(v[A]),S>=0?(S>0&&(f.lastNeed=S-2),S):--A<x||S===-2?0:(S=a(v[A]),S>=0?(S>0&&(S===2?S=0:f.lastNeed=S-3),S):0))}function s(f,v,x){if((v[0]&192)!==128)return f.lastNeed=0,"�";if(f.lastNeed>1&&v.length>1){if((v[1]&192)!==128)return f.lastNeed=1,"�";if(f.lastNeed>2&&v.length>2&&(v[2]&192)!==128)return f.lastNeed=2,"�"}}function l(f){var v=this.lastTotal-this.lastNeed,x=s(this,f);if(x!==void 0)return x;if(this.lastNeed<=f.length)return f.copy(this.lastChar,v,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);f.copy(this.lastChar,v,0,f.length),this.lastNeed-=f.length}function d(f,v){var x=o(this,f,v);if(!this.lastNeed)return f.toString("utf8",v);this.lastTotal=x;var A=f.length-(x-this.lastNeed);return f.copy(this.lastChar,0,A),f.toString("utf8",v,A)}function p(f){var v=f&&f.length?this.write(f):"";return this.lastNeed?v+"�":v}function h(f,v){if((f.length-v)%2===0){var x=f.toString("utf16le",v);if(x){var A=x.charCodeAt(x.length-1);if(A>=55296&&A<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=f[f.length-2],this.lastChar[1]=f[f.length-1],x.slice(0,-1)}return x}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=f[f.length-1],f.toString("utf16le",v,f.length-1)}function m(f){var v=f&&f.length?this.write(f):"";if(this.lastNeed){var x=this.lastTotal-this.lastNeed;return v+this.lastChar.toString("utf16le",0,x)}return v}function b(f,v){var x=(f.length-v)%3;return x===0?f.toString("base64",v):(this.lastNeed=3-x,this.lastTotal=3,x===1?this.lastChar[0]=f[f.length-1]:(this.lastChar[0]=f[f.length-2],this.lastChar[1]=f[f.length-1]),f.toString("base64",v,f.length-x))}function y(f){var v=f&&f.length?this.write(f):"";return this.lastNeed?v+this.lastChar.toString("base64",0,3-this.lastNeed):v}function w(f){return f.toString(this.encoding)}function k(f){return f&&f.length?this.write(f):""}return ka}var Po=bi.codes.ERR_STREAM_PREMATURE_CLOSE;function cp(e){var t=!1;return function(){if(!t){t=!0;for(var i=arguments.length,n=new Array(i),r=0;r<i;r++)n[r]=arguments[r];e.apply(this,n)}}}function dp(){}function up(e){return e.setHeader&&typeof e.abort=="function"}function pc(e,t,i){if(typeof t=="function")return pc(e,null,t);t||(t={}),i=cp(i||dp);var n=t.readable||t.readable!==!1&&e.readable,r=t.writable||t.writable!==!1&&e.writable,a=function(){e.writable||s()},o=e._writableState&&e._writableState.finished,s=function(){r=!1,o=!0,n||i.call(e)},l=e._readableState&&e._readableState.endEmitted,d=function(){n=!1,l=!0,r||i.call(e)},p=function(y){i.call(e,y)},h=function(){var y;if(n&&!l)return(!e._readableState||!e._readableState.ended)&&(y=new Po),i.call(e,y);if(r&&!o)return(!e._writableState||!e._writableState.ended)&&(y=new Po),i.call(e,y)},m=function(){e.req.on("finish",s)};return up(e)?(e.on("complete",s),e.on("abort",h),e.req?m():e.on("request",m)):r&&!e._writableState&&(e.on("end",a),e.on("close",a)),e.on("end",d),e.on("finish",s),t.error!==!1&&e.on("error",p),e.on("close",h),function(){e.removeListener("complete",s),e.removeListener("abort",h),e.removeListener("request",m),e.req&&e.req.removeListener("finish",s),e.removeListener("end",a),e.removeListener("close",a),e.removeListener("finish",s),e.removeListener("end",d),e.removeListener("error",p),e.removeListener("close",h)}}var As=pc,_a,Bo;function pp(){if(Bo)return _a;Bo=1;var e;function t(x,A,S){return A=i(A),A in x?Object.defineProperty(x,A,{value:S,enumerable:!0,configurable:!0,writable:!0}):x[A]=S,x}function i(x){var A=n(x,"string");return typeof A=="symbol"?A:String(A)}function n(x,A){if(typeof x!="object"||x===null)return x;var S=x[Symbol.toPrimitive];if(S!==void 0){var T=S.call(x,A);if(typeof T!="object")return T;throw new TypeError("@@toPrimitive must return a primitive value.")}return(A==="string"?String:Number)(x)}var r=As,a=Symbol("lastResolve"),o=Symbol("lastReject"),s=Symbol("error"),l=Symbol("ended"),d=Symbol("lastPromise"),p=Symbol("handlePromise"),h=Symbol("stream");function m(x,A){return{value:x,done:A}}function b(x){var A=x[a];if(A!==null){var S=x[h].read();S!==null&&(x[d]=null,x[a]=null,x[o]=null,A(m(S,!1)))}}function y(x){process.nextTick(b,x)}function w(x,A){return function(S,T){x.then(function(){if(A[l]){S(m(void 0,!0));return}A[p](S,T)},T)}}var k=Object.getPrototypeOf(function(){}),f=Object.setPrototypeOf((e={get stream(){return this[h]},next:function(){var A=this,S=this[s];if(S!==null)return Promise.reject(S);if(this[l])return Promise.resolve(m(void 0,!0));if(this[h].destroyed)return new Promise(function(z,O){process.nextTick(function(){A[s]?O(A[s]):z(m(void 0,!0))})});var T=this[d],I;if(T)I=new Promise(w(T,this));else{var L=this[h].read();if(L!==null)return Promise.resolve(m(L,!1));I=new Promise(this[p])}return this[d]=I,I}},t(e,Symbol.asyncIterator,function(){return this}),t(e,"return",function(){var A=this;return new Promise(function(S,T){A[h].destroy(null,function(I){if(I){T(I);return}S(m(void 0,!0))})})}),e),k),v=function(A){var S,T=Object.create(f,(S={},t(S,h,{value:A,writable:!0}),t(S,a,{value:null,writable:!0}),t(S,o,{value:null,writable:!0}),t(S,s,{value:null,writable:!0}),t(S,l,{value:A._readableState.endEmitted,writable:!0}),t(S,p,{value:function(L,z){var O=T[h].read();O?(T[d]=null,T[a]=null,T[o]=null,L(m(O,!1))):(T[a]=L,T[o]=z)},writable:!0}),S));return T[d]=null,r(A,function(I){if(I&&I.code!=="ERR_STREAM_PREMATURE_CLOSE"){var L=T[o];L!==null&&(T[d]=null,T[a]=null,T[o]=null,L(I)),T[s]=I;return}var z=T[a];z!==null&&(T[d]=null,T[a]=null,T[o]=null,z(m(void 0,!0))),T[l]=!0}),A.on("readable",y.bind(null,T)),T};return _a=v,_a}var Sa,Do;function hp(){return Do||(Do=1,Sa=function(){throw new Error("Readable.from is not available in the browser")}),Sa}var xa,zo;function hc(){if(zo)return xa;zo=1,xa=z;var e;z.ReadableState=L,Nr.EventEmitter;var t=function(C,q){return C.listeners(q).length},i=oc,n=yi.Buffer,r=(typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof self<"u"?self:{}).Uint8Array||function(){};function a(E){return n.from(E)}function o(E){return n.isBuffer(E)||E instanceof r}var s=vi,l;s&&s.debuglog?l=s.debuglog("stream"):l=function(){};var d=Ju(),p=lc,h=dc,m=h.getHighWaterMark,b=bi.codes,y=b.ERR_INVALID_ARG_TYPE,w=b.ERR_STREAM_PUSH_AFTER_EOF,k=b.ERR_METHOD_NOT_IMPLEMENTED,f=b.ERR_STREAM_UNSHIFT_AFTER_END_EVENT,v,x,A;An(z,i);var S=p.errorOrDestroy,T=["error","close","destroy","pause","resume"];function I(E,C,q){if(typeof E.prependListener=="function")return E.prependListener(C,q);!E._events||!E._events[C]?E.on(C,q):Array.isArray(E._events[C])?E._events[C].unshift(q):E._events[C]=[q,E._events[C]]}function L(E,C,q){e=e||Hi(),E=E||{},typeof q!="boolean"&&(q=C instanceof e),this.objectMode=!!E.objectMode,q&&(this.objectMode=this.objectMode||!!E.readableObjectMode),this.highWaterMark=m(this,E,"readableHighWaterMark",q),this.buffer=new d,this.length=0,this.pipes=null,this.pipesCount=0,this.flowing=null,this.ended=!1,this.endEmitted=!1,this.reading=!1,this.sync=!0,this.needReadable=!1,this.emittedReadable=!1,this.readableListening=!1,this.resumeScheduled=!1,this.paused=!0,this.emitClose=E.emitClose!==!1,this.autoDestroy=!!E.autoDestroy,this.destroyed=!1,this.defaultEncoding=E.defaultEncoding||"utf8",this.awaitDrain=0,this.readingMore=!1,this.decoder=null,this.encoding=null,E.encoding&&(v||(v=Mo().StringDecoder),this.decoder=new v(E.encoding),this.encoding=E.encoding)}function z(E){if(e=e||Hi(),!(this instanceof z))return new z(E);var C=this instanceof e;this._readableState=new L(E,this,C),this.readable=!0,E&&(typeof E.read=="function"&&(this._read=E.read),typeof E.destroy=="function"&&(this._destroy=E.destroy)),i.call(this)}Object.defineProperty(z.prototype,"destroyed",{enumerable:!1,get:function(){return this._readableState===void 0?!1:this._readableState.destroyed},set:function(C){this._readableState&&(this._readableState.destroyed=C)}}),z.prototype.destroy=p.destroy,z.prototype._undestroy=p.undestroy,z.prototype._destroy=function(E,C){C(E)},z.prototype.push=function(E,C){var q=this._readableState,ee;return q.objectMode?ee=!0:typeof E=="string"&&(C=C||q.defaultEncoding,C!==q.encoding&&(E=n.from(E,C),C=""),ee=!0),O(this,E,C,!1,ee)},z.prototype.unshift=function(E){return O(this,E,null,!0,!1)};function O(E,C,q,ee,ke){l("readableAddChunk",C);var le=E._readableState;if(C===null)le.reading=!1,ie(E,le);else{var fe;if(ke||(fe=j(le,C)),fe)S(E,fe);else if(le.objectMode||C&&C.length>0)if(typeof C!="string"&&!le.objectMode&&Object.getPrototypeOf(C)!==n.prototype&&(C=a(C)),ee)le.endEmitted?S(E,new f):Y(E,le,C,!0);else if(le.ended)S(E,new w);else{if(le.destroyed)return!1;le.reading=!1,le.decoder&&!q?(C=le.decoder.write(C),le.objectMode||C.length!==0?Y(E,le,C,!1):N(E,le)):Y(E,le,C,!1)}else ee||(le.reading=!1,N(E,le))}return!le.ended&&(le.length<le.highWaterMark||le.length===0)}function Y(E,C,q,ee){C.flowing&&C.length===0&&!C.sync?(C.awaitDrain=0,E.emit("data",q)):(C.length+=C.objectMode?1:q.length,ee?C.buffer.unshift(q):C.buffer.push(q),C.needReadable&&te(E)),N(E,C)}function j(E,C){var q;return!o(C)&&typeof C!="string"&&C!==void 0&&!E.objectMode&&(q=new y("chunk",["string","Buffer","Uint8Array"],C)),q}z.prototype.isPaused=function(){return this._readableState.flowing===!1},z.prototype.setEncoding=function(E){v||(v=Mo().StringDecoder);var C=new v(E);this._readableState.decoder=C,this._readableState.encoding=this._readableState.decoder.encoding;for(var q=this._readableState.buffer.head,ee="";q!==null;)ee+=C.write(q.data),q=q.next;return this._readableState.buffer.clear(),ee!==""&&this._readableState.buffer.push(ee),this._readableState.length=ee.length,this};var D=1073741824;function B(E){return E>=D?E=D:(E--,E|=E>>>1,E|=E>>>2,E|=E>>>4,E|=E>>>8,E|=E>>>16,E++),E}function W(E,C){return E<=0||C.length===0&&C.ended?0:C.objectMode?1:E!==E?C.flowing&&C.length?C.buffer.head.data.length:C.length:(E>C.highWaterMark&&(C.highWaterMark=B(E)),E<=C.length?E:C.ended?C.length:(C.needReadable=!0,0))}z.prototype.read=function(E){l("read",E),E=parseInt(E,10);var C=this._readableState,q=E;if(E!==0&&(C.emittedReadable=!1),E===0&&C.needReadable&&((C.highWaterMark!==0?C.length>=C.highWaterMark:C.length>0)||C.ended))return l("read: emitReadable",C.length,C.ended),C.length===0&&C.ended?H(this):te(this),null;if(E=W(E,C),E===0&&C.ended)return C.length===0&&H(this),null;var ee=C.needReadable;l("need readable",ee),(C.length===0||C.length-E<C.highWaterMark)&&(ee=!0,l("length less than watermark",ee)),C.ended||C.reading?(ee=!1,l("reading or ended",ee)):ee&&(l("do read"),C.reading=!0,C.sync=!0,C.length===0&&(C.needReadable=!0),this._read(C.highWaterMark),C.sync=!1,C.reading||(E=W(q,C)));var ke;return E>0?ke=M(E,C):ke=null,ke===null?(C.needReadable=C.length<=C.highWaterMark,E=0):(C.length-=E,C.awaitDrain=0),C.length===0&&(C.ended||(C.needReadable=!0),q!==E&&C.ended&&H(this)),ke!==null&&this.emit("data",ke),ke};function ie(E,C){if(l("onEofChunk"),!C.ended){if(C.decoder){var q=C.decoder.end();q&&q.length&&(C.buffer.push(q),C.length+=C.objectMode?1:q.length)}C.ended=!0,C.sync?te(E):(C.needReadable=!1,C.emittedReadable||(C.emittedReadable=!0,re(E)))}}function te(E){var C=E._readableState;l("emitReadable",C.needReadable,C.emittedReadable),C.needReadable=!1,C.emittedReadable||(l("emitReadable",C.flowing),C.emittedReadable=!0,process.nextTick(re,E))}function re(E){var C=E._readableState;l("emitReadable_",C.destroyed,C.length,C.ended),!C.destroyed&&(C.length||C.ended)&&(E.emit("readable"),C.emittedReadable=!1),C.needReadable=!C.flowing&&!C.ended&&C.length<=C.highWaterMark,$(E)}function N(E,C){C.readingMore||(C.readingMore=!0,process.nextTick(ae,E,C))}function ae(E,C){for(;!C.reading&&!C.ended&&(C.length<C.highWaterMark||C.flowing&&C.length===0);){var q=C.length;if(l("maybeReadMore read 0"),E.read(0),q===C.length)break}C.readingMore=!1}z.prototype._read=function(E){S(this,new k("_read()"))},z.prototype.pipe=function(E,C){var q=this,ee=this._readableState;switch(ee.pipesCount){case 0:ee.pipes=E;break;case 1:ee.pipes=[ee.pipes,E];break;default:ee.pipes.push(E);break}ee.pipesCount+=1,l("pipe count=%d opts=%j",ee.pipesCount,C);var ke=(!C||C.end!==!1)&&E!==process.stdout&&E!==process.stderr,le=ke?Xe:oe;ee.endEmitted?process.nextTick(le):q.once("end",le),E.on("unpipe",fe);function fe(g,c){l("onunpipe"),g===q&&c&&c.hasUnpiped===!1&&(c.hasUnpiped=!0,Re())}function Xe(){l("onend"),E.end()}var Ze=J(q);E.on("drain",Ze);var Ue=!1;function Re(){l("cleanup"),E.removeListener("close",We),E.removeListener("finish",je),E.removeListener("drain",Ze),E.removeListener("error",Ne),E.removeListener("unpipe",fe),q.removeListener("end",Xe),q.removeListener("end",oe),q.removeListener("data",De),Ue=!0,ee.awaitDrain&&(!E._writableState||E._writableState.needDrain)&&Ze()}q.on("data",De);function De(g){l("ondata");var c=E.write(g);l("dest.write",c),c===!1&&((ee.pipesCount===1&&ee.pipes===E||ee.pipesCount>1&&se(ee.pipes,E)!==-1)&&!Ue&&(l("false write response, pause",ee.awaitDrain),ee.awaitDrain++),q.pause())}function Ne(g){l("onerror",g),oe(),E.removeListener("error",Ne),t(E,"error")===0&&S(E,g)}I(E,"error",Ne);function We(){E.removeListener("finish",je),oe()}E.once("close",We);function je(){l("onfinish"),E.removeListener("close",We),oe()}E.once("finish",je);function oe(){l("unpipe"),q.unpipe(E)}return E.emit("pipe",q),ee.flowing||(l("pipe resume"),q.resume()),E};function J(E){return function(){var q=E._readableState;l("pipeOnDrain",q.awaitDrain),q.awaitDrain&&q.awaitDrain--,q.awaitDrain===0&&t(E,"data")&&(q.flowing=!0,$(E))}}z.prototype.unpipe=function(E){var C=this._readableState,q={hasUnpiped:!1};if(C.pipesCount===0)return this;if(C.pipesCount===1)return E&&E!==C.pipes?this:(E||(E=C.pipes),C.pipes=null,C.pipesCount=0,C.flowing=!1,E&&E.emit("unpipe",this,q),this);if(!E){var ee=C.pipes,ke=C.pipesCount;C.pipes=null,C.pipesCount=0,C.flowing=!1;for(var le=0;le<ke;le++)ee[le].emit("unpipe",this,{hasUnpiped:!1});return this}var fe=se(C.pipes,E);return fe===-1?this:(C.pipes.splice(fe,1),C.pipesCount-=1,C.pipesCount===1&&(C.pipes=C.pipes[0]),E.emit("unpipe",this,q),this)},z.prototype.on=function(E,C){var q=i.prototype.on.call(this,E,C),ee=this._readableState;return E==="data"?(ee.readableListening=this.listenerCount("readable")>0,ee.flowing!==!1&&this.resume()):E==="readable"&&!ee.endEmitted&&!ee.readableListening&&(ee.readableListening=ee.needReadable=!0,ee.flowing=!1,ee.emittedReadable=!1,l("on readable",ee.length,ee.reading),ee.length?te(this):ee.reading||process.nextTick(ne,this)),q},z.prototype.addListener=z.prototype.on,z.prototype.removeListener=function(E,C){var q=i.prototype.removeListener.call(this,E,C);return E==="readable"&&process.nextTick(K,this),q},z.prototype.removeAllListeners=function(E){var C=i.prototype.removeAllListeners.apply(this,arguments);return(E==="readable"||E===void 0)&&process.nextTick(K,this),C};function K(E){var C=E._readableState;C.readableListening=E.listenerCount("readable")>0,C.resumeScheduled&&!C.paused?C.flowing=!0:E.listenerCount("data")>0&&E.resume()}function ne(E){l("readable nexttick read 0"),E.read(0)}z.prototype.resume=function(){var E=this._readableState;return E.flowing||(l("resume"),E.flowing=!E.readableListening,de(this,E)),E.paused=!1,this};function de(E,C){C.resumeScheduled||(C.resumeScheduled=!0,process.nextTick(G,E,C))}function G(E,C){l("resume",C.reading),C.reading||E.read(0),C.resumeScheduled=!1,E.emit("resume"),$(E),C.flowing&&!C.reading&&E.read(0)}z.prototype.pause=function(){return l("call pause flowing=%j",this._readableState.flowing),this._readableState.flowing!==!1&&(l("pause"),this._readableState.flowing=!1,this.emit("pause")),this._readableState.paused=!0,this};function $(E){var C=E._readableState;for(l("flow",C.flowing);C.flowing&&E.read()!==null;);}z.prototype.wrap=function(E){var C=this,q=this._readableState,ee=!1;E.on("end",function(){if(l("wrapped end"),q.decoder&&!q.ended){var fe=q.decoder.end();fe&&fe.length&&C.push(fe)}C.push(null)}),E.on("data",function(fe){if(l("wrapped data"),q.decoder&&(fe=q.decoder.write(fe)),!(q.objectMode&&fe==null)&&!(!q.objectMode&&(!fe||!fe.length))){var Xe=C.push(fe);Xe||(ee=!0,E.pause())}});for(var ke in E)this[ke]===void 0&&typeof E[ke]=="function"&&(this[ke]=function(Xe){return function(){return E[Xe].apply(E,arguments)}}(ke));for(var le=0;le<T.length;le++)E.on(T[le],this.emit.bind(this,T[le]));return this._read=function(fe){l("wrapped _read",fe),ee&&(ee=!1,E.resume())},this},typeof Symbol=="function"&&(z.prototype[Symbol.asyncIterator]=function(){return x===void 0&&(x=pp()),x(this)}),Object.defineProperty(z.prototype,"readableHighWaterMark",{enumerable:!1,get:function(){return this._readableState.highWaterMark}}),Object.defineProperty(z.prototype,"readableBuffer",{enumerable:!1,get:function(){return this._readableState&&this._readableState.buffer}}),Object.defineProperty(z.prototype,"readableFlowing",{enumerable:!1,get:function(){return this._readableState.flowing},set:function(C){this._readableState&&(this._readableState.flowing=C)}}),z._fromList=M,Object.defineProperty(z.prototype,"readableLength",{enumerable:!1,get:function(){return this._readableState.length}});function M(E,C){if(C.length===0)return null;var q;return C.objectMode?q=C.buffer.shift():!E||E>=C.length?(C.decoder?q=C.buffer.join(""):C.buffer.length===1?q=C.buffer.first():q=C.buffer.concat(C.length),C.buffer.clear()):q=C.buffer.consume(E,C.decoder),q}function H(E){var C=E._readableState;l("endReadable",C.endEmitted),C.endEmitted||(C.ended=!0,process.nextTick(Q,C,E))}function Q(E,C){if(l("endReadableNT",E.endEmitted,E.length),!E.endEmitted&&E.length===0&&(E.endEmitted=!0,C.readable=!1,C.emit("end"),E.autoDestroy)){var q=C._writableState;(!q||q.autoDestroy&&q.finished)&&C.destroy()}}typeof Symbol=="function"&&(z.from=function(E,C){return A===void 0&&(A=hp()),A(z,E,C)});function se(E,C){for(var q=0,ee=E.length;q<ee;q++)if(E[q]===C)return q;return-1}return xa}var fc=Dt,Fr=bi.codes,fp=Fr.ERR_METHOD_NOT_IMPLEMENTED,mp=Fr.ERR_MULTIPLE_CALLBACK,gp=Fr.ERR_TRANSFORM_ALREADY_TRANSFORMING,yp=Fr.ERR_TRANSFORM_WITH_LENGTH_0,Ur=Hi();An(Dt,Ur);function vp(e,t){var i=this._transformState;i.transforming=!1;var n=i.writecb;if(n===null)return this.emit("error",new mp);i.writechunk=null,i.writecb=null,t!=null&&this.push(t),n(e);var r=this._readableState;r.reading=!1,(r.needReadable||r.length<r.highWaterMark)&&this._read(r.highWaterMark)}function Dt(e){if(!(this instanceof Dt))return new Dt(e);Ur.call(this,e),this._transformState={afterTransform:vp.bind(this),needTransform:!1,transforming:!1,writecb:null,writechunk:null,writeencoding:null},this._readableState.needReadable=!0,this._readableState.sync=!1,e&&(typeof e.transform=="function"&&(this._transform=e.transform),typeof e.flush=="function"&&(this._flush=e.flush)),this.on("prefinish",bp)}function bp(){var e=this;typeof this._flush=="function"&&!this._readableState.destroyed?this._flush(function(t,i){Oo(e,t,i)}):Oo(this,null,null)}Dt.prototype.push=function(e,t){return this._transformState.needTransform=!1,Ur.prototype.push.call(this,e,t)};Dt.prototype._transform=function(e,t,i){i(new fp("_transform()"))};Dt.prototype._write=function(e,t,i){var n=this._transformState;if(n.writecb=i,n.writechunk=e,n.writeencoding=t,!n.transforming){var r=this._readableState;(n.needTransform||r.needReadable||r.length<r.highWaterMark)&&this._read(r.highWaterMark)}};Dt.prototype._read=function(e){var t=this._transformState;t.writechunk!==null&&!t.transforming?(t.transforming=!0,this._transform(t.writechunk,t.writeencoding,t.afterTransform)):t.needTransform=!0};Dt.prototype._destroy=function(e,t){Ur.prototype._destroy.call(this,e,function(i){t(i)})};function Oo(e,t,i){if(t)return e.emit("error",t);if(i!=null&&e.push(i),e._writableState.length)throw new yp;if(e._transformState.transforming)throw new gp;return e.push(null)}var wp=_n,mc=fc;An(_n,mc);function _n(e){if(!(this instanceof _n))return new _n(e);mc.call(this,e)}_n.prototype._transform=function(e,t,i){i(null,e)};var Ea;function kp(e){var t=!1;return function(){t||(t=!0,e.apply(void 0,arguments))}}var gc=bi.codes,_p=gc.ERR_MISSING_ARGS,Sp=gc.ERR_STREAM_DESTROYED;function No(e){if(e)throw e}function xp(e){return e.setHeader&&typeof e.abort=="function"}function Ep(e,t,i,n){n=kp(n);var r=!1;e.on("close",function(){r=!0}),Ea===void 0&&(Ea=As),Ea(e,{readable:t,writable:i},function(o){if(o)return n(o);r=!0,n()});var a=!1;return function(o){if(!r&&!a){if(a=!0,xp(e))return e.abort();if(typeof e.destroy=="function")return e.destroy();n(o||new Sp("pipe"))}}}function Ho(e){e()}function Tp(e,t){return e.pipe(t)}function Ap(e){return!e.length||typeof e[e.length-1]!="function"?No:e.pop()}function Cp(){for(var e=arguments.length,t=new Array(e),i=0;i<e;i++)t[i]=arguments[i];var n=Ap(t);if(Array.isArray(t[0])&&(t=t[0]),t.length<2)throw new _p("streams");var r,a=t.map(function(o,s){var l=s<t.length-1,d=s>0;return Ep(o,l,d,function(p){r||(r=p),p&&a.forEach(Ho),!l&&(a.forEach(Ho),n(r))})});return t.reduce(Tp)}var Lp=Cp;(function(e,t){t=e.exports=hc(),t.Stream=t,t.Readable=t,t.Writable=uc(),t.Duplex=Hi(),t.Transform=fc,t.PassThrough=wp,t.finished=As,t.pipeline=Lp})(Va,Va.exports);var yc=Va.exports;function qo(e,t){for(const i in t)Object.defineProperty(e,i,{value:t[i],enumerable:!0,configurable:!0});return e}function Ip(e,t,i){if(!e||typeof e=="string")throw new TypeError("Please pass an Error to err-code");i||(i={}),typeof t=="object"&&(i=t,t=""),t&&(i.code=t);try{return qo(e,i)}catch{i.message=e.message,i.stack=e.stack;const r=function(){};return r.prototype=Object.create(Object.getPrototypeOf(e)),qo(new r,i)}}var Rp=Ip;const $p=zr("simple-peer"),vc=Bu,Fo=Ts,Mp=yc,Ta=Hr,ve=Rp,{Buffer:Pp}=yi,Aa=64*1024,Bp=5*1e3,Dp=5*1e3;function Uo(e){return e.replace(/a=ice-options:trickle\s\n/g,"")}let jr=class Xa extends Mp.Duplex{constructor(t){if(t=Object.assign({allowHalfOpen:!1},t),super(t),this._id=Fo(4).toString("hex").slice(0,7),this._debug("new peer %o",t),this.channelName=t.initiator?t.channelName||Fo(20).toString("hex"):null,this.initiator=t.initiator||!1,this.channelConfig=t.channelConfig||Xa.channelConfig,this.channelNegotiated=this.channelConfig.negotiated,this.config=Object.assign({},Xa.config,t.config),this.offerOptions=t.offerOptions||{},this.answerOptions=t.answerOptions||{},this.sdpTransform=t.sdpTransform||(i=>i),this.streams=t.streams||(t.stream?[t.stream]:[]),this.trickle=t.trickle!==void 0?t.trickle:!0,this.allowHalfTrickle=t.allowHalfTrickle!==void 0?t.allowHalfTrickle:!1,this.iceCompleteTimeout=t.iceCompleteTimeout||Bp,this.destroyed=!1,this.destroying=!1,this._connected=!1,this.remoteAddress=void 0,this.remoteFamily=void 0,this.remotePort=void 0,this.localAddress=void 0,this.localFamily=void 0,this.localPort=void 0,this._wrtc=t.wrtc&&typeof t.wrtc=="object"?t.wrtc:vc(),!this._wrtc)throw ve(typeof window>"u"?new Error("No WebRTC support: Specify `opts.wrtc` option in this environment"):new Error("No WebRTC support: Not a supported browser"),"ERR_WEBRTC_SUPPORT");this._pcReady=!1,this._channelReady=!1,this._iceComplete=!1,this._iceCompleteTimer=null,this._channel=null,this._pendingCandidates=[],this._isNegotiating=!1,this._firstNegotiation=!0,this._batchedNegotiation=!1,this._queuedNegotiation=!1,this._sendersAwaitingStable=[],this._senderMap=new Map,this._closingInterval=null,this._remoteTracks=[],this._remoteStreams=[],this._chunk=null,this._cb=null,this._interval=null;try{this._pc=new this._wrtc.RTCPeerConnection(this.config)}catch(i){this.destroy(ve(i,"ERR_PC_CONSTRUCTOR"));return}this._isReactNativeWebrtc=typeof this._pc._peerConnectionId=="number",this._pc.oniceconnectionstatechange=()=>{this._onIceStateChange()},this._pc.onicegatheringstatechange=()=>{this._onIceStateChange()},this._pc.onconnectionstatechange=()=>{this._onConnectionStateChange()},this._pc.onsignalingstatechange=()=>{this._onSignalingStateChange()},this._pc.onicecandidate=i=>{this._onIceCandidate(i)},typeof this._pc.peerIdentity=="object"&&this._pc.peerIdentity.catch(i=>{this.destroy(ve(i,"ERR_PC_PEER_IDENTITY"))}),this.initiator||this.channelNegotiated?this._setupData({channel:this._pc.createDataChannel(this.channelName,this.channelConfig)}):this._pc.ondatachannel=i=>{this._setupData(i)},this.streams&&this.streams.forEach(i=>{this.addStream(i)}),this._pc.ontrack=i=>{this._onTrack(i)},this._debug("initial negotiation"),this._needsNegotiation(),this._onFinishBound=()=>{this._onFinish()},this.once("finish",this._onFinishBound)}get bufferSize(){return this._channel&&this._channel.bufferedAmount||0}get connected(){return this._connected&&this._channel.readyState==="open"}address(){return{port:this.localPort,family:this.localFamily,address:this.localAddress}}signal(t){if(!this.destroying){if(this.destroyed)throw ve(new Error("cannot signal after peer is destroyed"),"ERR_DESTROYED");if(typeof t=="string")try{t=JSON.parse(t)}catch{t={}}this._debug("signal()"),t.renegotiate&&this.initiator&&(this._debug("got request to renegotiate"),this._needsNegotiation()),t.transceiverRequest&&this.initiator&&(this._debug("got request for transceiver"),this.addTransceiver(t.transceiverRequest.kind,t.transceiverRequest.init)),t.candidate&&(this._pc.remoteDescription&&this._pc.remoteDescription.type?this._addIceCandidate(t.candidate):this._pendingCandidates.push(t.candidate)),t.sdp&&this._pc.setRemoteDescription(new this._wrtc.RTCSessionDescription(t)).then(()=>{this.destroyed||(this._pendingCandidates.forEach(i=>{this._addIceCandidate(i)}),this._pendingCandidates=[],this._pc.remoteDescription.type==="offer"&&this._createAnswer())}).catch(i=>{this.destroy(ve(i,"ERR_SET_REMOTE_DESCRIPTION"))}),!t.sdp&&!t.candidate&&!t.renegotiate&&!t.transceiverRequest&&this.destroy(ve(new Error("signal() called with invalid signal data"),"ERR_SIGNALING"))}}_addIceCandidate(t){const i=new this._wrtc.RTCIceCandidate(t);this._pc.addIceCandidate(i).catch(n=>{!i.address||i.address.endsWith(".local")?void 0:this.destroy(ve(n,"ERR_ADD_ICE_CANDIDATE"))})}send(t){if(!this.destroying){if(this.destroyed)throw ve(new Error("cannot send after peer is destroyed"),"ERR_DESTROYED");this._channel.send(t)}}addTransceiver(t,i){if(!this.destroying){if(this.destroyed)throw ve(new Error("cannot addTransceiver after peer is destroyed"),"ERR_DESTROYED");if(this._debug("addTransceiver()"),this.initiator)try{this._pc.addTransceiver(t,i),this._needsNegotiation()}catch(n){this.destroy(ve(n,"ERR_ADD_TRANSCEIVER"))}else this.emit("signal",{type:"transceiverRequest",transceiverRequest:{kind:t,init:i}})}}addStream(t){if(!this.destroying){if(this.destroyed)throw ve(new Error("cannot addStream after peer is destroyed"),"ERR_DESTROYED");this._debug("addStream()"),t.getTracks().forEach(i=>{this.addTrack(i,t)})}}addTrack(t,i){if(this.destroying)return;if(this.destroyed)throw ve(new Error("cannot addTrack after peer is destroyed"),"ERR_DESTROYED");this._debug("addTrack()");const n=this._senderMap.get(t)||new Map;let r=n.get(i);if(!r)r=this._pc.addTrack(t,i),n.set(i,r),this._senderMap.set(t,n),this._needsNegotiation();else throw r.removed?ve(new Error("Track has been removed. You should enable/disable tracks that you want to re-add."),"ERR_SENDER_REMOVED"):ve(new Error("Track has already been added to that stream."),"ERR_SENDER_ALREADY_ADDED")}replaceTrack(t,i,n){if(this.destroying)return;if(this.destroyed)throw ve(new Error("cannot replaceTrack after peer is destroyed"),"ERR_DESTROYED");this._debug("replaceTrack()");const r=this._senderMap.get(t),a=r?r.get(n):null;if(!a)throw ve(new Error("Cannot replace track that was never added."),"ERR_TRACK_NOT_ADDED");i&&this._senderMap.set(i,r),a.replaceTrack!=null?a.replaceTrack(i):this.destroy(ve(new Error("replaceTrack is not supported in this browser"),"ERR_UNSUPPORTED_REPLACETRACK"))}removeTrack(t,i){if(this.destroying)return;if(this.destroyed)throw ve(new Error("cannot removeTrack after peer is destroyed"),"ERR_DESTROYED");this._debug("removeSender()");const n=this._senderMap.get(t),r=n?n.get(i):null;if(!r)throw ve(new Error("Cannot remove track that was never added."),"ERR_TRACK_NOT_ADDED");try{r.removed=!0,this._pc.removeTrack(r)}catch(a){a.name==="NS_ERROR_UNEXPECTED"?this._sendersAwaitingStable.push(r):this.destroy(ve(a,"ERR_REMOVE_TRACK"))}this._needsNegotiation()}removeStream(t){if(!this.destroying){if(this.destroyed)throw ve(new Error("cannot removeStream after peer is destroyed"),"ERR_DESTROYED");this._debug("removeSenders()"),t.getTracks().forEach(i=>{this.removeTrack(i,t)})}}_needsNegotiation(){this._debug("_needsNegotiation"),!this._batchedNegotiation&&(this._batchedNegotiation=!0,Ta(()=>{this._batchedNegotiation=!1,this.initiator||!this._firstNegotiation?(this._debug("starting batched negotiation"),this.negotiate()):this._debug("non-initiator initial negotiation request discarded"),this._firstNegotiation=!1}))}negotiate(){if(!this.destroying){if(this.destroyed)throw ve(new Error("cannot negotiate after peer is destroyed"),"ERR_DESTROYED");this.initiator?this._isNegotiating?(this._queuedNegotiation=!0,this._debug("already negotiating, queueing")):(this._debug("start negotiation"),setTimeout(()=>{this._createOffer()},0)):this._isNegotiating?(this._queuedNegotiation=!0,this._debug("already negotiating, queueing")):(this._debug("requesting negotiation from initiator"),this.emit("signal",{type:"renegotiate",renegotiate:!0})),this._isNegotiating=!0}}destroy(t){this._destroy(t,()=>{})}_destroy(t,i){this.destroyed||this.destroying||(this.destroying=!0,this._debug("destroying (error: %s)",t&&(t.message||t)),Ta(()=>{if(this.destroyed=!0,this.destroying=!1,this._debug("destroy (error: %s)",t&&(t.message||t)),this.readable=this.writable=!1,this._readableState.ended||this.push(null),this._writableState.finished||this.end(),this._connected=!1,this._pcReady=!1,this._channelReady=!1,this._remoteTracks=null,this._remoteStreams=null,this._senderMap=null,clearInterval(this._closingInterval),this._closingInterval=null,clearInterval(this._interval),this._interval=null,this._chunk=null,this._cb=null,this._onFinishBound&&this.removeListener("finish",this._onFinishBound),this._onFinishBound=null,this._channel){try{this._channel.close()}catch{}this._channel.onmessage=null,this._channel.onopen=null,this._channel.onclose=null,this._channel.onerror=null}if(this._pc){try{this._pc.close()}catch{}this._pc.oniceconnectionstatechange=null,this._pc.onicegatheringstatechange=null,this._pc.onsignalingstatechange=null,this._pc.onicecandidate=null,this._pc.ontrack=null,this._pc.ondatachannel=null}this._pc=null,this._channel=null,t&&this.emit("error",t),this.emit("close"),i()}))}_setupData(t){if(!t.channel)return this.destroy(ve(new Error("Data channel event is missing `channel` property"),"ERR_DATA_CHANNEL"));this._channel=t.channel,this._channel.binaryType="arraybuffer",typeof this._channel.bufferedAmountLowThreshold=="number"&&(this._channel.bufferedAmountLowThreshold=Aa),this.channelName=this._channel.label,this._channel.onmessage=n=>{this._onChannelMessage(n)},this._channel.onbufferedamountlow=()=>{this._onChannelBufferedAmountLow()},this._channel.onopen=()=>{this._onChannelOpen()},this._channel.onclose=()=>{this._onChannelClose()},this._channel.onerror=n=>{const r=n.error instanceof Error?n.error:new Error(`Datachannel error: ${n.message} ${n.filename}:${n.lineno}:${n.colno}`);this.destroy(ve(r,"ERR_DATA_CHANNEL"))};let i=!1;this._closingInterval=setInterval(()=>{this._channel&&this._channel.readyState==="closing"?(i&&this._onChannelClose(),i=!0):i=!1},Dp)}_read(){}_write(t,i,n){if(this.destroyed)return n(ve(new Error("cannot write after peer is destroyed"),"ERR_DATA_CHANNEL"));if(this._connected){try{this.send(t)}catch(r){return this.destroy(ve(r,"ERR_DATA_CHANNEL"))}this._channel.bufferedAmount>Aa?(this._debug("start backpressure: bufferedAmount %d",this._channel.bufferedAmount),this._cb=n):n(null)}else this._debug("write before connect"),this._chunk=t,this._cb=n}_onFinish(){if(this.destroyed)return;const t=()=>{setTimeout(()=>this.destroy(),1e3)};this._connected?t():this.once("connect",t)}_startIceCompleteTimeout(){this.destroyed||this._iceCompleteTimer||(this._debug("started iceComplete timeout"),this._iceCompleteTimer=setTimeout(()=>{this._iceComplete||(this._iceComplete=!0,this._debug("iceComplete timeout completed"),this.emit("iceTimeout"),this.emit("_iceComplete"))},this.iceCompleteTimeout))}_createOffer(){this.destroyed||this._pc.createOffer(this.offerOptions).then(t=>{if(this.destroyed)return;!this.trickle&&!this.allowHalfTrickle&&(t.sdp=Uo(t.sdp)),t.sdp=this.sdpTransform(t.sdp);const i=()=>{if(this.destroyed)return;const a=this._pc.localDescription||t;this._debug("signal"),this.emit("signal",{type:a.type,sdp:a.sdp})},n=()=>{this._debug("createOffer success"),!this.destroyed&&(this.trickle||this._iceComplete?i():this.once("_iceComplete",i))},r=a=>{this.destroy(ve(a,"ERR_SET_LOCAL_DESCRIPTION"))};this._pc.setLocalDescription(t).then(n).catch(r)}).catch(t=>{this.destroy(ve(t,"ERR_CREATE_OFFER"))})}_requestMissingTransceivers(){this._pc.getTransceivers&&this._pc.getTransceivers().forEach(t=>{!t.mid&&t.sender.track&&!t.requested&&(t.requested=!0,this.addTransceiver(t.sender.track.kind))})}_createAnswer(){this.destroyed||this._pc.createAnswer(this.answerOptions).then(t=>{if(this.destroyed)return;!this.trickle&&!this.allowHalfTrickle&&(t.sdp=Uo(t.sdp)),t.sdp=this.sdpTransform(t.sdp);const i=()=>{if(this.destroyed)return;const a=this._pc.localDescription||t;this._debug("signal"),this.emit("signal",{type:a.type,sdp:a.sdp}),this.initiator||this._requestMissingTransceivers()},n=()=>{this.destroyed||(this.trickle||this._iceComplete?i():this.once("_iceComplete",i))},r=a=>{this.destroy(ve(a,"ERR_SET_LOCAL_DESCRIPTION"))};this._pc.setLocalDescription(t).then(n).catch(r)}).catch(t=>{this.destroy(ve(t,"ERR_CREATE_ANSWER"))})}_onConnectionStateChange(){this.destroyed||this._pc.connectionState==="failed"&&this.destroy(ve(new Error("Connection failed."),"ERR_CONNECTION_FAILURE"))}_onIceStateChange(){if(this.destroyed)return;const t=this._pc.iceConnectionState,i=this._pc.iceGatheringState;this._debug("iceStateChange (connection: %s) (gathering: %s)",t,i),this.emit("iceStateChange",t,i),(t==="connected"||t==="completed")&&(this._pcReady=!0,this._maybeReady()),t==="failed"&&this.destroy(ve(new Error("Ice connection failed."),"ERR_ICE_CONNECTION_FAILURE")),t==="closed"&&this.destroy(ve(new Error("Ice connection closed."),"ERR_ICE_CONNECTION_CLOSED"))}getStats(t){const i=n=>(Object.prototype.toString.call(n.values)==="[object Array]"&&n.values.forEach(r=>{Object.assign(n,r)}),n);this._pc.getStats.length===0||this._isReactNativeWebrtc?this._pc.getStats().then(n=>{const r=[];n.forEach(a=>{r.push(i(a))}),t(null,r)},n=>t(n)):this._pc.getStats.length>0?this._pc.getStats(n=>{if(this.destroyed)return;const r=[];n.result().forEach(a=>{const o={};a.names().forEach(s=>{o[s]=a.stat(s)}),o.id=a.id,o.type=a.type,o.timestamp=a.timestamp,r.push(i(o))}),t(null,r)},n=>t(n)):t(null,[])}_maybeReady(){if(this._debug("maybeReady pc %s channel %s",this._pcReady,this._channelReady),this._connected||this._connecting||!this._pcReady||!this._channelReady)return;this._connecting=!0;const t=()=>{this.destroyed||this.getStats((i,n)=>{if(this.destroyed)return;i&&(n=[]);const r={},a={},o={};let s=!1;n.forEach(d=>{(d.type==="remotecandidate"||d.type==="remote-candidate")&&(r[d.id]=d),(d.type==="localcandidate"||d.type==="local-candidate")&&(a[d.id]=d),(d.type==="candidatepair"||d.type==="candidate-pair")&&(o[d.id]=d)});const l=d=>{s=!0;let p=a[d.localCandidateId];p&&(p.ip||p.address)?(this.localAddress=p.ip||p.address,this.localPort=Number(p.port)):p&&p.ipAddress?(this.localAddress=p.ipAddress,this.localPort=Number(p.portNumber)):typeof d.googLocalAddress=="string"&&(p=d.googLocalAddress.split(":"),this.localAddress=p[0],this.localPort=Number(p[1])),this.localAddress&&(this.localFamily=this.localAddress.includes(":")?"IPv6":"IPv4");let h=r[d.remoteCandidateId];h&&(h.ip||h.address)?(this.remoteAddress=h.ip||h.address,this.remotePort=Number(h.port)):h&&h.ipAddress?(this.remoteAddress=h.ipAddress,this.remotePort=Number(h.portNumber)):typeof d.googRemoteAddress=="string"&&(h=d.googRemoteAddress.split(":"),this.remoteAddress=h[0],this.remotePort=Number(h[1])),this.remoteAddress&&(this.remoteFamily=this.remoteAddress.includes(":")?"IPv6":"IPv4"),this._debug("connect local: %s:%s remote: %s:%s",this.localAddress,this.localPort,this.remoteAddress,this.remotePort)};if(n.forEach(d=>{d.type==="transport"&&d.selectedCandidatePairId&&l(o[d.selectedCandidatePairId]),(d.type==="googCandidatePair"&&d.googActiveConnection==="true"||(d.type==="candidatepair"||d.type==="candidate-pair")&&d.selected)&&l(d)}),!s&&(!Object.keys(o).length||Object.keys(a).length)){setTimeout(t,100);return}else this._connecting=!1,this._connected=!0;if(this._chunk){try{this.send(this._chunk)}catch(p){return this.destroy(ve(p,"ERR_DATA_CHANNEL"))}this._chunk=null,this._debug('sent chunk from "write before connect"');const d=this._cb;this._cb=null,d(null)}typeof this._channel.bufferedAmountLowThreshold!="number"&&(this._interval=setInterval(()=>this._onInterval(),150),this._interval.unref&&this._interval.unref()),this._debug("connect"),this.emit("connect")})};t()}_onInterval(){!this._cb||!this._channel||this._channel.bufferedAmount>Aa||this._onChannelBufferedAmountLow()}_onSignalingStateChange(){this.destroyed||(this._pc.signalingState==="stable"&&(this._isNegotiating=!1,this._debug("flushing sender queue",this._sendersAwaitingStable),this._sendersAwaitingStable.forEach(t=>{this._pc.removeTrack(t),this._queuedNegotiation=!0}),this._sendersAwaitingStable=[],this._queuedNegotiation?(this._debug("flushing negotiation queue"),this._queuedNegotiation=!1,this._needsNegotiation()):(this._debug("negotiated"),this.emit("negotiated"))),this._debug("signalingStateChange %s",this._pc.signalingState),this.emit("signalingStateChange",this._pc.signalingState))}_onIceCandidate(t){this.destroyed||(t.candidate&&this.trickle?this.emit("signal",{type:"candidate",candidate:{candidate:t.candidate.candidate,sdpMLineIndex:t.candidate.sdpMLineIndex,sdpMid:t.candidate.sdpMid}}):!t.candidate&&!this._iceComplete&&(this._iceComplete=!0,this.emit("_iceComplete")),t.candidate&&this._startIceCompleteTimeout())}_onChannelMessage(t){if(this.destroyed)return;let i=t.data;i instanceof ArrayBuffer&&(i=Pp.from(i)),this.push(i)}_onChannelBufferedAmountLow(){if(this.destroyed||!this._cb)return;this._debug("ending backpressure: bufferedAmount %d",this._channel.bufferedAmount);const t=this._cb;this._cb=null,t(null)}_onChannelOpen(){this._connected||this.destroyed||(this._debug("on channel open"),this._channelReady=!0,this._maybeReady())}_onChannelClose(){this.destroyed||(this._debug("on channel close"),this.destroy())}_onTrack(t){this.destroyed||t.streams.forEach(i=>{this._debug("on track"),this.emit("track",t.track,i),this._remoteTracks.push({track:t.track,stream:i}),!this._remoteStreams.some(n=>n.id===i.id)&&(this._remoteStreams.push(i),Ta(()=>{this._debug("on stream"),this.emit("stream",i)}))})}_debug(){const t=[].slice.call(arguments);t[0]="["+this._id+"] "+t[0],$p.apply(null,t)}};jr.WEBRTC_SUPPORT=!!vc();jr.config={iceServers:[{urls:["stun:stun.l.google.com:19302","stun:global.stun.twilio.com:3478"]}],sdpSemantics:"unified-plan"};jr.channelConfig={};var bc=jr,Cs={};(function(e){e.DEFAULT_ANNOUNCE_PEERS=50,e.MAX_ANNOUNCE_PEERS=82,e.binaryToHex=i=>(typeof i!="string"&&(i=String(i)),Buffer.from(i,"binary").toString("hex")),e.hexToBinary=i=>(typeof i!="string"&&(i=String(i)),Buffer.from(i,"hex").toString("binary")),e.parseUrl=i=>{const n=new URL(i.replace(/^udp:/,"http:"));return i.match(/^udp:/)&&Object.defineProperties(n,{href:{value:n.href.replace(/^http/,"udp")},protocol:{value:n.protocol.replace(/^http/,"udp")},origin:{value:n.origin.replace(/^http/,"udp")}}),n},Object.assign(e,vi)})(Cs);var wc={exports:{}};(function(e){var t=function(){function i(m,b){return b!=null&&m instanceof b}var n;try{n=Map}catch{n=function(){}}var r;try{r=Set}catch{r=function(){}}var a;try{a=Promise}catch{a=function(){}}function o(m,b,y,w,k){typeof b=="object"&&(y=b.depth,w=b.prototype,k=b.includeNonEnumerable,b=b.circular);var f=[],v=[],x=typeof Buffer<"u";typeof b>"u"&&(b=!0),typeof y>"u"&&(y=1/0);function A(S,T){if(S===null)return null;if(T===0)return S;var I,L;if(typeof S!="object")return S;if(i(S,n))I=new n;else if(i(S,r))I=new r;else if(i(S,a))I=new a(function(te,re){S.then(function(N){te(A(N,T-1))},function(N){re(A(N,T-1))})});else if(o.__isArray(S))I=[];else if(o.__isRegExp(S))I=new RegExp(S.source,h(S)),S.lastIndex&&(I.lastIndex=S.lastIndex);else if(o.__isDate(S))I=new Date(S.getTime());else{if(x&&Buffer.isBuffer(S))return Buffer.allocUnsafe?I=Buffer.allocUnsafe(S.length):I=new Buffer(S.length),S.copy(I),I;i(S,Error)?I=Object.create(S):typeof w>"u"?(L=Object.getPrototypeOf(S),I=Object.create(L)):(I=Object.create(w),L=w)}if(b){var z=f.indexOf(S);if(z!=-1)return v[z];f.push(S),v.push(I)}i(S,n)&&S.forEach(function(te,re){var N=A(re,T-1),ae=A(te,T-1);I.set(N,ae)}),i(S,r)&&S.forEach(function(te){var re=A(te,T-1);I.add(re)});for(var O in S){var Y;L&&(Y=Object.getOwnPropertyDescriptor(L,O)),!(Y&&Y.set==null)&&(I[O]=A(S[O],T-1))}if(Object.getOwnPropertySymbols)for(var j=Object.getOwnPropertySymbols(S),O=0;O<j.length;O++){var D=j[O],B=Object.getOwnPropertyDescriptor(S,D);B&&!B.enumerable&&!k||(I[D]=A(S[D],T-1),B.enumerable||Object.defineProperty(I,D,{enumerable:!1}))}if(k)for(var W=Object.getOwnPropertyNames(S),O=0;O<W.length;O++){var ie=W[O],B=Object.getOwnPropertyDescriptor(S,ie);B&&B.enumerable||(I[ie]=A(S[ie],T-1),Object.defineProperty(I,ie,{enumerable:!1}))}return I}return A(m,y)}o.clonePrototype=function(b){if(b===null)return null;var y=function(){};return y.prototype=b,new y};function s(m){return Object.prototype.toString.call(m)}o.__objToStr=s;function l(m){return typeof m=="object"&&s(m)==="[object Date]"}o.__isDate=l;function d(m){return typeof m=="object"&&s(m)==="[object Array]"}o.__isArray=d;function p(m){return typeof m=="object"&&s(m)==="[object RegExp]"}o.__isRegExp=p;function h(m){var b="";return m.global&&(b+="g"),m.ignoreCase&&(b+="i"),m.multiline&&(b+="m"),b}return o.__getRegExpFlags=h,o}();e.exports&&(e.exports=t)})(wc);var zp=wc.exports;const Op=zr("simple-websocket"),Np=Ts,Hp=yc,jo=Hr,pn=vi,ln=typeof pn!="function"?WebSocket:pn,Ko=64*1024;let kc=class extends Hp.Duplex{constructor(t={}){if(typeof t=="string"&&(t={url:t}),t=Object.assign({allowHalfOpen:!1},t),super(t),t.url==null&&t.socket==null)throw new Error("Missing required `url` or `socket` option");if(t.url!=null&&t.socket!=null)throw new Error("Must specify either `url` or `socket` option, not both");if(this._id=Np(4).toString("hex").slice(0,7),this._debug("new websocket: %o",t),this.connected=!1,this.destroyed=!1,this._chunk=null,this._cb=null,this._interval=null,t.socket)this.url=t.socket.url,this._ws=t.socket,this.connected=t.socket.readyState===ln.OPEN;else{this.url=t.url;try{typeof pn=="function"?this._ws=new ln(t.url,null,{...t,encoding:void 0}):this._ws=new ln(t.url)}catch(i){jo(()=>this.destroy(i));return}}this._ws.binaryType="arraybuffer",t.socket&&this.connected?jo(()=>this._handleOpen()):this._ws.onopen=()=>this._handleOpen(),this._ws.onmessage=i=>this._handleMessage(i),this._ws.onclose=()=>this._handleClose(),this._ws.onerror=i=>this._handleError(i),this._handleFinishBound=()=>this._handleFinish(),this.once("finish",this._handleFinishBound)}send(t){this._ws.send(t)}destroy(t){this._destroy(t,()=>{})}_destroy(t,i){if(!this.destroyed){if(this._debug("destroy (error: %s)",t&&(t.message||t)),this.readable=this.writable=!1,this._readableState.ended||this.push(null),this._writableState.finished||this.end(),this.connected=!1,this.destroyed=!0,clearInterval(this._interval),this._interval=null,this._chunk=null,this._cb=null,this._handleFinishBound&&this.removeListener("finish",this._handleFinishBound),this._handleFinishBound=null,this._ws){const n=this._ws,r=()=>{n.onclose=null};if(n.readyState===ln.CLOSED)r();else try{n.onclose=r,n.close()}catch{r()}n.onopen=null,n.onmessage=null,n.onerror=()=>{}}this._ws=null,t&&this.emit("error",t),this.emit("close"),i()}}_read(){}_write(t,i,n){if(this.destroyed)return n(new Error("cannot write after socket is destroyed"));if(this.connected){try{this.send(t)}catch(r){return this.destroy(r)}typeof pn!="function"&&this._ws.bufferedAmount>Ko?(this._debug("start backpressure: bufferedAmount %d",this._ws.bufferedAmount),this._cb=n):n(null)}else this._debug("write before connect"),this._chunk=t,this._cb=n}_handleOpen(){if(!(this.connected||this.destroyed)){if(this.connected=!0,this._chunk){try{this.send(this._chunk)}catch(i){return this.destroy(i)}this._chunk=null,this._debug('sent chunk from "write before connect"');const t=this._cb;this._cb=null,t(null)}typeof pn!="function"&&(this._interval=setInterval(()=>this._onInterval(),150),this._interval.unref&&this._interval.unref()),this._debug("connect"),this.emit("connect")}}_handleMessage(t){if(this.destroyed)return;let i=t.data;i instanceof ArrayBuffer&&(i=Buffer.from(i)),this.push(i)}_handleClose(){this.destroyed||(this._debug("on close"),this.destroy())}_handleError(t){this.destroy(new Error(`Error connecting to ${this.url}`))}_handleFinish(){if(this.destroyed)return;const t=()=>{setTimeout(()=>this.destroy(),1e3)};this.connected?t():this.once("connect",t)}_onInterval(){if(!this._cb||!this._ws||this._ws.bufferedAmount>Ko)return;this._debug("ending backpressure: bufferedAmount %d",this._ws.bufferedAmount);const t=this._cb;this._cb=null,t(null)}_debug(){const t=[].slice.call(arguments);t[0]="["+this._id+"] "+t[0],Op.apply(null,t)}};kc.WEBSOCKET_SUPPORT=!!ln;var qp=kc;const Fp=Nr;let Up=class extends Fp{constructor(t,i){super(),this.client=t,this.announceUrl=i,this.interval=null,this.destroyed=!1}setInterval(t){t==null&&(t=this.DEFAULT_ANNOUNCE_INTERVAL),clearInterval(this.interval),t&&(this.interval=setInterval(()=>{this.announce(this.client._defaultAnnounceOpts())},t),this.interval.unref&&this.interval.unref())}};var jp=Up;const Kp=zp,bt=zr("bittorrent-tracker:websocket-tracker"),Wp=bc,Yp=Ts,Vp=qp,Gp=vi,Ft=Cs,Jp=jp,Rt={},Xp=10*1e3,Zp=60*60*1e3,Qp=5*60*1e3,eh=50*1e3;let Ls=class extends Jp{constructor(t,i){super(t,i),bt("new websocket tracker %s",i),this.peers={},this.socket=null,this.reconnecting=!1,this.retries=0,this.reconnectTimer=null,this.expectingResponse=!1,this._openSocket()}announce(t){if(this.destroyed||this.reconnecting)return;if(!this.socket.connected){this.socket.once("connect",()=>{this.announce(t)});return}const i=Object.assign({},t,{action:"announce",info_hash:this.client._infoHashBinary,peer_id:this.client._peerIdBinary});if(this._trackerId&&(i.trackerid=this._trackerId),t.event==="stopped"||t.event==="completed")this._send(i);else{const n=Math.min(t.numwant,5);this._generateOffers(n,r=>{i.numwant=n,i.offers=r,this._send(i)})}}scrape(t){if(this.destroyed||this.reconnecting)return;if(!this.socket.connected){this.socket.once("connect",()=>{this.scrape(t)});return}const n={action:"scrape",info_hash:Array.isArray(t.infoHash)&&t.infoHash.length>0?t.infoHash.map(r=>r.toString("binary")):t.infoHash&&t.infoHash.toString("binary")||this.client._infoHashBinary};this._send(n)}destroy(t=Wo){if(this.destroyed)return t(null);this.destroyed=!0,clearInterval(this.interval),clearTimeout(this.reconnectTimer);for(const a in this.peers){const o=this.peers[a];clearTimeout(o.trackerTimeout),o.destroy()}if(this.peers=null,this.socket&&(this.socket.removeListener("connect",this._onSocketConnectBound),this.socket.removeListener("data",this._onSocketDataBound),this.socket.removeListener("close",this._onSocketCloseBound),this.socket.removeListener("error",this._onSocketErrorBound),this.socket=null),this._onSocketConnectBound=null,this._onSocketErrorBound=null,this._onSocketDataBound=null,this._onSocketCloseBound=null,Rt[this.announceUrl]&&(Rt[this.announceUrl].consumers-=1),Rt[this.announceUrl].consumers>0)return t();let i=Rt[this.announceUrl];delete Rt[this.announceUrl],i.on("error",Wo),i.once("close",t);let n;if(!this.expectingResponse)return r();n=setTimeout(r,Ft.DESTROY_TIMEOUT),i.once("data",r);function r(){n&&(clearTimeout(n),n=null),i.removeListener("data",r),i.destroy(),i=null}}_openSocket(){if(this.destroyed=!1,this.peers||(this.peers={}),this._onSocketConnectBound=()=>{this._onSocketConnect()},this._onSocketErrorBound=t=>{this._onSocketError(t)},this._onSocketDataBound=t=>{this._onSocketData(t)},this._onSocketCloseBound=()=>{this._onSocketClose()},this.socket=Rt[this.announceUrl],this.socket)Rt[this.announceUrl].consumers+=1,this.socket.connected&&this._onSocketConnectBound();else{const t=new URL(this.announceUrl);let i;this.client._proxyOpts&&(i=t.protocol==="wss:"?this.client._proxyOpts.httpsAgent:this.client._proxyOpts.httpAgent,!i&&this.client._proxyOpts.socksProxy&&(i=new Gp.Agent(Kp(this.client._proxyOpts.socksProxy),t.protocol==="wss:"))),this.socket=Rt[this.announceUrl]=new Vp({url:this.announceUrl,agent:i}),this.socket.consumers=1,this.socket.once("connect",this._onSocketConnectBound)}this.socket.on("data",this._onSocketDataBound),this.socket.once("close",this._onSocketCloseBound),this.socket.once("error",this._onSocketErrorBound)}_onSocketConnect(){this.destroyed||this.reconnecting&&(this.reconnecting=!1,this.retries=0,this.announce(this.client._defaultAnnounceOpts()))}_onSocketData(t){if(!this.destroyed){this.expectingResponse=!1;try{t=JSON.parse(t)}catch{this.client.emit("warning",new Error("Invalid tracker response"));return}t.action==="announce"?this._onAnnounceResponse(t):t.action==="scrape"?this._onScrapeResponse(t):this._onSocketError(new Error(`invalid action in WS response: ${t.action}`))}}_onAnnounceResponse(t){if(t.info_hash!==this.client._infoHashBinary){bt("ignoring websocket data from %s for %s (looking for %s: reused socket)",this.announceUrl,Ft.binaryToHex(t.info_hash),this.client.infoHash);return}if(t.peer_id&&t.peer_id===this.client._peerIdBinary)return;bt("received %s from %s for %s",JSON.stringify(t),this.announceUrl,this.client.infoHash);const i=t["failure reason"];if(i)return this.client.emit("warning",new Error(i));const n=t["warning message"];n&&this.client.emit("warning",new Error(n));const r=t.interval||t["min interval"];r&&this.setInterval(r*1e3);const a=t["tracker id"];if(a&&(this._trackerId=a),t.complete!=null){const s=Object.assign({},t,{announce:this.announceUrl,infoHash:Ft.binaryToHex(t.info_hash)});this.client.emit("update",s)}let o;if(t.offer&&t.peer_id&&(bt("creating peer (from remote offer)"),o=this._createPeer(),o.id=Ft.binaryToHex(t.peer_id),o.once("signal",s=>{const l={action:"announce",info_hash:this.client._infoHashBinary,peer_id:this.client._peerIdBinary,to_peer_id:t.peer_id,answer:s,offer_id:t.offer_id};this._trackerId&&(l.trackerid=this._trackerId),this._send(l)}),this.client.emit("peer",o),o.signal(t.offer)),t.answer&&t.peer_id){const s=Ft.binaryToHex(t.offer_id);o=this.peers[s],o?(o.id=Ft.binaryToHex(t.peer_id),this.client.emit("peer",o),o.signal(t.answer),clearTimeout(o.trackerTimeout),o.trackerTimeout=null,delete this.peers[s]):bt(`got unexpected answer: ${JSON.stringify(t.answer)}`)}}_onScrapeResponse(t){t=t.files||{};const i=Object.keys(t);if(i.length===0){this.client.emit("warning",new Error("invalid scrape response"));return}i.forEach(n=>{const r=Object.assign(t[n],{announce:this.announceUrl,infoHash:Ft.binaryToHex(n)});this.client.emit("scrape",r)})}_onSocketClose(){this.destroyed||(this.destroy(),this._startReconnectTimer())}_onSocketError(t){this.destroyed||(this.destroy(),this.client.emit("warning",t),this._startReconnectTimer())}_startReconnectTimer(){const t=Math.floor(Math.random()*Qp)+Math.min(Math.pow(2,this.retries)*Xp,Zp);this.reconnecting=!0,clearTimeout(this.reconnectTimer),this.reconnectTimer=setTimeout(()=>{this.retries++,this._openSocket()},t),this.reconnectTimer.unref&&this.reconnectTimer.unref(),bt("reconnecting socket in %s ms",t)}_send(t){if(this.destroyed)return;this.expectingResponse=!0;const i=JSON.stringify(t);bt("send %s",i),this.socket.send(i)}_generateOffers(t,i){const n=this,r=[];bt("generating %s offers",t);for(let s=0;s<t;++s)a();o();function a(){const s=Yp(20).toString("hex");bt("creating peer (from _generateOffers)");const l=n.peers[s]=n._createPeer({initiator:!0});l.once("signal",d=>{r.push({offer:d,offer_id:Ft.hexToBinary(s)}),o()}),l.trackerTimeout=setTimeout(()=>{bt("tracker timeout: destroying peer"),l.trackerTimeout=null,delete n.peers[s],l.destroy()},eh),l.trackerTimeout.unref&&l.trackerTimeout.unref()}function o(){r.length===t&&(bt("generated %s offers",t),i(r))}}_createPeer(t){const i=this;t=Object.assign({trickle:!1,config:i.client._rtcConfig,wrtc:i.client._wrtc},t);const n=new Wp(t);return n.once("error",r),n.once("connect",a),n;function r(o){i.client.emit("warning",new Error(`Connection error: ${o.message}`)),n.destroy()}function a(){n.removeListener("error",r),n.removeListener("connect",a)}}};Ls.prototype.DEFAULT_ANNOUNCE_INTERVAL=30*1e3;Ls._socketPool=Rt;function Wo(){}var th=Ls;const Ut=zr("bittorrent-tracker:client"),ih=Nr,nh=Ru,rh=$u,ah=bc,sh=Hr,Yo=Cs,Vo=vi,Go=vi,oh=th;class Za extends ih{constructor(t={}){if(super(),!t.peerId)throw new Error("Option `peerId` is required");if(!t.infoHash)throw new Error("Option `infoHash` is required");if(!t.announce)throw new Error("Option `announce` is required");if(!process.browser&&!t.port)throw new Error("Option `port` is required");this.peerId=typeof t.peerId=="string"?t.peerId:t.peerId.toString("hex"),this._peerIdBuffer=Buffer.from(this.peerId,"hex"),this._peerIdBinary=this._peerIdBuffer.toString("binary"),this.infoHash=typeof t.infoHash=="string"?t.infoHash.toLowerCase():t.infoHash.toString("hex"),this._infoHashBuffer=Buffer.from(this.infoHash,"hex"),this._infoHashBinary=this._infoHashBuffer.toString("binary"),Ut("new client %s",this.infoHash),this.destroyed=!1,this._port=t.port,this._getAnnounceOpts=t.getAnnounceOpts,this._rtcConfig=t.rtcConfig,this._userAgent=t.userAgent,this._proxyOpts=t.proxyOpts,this._wrtc=typeof t.wrtc=="function"?t.wrtc():t.wrtc;let i=typeof t.announce=="string"?[t.announce]:t.announce==null?[]:t.announce;i=i.map(a=>(a=a.toString(),a[a.length-1]==="/"&&(a=a.substring(0,a.length-1)),a)),i=Array.from(new Set(i));const n=this._wrtc!==!1&&(!!this._wrtc||ah.WEBRTC_SUPPORT),r=a=>{sh(()=>{this.emit("warning",a)})};this._trackers=i.map(a=>{let o;try{o=Yo.parseUrl(a)}catch{return r(new Error(`Invalid tracker URL: ${a}`)),null}const s=o.port;if(s<0||s>65535)return r(new Error(`Invalid tracker port: ${a}`)),null;const l=o.protocol;return(l==="http:"||l==="https:")&&typeof Vo=="function"?new Vo(this,a):l==="udp:"&&typeof Go=="function"?new Go(this,a):(l==="ws:"||l==="wss:")&&n?l==="ws:"&&typeof window<"u"&&window.location.protocol==="https:"?(r(new Error(`Unsupported tracker protocol: ${a}`)),null):new oh(this,a):(r(new Error(`Unsupported tracker protocol: ${a}`)),null)}).filter(Boolean)}start(t){t=this._defaultAnnounceOpts(t),t.event="started",Ut("send `start` %o",t),this._announce(t),this._trackers.forEach(i=>{i.setInterval()})}stop(t){t=this._defaultAnnounceOpts(t),t.event="stopped",Ut("send `stop` %o",t),this._announce(t)}complete(t){t||(t={}),t=this._defaultAnnounceOpts(t),t.event="completed",Ut("send `complete` %o",t),this._announce(t)}update(t){t=this._defaultAnnounceOpts(t),t.event&&delete t.event,Ut("send `update` %o",t),this._announce(t)}_announce(t){this._trackers.forEach(i=>{i.announce(t)})}scrape(t){Ut("send `scrape`"),t||(t={}),this._trackers.forEach(i=>{i.scrape(t)})}setInterval(t){Ut("setInterval %d",t),this._trackers.forEach(i=>{i.setInterval(t)})}destroy(t){if(this.destroyed)return;this.destroyed=!0,Ut("destroy");const i=this._trackers.map(n=>r=>{n.destroy(r)});rh(i,t),this._trackers=[],this._getAnnounceOpts=null}_defaultAnnounceOpts(t={}){return t.numwant==null&&(t.numwant=Yo.DEFAULT_ANNOUNCE_PEERS),t.uploaded==null&&(t.uploaded=0),t.downloaded==null&&(t.downloaded=0),this._getAnnounceOpts&&(t=Object.assign({},t,this._getAnnounceOpts())),t}}Za.scrape=(e,t)=>{if(t=nh(t),!e.infoHash)throw new Error("Option `infoHash` is required");if(!e.announce)throw new Error("Option `announce` is required");const i=Object.assign({},e,{infoHash:Array.isArray(e.infoHash)?e.infoHash[0]:e.infoHash,peerId:Buffer.from("01234567890123456789"),port:6881}),n=new Za(i);n.once("error",t),n.once("warning",t);let r=Array.isArray(e.infoHash)?e.infoHash.length:1;const a={};return n.on("scrape",o=>{if(r-=1,a[o.infoHash]=o,r===0){n.destroy();const s=Object.keys(a);s.length===1?t(null,a[s[0]]):t(null,a)}}),e.infoHash=Array.isArray(e.infoHash)?e.infoHash.map(o=>Buffer.from(o,"hex")):Buffer.from(e.infoHash,"hex"),n.scrape({infoHash:e.infoHash}),n};var lh=Za;const ch=Yl(lh);var _c={exports:{}},Oe=_c.exports={},Et,Tt;function Qa(){throw new Error("setTimeout has not been defined")}function es(){throw new Error("clearTimeout has not been defined")}(function(){try{typeof setTimeout=="function"?Et=setTimeout:Et=Qa}catch{Et=Qa}try{typeof clearTimeout=="function"?Tt=clearTimeout:Tt=es}catch{Tt=es}})();function Sc(e){if(Et===setTimeout)return setTimeout(e,0);if((Et===Qa||!Et)&&setTimeout)return Et=setTimeout,setTimeout(e,0);try{return Et(e,0)}catch{try{return Et.call(null,e,0)}catch{return Et.call(this,e,0)}}}function dh(e){if(Tt===clearTimeout)return clearTimeout(e);if((Tt===es||!Tt)&&clearTimeout)return Tt=clearTimeout,clearTimeout(e);try{return Tt(e)}catch{try{return Tt.call(null,e)}catch{return Tt.call(this,e)}}}var Pt=[],Mi=!1,hi,tr=-1;function uh(){!Mi||!hi||(Mi=!1,hi.length?Pt=hi.concat(Pt):tr=-1,Pt.length&&xc())}function xc(){if(!Mi){var e=Sc(uh);Mi=!0;for(var t=Pt.length;t;){for(hi=Pt,Pt=[];++tr<t;)hi&&hi[tr].run();tr=-1,t=Pt.length}hi=null,Mi=!1,dh(e)}}Oe.nextTick=function(e){var t=new Array(arguments.length-1);if(arguments.length>1)for(var i=1;i<arguments.length;i++)t[i-1]=arguments[i];Pt.push(new Ec(e,t)),Pt.length===1&&!Mi&&Sc(xc)};function Ec(e,t){this.fun=e,this.array=t}Ec.prototype.run=function(){this.fun.apply(null,this.array)};Oe.title="browser";Oe.browser=!0;Oe.env={};Oe.argv=[];Oe.version="";Oe.versions={};function Nt(){}Oe.on=Nt;Oe.addListener=Nt;Oe.once=Nt;Oe.off=Nt;Oe.removeListener=Nt;Oe.removeAllListeners=Nt;Oe.emit=Nt;Oe.prependListener=Nt;Oe.prependOnceListener=Nt;Oe.listeners=function(e){return[]};Oe.binding=function(e){throw new Error("process.binding is not supported")};Oe.cwd=function(){return"/"};Oe.chdir=function(e){throw new Error("process.chdir is not supported")};Oe.umask=function(){return 0};var ph=_c.exports;const hh=Yl(ph);globalThis.Buffer||(globalThis.Buffer=yi.Buffer);globalThis.process||(globalThis.process=hh);const fh=["wss://tracker.openwebtorrent.com","wss://tracker.btorrent.xyz","wss://tracker.webtorrent.dev","wss://tracker.files.fm:7073/announce","wss://spacetrackr.link:443/announce","wss://tracker.fastcast.nz:443/announce"],mh=160,Tc="cinepulse.decision-room.owner.",gh="cinepulse.decision-room.autoplay";function Ti(e=12){const t=new Uint8Array(e);return crypto.getRandomValues(t),Array.from(t,i=>i.toString(16).padStart(2,"0")).join("")}function Ke(e=""){const t=String(e).replace(/\D/g,"");return t.length===6?t:""}function Dn(e,t="",i=null){if(!e?.id)return;const n=e.type==="tv"?"tv":"movie";try{sessionStorage.setItem(gh,JSON.stringify({id:String(e.id),type:n,roomCode:Ke(t),season:n==="tv"?Math.max(1,Number(e.season)||1):null,episode:n==="tv"?Math.max(1,Number(e.episode)||1):null,initialSync:i||null,createdAt:Date.now()}))}catch{}window.dispatchEvent(new CustomEvent("cinepulse:decision-room-open"));const r=`#detail?type=${n}&id=${e.id}`;window.location.hash===r?window.dispatchEvent(new Event("hashchange")):window.location.hash=r}async function yh(e){const t=new TextEncoder().encode(`cinepulse-decision-room-v1:${e}`),i=await crypto.subtle.digest("SHA-256",t);return Array.from(new Uint8Array(i).slice(0,20),n=>n.toString(16).padStart(2,"0")).join("")}function vh(){const e=new Uint32Array(1);return crypto.getRandomValues(e),String(1e5+e[0]%9e5)}function bh(e){const t=Ke(e);if(t)try{sessionStorage.setItem(`${Tc}${t}`,"1")}catch{}}function wh(e){const t=Ke(e);if(!t)return!1;try{return sessionStorage.getItem(`${Tc}${t}`)==="1"}catch{return!1}}function kh(){try{return Ke(new URL(window.location.href).searchParams.get("oda")||"")}catch{return""}}function Ac(e){const t=new URL(window.location.href);return t.searchParams.set("oda",Ke(e)),t.toString()}function _h(){try{const e=new URL(window.location.href);e.searchParams.delete("oda"),history.replaceState(history.state,"",e.toString())}catch{}}function ts(){const e=["Sinemasever","Gece Kuşu","Patlamış Mısır","Film Avcısı","Koltuğunda"],t=Ti(2).toUpperCase();return`${e[Math.floor(Math.random()*e.length)]} ${t}`}class Sh{constructor({roomCode:t,nickname:i=ts(),isHost:n=!1}){this.roomCode=Ke(t),this.nickname=String(i||ts()).slice(0,30),this.isHost=!!n,this.selfId=Ti(10),this.client=null,this.peers=new Map,this.peerParticipantIds=new WeakMap,this.trackerPeerCount=1,this.announceTimer=null,this.participants=new Map([[this.selfId,{id:this.selfId,nickname:this.nickname,role:this.isHost?"moderator":"participant"}]]),this.listeners=new Set,this.receivedIds=new Set,this.cards=[],this.votes={},this.ratings={},this.suggestions=[],this.syncMode="smooth",this.silentVoting=!1,this.sharedPlayback=null,this.lastPlayerSync=null,this.roomFinish=null,this.chatMessages=[],this.roomSummary=null,this.playbackStartedAt=0,this.roomActivity={reactions:[],chats:[]},this.onPlayerSync=r=>{const a=r.detail;!this.isHost||!a||Ke(a.roomCode)!==this.roomCode||!this.sharedPlayback||String(a.mediaId)!==String(this.sharedPlayback.id)||a.type!==this.sharedPlayback.type||(this.lastPlayerSync=a,this.broadcast({type:"player-sync",sync:a}))},window.addEventListener("cinepulse:player-sync",this.onPlayerSync),this.onRoomFinish=r=>{const a=r.detail;!this.isHost||!a||Ke(a.roomCode)!==this.roomCode||(this.roomFinish=a,this.broadcast({type:"room-finish",finish:a}))},this.onRoomFinishVote=r=>{const a=r.detail;!a||Ke(a.roomCode)!==this.roomCode||!a.optionId||this.broadcast({type:"room-finish-vote",vote:a})},this.onRoomFinishChoice=r=>{const a=r.detail;!this.isHost||!a||Ke(a.roomCode)!==this.roomCode||(this.broadcast({type:"room-finish-choice",choice:a}),this.applyRoomFinishChoice(a))},this.onRoomReaction=r=>{const a=r.detail;if(!a||Ke(a.roomCode)!==this.roomCode||!a.emoji)return;const o={...a,senderId:this.selfId,sentAt:Date.now()};this.recordRoomReaction(o),this.broadcast({type:"room-reaction",reaction:o})},window.addEventListener("cinepulse:room-finish",this.onRoomFinish),window.addEventListener("cinepulse:room-finish-vote",this.onRoomFinishVote),window.addEventListener("cinepulse:room-finish-choice",this.onRoomFinishChoice),window.addEventListener("cinepulse:room-reaction",this.onRoomReaction),this.onRoomChatSend=r=>{const a=r.detail,o=String(a?.text||"").trim().slice(0,240);if(!a||Ke(a.roomCode)!==this.roomCode||!o)return;const s={id:String(a.id||`chat-${Date.now()}-${Math.random().toString(36).slice(2,8)}`),text:o,nickname:this.nickname,senderId:this.selfId,sentAt:Number(a.sentAt)||Date.now(),at:Math.max(0,Number(a.at)||0)};this.chatMessages=[...this.chatMessages,s].slice(-60),this.recordRoomChat(s),this.broadcast({type:"room-chat",chat:s})},window.addEventListener("cinepulse:room-chat-send",this.onRoomChatSend),this.onRoomPlaybackHealth=r=>{const a=r.detail;!a||Ke(a.roomCode)!==this.roomCode||a.senderId===this.selfId||this.broadcast({type:"playback-health",health:{senderId:this.selfId,status:a.status==="buffering"?"buffering":"ready",bufferedAhead:Math.max(0,Number(a.bufferedAhead)||0),reportedAt:Date.now()}})},window.addEventListener("cinepulse:room-playback-health",this.onRoomPlaybackHealth),this.onRoomPlaybackProgress=r=>{const a=r.detail;!a||Ke(a.roomCode)!==this.roomCode||this.broadcast({type:"playback-progress",progress:{senderId:this.selfId,nickname:this.nickname,time:Math.max(0,Number(a.time)||0),playing:!!a.playing,buffering:!!a.buffering,reportedAt:Date.now()}})},window.addEventListener("cinepulse:room-playback-progress",this.onRoomPlaybackProgress),this.onRoomPlaybackCheckpoint=r=>{const a=r.detail;!this.isHost||!a||Ke(a.roomCode)!==this.roomCode||!a.targetId||this.broadcast({type:"playback-checkpoint",checkpoint:{targetId:a.targetId,action:a.action==="resume"?"resume":"hold",mediaId:String(a.mediaId||""),type:a.type==="tv"?"tv":"movie"}})},window.addEventListener("cinepulse:room-playback-checkpoint",this.onRoomPlaybackCheckpoint),this.onRoomPlaybackFinished=r=>{const a=r.detail;!a||Ke(a.roomCode)!==this.roomCode||this.broadcast({type:"playback-finished",finished:{mediaId:String(a.mediaId||""),type:a.type==="tv"?"tv":"movie",season:Math.max(1,Number(a.season)||1),episode:Math.max(1,Number(a.episode)||1),nickname:this.nickname}})},window.addEventListener("cinepulse:room-playback-finished",this.onRoomPlaybackFinished),this.onRoomSummary=r=>{const a=r.detail;if(!this.isHost||!a||Ke(a.roomCode)!==this.roomCode)return;const o=new Map;this.roomActivity.reactions.forEach(p=>o.set(p.emoji,(o.get(p.emoji)||0)+1));const s=Array.from(o.entries()).sort((p,h)=>h[1]-p[1])[0]||null,l=new Map;this.roomActivity.chats.forEach(p=>{const h=Math.floor(Math.max(0,Number(p.at)||0)/60)*60;l.set(h,(l.get(h)||0)+1)});const d=Array.from(l.entries()).sort((p,h)=>h[1]-p[1])[0]||null;this.roomSummary={roomCode:this.roomCode,mediaId:String(a.mediaId||this.sharedPlayback?.id||""),type:a.type==="tv"?"tv":"movie",participants:this.participants.size,watchedSeconds:Math.max(0,Number(a.seconds)||0),topReaction:s?{emoji:s[0],count:s[1]}:null,topTalkSecond:d?d[0]:null,chatCount:this.roomActivity.chats.length},this.broadcast({type:"room-summary",summary:this.roomSummary}),window.dispatchEvent(new CustomEvent("cinepulse:room-summary-remote",{detail:this.roomSummary}))},this.onRoomRhythm=r=>{const a=r.detail;!this.isHost||!a||Ke(a.roomCode)!==this.roomCode||!a.targetId||this.broadcast({type:"room-rhythm",rhythm:a})},window.addEventListener("cinepulse:room-summary",this.onRoomSummary),window.addEventListener("cinepulse:room-rhythm",this.onRoomRhythm),this.destroyed=!1}applyRoomFinishChoice(t){if(this.roomFinish=null,t.action==="open"&&t.card?.id){this.sharedPlayback={id:t.card.id,type:t.card.type==="tv"?"tv":"movie",season:Math.max(1,Number(t.card.season)||1),episode:Math.max(1,Number(t.card.episode)||1)},this.lastPlayerSync=null,this.playbackStartedAt=Date.now(),this.roomSummary=null,this.roomActivity={reactions:[],chats:[]},this.emit(),Dn(t.card,this.roomCode);return}t.action==="close"&&(this.sharedPlayback=null,this.lastPlayerSync=null,window.dispatchEvent(new CustomEvent("cinepulse:decision-room-close-player",{detail:{roomCode:this.roomCode}}))),this.emit()}snapshot(){return{roomCode:this.roomCode,nickname:this.nickname,selfId:this.selfId,isHost:this.isHost,peerCount:this.peers.size,trackerPeerCount:this.trackerPeerCount,participants:Array.from(this.participants.values()),cards:this.cards,votes:this.votes,ratings:this.ratings,suggestions:this.suggestions,syncMode:this.syncMode,silentVoting:this.silentVoting,chatMessages:this.chatMessages,roomSummary:this.roomSummary}}subscribe(t){return this.listeners.add(t),t(this.snapshot()),()=>this.listeners.delete(t)}emit(){const t=this.snapshot();if(this.listeners.forEach(i=>i(t)),this.sharedPlayback){const i={roomCode:this.roomCode,isHost:this.isHost,selfId:this.selfId,participants:t.participants,peerCount:t.peerCount,chatMessages:t.chatMessages,syncMode:t.syncMode,silentVoting:t.silentVoting,roomSummary:t.roomSummary};window.__cinepulseDecisionRoomPresence=i,window.dispatchEvent(new CustomEvent("cinepulse:decision-room-presence",{detail:i}))}}async connect(){if(!this.roomCode)throw new Error("Geçersiz oda kodu.");const t=await yh(this.roomCode);this.destroyed||(this.client=new ch({infoHash:t,peerId:Ti(20),announce:fh,port:0,rtcConfig:{iceServers:[{urls:"stun:stun.l.google.com:19302"},{urls:"stun:global.stun.twilio.com:3478"}]}}),this.client.on("peer",i=>this.attachPeer(i)),this.client.on("update",i=>{const n=Number(i?.complete||0)+Number(i?.incomplete||0);this.trackerPeerCount=Math.max(1,n||1),this.emit()}),this.client.on("warning",()=>this.emit()),this.client.on("error",()=>this.emit()),this.client.start({numwant:5,left:1}),this.announceTimer=window.setInterval(()=>{try{this.client?.update({numwant:5,left:1})}catch{}},15e3),this.emit())}attachPeer(t){let i=t.id||Ti(8);const n=()=>{this.destroyed||(i=t.id||i,this.peers.set(i,t),this.sendTo(t,{type:"hello",participant:{id:this.selfId,nickname:this.nickname,role:this.isHost?"moderator":"participant"},wantsState:!0}),this.emit())},r=s=>this.receive(s,t),a=()=>{this.peers.delete(i);const s=this.peerParticipantIds.get(t);s&&(Array.from(this.peers.values()).some(d=>this.peerParticipantIds.get(d)===s)||this.participants.delete(s)),this.emit()},o=()=>a();t.once("connect",n),t.on("data",r),t.once("close",a),t.once("error",o)}sendTo(t,i){try{if(!t||t.destroyed||!t.connected)return;t.send(JSON.stringify({...i,id:Ti(10),senderId:this.selfId}))}catch{}}broadcast(t){const i={...t,id:Ti(10),senderId:this.selfId};this.remember(i.id),this.peers.forEach(n=>{try{!n.destroyed&&n.connected&&n.send(JSON.stringify(i))}catch{}})}remember(t){this.receivedIds.add(t),this.receivedIds.size>mh&&this.receivedIds.delete(this.receivedIds.values().next().value)}receive(t,i){let n;try{n=JSON.parse(typeof t=="string"?t:new TextDecoder().decode(t))}catch{return}if(!(!n?.id||this.receivedIds.has(n.id)||n.senderId===this.selfId)){if(this.remember(n.id),n.type==="hello"&&n.participant?.id&&(this.participants.set(n.participant.id,n.participant),this.peerParticipantIds.set(i,n.participant.id),n.wantsState&&(this.sendTo(i,{type:"hello",participant:{id:this.selfId,nickname:this.nickname,role:this.isHost?"moderator":"participant"}}),this.isHost&&this.sendTo(i,{type:"state",cards:this.cards,votes:this.votes,ratings:this.ratings,suggestions:this.suggestions,syncMode:this.syncMode,silentVoting:this.silentVoting,participants:Array.from(this.participants.values()),sharedPlayback:this.sharedPlayback,lastPlayerSync:this.lastPlayerSync,roomFinish:this.roomFinish,chatMessages:this.chatMessages})),this.emit()),n.type==="state"&&Array.isArray(n.cards)&&!this.isHost){if(this.cards=n.cards.slice(0,12),this.votes=n.votes||{},this.ratings=n.ratings||{},this.suggestions=Array.isArray(n.suggestions)?n.suggestions.slice(-20):[],this.syncMode=n.syncMode==="strict"?"strict":"smooth",this.silentVoting=n.silentVoting===!0,Array.isArray(n.participants)&&n.participants.forEach(r=>{r?.id&&r?.nickname&&this.participants.set(r.id,r)}),n.sharedPlayback?.id){const r={id:n.sharedPlayback.id,type:n.sharedPlayback.type==="tv"?"tv":"movie",season:Math.max(1,Number(n.sharedPlayback.season)||1),episode:Math.max(1,Number(n.sharedPlayback.episode)||1)},a=!this.sharedPlayback||String(this.sharedPlayback.id)!==String(r.id)||this.sharedPlayback.type!==r.type||Number(this.sharedPlayback.season)!==Number(r.season)||Number(this.sharedPlayback.episode)!==Number(r.episode);this.sharedPlayback=r,this.lastPlayerSync=n.lastPlayerSync||null,this.roomFinish=n.roomFinish||null,this.chatMessages=Array.isArray(n.chatMessages)?n.chatMessages.slice(-60):[],a?Dn(r,this.roomCode,this.lastPlayerSync):this.lastPlayerSync&&window.dispatchEvent(new CustomEvent("cinepulse:player-sync-remote",{detail:this.lastPlayerSync}))}this.emit()}if(n.type==="cards"&&Array.isArray(n.cards)&&!this.isHost&&(this.cards=n.cards.slice(0,12),this.votes=n.votes||{},this.ratings=n.ratings||{},this.emit()),n.type==="suggestions"&&Array.isArray(n.suggestions)&&!this.isHost&&(this.suggestions=n.suggestions.slice(-20),this.emit()),n.type==="sync-mode"&&!this.isHost&&(this.syncMode=n.syncMode==="strict"?"strict":"smooth",this.emit()),n.type==="silent-voting"&&!this.isHost&&(this.silentVoting=n.enabled===!0,this.emit()),n.type==="suggest-card"&&this.isHost&&n.card?.id){const r=`${n.senderId}:${n.card.type}:${n.card.id}`;if(!this.cards.some(o=>String(o.id)===String(n.card.id)&&o.type===n.card.type)&&!this.suggestions.some(o=>o.id===r)){const o=this.participants.get(n.senderId);this.suggestions=[...this.suggestions,{id:r,card:n.card,nickname:o?.nickname||"Katılımcı"}].slice(-20),this.broadcast({type:"suggestions",suggestions:this.suggestions}),this.emit()}}if(n.type==="playback-health"&&this.isHost&&n.health?.senderId&&window.dispatchEvent(new CustomEvent("cinepulse:room-playback-health-remote",{detail:{...n.health,roomCode:this.roomCode,syncMode:this.syncMode}})),n.type==="playback-progress"&&this.isHost&&n.progress?.senderId&&window.dispatchEvent(new CustomEvent("cinepulse:room-playback-progress-remote",{detail:{...n.progress,roomCode:this.roomCode}})),n.type==="playback-checkpoint"&&n.checkpoint?.targetId&&window.dispatchEvent(new CustomEvent("cinepulse:room-playback-checkpoint-remote",{detail:{...n.checkpoint,roomCode:this.roomCode}})),n.type==="playback-finished"&&n.finished?.mediaId&&window.dispatchEvent(new CustomEvent("cinepulse:room-playback-finished-remote",{detail:{...n.finished,roomCode:this.roomCode,senderId:n.senderId}})),n.type==="vote"&&n.cardId&&n.senderId&&(this.votes={...this.votes,[n.cardId]:{...this.votes[n.cardId]||{},[n.senderId]:n.vote==="yes"?"yes":"no"}},this.emit()),n.type==="rating"&&n.cardId&&n.senderId){const r=Math.max(1,Math.min(5,Number(n.rating)||0));if(!r)return;this.ratings={...this.ratings,[n.cardId]:{...this.ratings[n.cardId]||{},[n.senderId]:r}},this.emit()}if(n.type==="open"&&n.card?.id&&(this.sharedPlayback={id:n.card.id,type:n.card.type==="tv"?"tv":"movie",season:Math.max(1,Number(n.card.season)||1),episode:Math.max(1,Number(n.card.episode)||1)},this.emit(),Dn(n.card,this.roomCode)),n.type==="player-sync"&&n.sync&&!this.isHost){const r=n.sync;if(!this.sharedPlayback||String(r.mediaId)!==String(this.sharedPlayback.id)||r.type!==this.sharedPlayback.type)return;this.lastPlayerSync=r,window.dispatchEvent(new CustomEvent("cinepulse:player-sync-remote",{detail:r}))}if(n.type==="room-finish"&&n.finish&&!this.isHost&&(this.roomFinish=n.finish,window.dispatchEvent(new CustomEvent("cinepulse:room-finish-remote",{detail:n.finish})),this.emit()),n.type==="room-finish-vote"&&n.vote){const r=n.vote;if(this.roomFinish?.id!==r.finishId)return;this.roomFinish={...this.roomFinish,votes:{...this.roomFinish.votes||{},[n.senderId]:r.optionId}},window.dispatchEvent(new CustomEvent("cinepulse:room-finish-vote-remote",{detail:this.roomFinish})),this.emit()}if(n.type==="room-finish-choice"&&n.choice&&!this.isHost&&this.applyRoomFinishChoice(n.choice),n.type==="room-reaction"&&n.reaction&&(this.recordRoomReaction(n.reaction),window.dispatchEvent(new CustomEvent("cinepulse:room-reaction-remote",{detail:n.reaction}))),n.type==="room-chat"&&n.chat?.text){const r={...n.chat,senderId:n.senderId||n.chat.senderId};this.chatMessages=[...this.chatMessages,r].slice(-60),this.recordRoomChat(r),window.dispatchEvent(new CustomEvent("cinepulse:room-chat-remote",{detail:r}))}n.type==="room-summary"&&n.summary&&(this.roomSummary=n.summary,window.dispatchEvent(new CustomEvent("cinepulse:room-summary-remote",{detail:n.summary})),this.emit()),n.type==="room-rhythm"&&n.rhythm?.targetId&&window.dispatchEvent(new CustomEvent("cinepulse:room-rhythm-remote",{detail:{...n.rhythm,roomCode:this.roomCode}}))}}setCards(t){this.isHost&&(this.cards=Array.isArray(t)?t.slice(0,12):[],this.votes={},this.ratings={},this.broadcast({type:"cards",cards:this.cards,votes:this.votes,ratings:this.ratings}),this.emit())}addCard(t){return!this.isHost||!t?.id||this.cards.length>=12||this.cards.some(i=>String(i.id)===String(t.id)&&i.type===t.type)?!1:(this.cards=[...this.cards,t],this.broadcast({type:"cards",cards:this.cards,votes:this.votes,ratings:this.ratings}),this.emit(),!0)}suggest(t){return this.isHost||!t?.id?!1:(this.broadcast({type:"suggest-card",card:t}),!0)}acceptSuggestion(t){if(!this.isHost)return!1;const i=this.suggestions.find(n=>n.id===t);return!i||this.cards.length>=12?!1:(this.suggestions=this.suggestions.filter(n=>n.id!==t),this.cards.some(n=>String(n.id)===String(i.card.id)&&n.type===i.card.type)||(this.cards=[...this.cards,i.card],this.broadcast({type:"cards",cards:this.cards,votes:this.votes,ratings:this.ratings})),this.broadcast({type:"suggestions",suggestions:this.suggestions}),this.emit(),!0)}dismissSuggestion(t){if(!this.isHost)return!1;const i=this.suggestions.filter(n=>n.id!==t);return i.length===this.suggestions.length?!1:(this.suggestions=i,this.broadcast({type:"suggestions",suggestions:this.suggestions}),this.emit(),!0)}setSyncMode(t){this.isHost&&(this.syncMode=t==="strict"?"strict":"smooth",this.broadcast({type:"sync-mode",syncMode:this.syncMode}),this.emit())}setSilentVoting(t){this.isHost&&(this.silentVoting=t===!0,this.broadcast({type:"silent-voting",enabled:this.silentVoting}),this.emit())}removeCard(t){if(!this.isHost||!t)return!1;const i=this.cards.filter(n=>String(n.id)!==String(t));return i.length===this.cards.length?!1:(this.cards=i,delete this.votes[t],delete this.ratings[t],this.broadcast({type:"cards",cards:this.cards,votes:this.votes,ratings:this.ratings}),this.emit(),!0)}vote(t,i){t&&(this.votes={...this.votes,[t]:{...this.votes[t]||{},[this.selfId]:i==="yes"?"yes":"no"}},this.broadcast({type:"vote",cardId:t,vote:i==="yes"?"yes":"no"}),this.emit())}rate(t,i){if(!t)return;const n=Math.max(1,Math.min(5,Number(i)||0));n&&(this.ratings={...this.ratings,[t]:{...this.ratings[t]||{},[this.selfId]:n}},this.broadcast({type:"rating",cardId:t,rating:n}),this.emit())}openForEveryone(t){if(!t?.id)return;this.sharedPlayback={id:t.id,type:t.type==="tv"?"tv":"movie",season:Math.max(1,Number(t.season)||1),episode:Math.max(1,Number(t.episode)||1)},this.playbackStartedAt=Date.now(),this.roomSummary=null,this.roomActivity={reactions:[],chats:[]},this.emit(),this.broadcast({type:"open",card:t});const i=()=>{this.destroyed||!this.sharedPlayback||this.broadcast({type:"state",cards:this.cards,votes:this.votes,ratings:this.ratings,suggestions:this.suggestions,syncMode:this.syncMode,silentVoting:this.silentVoting,participants:Array.from(this.participants.values()),sharedPlayback:this.sharedPlayback,lastPlayerSync:this.lastPlayerSync,roomFinish:this.roomFinish,chatMessages:this.chatMessages})};window.setTimeout(i,350),window.setTimeout(i,1400),Dn(t,this.roomCode)}recordRoomReaction(t){t?.emoji&&(this.roomActivity.reactions=[...this.roomActivity.reactions,{emoji:String(t.emoji),at:Math.max(0,Number(t.at)||0),senderId:t.senderId||""}].slice(-240))}recordRoomChat(t){t?.text&&(this.roomActivity.chats=[...this.roomActivity.chats,{at:Math.max(0,Number(t.at)||0),senderId:t.senderId||""}].slice(-120))}destroy(){this.destroyed=!0,window.removeEventListener("cinepulse:player-sync",this.onPlayerSync),window.removeEventListener("cinepulse:room-finish",this.onRoomFinish),window.removeEventListener("cinepulse:room-finish-vote",this.onRoomFinishVote),window.removeEventListener("cinepulse:room-finish-choice",this.onRoomFinishChoice),window.removeEventListener("cinepulse:room-reaction",this.onRoomReaction),window.removeEventListener("cinepulse:room-chat-send",this.onRoomChatSend),window.removeEventListener("cinepulse:room-playback-health",this.onRoomPlaybackHealth),window.removeEventListener("cinepulse:room-playback-progress",this.onRoomPlaybackProgress),window.removeEventListener("cinepulse:room-playback-checkpoint",this.onRoomPlaybackCheckpoint),window.removeEventListener("cinepulse:room-playback-finished",this.onRoomPlaybackFinished),window.removeEventListener("cinepulse:room-summary",this.onRoomSummary),window.removeEventListener("cinepulse:room-rhythm",this.onRoomRhythm),this.announceTimer&&window.clearInterval(this.announceTimer),this.announceTimer=null,this.peers.forEach(t=>{try{t.destroy()}catch{}}),this.peers.clear();try{this.client?.stop()}catch{}try{this.client?.destroy()}catch{}this.listeners.clear()}}let zt=null,it=null,qi=null,Fi=null;function Cc(){Pi(!1);const e=document.createElement("div");e.className="decision-room-backdrop",document.body.appendChild(e),zt=e,e.innerHTML=`
    ...
    </section>`,e.querySelector("#btn-close-decision-room").onclick=()=>Pi(!1),e.addEventListener("click",i=>{i.target===e&&Pi(!1)}),e.querySelector("#btn-create-decision-room").onclick=()=>kr({roomCode:vh(),isHost:!0});const t=()=>{const i=e.querySelector("#decision-room-code-input"),n=String(i?.value||"").replace(/\D/g,"").slice(0,6);if(n.length!==6){i?.focus(),Z("6 haneli oda kodunu yaz.","warning");return}kr({roomCode:n,isHost:!1})};e.querySelector("#btn-join-decision-room").onclick=t,e.querySelector("#decision-room-code-input").onkeydown=i=>{i.key==="Enter"&&t()},V(e)}function ht(e=""){const t=document.createElement("div");return t.textContent=String(e),t.innerHTML}function xh(e,t){const n=Object.values(t.votes[e.id]||{}).filter(a=>a==="yes").length,r=Math.max(1,t.participants.length);return{yes:n,needed:r,matched:n>=r}}function zn(e,t){const i=Object.values(t.ratings?.[e.id]||{}).map(Number).filter(a=>a>=1&&a<=5),n=t.ratings?.[e.id]?.[t.selfId]||0;return{average:i.length?i.reduce((a,o)=>a+o,0)/i.length:0,count:i.length,mine:n}}function Lc(){return`
    ...
    <section id="decision-room-suggestion-panel" class="decision-room-suggestion-panel" hidden>
      ...
      <div id="decision-room-suggestion-results" class="decision-room-content-results"></div>
          ...
          <div class="decision-room-card-body">
            ...
            <strong>${ht(v)}</strong>
            <small>${A.matched?"Herkes izlemek istiyor!":`${A.yes}/${A.needed} kişi izlemek istiyor`}</small>
    ...
    </section>`;const o=()=>Pi(!0);a.querySelector("#btn-close-decision-room").addEventListener("click",o),a.addEventListener("click",d=>{d.target===a&&o()});const s=()=>Pc();window.addEventListener("cinepulse:decision-room-open",s,{once:!0}),Fi=()=>window.removeEventListener("cinepulse:decision-room-open",s);const l=new Sh({roomCode:i,nickname:r,isHost:n});it=l,qi=l.subscribe(d=>Ic(a,d)),await l.connect(),!(it!==l||zt!==a)&&(Rc(a,l),$c(a,l),a.querySelector("#btn-copy-decision-room").onclick=async()=>{try{await navigator.clipboard.writeText(i),Z("Oda kodu kopyalandı.","success")}catch{const p=a.querySelector("#decision-room-code"),h=document.createRange();h.selectNodeContents(p),window.getSelection()?.removeAllRanges(),window.getSelection()?.addRange(h),document.execCommand("copy"),window.getSelection()?.removeAllRanges(),Z("Oda kodu kopyalandı.","success")}},a.querySelector("#btn-refresh-decision-cards").onclick=()=>Mc(it,a),V(a))}function Pi(e=!0){Fi?.(),Fi=null,qi?.(),qi=null,it?.destroy(),it=null,zt?.remove(),zt=null,e&&_h()}function Im(){if(zt)return;if(!it){Cc();return}const e=it,t=document.createElement("div");t.id="decision-room-modal-root",t.className="decision-room-backdrop",document.body.appendChild(t),zt=t,t.innerHTML=`
    <section class="decision-room-dialog" role="dialog" aria-modal="true" aria-label="Ortak Karar Odası">
      <button id="btn-close-decision-room" class="decision-room-close" aria-label="Kapat"><i data-lucide="x"></i></button>
      ...
      <div id="decision-room-deck" class="decision-room-deck"></div>
      <footer class="decision-room-footer"><span>Oda kapanınca oylar silinir.</span><button id="btn-refresh-decision-cards"><i data-lucide="refresh-cw"></i> Yeni adaylar</button></footer>
    </section>`;const i=()=>Pi(!0);t.querySelector("#btn-close-decision-room").onclick=i,t.addEventListener("click",r=>{r.target===t&&i()});const n=()=>Pc();window.addEventListener("cinepulse:decision-room-open",n,{once:!0}),Fi=()=>window.removeEventListener("cinepulse:decision-room-open",n),qi=e.subscribe(r=>Ic(t,r)),Rc(t,e),$c(t,e),t.querySelector("#btn-copy-decision-room").onclick=async()=>{try{await navigator.clipboard.writeText(e.roomCode),Z("Oda kodu kopyalandı.","success")}catch{Z(`Oda kodu: ${e.roomCode}`,"info")}},t.querySelector("#btn-refresh-decision-cards").onclick=()=>Mc(e,t),V(t)}function Pc(){Fi?.(),Fi=null,qi?.(),qi=null,zt?.remove(),zt=null}function Eh(e="home"){const t=En(),i=Wl(),n=t.isKid,r=Ni();return`
    <!-- ================================================================
         TOP NAVBAR
    ================================================================ -->
  ...
  `}let Zi=null,On=null,Jo=!1;function Xo(e){const t=document.getElementById("main-navbar");Zi&&window.removeEventListener("scroll",Zi),Zi=()=>t?.classList.toggle("scrolled",window.scrollY>20),Zi(),window.addEventListener("scroll",Zi,{passive:!0});const i=document.getElementById("mobile-search-row");document.getElementById("btn-mobile-search-toggle")?.addEventListener("click",()=>{i?.classList.toggle("hidden"),i?.classList.contains("hidden")||(document.getElementById("mobile-search-input")?.focus(),V())}),document.getElementById("btn-mobile-search-close")?.addEventListener("click",()=>{i?.classList.add("hidden")}),document.getElementById("btn-nav-notifications")?.addEventListener("click",wu),document.getElementById("btn-nav-profile")?.addEventListener("click",yu);const n=document.getElementById("nav-hub-li"),r=document.getElementById("btn-desktop-hub"),a=document.getElementById("hub-mega-dropdown");let o;function s(){clearTimeout(o),r?.setAttribute("aria-expanded","true"),a?.classList.add("open")}function l(){clearTimeout(o),r?.setAttribute("aria-expanded","false"),a?.classList.remove("open")}function d(){clearTimeout(o),o=setTimeout(()=>{!n?.matches(":hover")&&!a?.matches(":hover")&&l()},350)}if(n){n.addEventListener("mouseenter",s),n.addEventListener("mouseleave",d),a?.addEventListener("mouseenter",s),a?.addEventListener("mouseleave",d),r?.addEventListener("click",f=>{f.stopPropagation(),s()}),a?.querySelectorAll(".hub-nav-trigger").forEach(f=>{f.addEventListener("click",l)});const w=f=>{f.key==="Escape"&&l()};window.addEventListener("keydown",w);const k=f=>{n.contains(f.target)||l()};document.addEventListener("click",k)}document.getElementById("btn-hub-random-spin")?.addEventListener("click",async()=>{l(),wo()}),document.getElementById("btn-hub-series-recommend")?.addEventListener("click",l),document.getElementById("btn-hub-trakt")?.addEventListener("click",()=>{l(),yr()});const p=document.getElementById("mobile-hub-backdrop"),h=document.getElementById("mobile-hub-sheet");let m;function b(){p&&(clearTimeout(m),h?.classList.remove("sheet-closing"),p.classList.remove("hidden"),document.body.style.overflow="hidden")}function y(){p&&(document.body.style.overflow="",h?.classList.add("sheet-closing"),clearTimeout(m),m=setTimeout(()=>{p.classList.add("hidden"),h?.classList.remove("sheet-closing")},280))}document.getElementById("btn-open-mobile-hub")?.addEventListener("click",w=>{w.preventDefault(),b()},{once:!1}),document.getElementById("btn-close-mobile-hub")?.addEventListener("click",y),p?.addEventListener("click",w=>{w.target===p&&y()}),p?.querySelectorAll(".hub-nav-trigger").forEach(w=>{w.addEventListener("click",y)}),document.getElementById("btn-hub-random-spin-mobile")?.addEventListener("click",async()=>{y(),wo()}),document.getElementById("btn-hub-series-recommend-mobile")?.addEventListener("click",y),document.getElementById("btn-hub-trakt-mobile")?.addEventListener("click",()=>{y(),yr()}),document.querySelectorAll("[data-open-decision-room]").forEach(w=>{w.addEventListener("click",()=>{l(),y(),kr()})}),Zo("nav-search-input","search-overlay"),Zo("mobile-search-input","mobile-search-overlay"),Jo||(Jo=!0,document.addEventListener("click",w=>{for(const[k,f]of[["nav-search-input","search-overlay"],["mobile-search-input","mobile-search-overlay"]]){const v=document.getElementById(k),x=document.getElementById(f);x&&!v?.contains(w.target)&&!x.contains(w.target)&&x.classList.add("hidden")}})),On&&document.removeEventListener("keydown",On),On=w=>{(w.metaKey||w.ctrlKey)&&w.key.toLowerCase()==="k"&&(w.preventDefault(),window.innerWidth<=992&&i?(i.classList.remove("hidden"),document.getElementById("mobile-search-input")?.focus()):document.getElementById("nav-search-input")?.focus())},window.addEventListener("keydown",On)}function Zo(e,t){const i=document.getElementById(e),n=document.getElementById(t);let r=null;!i||!n||(i.addEventListener("input",a=>{const o=a.target.value.trim();if(clearTimeout(r),o.length<2){n.classList.add("hidden"),n.innerHTML="";return}n.innerHTML='<div class="search-no-results" style="display:flex;align-items:center;gap:8px;padding:1rem;color:var(--text-muted);font-size:.85rem;"><span class="tv-loading-spinner" style="width:16px;height:16px;border-width:2px;"></span> Aranıyor...</div>',n.classList.remove("hidden"),r=setTimeout(async()=>{try{let h=function(){n.querySelectorAll(".search-item").forEach(m=>{m.addEventListener("click",()=>{n.classList.add("hidden"),i.value="",document.getElementById("mobile-search-row")?.classList.add("hidden")})})};const s=await ws(o),l=Array.isArray(s)?s.slice(0,8):s?.results?.slice(0,8)||[],d=`
          ...
          </a>`;if(!l.length){n.innerHTML=`<div class="search-no-results" style="padding-bottom:.5rem;">TMDB Sonucu Bulunamadı</div>${d}`,n.classList.remove("hidden"),V(n),h();return}const p=l.map(m=>{const b=m.media_type==="tv"||!!m.first_air_date||!m.release_date&&!!m.name,y=m.title||m.name||"İsimsiz",w=(m.release_date||m.first_air_date||"").slice(0,4),k=lt(m.poster_path,et.POSTER_SMALL||et.POSTER_MEDIUM);return`
            <a href="#detail?type=${b?"tv":"movie"}&id=${m.id}" class="search-item">
  ...
  `,r.classList.remove("hidden"),document.body.style.overflow="hidden",V();const s=()=>{r.innerHTML="",r.classList.add("hidden"),document.body.style.overflow="",Qi&&(window.removeEventListener("keydown",Qi),Qi=null)},l=r.querySelector("#btn-close-trailer");l&&l.addEventListener("click",s),r.querySelector(".btn-trailer-detail")?.addEventListener("click",s);const d=r.querySelector(".trailer-modal-overlay");d&&d.addEventListener("click",p=>{p.target===d&&s()}),Qi=p=>{p.key==="Escape"&&s()},window.addEventListener("keydown",Qi)}let st=0,_r=null,ir=0;const Nn=new Map;function Th(){clearInterval(_r),_r=null,ir++}function Is(e){const t=e?.backdrop_path||e?.poster_path,i=window.innerWidth<=768?et.BACKDROP_LARGE:et.BACKDROP_XLARGE;return lt(t,i)}function Rs(e,t="auto"){if(!e)return Promise.resolve(null);if(Nn.has(e))return Nn.get(e);const i=new Promise(n=>{const r=new Image;r.decoding="async",r.fetchPriority=t,r.onload=async()=>{try{await r.decode()}catch{}n(e)},r.onerror=()=>{Nn.delete(e),n(null)},r.src=e});return Nn.set(e,i),i}function Ah(e=[]){const i=Ct()?e.filter(Zt):e;if(!i||i.length===0)return"";st=0;const n=i.slice(0,10),r=n[0],a=r.id,o=r.first_air_date||r.media_type==="tv"?"tv":"movie",s=r.title||r.name||"Öne Çıkan Yapım",l=r.overview&&r.overview.trim().length>15?r.overview:qe(r,o),d=Is(r),p=r.vote_average?r.vote_average.toFixed(1):"8.8",h=(r.first_air_date||r.release_date||"").substring(0,4),m=ms(a);let b=document.getElementById("hero-backdrop-preload");return b||(b=document.createElement("link"),b.id="hero-backdrop-preload",b.rel="preload",b.as="image",document.head.appendChild(b)),b.href=d,b.fetchPriority="high",window.innerWidth>768&&Rs(d,"high"),`
      ...
      <div class="container">
        <div class="hero-content">
          ...
          <div class="hero-dots-wrapper" id="hero-dots-container">
            ${n.map((y,w)=>`
              <div class="hero-dot ${w===st?"active":""}" data-index="${w}" role="button" aria-label="Slayt ${w+1}"></div>
            `).join("")}
          </div>
        </div>
      </div>
    </section>
  `}function Ch(e=[]){const i=Ct()?e.filter(Zt):e;if(!i||i.length===0)return;const n=i.slice(0,10);st=0;const r=document.getElementById("hero-play-btn"),a=document.getElementById("hero-list-btn"),o=document.getElementById("hero-trailer-btn"),s=document.getElementById("hero-slider-section"),l=document.getElementById("hero-backdrop-img"),d=document.getElementById("hero-arrow-prev"),p=document.getElementById("hero-arrow-next");(async()=>{if(l&&!l.complete&&await new Promise(T=>{l.addEventListener("load",T,{once:!0}),l.addEventListener("error",T,{once:!0})}),l?.complete&&l.naturalWidth>0)try{await l.decode()}catch{}requestAnimationFrame(()=>{s?.isConnected&&(s.classList.remove("is-loading"),s.setAttribute("aria-busy","false"))})})();const m=()=>n.slice(1,4).forEach(T=>Rs(Is(T)));"requestIdleCallback"in window?window.requestIdleCallback(m,{timeout:1500}):setTimeout(m,500),n.slice(0,2).forEach(T=>{const I=T.first_air_date||T.media_type==="tv"?"tv":"movie";kn(I,T.id).catch(()=>null)});function b(){Hn(n[(st+1)%n.length],(st+1)%n.length),S()}function y(){Hn(n[(st-1+n.length)%n.length],(st-1+n.length)%n.length),S()}d?.addEventListener("click",y),p?.addEventListener("click",b);const w=T=>{if(!s?.isConnected){document.removeEventListener("keydown",w);return}T.key==="ArrowRight"&&b(),T.key==="ArrowLeft"&&y()};document.addEventListener("keydown",w);let k=null,f=!1;const v=50;function x(T){k=T,f=!0}function A(T){if(!f||k===null)return;f=!1;const I=k-T;Math.abs(I)<v||(I>0?b():y(),k=null)}s?.addEventListener("touchstart",T=>x(T.touches[0].clientX),{passive:!0}),s?.addEventListener("touchend",T=>A(T.changedTouches[0].clientX),{passive:!0}),s?.addEventListener("touchcancel",()=>{f=!1,k=null},{passive:!0}),s?.addEventListener("mousedown",T=>{T.button===0&&x(T.clientX)}),s?.addEventListener("mouseup",T=>{T.button===0&&A(T.clientX)}),s?.addEventListener("mouseleave",()=>{f=!1,k=null}),r?.addEventListener("click",()=>{window.location.hash=`#detail?type=${r.getAttribute("data-type")}&id=${r.getAttribute("data-id")}`}),o?.addEventListener("click",async()=>{if(Lt().trailersEnabled===!1){Z("Fragmanlar yönetici ayarlarından kapatıldı.","info");return}const T=n[st];if(!T)return;const I=T.first_air_date||T.media_type==="tv"?"tv":"movie",L=o.innerHTML;o.innerHTML='<i data-lucide="loader-2" class="spin-loader" style="width:17px;height:17px;"></i> <span>Yükleniyor...</span>',V(o);try{const z=await kn(I,T.id,T.title||T.name);z?Bc({title:T.title||T.name,trailerInfo:z,mediaId:T.id,mediaType:I}):Z("Bu yapım için resmi tanıtım fragmanı bulunamadı.","info")}catch{Z("Fragman yüklenirken hata oluştu.","error")}finally{o.innerHTML=L,V(o)}}),a?.addEventListener("click",()=>{const T=n[st],I=Ll(T);Z(I?"İzleme listene eklendi!":"İzleme listenden çıkarıldı.",I?"success":"info"),a.title=I?"Listemden Çıkar":"Listeme Ekle",a.innerHTML=`<i data-lucide="${I?"check":"plus"}" style="width: 17px; height: 17px; ${I?"color: var(--primary);":""}"></i>`,V(a)}),document.querySelectorAll(".hero-dot").forEach(T=>{T.addEventListener("click",()=>{const I=parseInt(T.getAttribute("data-index"),10);Hn(n[I],I),S()})});function S(){clearInterval(_r),_r=setInterval(()=>{if(n.length>1){const T=(st+1)%n.length;Hn(n[T],T)}},6e3)}S()}async function Hn(e,t=st){if(!e||Ct()&&!Zt(e))return;const i=document.getElementById("hero-backdrop-img"),n=document.getElementById("hero-title-text"),r=document.getElementById("hero-overview-text"),a=document.getElementById("hero-play-btn"),o=document.getElementById("hero-list-btn"),s=document.getElementById("hero-trailer-btn"),l=document.getElementById("hero-rating-badge"),d=document.getElementById("hero-year-badge"),p=document.getElementById("hero-type-badge"),h=e.first_air_date||e.media_type==="tv"?"tv":"movie",m=Is(e),b=e.vote_average?e.vote_average.toFixed(1):"8.5",y=(e.first_air_date||e.release_date||"").substring(0,4),w=++ir;if(i&&i.src!==m){const v=await Rs(m,"high");if(!v||w!==ir||!i.isConnected)return;i.src=v;try{await i.decode()}catch{}if(w!==ir||!i.isConnected)return}st=t;const k=document.querySelector("#hero-slider-section .hero-content");k?.classList.remove("hero-content-committing"),requestAnimationFrame(()=>{k?.isConnected&&k.classList.add("hero-content-committing")}),n&&(n.textContent=e.title||e.name);const f=e.overview&&e.overview.trim().length>15?e.overview:qe(e,h);if(r&&(r.textContent=f),l&&(l.innerHTML=`<i data-lucide="star" style="width:13px;height:13px;fill:currentColor"></i> ${b} IMDb`),d&&(d.textContent=y||"2024"),p&&(p.textContent=h==="tv"?"DİZİ":"FİLM"),a&&(a.setAttribute("data-id",e.id),a.setAttribute("data-type",h)),s&&(s.setAttribute("data-id",e.id),s.setAttribute("data-type",h)),o){o.setAttribute("data-id",e.id),o.setAttribute("data-type",h);const v=ms(e.id);o.title=v?"Listemden Çıkar":"Listeme Ekle",o.innerHTML=`<i data-lucide="${v?"check":"plus"}" style="width:17px;height:17px;${v?"color:var(--primary);":""}"></i>`}V(document.getElementById("hero-slider-section")),document.querySelectorAll(".hero-dot").forEach((v,x)=>{v.classList.toggle("active",x===st)})}const $s=new Map,Sr=new Map;let Bi=null,Dc=null;function zc(){const e=window.location.hash||"#home";e.startsWith("#detail")||(Dc=e,window.scrollY>0&&$s.set(e,window.scrollY))}function Lh(){zc(),Bi===null&&(Bi=window.setTimeout(()=>{Bi=null,Kr()},300))}function Kr(){Bi!==null&&(clearTimeout(Bi),Bi=null),(window.location.hash||"#home")===Dc&&zc();for(const[e,t]of $s)if(t>0)try{sessionStorage.setItem(`cinepulse_scroll_${e}`,String(t))}catch{}for(const[e,t]of Sr)try{sessionStorage.setItem(`cinepulse_rail_${e}`,String(t))}catch{}}const Qo=Kr;function Ih(e=window.location.hash||"#home"){if(e.startsWith("#detail")){window.scrollTo({top:0,behavior:"instant"});return}document.querySelectorAll(".card-rail").forEach(i=>{if(i.id){let n=Sr.get(i.id);if(typeof n!="number")try{const r=sessionStorage.getItem(`cinepulse_rail_${i.id}`);r&&(n=parseFloat(r))}catch{}typeof n=="number"&&n>0&&(i.scrollLeft=n,requestAnimationFrame(()=>{i.scrollLeft=n}))}});let t=$s.get(e);if(typeof t!="number")try{const i=sessionStorage.getItem(`cinepulse_scroll_${e}`);i&&(t=parseFloat(i))}catch{}if(typeof t=="number"&&t>0){const i=(n=0)=>{window.scrollTo({top:t,behavior:"instant"}),n<15&&document.body.scrollHeight<t+window.innerHeight&&setTimeout(()=>i(n+1),60)};requestAnimationFrame(()=>i(0))}else window.scrollTo({top:0,behavior:"instant"})}const Rh={},$h="https://cine-pulse-drab.vercel.app";(Rh?.VITE_MKV_RELAY_ORIGIN||"").replace(/\/$/,"");function Di(e=""){if(!e||/^https?:\/\//i.test(e))return e;if(typeof window>"u")return`http://127.0.0.1:4000${e}`;const t=window.location?.hostname||"";return!!(window.Capacitor?.isNativePlatform?.()||window.location?.protocol==="capacitor:"||t==="localhost"||t==="127.0.0.1"||t.endsWith("github.io"))?`${$h}${e}`:e}const hn=new Map,xr="cp_fanart_v4_",Mh="4e44d9029b1270a757cddc766a1bcb63";function Ph(e){if(hn.has(e))return hn.get(e);try{const t=localStorage.getItem(xr+e)||sessionStorage.getItem(xr+e);if(t!==null){const i=t?JSON.parse(t):null;return hn.set(e,i),i}}catch{}}function qn(e,t){hn.set(e,t);try{const i=t?JSON.stringify(t):"";localStorage.setItem(xr+e,i)}catch{try{sessionStorage.setItem(xr+e,t?JSON.stringify(t):"")}catch{}}}async function Bh(e,t){try{const i=await fetch(`https://api.themoviedb.org/3/${t==="tv"?"tv":"movie"}/${e}/images?api_key=${Mh}&include_image_language=tr,en,null`,{signal:AbortSignal.timeout(3500)});if(!i.ok)return null;const n=await i.json(),r=n.logos||[];let a=null;r.length>0&&(r.sort((d,p)=>{const h=m=>m.iso_639_1==="tr"?3:m.iso_639_1==="en"?2:1;return h(p)-h(d)||(p.vote_average||0)-(d.vote_average||0)}),r[0]?.file_path&&(a=`https://image.tmdb.org/t/p/w500${r[0].file_path}`));const s=(n.backdrops||[]).filter(d=>(d.iso_639_1==="tr"||d.iso_639_1==="en")&&(d.aspect_ratio||0)>1.35&&d.file_path);let l=null;return s.length>0&&(s.sort((d,p)=>{const h=m=>m.iso_639_1==="tr"?2:1;return h(p)-h(d)||(p.vote_average||0)-(d.vote_average||0)}),l=`https://image.tmdb.org/t/p/w780${s[0].file_path}`),l||a?{image:l||null,logo:l?null:a}:null}catch{return null}}async function Dh(e,t){try{const i=Di(`/api/fanart?type=${t==="tv"?"tv":"movie"}&id=${encodeURIComponent(e)}`),n=await fetch(i,{signal:AbortSignal.timeout(3e3)});if(!n.ok)return null;const r=await n.json();return r.image?{image:r.image,logo:r.logo||null}:null}catch{return null}}async function Oc(e,t="movie"){if(!/^\d+$/.test(String(e)))return null;const i=t==="tv"?"tv":"movie",n=`${i}:${e}`,r=Ph(n);if(r!==void 0)return r;const a=(async()=>{const s=Bh(e,i),l=Dh(e,i),d=await s;if(d)return qn(n,d),d;const p=await l;return p?(qn(n,p),p):(qn(n,null),null)})();hn.set(n,a);const o=await a;return qn(n,o),o}function el(e){Array.isArray(e)&&e.forEach((t,i)=>{if(!t?.id)return;const n=t.media_type==="tv"||t.type==="tv"?"tv":"movie";setTimeout(()=>Oc(t.id,n),i*30)})}const zh=xl||["anime","kimetsu","yaiba","iblis keser","demon slayer","naruto","boruto","shingeki","titan"];function jt(e=""){return String(e).replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t])}function Oh(e){return e?/[\u3040-\u30ff\u3400-\u4dbf\u4e00-\u9fff]/.test(e):!1}function Ms(e){if(!e)return!1;if(e.isAnime===!0||e.type==="anime"||e.media_type==="anime"||e.id&&Fe(e.id))return!0;const i=(e.genre_ids||(Array.isArray(e.genres)?e.genres.map(a=>typeof a=="object"?a.id:a):[])).some(a=>Number(a)===16),n=e.original_language==="ja"||Array.isArray(e.origin_country)&&e.origin_country.includes("JP");if(i&&n||i&&(e.origin_country?.includes("JP")||e.original_language==="ja")||e.original_language==="ja"&&(i||Oh(e.original_name||e.original_title||e.title||e.name))||Array.isArray(e.genres)&&e.genres.map(o=>typeof o=="object"?o.name:String(o)).filter(Boolean).some(o=>/anime/i.test(o)))return e.id&&Se(e.id),!0;if(typeof e.id=="string"&&(e.id.startsWith("ta_")||e.id.startsWith("acx_")||e.id.startsWith("tra_")))return Se(e.id),!0;const r=(e.title||e.name||e.original_title||e.original_name||"").toLowerCase();for(const a of zh)if(r.includes(a))return e.id&&Se(e.id),!0;return!1}function Nc(e){return e?e.first_air_date||e.number_of_seasons||e.episodesCount||Array.isArray(e.seasons)&&e.seasons.length>0||e.type==="tv"||e.media_type==="tv"?!0:(e.type==="movie"||e.media_type==="movie"||e.release_date&&!e.first_air_date,!1):!1}function Ps(e){return e?e.isAnime||e.type==="anime"||Ms(e)||e.id&&Fe(e.id)?"anime":e.type==="documentary"||e.media_type==="documentary"||(e.genre_ids||(Array.isArray(e.genres)?e.genres.map(i=>typeof i=="object"?i.id:i):[])).some(i=>Number(i)===99)?"documentary":e.type==="movie"||e.media_type==="movie"?"movie":e.type==="tv"||e.media_type==="tv"||Nc(e)?"tv":"movie":"movie"}function St(e,t={}){const i=e.id,n=Ps(e),r=!!(e.isAnime||n==="anime"||Ms(e)||e.id&&Fe(e.id)),a=!!(e.isSeries!==void 0?e.isSeries:Nc(e)),o=a?"tv":"movie";let s=e.title||e.name||"";(!s||Br(s))&&(s=e.title_en||e.name_en||e.original_name||e.original_title||s||"İsimsiz İçerik");const l=s,d=e.poster_path||e.posterPath||e.poster||"",p=e.backdrop_path||e.backdropPath||e.backdrop||"",h=lt(d,et.POSTER_MEDIUM),m=p?lt(p,et.BACKDROP_LARGE):h,y=Lt().cardLayout==="landscape"?m:h;let w=e.vote_average??e.voteAverage??e.rating,k=w?Number(w).toFixed(1):"";k==="0.0"&&(k="");const f=e.release_date||e.first_air_date||(e.year?String(e.year):""),v=f?String(f).substring(0,4):"";let x=e.progressPercent||0,A=e.season||1,S=e.episode||1,T=e.currentTime||0,I=e.completed||!1,L=!1;if(t.isContinueSection||e.currentTime>0&&!I||e.progressPercent>0&&!I)L=!0;else{const te=Xt(i,A,S);te&&(I=te.completed||!1,!I&&te.duration>0&&te.currentTime>15&&(x=Math.min(100,Math.round(te.currentTime/te.duration*100)),T=te.currentTime,a&&(A=te.season||1,S=te.episode||1)))}let z="FİLM",O="type-movie";r?(z=a?"ANİME DİZİSİ":"ANİME FİLMİ",O="type-anime"):n==="tv"||a?(z="DİZİ",O="type-tv"):n==="documentary"&&(z="BELGESEL",O="type-doc");const Y=e.original_title||e.original_name||"",j=encodeURIComponent(l),D=encodeURIComponent(Y),B=encodeURIComponent(d||""),W=encodeURIComponent(p||"");return`
    <div class="media-card" 
      data-id="${i}" 
      data-type="${o}" 
      data-isanime="${r?"true":"false"}"
      data-title="${j}" 
      data-originaltitle="${D}"
      data-poster="${B}"
      data-backdrop="${W}"
      data-tmdbid="${i}"
      ...
      <div class="card-poster-wrapper ${p?"":"card-fanart-portrait-fallback"}">
        <img 
          ...
          loading="lazy" 
          decoding="async"
          onerror="this.onerror=null;this.src='${wn}'"
        />
      ...
      <div class="card-info">
        ...
        <div class="card-meta">
          <span class="card-type-tag ${O}">${z}</span>
          ${v?`<span class="card-year-tag">${v}</span>`:""}
        </div>
      </div>
    </div>
  `}function mt(e){if(!e||(Ui(e),e._hasMediaEventsDelegated))return;e._hasMediaEventsDelegated=!0;let t=0;e.addEventListener("click",s=>{if(Date.now()<t){s.preventDefault(),s.stopPropagation();return}if(s.target.closest(".btn-lib-delete")||s.target.closest(".btn-delete-history"))return;const l=s.target.closest(".media-card");if(!l)return;s.preventDefault();const d=l.getAttribute("data-id"),p=l.getAttribute("data-type"),h=l.getAttribute("data-isanime")==="true"||p==="anime"||Fe(d),m=parseInt(l.getAttribute("data-season")||"1",10),b=parseInt(l.getAttribute("data-episode")||"1",10),y=parseFloat(l.getAttribute("data-currenttime")||"0"),w=decodeURIComponent(l.getAttribute("data-title")||""),k=decodeURIComponent(l.getAttribute("data-originaltitle")||""),f=l.getAttribute("data-poster")||"",v=l.getAttribute("data-backdrop")||"",x=l.getAttribute("data-iscontinue")==="true",A=l.getAttribute("data-isseries"),S=l.getAttribute("data-mediatype"),T=A!==null?A==="true":S==="tv"||p==="tv";x&&(l.closest("#continue-watching-rail")||l.closest(".continue-card-wrapper")||y>0)?Qt({type:h?"anime":T?"tv":"movie",isAnime:h,isSeries:T,tmdbId:d,title:T?`${w} - S${m}E${b}`:w,seriesTitle:w,originalTitle:k||w,season:T?m:void 0,episode:T?b:void 0,posterPath:f,backdropPath:v,currentTime:y}):(Qo(),window.location.hash=`#detail?type=${h?"anime":p}&id=${d}`)}),document.querySelector("link[rel=preconnect][href*=youtube-nocookie]")||["https://www.youtube-nocookie.com","https://i.ytimg.com"].forEach(s=>{const l=document.createElement("link");l.rel="preconnect",l.href=s,l.crossOrigin="anonymous",document.head.appendChild(l)});const i=window.matchMedia("(hover: hover) and (pointer: fine)").matches,n=window.matchMedia("(pointer: coarse)").matches,r=Lt(),a=r.hoverPreviewsEnabled!==!1&&r.trailersEnabled!==!1;function o(s,l){if(s.querySelector(".card-hover-video-preview"))return;let d=sessionStorage.getItem("cinepulse_preview_sound")==="on";l.then(p=>{if(!p||!p.key||!p.key.trim()||!s.isConnected||i&&!s.matches(":hover"))return;const h=decodeURIComponent(s.getAttribute("data-title")||"Fragman"),m=s.querySelector(".card-type-tag")?.textContent?.trim()||"",b=s.querySelector(".card-year-tag")?.textContent?.trim()||"",y=s.querySelector(".card-rating-pill span")?.textContent?.trim()||"",w=s.getAttribute("data-id")||"",k=s.getAttribute("data-type")||"movie",f=`#detail?type=${encodeURIComponent(k)}&id=${encodeURIComponent(w)}`,v=encodeURIComponent(p.key),x=document.createElement("div");x.className="card-hover-video-preview";const A=window.innerWidth<=700;if(A&&(document.querySelectorAll(".card-hover-video-preview").forEach(B=>{typeof B._closePreview=="function"?B._closePreview():(B.closest?.(".media-card")?.classList.remove("preview-active"),B.remove())}),document.querySelectorAll(".card-preview-mobile-close-portal").forEach(B=>B.remove()),x.classList.add("is-mobile-sheet")),x.innerHTML=`
        ...
        <div class="card-preview-details">
          <div class="card-preview-copy">
            ...
            <div class="card-preview-meta">
              ${y?`<span class="card-preview-match">${jt(y)} IMDb</span>`:""}
              ${b?`<span>${jt(b)}</span>`:""}
              ${m?`<span>${jt(m)}</span>`:""}
            </div>
          </div>
          <div class="card-preview-actions">
            ...
            <a class="card-preview-open" href="${jt(p.watchUrl||`https://www.youtube.com/watch?v=${v}`)}" target="_blank" rel="noopener noreferrer" title="YouTube'da aç" aria-label="Fragmanı YouTube'da aç"><i data-lucide="external-link"></i></a>
      ...
      `,!A){const B=s.getBoundingClientRect(),W=window.innerHeight<520?12:76,ie=Math.min(460,Math.max(390,B.width*2.2),window.innerWidth-32),te=Math.max(240,(window.innerHeight-W-94)*16/9),re=Math.max(240,Math.min(ie,te)),N=re*9/16+82,ae=Math.max(16,Math.min(window.innerWidth-re-16,B.left+(B.width-re)/2)),J=Math.max(W,Math.min(window.innerHeight-N-12,B.top+(B.height-N)/2));x.style.left=`${ae}px`,x.style.top=`${J}px`,x.style.width=`${re}px`}s.classList.add("preview-active"),s.appendChild(x),V();const S=x.querySelector("iframe");let T=null,I=null;A&&(T=document.createElement("button"),T.type="button",T.className="card-preview-mobile-close-portal",T.setAttribute("aria-label","Fragmanı kapat"),T.title="Fragmanı kapat",T.innerHTML='<i data-lucide="x"></i>',I=()=>{const B=x.getBoundingClientRect();T.style.top=`${Math.max(8,B.top+12)}px`,T.style.left=`${Math.max(8,B.right-52)}px`},document.body.appendChild(T),requestAnimationFrame(I),window.addEventListener("resize",I,{passive:!0}),V(T)),x.addEventListener("click",B=>B.stopPropagation()),x.addEventListener("touchend",B=>B.stopPropagation(),{passive:!0});const L=x.querySelector(".card-preview-sound"),z=x.querySelector(".card-preview-close-btn");x.querySelector(".card-preview-detail")?.addEventListener("click",()=>{Qo(),j()});const O=(B,W=[])=>{S?.contentWindow?.postMessage(JSON.stringify({event:"command",func:B,args:W}),"*")},Y=()=>{O(d?"unMute":"mute"),d&&O("setVolume",[75]),L.classList.toggle("is-on",d),L.title=d?"Sesi kapat":"Sesi aç",L.setAttribute("aria-label",L.title),L.innerHTML=`<i data-lucide="${d?"volume-2":"volume-x"}"></i>`,V()},j=()=>{I&&window.removeEventListener("resize",I);try{T?.remove()}catch{}try{x.remove()}catch{}s.classList.remove("preview-active")};x._closePreview=j;const D=window.setTimeout(()=>{x.classList.add("video-ready")},1500);S.addEventListener("load",()=>{window.clearTimeout(D),x.classList.add("video-ready"),d&&window.setTimeout(Y,180)},{once:!0}),L.addEventListener("click",B=>{B.preventDefault(),B.stopPropagation(),d=!d,sessionStorage.setItem("cinepulse_preview_sound",d?"on":"off"),Y(),window.setTimeout(Y,180)}),z&&z.addEventListener("click",B=>{B.preventDefault(),B.stopPropagation(),j()}),T?.addEventListener("click",B=>{B.preventDefault(),B.stopPropagation(),j()})}).catch(()=>{})}if(i&&a){const s=new WeakMap;e.addEventListener("pointerover",l=>{const d=l.target.closest(".media-card");if(!d||l.relatedTarget&&d.contains(l.relatedTarget))return;const p=d.getAttribute("data-id"),h=d.getAttribute("data-type")||"movie",m=kn(h==="tv"?"tv":"movie",p),b=setTimeout(()=>o(d,m),850);s.set(d,b)}),e.addEventListener("pointerout",l=>{const d=l.target.closest(".media-card");if(!d||l.relatedTarget&&d.contains(l.relatedTarget))return;const p=s.get(d);p&&clearTimeout(p),s.delete(d);const h=d.querySelector(".card-hover-video-preview");if(h)try{h.remove()}catch{}d.classList.remove("preview-active")})}if(n&&a){const l=new WeakMap;e.addEventListener("touchstart",p=>{if(p.target.closest(".card-hover-video-preview"))return;const h=p.target.closest(".media-card");if(!h)return;const m={opened:!1,timer:null},b=h.getAttribute("data-id"),y=h.getAttribute("data-type")||"movie",w=kn(y==="tv"?"tv":"movie",b);m.timer=setTimeout(()=>{m.timer=null,m.opened=!0,t=Date.now()+900;try{navigator.vibrate?.(40)}catch{}o(h,w)},600),l.set(h,m)},{passive:!0});const d=p=>{const h=p.target.closest(".media-card"),m=h&&l.get(h);m&&(m.timer&&clearTimeout(m.timer),m.timer=null,(!m.opened||p.type!=="touchend")&&l.delete(h))};e.addEventListener("touchend",d,{passive:!0}),e.addEventListener("touchmove",d,{passive:!0}),e.addEventListener("touchcancel",d,{passive:!0}),e.addEventListener("touchend",p=>{const h=p.target.closest(".media-card");(h&&l.get(h))?.opened&&l.delete(h)},{passive:!0})}}let en=null;function Nh(){return en||("IntersectionObserver"in window?(en=new IntersectionObserver(e=>{e.forEach(t=>{t.isIntersecting&&(en.unobserve(t.target),is(t.target))})},{rootMargin:"800px 0px"}),en):null)}async function is(e){if(!e||e.dataset.fanartState==="loaded"||e.dataset.fanartState==="loading")return;e.dataset.fanartState="loading";const t=e.querySelector(".card-poster-img");if(t)try{const i=await Oc(e.dataset.tmdbid,e.dataset.mediatype||"movie");if(!e.isConnected)return;if(!i?.image&&!i?.logo){e.dataset.fanartState="empty";return}i.image&&(t.dataset.backdropSrc=i.image,(Lt().cardLayout==="landscape"||document.documentElement.classList.contains("cards-landscape"))&&(t.src=i.image));const n=e.querySelector(".card-fanart-logo");if(n&&i.logo){n.src=i.logo;const r=e.querySelector(".card-poster-wrapper");r?.classList.remove("card-fanart-placeholder"),r?.classList.toggle("card-fanart-composite",!0)}e.dataset.fanartState="loaded"}catch{e.dataset.fanartState="empty"}}function Ui(e=document,t=!1){const n=(e&&e.querySelectorAll?e:document).querySelectorAll('.media-card[data-tmdbid]:not([data-fanart-state="loaded"])');if(!n.length)return;if(t){n.forEach(a=>is(a));return}const r=Nh();if(!r){n.forEach(a=>is(a));return}n.forEach(a=>r.observe(a))}let tt=null,Kt=null,Ai=0;const Er=new Map,ns=new Set,Hh=10*60*1e3;function qh(){Th();for(const e of ns)e.disconnect();ns.clear()}function Fh(e){try{const t=sessionStorage.getItem(`cinepulse_home_fast_v7_${e?"kids":"adult"}`);if(!t)return null;const i=JSON.parse(t);return!i?.savedAt||Date.now()-i.savedAt>Hh?null:i.data?.isKid===e?i.data:null}catch{return null}}function Ca(e){try{sessionStorage.setItem(`cinepulse_home_fast_v7_${e.isKid?"kids":"adult"}`,JSON.stringify({savedAt:Date.now(),data:e}))}catch{}}function fn(){tt=null,Kt=null,Ai++;try{sessionStorage.removeItem("cinepulse_home_fast_v2_kids"),sessionStorage.removeItem("cinepulse_home_fast_v2_adult"),sessionStorage.removeItem("cinepulse_home_fast_v3_kids"),sessionStorage.removeItem("cinepulse_home_fast_v3_adult"),sessionStorage.removeItem("cinepulse_home_fast_v4_kids"),sessionStorage.removeItem("cinepulse_home_fast_v4_adult"),sessionStorage.removeItem("cinepulse_home_fast_v5_kids"),sessionStorage.removeItem("cinepulse_home_fast_v5_adult"),sessionStorage.removeItem("cinepulse_home_fast_v6_kids"),sessionStorage.removeItem("cinepulse_home_fast_v6_adult"),sessionStorage.removeItem("cinepulse_home_fast_v7_kids"),sessionStorage.removeItem("cinepulse_home_fast_v7_adult")}catch{}Er.clear(),Object.keys(_e).forEach(e=>{_e[e].page=1,_e[e].loading=!1,_e[e].exhausted=!1})}const _e={"rail-popular-tv":{page:1,loading:!1,exhausted:!1,fetcher:ur},"rail-popular-movies":{page:1,loading:!1,exhausted:!1,fetcher:pr},"rail-top-tv":{page:1,loading:!1,exhausted:!1,fetcher:e=>Ci("tv",e)},"rail-top-movies":{page:1,loading:!1,exhausted:!1,fetcher:e=>Ci("movie",e)},"rail-anime":{page:1,loading:!1,exhausted:!1,fetcher:hr},"rail-adult-animation":{page:1,loading:!1,exhausted:!1,fetcher:Ha},"rail-cartoon-series":{page:1,loading:!1,exhausted:!1,fetcher:dr},"rail-documentary":{page:1,loading:!1,exhausted:!1,fetcher:fr}};function Pe({id:e,icon:t,title:i,accent:n,items:r}){if(!r||r.length===0)return"";const a=Er.get(e)||[],s=[...r,...a].map(l=>St(l)).join("");return`
  ...
  `}function Uh(e){return!e||e.length===0?"":`
    <section class="rail-section">
      <div class="container">
        <div class="rail-header">
          <h2 class="rail-title">
  ...
  `}function tl(e){const t=e.querySelectorAll(".rail-sentinel");t.length!==0&&t.forEach(i=>{const n=i.getAttribute("data-rail"),r=document.getElementById(n);if(!r)return;const a=async()=>{const s=_e[n];if(!s||s.loading||s.exhausted)return;s.loading=!0;const l=document.createElement("div");l.className="rail-loader",l.innerHTML='<i data-lucide="loader-2" class="spin-loader" style="width:22px;height:22px;color:var(--text-muted);"></i>',i.before(l),V(l);try{const d=new Set(Array.from(r.querySelectorAll(".media-card[data-id]")).map(m=>String(m.getAttribute("data-id"))).filter(Boolean));let p=[];for(let m=0;m<4&&p.length===0;m+=1){s.page+=1;const b=await s.fetcher(s.page);if(!b||b.length===0){s.exhausted=!0;break}p=b.filter(y=>{const w=String(y?.id||"");return!w||d.has(w)?!1:(d.add(w),!0)})}if(l.remove(),p.length===0||!r.isConnected){s.loading=!1;return}const h=Er.get(n)||[];Er.set(n,[...h,...p]),p.forEach(m=>{const b=document.createElement("div");b.innerHTML=St(m);const y=b.firstElementChild;y&&(r.insertBefore(y,i),y.addEventListener("click",()=>{const w=y.getAttribute("data-id"),k=y.getAttribute("data-type");window.location.hash=`#detail?type=${k}&id=${w}`}))}),V(r),Ui(r)}catch{l.remove()}s.loading=!1};r.addEventListener("scroll",()=>{r.scrollWidth-(r.scrollLeft+r.clientWidth)<600&&a()},{passive:!0});const o=new IntersectionObserver(s=>{s.forEach(l=>{l.isIntersecting&&a()})},{root:r,rootMargin:"0px 400px 0px 0px",threshold:0});o.observe(i),ns.add(o)})}async function jh(){const e=Ai,t=Ct();let i,n,r,a,o,s,l,d,p,h,m,b;tt||(tt=Fh(t));let y=null,w=!1,k=!1;if(tt&&tt.isKid===t)({trending:i,popularTV:n,popularMovies:r,topRatedTV:a,topRatedMovies:o,animeItems:s,docItems:l,kidsAdventures:d,adultAnimationItems:p,cartoonSeriesItems:h,kidsAnimationItems:m,kidsClassicCartoonItems:b}=tt),y=Kt,w=!y;else if(t){if(y=Promise.all([oo(1),Fa(1),ao(1),so(1)]).then(L=>{e===Ai&&([d,s,m,b]=L,tt={isKid:!0,trending:i,popularTV:n,popularMovies:r,kidsAdventures:d,animeItems:s,kidsAnimationItems:m,kidsClassicCartoonItems:b},k&&Ca(tt),w=!0)}).catch(()=>{w=!0}),Kt=y,y.then(()=>{Kt===y&&(Kt=null)}),[n,r]=await Promise.all([Na(1),qa(1)]),i=[...r||[],...n||[]].filter(L=>L.backdrop_path&&Zt(L)).slice(0,10),e!==Ai)return null;w||(tt={isKid:!0,trending:i,popularTV:n,popularMovies:r})}else{if(y=Promise.all([Ci("tv",1),Ci("movie",1),hr(1),fr(1),Ha(1),dr(1)]).then(L=>{e===Ai&&([a,o,s,l,p,h]=L,tt={isKid:!1,trending:i,popularTV:n,popularMovies:r,topRatedTV:a,topRatedMovies:o,animeItems:s,docItems:l,adultAnimationItems:p,cartoonSeriesItems:h},k&&Ca(tt),w=!0)}).catch(()=>{w=!0}),Kt=y,y.then(()=>{Kt===y&&(Kt=null)}),[i,n,r]=await Promise.all([Bl("all","week",1),ur(1),pr(1)]),e!==Ai)return null;w||(tt={isKid:!1,trending:i,popularTV:n,popularMovies:r})}k=!0,w&&tt&&Ca(tt);const f=w,v=to(),x=Gs(v);let A;t?A=[...r||[],...n||[]].filter(z=>z.backdrop_path&&Zt(z)).slice(0,10):A=i;const S=Ah(A);t?(_e["rail-kids-animation"]||(_e["rail-kids-animation"]={page:1,loading:!1,exhausted:!1,fetcher:ao}),_e["rail-kids-classics"]||(_e["rail-kids-classics"]={page:1,loading:!1,exhausted:!1,fetcher:so}),_e["rail-kids-movies"]||(_e["rail-kids-movies"]={page:1,loading:!1,exhausted:!1,fetcher:qa}),_e["rail-kids-adventures"]||(_e["rail-kids-adventures"]={page:1,loading:!1,exhausted:!1,fetcher:oo}),_e["rail-anime"]||(_e["rail-anime"]={page:1,loading:!1,exhausted:!1,fetcher:Fa})):(_e["rail-popular-tv"]||(_e["rail-popular-tv"]={page:1,loading:!1,exhausted:!1,fetcher:ur}),_e["rail-popular-movies"]||(_e["rail-popular-movies"]={page:1,loading:!1,exhausted:!1,fetcher:pr}),_e["rail-top-tv"]||(_e["rail-top-tv"]={page:1,loading:!1,exhausted:!1,fetcher:L=>Ci("tv",L)}),_e["rail-top-movies"]||(_e["rail-top-movies"]={page:1,loading:!1,exhausted:!1,fetcher:L=>Ci("movie",L)}),_e["rail-anime"]||(_e["rail-anime"]={page:1,loading:!1,exhausted:!1,fetcher:hr}),_e["rail-adult-animation"]||(_e["rail-adult-animation"]={page:1,loading:!1,exhausted:!1,fetcher:Ha}),_e["rail-cartoon-series"]||(_e["rail-cartoon-series"]={page:1,loading:!1,exhausted:!1,fetcher:dr})),t||_e["rail-documentary"]||(_e["rail-documentary"]={page:1,loading:!1,exhausted:!1,fetcher:fr}),Object.values(_e).forEach(L=>{L.loading=!1});let T="";return t?T=`
  ...
  `,init:L=>{const z=A&&A.length>0?A:i;z&&z.length>0&&Ch(z),mt(L);const O=j=>{j.querySelectorAll(".card-rail").forEach(D=>{const B=D.id;if(B){let W=Sr.get(B);if(typeof W!="number")try{const ie=sessionStorage.getItem(`cinepulse_rail_${B}`);ie&&(W=parseFloat(ie))}catch{}typeof W=="number"&&W>0&&(D.scrollLeft=W,requestAnimationFrame(()=>{D.scrollLeft=W})),D.addEventListener("scroll",()=>{Sr.set(B,D.scrollLeft)},{passive:!0})}D.addEventListener("wheel",W=>{Math.abs(W.deltaX)>Math.abs(W.deltaY)||(W.preventDefault(),D.scrollBy({left:W.deltaY*2.5,behavior:"smooth"}))},{passive:!1})})};if(O(L),L.querySelectorAll(".spotlight-hero, .spotlight-mini").forEach(j=>{j.addEventListener("click",()=>{const D=j.getAttribute("data-id"),B=j.getAttribute("data-type");D&&B&&(window.location.hash=`#detail?type=${B}&id=${D}`)})}),L.querySelector(".spotlight-hero-btn")?.addEventListener("click",j=>{j.stopPropagation();const D=L.querySelector(".spotlight-hero");if(D){const B=D.getAttribute("data-id"),W=D.getAttribute("data-type");window.location.hash=`#detail?type=${W}&id=${B}`}}),tl(L),y&&!f){const j=L.querySelector(".home-view");y.then(()=>{if({topRatedTV:a,topRatedMovies:o,animeItems:s,docItems:l,kidsAdventures:d,adultAnimationItems:p,cartoonSeriesItems:h,kidsAnimationItems:m,kidsClassicCartoonItems:b}=tt||{},!j?.isConnected||!(window.location.hash||"#home").startsWith("#home"))return;const D=document.createElement("div");D.className="home-more-rails",D.innerHTML=t?`
          ...
          `,j.append(D),V(D),mt(D),O(D),tl(D)})}L.querySelectorAll(".btn-delete-history").forEach(j=>{j.addEventListener("click",D=>{D.stopPropagation();const B=j.closest(".continue-card-wrapper");if(!B)return;const W=B.getAttribute("data-id");Da(W),Z("İçerik izleme geçmişinden kaldırıldı.","info"),B.style.transition="all 0.28s ease-out",B.style.transform="scale(0.85)",B.style.opacity="0",setTimeout(()=>{B.remove();const ie=L.querySelector("#continue-watching-rail");ie&&ie.children.length===0&&ie.closest(".rail-section")?.remove()},300)})});const Y=()=>{if(!(window.location.hash||"#home").startsWith("#home"))return;const j=L.querySelector(".home-view");if(!j?.isConnected)return;const D=Gs(to()),B=L.querySelector("#continue-watching-rail")?.closest(".rail-section");if(D&&D.length>0){const ie=D.slice(0,24).map(te=>`
  ...
  `,init:k=>{if(!k)return;let f=p,v=h;const x=()=>{const O=k.querySelector("#btn-mark-season-all");if(!O)return;const Y=ra(e,f,v),j=O.querySelector("span"),D=O.querySelector("i");j&&(j.textContent=Y?"Bu Sezon İzlendi":"Bu Sezonu İzlendi İşaretle"),D&&D.setAttribute("data-lucide",Y?"check-circle-2":"check-check"),Y?(O.style.background="rgba(16, 185, 129, 0.2)",O.style.borderColor="#10b981",O.style.color="#10b981"):(O.style.background="",O.style.borderColor="",O.style.color=""),V()};nr(e,t,n,f,k,a,o,i,d,x,s,b);const A=O=>{if(O&&O.detail&&O.detail.isProgressUpdate&&document.getElementById("player-modal"))return;const Y=k.querySelector("#episode-grid-container");Y&&(Y.querySelectorAll(".episode-card").forEach(j=>{const D=parseInt(j.getAttribute("data-season"),10),B=parseInt(j.getAttribute("data-episode"),10),W=Xt(e,D,B),ie=W?W.progressPercent:0,te=W?W.completed||ie>=90:!1,re=W&&!te&&W.currentTime>0,N=j.querySelector(".badge-watched-status"),ae=j.querySelector(".btn-mark-ep-watched"),J=j.querySelector(".card-progress-fill"),K=j.querySelector(".btn-mark-ep-halfway");N&&(te?(N.innerHTML='<i data-lucide="check" style="width:11px; height:11px"></i> İZLENDİ',N.style.background="var(--accent-green)",N.style.color="#fff",N.style.display="inline-flex"):re?(N.innerHTML='<i data-lucide="clock" style="width:11px; height:11px"></i> YARIDA',N.style.background="rgba(245, 158, 11, 0.95)",N.style.color="#000",N.style.display="inline-flex"):N.style.display="none"),ae&&(te?(ae.classList.add("watched"),ae.style.background="#10b981",ae.style.borderColor="#10b981",ae.title="İzlendi işaretini kaldır"):(ae.classList.remove("watched"),ae.style.background="rgba(0,0,0,0.65)",ae.style.borderColor="rgba(255,255,255,0.3)",ae.title="İzlendi olarak işaretle")),K&&(K.style.background=re?"#f59e0b":"rgba(0,0,0,0.65)",K.style.borderColor=re?"#f59e0b":"rgba(255,255,255,0.3)"),J&&(J.style.width=`${ie}%`,J.style.background=te?"var(--accent-green)":"#fbbf24")}),V()),x()};window.addEventListener("sineflix_data_changed",A),k.querySelectorAll(".season-pill").forEach(O=>{O.addEventListener("click",Y=>{Y.preventDefault(),k.querySelectorAll(".season-pill").forEach(j=>j.classList.remove("active")),O.classList.add("active"),O.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"}),f=parseInt(O.getAttribute("data-season"),10),v=parseInt(O.getAttribute("data-ep-count"),10)||10,nr(e,t,n,f,k,a,o,i,d,x,s,b),x()})});const S=k.querySelector(".season-pill.active");S&&setTimeout(()=>{S.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})},120);const T=k.querySelector("#season-tabs-bar"),I=k.querySelector("#btn-season-prev"),L=k.querySelector("#btn-season-next");if(T){I?.addEventListener("click",B=>{B.preventDefault(),T.scrollBy({left:-260,behavior:"smooth"})}),L?.addEventListener("click",B=>{B.preventDefault(),T.scrollBy({left:260,behavior:"smooth"})}),T.addEventListener("wheel",B=>{B.deltaY!==0&&T.scrollWidth>T.clientWidth&&(B.preventDefault(),T.scrollLeft+=B.deltaY)},{passive:!1});let O=!1,Y=0,j=0,D=!1;T.addEventListener("mousedown",B=>{B.button===0&&(O=!0,D=!1,T.classList.add("dragging"),Y=B.pageX-T.offsetLeft,j=T.scrollLeft)}),window.addEventListener("mousemove",B=>{if(!O)return;const ie=(B.pageX-T.offsetLeft-Y)*1.5;Math.abs(ie)>4&&(D=!0),T.scrollLeft=j-ie}),window.addEventListener("mouseup",()=>{O&&(O=!1,T.classList.remove("dragging"),setTimeout(()=>{D=!1},50))}),T.addEventListener("click",B=>{D&&(B.preventDefault(),B.stopPropagation())},!0)}const z=k.querySelector("#btn-mark-season-all");z&&z.addEventListener("click",O=>{O.preventDefault();const j=!ra(e,f,v);xd(e,f,v,j,{title:t,posterPath:a,backdropPath:o,type:s?"anime":"tv",isAnime:s}),Z(j?`${f}. Sezonun tüm bölümleri izlendi!`:`${f}. Sezon izlenmedi olarak işaretlendi.`,j?"success":"info");const D=k.querySelector("#episode-grid-container");D&&(D.querySelectorAll(".episode-card").forEach(B=>{const W=B.querySelector(".badge-watched-status"),ie=B.querySelector(".btn-mark-ep-watched");W&&(W.innerHTML='<i data-lucide="check" style="width:12px; height:12px"></i> İZLENDİ',W.style.background="var(--accent-green)",W.style.color="#fff",W.style.display=j?"inline-flex":"none"),ie&&(j?(ie.classList.add("watched"),ie.style.background="#10b981",ie.style.borderColor="#10b981",ie.title="İzlendi işaretini kaldır"):(ie.classList.remove("watched"),ie.style.background="rgba(0,0,0,0.65)",ie.style.borderColor="rgba(255,255,255,0.3)",ie.title="İzlendi olarak işaretle"))}),V()),x()}),y=O=>{b=!!O,nr(e,t,n,f,k,a,o,i,d,x,s,b)}},setSpoilerSafe(k){b=!!k,y?.(b)}}}function Wh(e){const t=Be().filter(i=>String(i?.id)===String(e)&&(Number(i.currentTime)>0||i.completed||Number(i.progressPercent)>0));return t.length?t.reduce((i,n)=>{const r={season:Math.max(1,Number(n.season)||1),episode:Math.max(1,Number(n.episode)||1)};return r.season>i.season||r.season===i.season&&r.episode>i.episode?r:i},{season:1,episode:1}):{season:1,episode:1}}async function nr(e,t,i,n,r,a="",o="",s="",l=[],d=null,p=!1,h=!1){const m=r.querySelector("#episode-grid-container");if(!m)return;m.innerHTML=`<div style="padding: 3rem; text-align: center; color: var(--text-muted); grid-column: 1/-1;"><i data-lucide="loader-2" class="spin-loader" style="width: 24px; height: 24px; margin-bottom: 0.5rem;"></i><div>${n}. Sezon bölümleri getiriliyor...</div></div>`,V();let b=null;try{b=await Vd(e,n)}catch{}if(!b||!b.episodes||b.episodes.length===0){m.innerHTML=`
      <div style="padding: 3rem; text-align: center; color: var(--text-muted); grid-column: 1/-1;">
    ...
    `,V(),r.querySelector("#btn-retry-season-episodes")?.addEventListener("click",()=>{nr(e,t,i,n,r,a,o,s,l,d,p,h)});return}const y=h?Wh(e):null,w=h?b.episodes.filter(f=>n<y.season||n===y.season&&Number(f.episode_number)<=y.episode+1):b.episodes;if(h&&w.length===0){m.innerHTML='<div class="spoiler-safe-locked"><i data-lucide="shield-check"></i><strong>Bu sezon spoiler korumasında</strong><span>Önceki sezona ilerledikçe bölüm detayları burada açılır.</span></div>',V();return}const k=h?`<div class="spoiler-safe-notice"><i data-lucide="shield-check"></i><span>Spoilersız keşif açık · S${y.season} B${y.episode+1} sonrasının detayları gizli.</span></div>`:"";m.innerHTML=k+w.map(f=>{const v=f.episode_number;let x=(f.name||"").trim();x=x.replace(new RegExp(`^(?:${v}\\s*[\\.\\:\\-]\\s*)+(?:Bölüm\\s*[\\:\\-]\\s*)?`,"i"),""),x=x.replace(new RegExp(`^Bölüm\\s*${v}\\s*[\\:\\-]\\s*`,"i"),""),x=x.trim();const A=x?`${v}. Bölüm: ${x}`:`${v}. Bölüm`;let S=f.overview?f.overview.trim():"";(!S||S.length<5)&&(i&&i.length>10?S=`${v}. Bölüm: ${i}`:S=`${t} ${n}. Sezon ${v}. Bölüm Türkçe Dublaj ve Altyazılı yüksek kalitede kesintisiz HD izle.`);const T=S.length>90,I=lt(f.still_path,et.STILL_MEDIUM),L=f.air_date||"",z=f.runtime?`${f.runtime} dk`:"",O=Xt(e,n,v),Y=O?O.progressPercent:0,j=O?O.completed||Y>=90:!1,D=O&&!j&&O.currentTime>0,B=Y>0?`
    ...
    `:"";let W="";return j?W=`
      ...
      `,`
      <div class="episode-card" data-tv-id="${e}" data-season="${n}" data-episode="${v}" data-title="${A}">
        <div class="episode-thumb-wrap">
          <img src="${I}" alt="${A}" loading="lazy" onerror="this.onerror=null; this.src='${wn}';" />
          ...
          <div style="position: absolute; top: 0.5rem; right: 0.5rem; display: flex; gap: 0.35rem; z-index: 5;">
            <button class="btn-mark-ep-halfway" data-tv-id="${e}" data-season="${n}" data-episode="${v}" title="Yarıda Bırakıldı (20. dk)" style="width: 28px; height: 28px; border-radius: 50%; background: ${D?"#f59e0b":"rgba(0,0,0,0.65)"}; border: 1px solid ${D?"#f59e0b":"rgba(255,255,255,0.3)"}; color: #fff; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: all 0.2s ease;">
        ...
        <div class="episode-info">
          <div class="episode-header-row">
            <span class="episode-title" title="${A}">${A}</span>
            <span class="episode-duration">${z||L}</span>
          </div>
    ...
    `}).join(""),V(),r.querySelectorAll(".btn-toggle-overview").forEach(f=>{f.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation();const x=f.closest(".episode-overview-container"),A=x?x.querySelector(".episode-overview"):null;if(!A)return;const S=f.querySelector("span"),T=f.querySelector("i");A.classList.contains("truncated")?(A.classList.remove("truncated"),S&&(S.textContent="Daralt"),T&&T.setAttribute("data-lucide","chevron-up")):(A.classList.add("truncated"),S&&(S.textContent="Devamını Oku"),T&&T.setAttribute("data-lucide","chevron-down")),V()})}),m.querySelectorAll(".btn-mark-ep-watched").forEach(f=>{f.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation();const x=parseInt(f.getAttribute("data-season"),10),A=parseInt(f.getAttribute("data-episode"),10),S=f.closest(".episode-card"),I=Al(e,x,A,{title:t,posterPath:a,backdropPath:o,type:p?"anime":"tv",isAnime:p}).completed;if(Z(I?`S${x} B${A} izlendi olarak işaretlendi!`:`S${x} B${A} izlendi işareti kaldırıldı.`,I?"success":"info"),I?(f.classList.add("watched"),f.style.background="#10b981",f.style.borderColor="#10b981",f.title="İzlendi işaretini kaldır"):(f.classList.remove("watched"),f.style.background="rgba(0,0,0,0.65)",f.style.borderColor="rgba(255,255,255,0.3)",f.title="İzlendi olarak işaretle"),S){const L=S.querySelector(".badge-watched-status");L&&(L.innerHTML='<i data-lucide="check" style="width:12px; height:12px"></i> İZLENDİ',L.style.background="var(--accent-green)",L.style.color="#fff",L.style.display=I?"inline-flex":"none")}typeof d=="function"&&d(),V()})}),m.querySelectorAll(".btn-mark-ep-halfway").forEach(f=>{f.addEventListener("click",v=>{v.preventDefault(),v.stopPropagation();const x=parseInt(f.getAttribute("data-season"),10),A=parseInt(f.getAttribute("data-episode"),10),S=f.closest(".episode-card");if(za(e,x,A,1200,{title:t,posterPath:a,backdropPath:o,type:p?"anime":"tv",isAnime:p,duration:2700}),f.style.background="#f59e0b",f.style.borderColor="#f59e0b",S){const T=S.querySelector(".badge-watched-status");T&&(T.innerHTML='<i data-lucide="clock" style="width:12px; height:12px"></i> YARIDA (20:00)',T.style.background="rgba(245, 158, 11, 0.9)",T.style.color="#000",T.style.display="inline-flex")}Z(`S${x} B${A} 20. dakikada yarıda bırakıldı olarak işaretlendi!`,"info"),V()})}),m.querySelectorAll(".episode-card").forEach(f=>{const v=S=>{if(S&&S.target&&(S.target.closest(".btn-mark-ep-watched")||S.target.closest(".btn-mark-ep-halfway")||S.target.closest(".btn-toggle-overview")))return;S&&(S.preventDefault(),S.stopPropagation());const T=parseInt(f.getAttribute("data-season"),10),I=parseInt(f.getAttribute("data-episode"),10),L=f.getAttribute("data-title"),z=Xt(e,T,I),O=z?z.currentTime:0;Qt({type:p?"anime":"tv",isAnime:p,tmdbId:e,title:`${t} - S${T}E${I}: ${L}`,seriesTitle:t,originalTitle:s||t,season:T,episode:I,posterPath:a,backdropPath:o,currentTime:O,seasonsList:l,maxEpisodes:b.episodes?b.episodes.length:0})};f.addEventListener("click",v);const x=f.querySelector(".episode-thumb-wrap");x&&x.addEventListener("click",v);const A=f.querySelector(".btn-play-episode-trigger");A&&A.addEventListener("click",v)})}let rr=null;async function Yh(e,t="",i=""){Si();const n=document.createElement("div");n.id="cast-explorer-modal-root",n.className="cast-explorer-backdrop",document.body.appendChild(n),rr=n,n.innerHTML=`
  ...
  `,V(n);const r=n.querySelector("#btn-close-cast-explorer");r&&(r.onclick=()=>Si()),n.onclick=I=>{I.target===n&&Si()};const a=I=>{I.key==="Escape"&&(Si(),window.removeEventListener("keydown",a))};window.addEventListener("keydown",a);const o=await Gd(e);if(!o){n.innerHTML=`
      <div class="cast-explorer-dialog">
        <button class="cast-explorer-close-btn" id="btn-close-cast-explorer" title="Kapat">
          <i data-lucide="x" style="width: 20px; height: 20px;"></i>
        </button>
    ...
    `,V(n);return}const s=o.name||t,l=o.profile_path?lt(o.profile_path,et.POSTER_MEDIUM):i||cr,d=o.birthday?o.birthday.substring(0,4):"",p=o.place_of_birth||"",h=o.known_for_department==="Acting"?"Oyuncu":o.known_for_department==="Directing"?"Yönetmen":o.known_for_department||"Sanatçı",m=o.biography&&o.biography.trim().length>20?o.biography:`${s}, sinema ve televizyon dünyasında yer aldığı yapımlarla tanınan başarılı bir sanatçıdır.`,b=o.combined_credits?.cast||[],y=o.combined_credits?.crew||[],w=[...b,...y],k=new Set,f=[];for(const I of w){if(!I||!I.id)continue;const L=`${I.media_type||"movie"}_${I.id}`;k.has(L)||(k.add(L),I.poster_path&&f.push(I))}f.sort((I,L)=>(L.popularity||0)-(I.popularity||0));const v=f.filter(I=>I.media_type==="movie"||!I.media_type&&I.title).length,x=f.filter(I=>I.media_type==="tv"||!I.media_type&&I.name).length;n.innerHTML=`
    <div class="cast-explorer-dialog">
      <button class="cast-explorer-close-btn" id="btn-close-cast-explorer" title="Kapat">
        <i data-lucide="x" style="width: 20px; height: 20px;"></i>
      </button>
  ...
  `,V(n);const A=n.querySelector("#btn-close-cast-explorer");A&&(A.onclick=()=>Si());const S=n.querySelector("#cast-explorer-grid");S&&(mt(S),S.addEventListener("click",()=>{setTimeout(()=>Si(),150)}));const T=n.querySelectorAll(".cast-tab-btn");T.forEach(I=>{I.onclick=()=>{T.forEach(O=>O.classList.remove("active")),I.classList.add("active");const L=I.getAttribute("data-filter");let z=f;L==="movie"?z=f.filter(O=>O.media_type==="movie"||!O.media_type&&O.title):L==="tv"&&(z=f.filter(O=>O.media_type==="tv"||!O.media_type&&O.name)),S&&(S.innerHTML=z.length>0?z.map(O=>St(O)).join(""):'<div class="cast-empty-state">Bu kategoride yapım bulunamadı.</div>',V(S))}})}function Si(){if(rr){try{rr.remove()}catch{}rr=null}}const Vh="https://api.tvmaze.com",Gh=5500,Hc=30*60*1e3,qc="cinepulse_tvmaze_cache_v1",Sn=new Map;function Jh(){try{const e=sessionStorage.getItem(qc);if(!e)return;const t=JSON.parse(e);t&&typeof t=="object"&&Object.entries(t).forEach(([i,n])=>{n?.savedAt&&Date.now()-n.savedAt<Hc&&Sn.set(i,n)})}catch{}}function Xh(){try{const e={};let t=0;for(const[i,n]of Sn.entries()){if(t++>=80)break;e[i]=n}sessionStorage.setItem(qc,JSON.stringify(e))}catch{}}function Bs(e){const t=Sn.get(e);if(t){if(Date.now()-t.savedAt>Hc){Sn.delete(e);return}return t.data}}function Ds(e,t){Sn.set(e,{savedAt:Date.now(),data:t}),Xh()}async function Tr(e){try{const t=await fetch(`${Vh}${e}`,{headers:{Accept:"application/json"},signal:AbortSignal.timeout(Gh)});return t.ok?await t.json():null}catch{return null}}function il(e){return String(e||"").toLowerCase().replace(/[^a-z0-9çğıöşü ]/gi," ").replace(/\s+/g," ").trim()}function Fc(e,t){const i=il(e),n=il(t);return!i||!n?!1:i===n?!0:i.includes(n)||n.includes(i)}function nl(e){return e?{season:e.season??null,number:e.number??null,name:e.name||"",airdate:e.airdate||"",airstamp:e.airstamp||"",runtime:e.runtime||null}:null}function Zh(e){switch(e){case"Running":return"Devam ediyor";case"Ended":return"Sonlandı";case"To Be Determined":return"Belirsiz";case"In Development":return"Yapım aşamasında";default:return e||""}}async function Qh(e){const t=`lookup:${e}`,i=Bs(t);if(i!==void 0)return i;const n=await Tr(`/lookup/shows?${e}`);return Ds(t,n||null),n||null}async function Uc(e){if(!e)return null;const t=`show:${e}`,i=Bs(t);if(i!==void 0)return i;const n=await Tr(`/shows/${e}?embed[]=nextepisode&embed[]=previousepisode`),r=n?{tvmazeId:n.id,name:n.name||"",status:n.status||"",statusLabel:Zh(n.status),premiered:n.premiered||"",officialSite:n.officialSite||"",thetvdbId:n.externals?.thetvdb??null,imdbId:n.externals?.imdb||"",nextEpisode:nl(n._embedded?.nextepisode),previousEpisode:nl(n._embedded?.previousepisode)}:null;return Ds(t,r),r}async function ef(e){const t=String(e||"").trim();if(!t)return null;const i=t.startsWith("tt")?t:`tt${t}`,r=(await Qh(`imdb=${encodeURIComponent(i)}`))?.id||null;return r?Uc(r):null}function jc(e,t){const i=parseInt(String(e?.premiered||"").substring(0,4),10),n=parseInt(String(t||""),10);return!n||!i?0:Math.abs(i-n)}function tf(e,t,i){let n=null,r=1/0;for(const a of e){if(!a||!Fc(a.name,t))continue;const o=jc(a,i);if(o>1)continue;const s=o*10+(a.status==="Running"?0:1);s<r&&(r=s,n=a)}return n}async function nf(e,t){const i=String(e||"").trim();if(i.length<2)return null;const n=`search:${i}:${t||""}`,r=Bs(n);if(r!==void 0)return r;let a=null;const o=await Tr(`/singlesearch/shows?q=${encodeURIComponent(i)}`);if(o&&Fc(o.name,i)&&jc(o,t)<=1&&(a=o),!a){const l=await Tr(`/search/shows?q=${encodeURIComponent(i)}`),d=Array.isArray(l)?l.map(p=>p?.show).filter(Boolean):[];a=tf(d,i,t)}const s=a?await Uc(a.id):null;return Ds(n,s),s}async function rf({imdbId:e,title:t,year:i}={}){let n=await ef(e);if(n||(n=await nf(t,i)),!n)return null;const r=n.nextEpisode;return{showName:n.name,statusLabel:n.statusLabel,officialSite:n.officialSite,nextEpisode:r,previousEpisode:n.previousEpisode,nextLabel:r?af(r):"",nextAirdateLabel:r?of(r.airdate,r.airstamp):""}}function af(e){if(!e)return"";const t=e.season!==null&&e.season!==void 0,i=e.number!==null&&e.number!==void 0,n=t&&e.season>=1900;return t&&!n&&i?`S${e.season} B${e.number}`:n&&e.name?e.name:i?`B${e.number}`:e.name||""}const sf=["Oca","Şub","Mar","Nis","May","Haz","Tem","Ağu","Eyl","Eki","Kas","Ara"];function of(e,t){const i=t?new Date(t):e?new Date(`${e}T21:00:00`):null;if(!i||Number.isNaN(i.getTime()))return e||"";const n=new Date,r=s=>new Date(s.getFullYear(),s.getMonth(),s.getDate()).getTime(),a=Math.round((r(i)-r(n))/864e5),o=t?`${String(i.getHours()).padStart(2,"0")}:${String(i.getMinutes()).padStart(2,"0")}`:"";return a<0?"Yayınlandı":a===0?o?`Bugün ${o}`:"Bugün":a===1?o?`Yarın ${o}`:"Yarın":a<=7?`${a} gün sonra`:`${i.getDate()} ${sf[i.getMonth()]}`}Jh();const rl="cinepulse.decision-room.autoplay";function lf(e,t){try{const i=JSON.parse(sessionStorage.getItem(rl)||"null");return sessionStorage.removeItem(rl),i&&String(i.id)===String(t)&&i.type===e&&Date.now()-Number(i.createdAt||0)<15e3?i:null}catch{return null}}function cf(e){if(!e||e<=0)return"";const t=Math.floor(e/60),i=e%60;return t>0?`${t} sa ${i>0?i+" dk":""} (${e} dk)`:`${e} dk`}async function df(e="tv",t){const i=typeof e=="object"&&e!==null?e.type||"tv":e||"tv",n=typeof e=="object"&&e!==null?e.id:t;let r=i==="series"||i==="tv"||i==="anime"?"tv":i==="movie"?"movie":"tv",a=await lo(r,n);if(a||(r=r==="tv"?"movie":"tv",a=await lo(r,n)),!a)return{html:'<div class="container" style="padding: 10rem 0; text-align: center;"><h2>İçerik bulunamadı.</h2></div>',init:()=>{}};const o=!!(a.seasons&&a.seasons.length>0)||r==="tv",s=o?"tv":"movie",l=Ms(a)||i==="anime"||r==="anime"||Fe(n);l&&Se(n);const d=a.title||a.name||"Detay",p=a.original_title||a.original_name||"",h=lt(a.backdrop_path,et.BACKDROP_ORIGINAL),m=lt(a.poster_path,et.POSTER_MEDIUM),b=a.vote_average?a.vote_average.toFixed(1):"8.5",y=(a.first_air_date||a.release_date||"").substring(0,4),w=a.overview&&a.overview.trim().length>15?a.overview:qe(a,s),k=a.genres||[],f=a.runtime?a.runtime*60:6600,v=Td(n),x=ms(n),A=s==="tv"?aa(n):null,S=s==="movie"?Xt(n,1,1):null,T=s==="movie"?bn(n,1,1):!1,I=s==="tv"?na(n,a.seasons||[]):!1,L=s==="movie"?T:I;let z=s==="movie"?"Filmi İzle":"1. Sezon 1. Bölümü İzle";if(s==="tv"&&A){const G=li(A.currentTime);z=`Devam Et <span class="play-btn-subinfo">S${A.season} B${A.episode}${G?" • "+G:""}</span>`}else s==="movie"&&S&&S.currentTime>0&&(z=`Devam Et <span class="play-btn-subinfo">${li(S.currentTime)}</span>`);const O=a.credits?.crew?a.credits.crew.filter(G=>G.job==="Director").map(G=>G.name):[],Y=a.created_by?a.created_by.map(G=>G.name):[],j=O.length>0?O.slice(0,2).join(", "):Y.length>0?Y.slice(0,2).join(", "):"",D=(parseFloat(b)/2).toFixed(1),B=Math.floor(D),W=D%1>=.4,ie="★".repeat(Math.min(5,B))+(W&&B<5?"½":""),te=a.credits&&a.credits.cast?a.credits.cast.slice(0,10):[];let re=null,N=!1;s==="tv"&&a.seasons&&(re=await Kh({tvId:n,seriesTitle:d,originalTitle:p,seriesOverview:w,seasons:a.seasons,posterPath:a.poster_path,backdropPath:a.backdrop_path,isAnime:l,spoilerFree:N}));const ae=a.recommendations?a.recommendations.results.slice(0,6):[],J=s==="movie"?T?"Film İzlendi":"İzlendi Olarak İşaretle":I?"Tüm Sezonlar İzlendi":"Tümünü İzlendi İşaretle",K=a.runtime?`
        ...
        <div class="detail-container">
          ...
          <div class="detail-layout">
            ...
            <div class="detail-poster-col">
              <img class="detail-poster-img" src="${m}" alt="${d}" onerror="this.onerror=null; this.src='${wn}';" />
            </div>
            ...
            <div class="detail-info-col">
              ...
              <div class="detail-badge-deck">
                ...
                <span class="badge badge-letterboxd" title="Letterboxd Derecelendirmesi">
                  <span style="letter-spacing: 0.05em; font-weight: 800;">${ie}</span> ${D}
                </span>
  ...
  `,init:G=>{if(!G)return;let $=lf(s,n);const M=G.querySelector("#btn-detail-back");M&&M.addEventListener("click",oe=>{oe.preventDefault(),window.history.length>1?window.history.back():window.location.hash="#home"}),re&&re.init(G);const H=G.querySelector("#detail-spoiler-free-toggle");H&&(H.checked=N,H.addEventListener("change",()=>{N=H.checked,re?.setSpoilerSafe(N),Z(N?"Spoilersız keşif açıldı. Sonraki bölüm detayları gizlendi.":"Spoilersız keşif kapatıldı.","info")}));const Q=G.querySelector("#btn-play-movie"),se=async()=>{if(!Q||Q.disabled)return;Q.disabled=!0;const oe=Q.innerHTML;Q.innerHTML='<i data-lucide="loader-2" class="spin-loader" style="width:18px;height:18px;fill:currentColor"></i> <span>Yükleniyor...</span>',V();try{const g=Xt(n,1,1);await Qt({type:l?"anime":"movie",isAnime:l,tmdbId:n,title:d,seriesTitle:d,originalTitle:p,posterPath:a.poster_path,backdropPath:a.backdrop_path,duration:f,currentTime:g?g.currentTime:0,roomSync:$?{roomCode:$.roomCode,mediaId:n,type:s,season:1,episode:1,initialSync:$.initialSync||null}:null})}catch{Z("Film açılırken hata oluştu, lütfen tekrar deneyin.","error")}finally{Q.disabled=!1,Q.innerHTML=oe,V()}};Q&&Q.addEventListener("click",se);const E=G.querySelector("#btn-resume-series"),C=async()=>{if(!E||E.disabled)return;E.disabled=!0;const oe=E.innerHTML;E.innerHTML='<i data-lucide="loader-2" class="spin-loader" style="width:18px;height:18px;fill:currentColor"></i> <span>Yükleniyor...</span>',V();try{const g=$;$=null;const c=aa(n),u=g?.season||(c?c.season:1),_=g?.episode||(c?c.episode:1),R=g?0:c?c.currentTime:0;await Qt({type:l?"anime":"tv",isAnime:l,tmdbId:n,title:`${d} - S${u}E${_}`,seriesTitle:d,originalTitle:p,season:u,episode:_,posterPath:a.poster_path,backdropPath:a.backdrop_path,currentTime:R,seasonsList:a.seasons||[],roomSync:g?{roomCode:g.roomCode,mediaId:n,type:s,season:u,episode:_,initialSync:g.initialSync||null}:null})}catch{Z("İçerik açılırken hata oluştu, lütfen tekrar deneyin.","error")}finally{E.disabled=!1,E.innerHTML=oe,V()}};E&&E.addEventListener("click",oe=>{oe.preventDefault(),C()}),$&&window.setTimeout(()=>{s==="movie"?se():C()},0);const q=G.querySelector("#btn-watch-trailer");q&&q.addEventListener("click",async()=>{q.disabled=!0;const oe=q.innerHTML;q.innerHTML='<i data-lucide="loader-2" class="spin-loader" style="width:18px;height:18px"></i> <span>Yükleniyor...</span>',V();try{const g=await kn(s,n,d);g?Bc({title:d,trailerInfo:g,mediaId:n,mediaType:l?"anime":s}):Z("Bu yapım için resmi fragman bulunamadı.","info")}catch{Z("Fragman yüklenirken bir hata oluştu.","error")}finally{q.disabled=!1,q.innerHTML=oe,V()}});const ee=G.querySelector("#btn-toggle-fav");ee&&ee.addEventListener("click",()=>{const oe=Ad({...a,type:l?"anime":s,isAnime:l,media_type:s});Z(oe?"Favorilere eklendi!":"Favorilerden çıkarıldı.",oe?"success":"info");const g=ee.querySelector("i"),c=ee.querySelector("span");g&&c&&(g.style.fill=oe?"var(--primary)":"none",g.style.color=oe?"var(--primary)":"currentColor",c.textContent=oe?"Favorilerimde":"Favorilere Ekle")});const ke=G.querySelector("#btn-toggle-watchlist");ke&&ke.addEventListener("click",()=>{const oe=Ll({...a,type:l?"anime":s,isAnime:l,media_type:s});Z(oe?"İzleme listesine eklendi!":"İzleme listesinden çıkarıldı.",oe?"success":"info");const g=ke.querySelector("i"),c=ke.querySelector("span");g&&c&&(g.setAttribute("data-lucide",oe?"check":"plus"),V(),c.textContent=oe?"Listemde":"İzleme Listeme Ekle")});const le=G.querySelector("#btn-toggle-watched-detail");le&&le.addEventListener("click",oe=>{if(oe.preventDefault(),s==="movie"){const c=Al(n,1,1,{title:d,posterPath:a.poster_path,backdropPath:a.backdrop_path,type:"movie",duration:f}).completed;Z(c?"✓ Film izlendi olarak işaretlendi!":"Film izlendi işareti kaldırıldı.",c?"success":"info"),c?le.classList.add("btn-watched-active"):le.classList.remove("btn-watched-active"),le.innerHTML=`
              <i data-lucide="${c?"check-circle-2":"check"}"></i>
              <span>${c?"Film İzlendi":"İzlendi Olarak İşaretle"}</span>
            `,V()}else{const c=!na(n,a.seasons||[]);Sd(n,a.seasons||[],c,{title:d,posterPath:a.poster_path,backdropPath:a.backdrop_path,type:l?"anime":"tv",isAnime:l}),Z(c?"✓ Dizinin tüm bölümleri izlendi olarak işaretlendi!":"Tüm bölümler izlenmedi yapıldı.",c?"success":"info"),c?le.classList.add("btn-watched-active"):le.classList.remove("btn-watched-active"),le.innerHTML=`
              <i data-lucide="${c?"check-circle-2":"check"}"></i>
              <span>${c?"Tüm Sezonlar İzlendi":"Tümünü İzlendi İşaretle"}</span>
            `,V(),G.querySelectorAll(".episode-card").forEach(_=>{const R=_.querySelector(".badge-watched-status"),P=_.querySelector(".btn-mark-ep-watched");R&&(R.innerHTML='<i data-lucide="check" style="width:12px; height:12px"></i> İZLENDİ',R.style.background="var(--accent-green)",R.style.color="#fff",R.style.display=c?"inline-flex":"none"),P&&(c?(P.classList.add("watched"),P.style.background="#10b981",P.style.borderColor="#10b981"):(P.classList.remove("watched"),P.style.background="rgba(0,0,0,0.65)",P.style.borderColor="rgba(255,255,255,0.3)"))});const u=G.querySelector("#btn-mark-season-all");if(u){const _=u.querySelector("span"),R=u.querySelector("i");_&&(_.textContent=c?"Bu Sezon İzlendi":"Bu Sezonu İzlendi İşaretle"),R&&R.setAttribute("data-lucide",c?"check-circle-2":"check-check"),c?(u.style.background="rgba(16, 185, 129, 0.2)",u.style.borderColor="#10b981",u.style.color="#10b981"):(u.style.background="",u.style.borderColor="",u.style.color="")}V()}});const fe=oe=>{if(oe&&oe.detail&&oe.detail.isProgressUpdate&&document.getElementById("player-modal"))return;const g=s==="movie"?bn(n,1,1):!1,c=s==="tv"?na(n,a.seasons||[]):!1,u=s==="movie"?g:c;if(le){u?le.classList.add("btn-watched-active"):le.classList.remove("btn-watched-active");const P=s==="movie"?u?"Film İzlendi":"İzlendi Olarak İşaretle":u?"Tüm Sezonlar İzlendi":"Tümünü İzlendi İşaretle";le.innerHTML=`
            <i data-lucide="${u?"check-circle-2":"check"}"></i>
            <span>${P}</span>
          `}const _=G.querySelector("#btn-play-movie");if(_&&s==="movie"){const P=Xt(n,1,1);if(P&&P.currentTime>0&&!P.completed){const F=li(P.currentTime);_.innerHTML=`<i data-lucide="play" style="fill:currentColor"></i> <span>Devam Et <span class="play-btn-subinfo">${F}</span></span>`}}const R=G.querySelector("#btn-resume-series");if(R&&s==="tv"){const P=aa(n);if(P){const F=li(P.currentTime);R.innerHTML=`<i data-lucide="play" style="fill:currentColor"></i> <span>Devam Et <span class="play-btn-subinfo">S${P.season} B${P.episode}${F?" • "+F:""}</span></span>`}}V()};window.addEventListener("sineflix_data_changed",fe);const Xe=G.querySelector("#btn-mark-halfway-detail");Xe&&Xe.addEventListener("click",oe=>{if(oe.preventDefault(),s==="movie"){const g=Math.round(f*.5),c=li(g);za(n,1,1,g,{title:d,posterPath:a.poster_path,backdropPath:a.backdrop_path,type:l?"anime":"movie",isAnime:l,duration:f}),Z(`⏳ Film ${c} dakikasında yarıda bırakıldı olarak işaretlendi!`,"info");const u=G.querySelector("#btn-play-movie span");u&&(u.textContent=`Kaldığın Yerden Devam Et (${c})`)}else{const g=A?A.season:1,c=A?A.episode:1;za(n,g,c,1200,{title:d,posterPath:a.poster_path,backdropPath:a.backdrop_path,type:l?"anime":"tv",isAnime:l,duration:3e3}),Z(`⏳ S${g} B${c} 20. dakikada yarıda bırakıldı olarak işaretlendi!`,"info");const u=G.querySelector("#btn-resume-series span");u&&(u.textContent=`Kaldığın Yerden Devam Et (S${g} B${c} • 20:00)`)}});const Ze=G.querySelector("#btn-expand-storyline"),Ue=G.querySelector("#detail-storyline-text");Ze&&Ue&&Ze.addEventListener("click",()=>{const oe=!Ue.classList.contains("truncated");Ue.classList.toggle("truncated");const g=Ze.querySelector("span"),c=Ze.querySelector("i");g&&(g.textContent=oe?"Devamını Oku":"Daralt"),c&&(c.style.transform=oe?"rotate(0deg)":"rotate(180deg)")});const Re=G.querySelector("#detail-cast-rail"),De=G.querySelector("#btn-cast-prev"),Ne=G.querySelector("#btn-cast-next");if(Re){De&&De.addEventListener("click",_=>{_.preventDefault(),Re.scrollBy({left:-280,behavior:"smooth"})}),Ne&&Ne.addEventListener("click",_=>{_.preventDefault(),Re.scrollBy({left:280,behavior:"smooth"})}),Re.addEventListener("wheel",_=>{_.deltaY!==0&&(_.preventDefault(),Re.scrollLeft+=_.deltaY)},{passive:!1});let oe=!1,g=0,c=0;Re.addEventListener("mousedown",_=>{oe=!0,Re.classList.add("dragging"),g=_.pageX-Re.offsetLeft,c=Re.scrollLeft});const u=()=>{oe=!1,Re.classList.remove("dragging")};Re.addEventListener("mouseleave",u),Re.addEventListener("mouseup",u),Re.addEventListener("mousemove",_=>{if(!oe)return;_.preventDefault();const P=(_.pageX-Re.offsetLeft-g)*1.5;Re.scrollLeft=c-P}),Re.querySelectorAll(".detail-actor-pill").forEach(_=>{_.addEventListener("click",R=>{R.preventDefault();const P=_.getAttribute("data-person-id"),F=_.getAttribute("data-person-name");P&&Yh(P,F)})})}const We=G.querySelector("#detail-next-episode-badge");We&&s==="tv"&&(async()=>{try{const oe=await rf({imdbId:a.external_ids?.imdb_id,title:p||d,year:y});if(!oe?.nextEpisode||!We.isConnected)return;const g=oe.nextLabel||"",c=oe.nextAirdateLabel||"";if(!g&&!c||c==="Yayınlandı")return;const u=[g?`Yeni bölüm ${g}`:"Yeni bölüm",c].filter(Boolean).join(" • ");We.innerHTML=`<i data-lucide="calendar-clock" style="width:13px; height:13px"></i><span>${u}</span>`,We.title=`Sonraki bölüm: ${g||"-"}${oe.nextEpisode.name?" — "+oe.nextEpisode.name:""}${c?" • "+c:""} (Kaynak: TVmaze)`,We.style.display="inline-flex",V(We)}catch{}})();const je=G.querySelector(".media-grid");je&&mt(je)}}}const uf="cinepulse_offline_db",pf=1,rt="downloads",mn="cinepulse-offline-media-v1";let Fn=null,gn=[];function Kc(e){return ji().then(t=>new Promise((i,n)=>{const r=t.transaction(rt,"readonly").objectStore(rt).get(e);r.onsuccess=()=>i(r.result||null),r.onerror=()=>n(r.error)}))}function zs(e,t){return new Request(new URL(`/__cinepulse_offline__/${encodeURIComponent(e)}/${t}`,location.origin))}function rs(e,t){return new URL(e,t).href}async function hf(e,t,i,n,r,a){let o=null;const s=[n,n.includes("/api/hls_proxy")?null:Di(`/api/hls_proxy?url=${encodeURIComponent(n)}`)].filter(Boolean);let l=null;for(let h=0;h<3;h++){const m=s[Math.min(h,s.length-1)];try{if(o=await fetch(m,{cache:"no-store"}),o&&o.ok)break}catch(b){if(l=b,h===2)throw l;await new Promise(y=>setTimeout(y,400*(h+1)))}}if(!o||!o.ok)throw new Error(`Bölüm parçası indirilemedi (HTTP ${o?.status||l?.message||"ağ hatası"})`);const d=await o.blob();await e.put(zs(t,i),new Response(d,{headers:{"Content-Type":o.headers.get("content-type")||"application/octet-stream"}})),a.loaded+=d.size,a.done+=1;const p=Math.min(98,5+Math.round(a.done/a.count*93));return r({percent:p,loaded:a.loaded,total:0,status:`%${p}`}),d.size}function al(e,t){const i=e.split(/\r?\n/),n=[];for(let r=0;r<i.length;r+=1){if(!i[r].startsWith("#EXT-X-STREAM-INF:"))continue;const a=Number(i[r].match(/(?:AVERAGE-)?BANDWIDTH=(\d+)/)?.[1])||0,o=i.slice(r+1).find(s=>s&&!s.startsWith("#"));o&&n.push({bandwidth:a,url:rs(o.trim(),t)})}return n.sort((r,a)=>a.bandwidth-r.bandwidth)[0]?.url||null}async function ff(e,t,i,n,r){let a=i.url||i.url,o=n,s=al(o,a),l=0;for(;s&&l<3;){l++;const A=await fetch(s,{cache:"no-store"});if(!A.ok)throw new Error(`Bölüm listesi alınamadı (HTTP ${A.status})`);a=A.url||s,o=await A.text(),s=al(o,a)}if(o.includes("#EXT-X-ENDLIST")||(o+=`
#EXT-X-ENDLIST
`),o.includes("#EXT-X-BYTERANGE"))throw new Error("Bu kaynak parçalı byte aralığı kullanıyor; başka bir yayın hattı seçin.");const d=o.split(/\r?\n/),p=[],h=[];let m=0;for(const A of d){if(!A){h.push(A);continue}if(A.startsWith("#EXT-X-BYTERANGE"))throw new Error("Bu kaynak parçalı byte aralığı kullanıyor; başka bir yayın hattı seçin.");if(A.startsWith("#EXT-X-KEY:")||A.startsWith("#EXT-X-MAP:")){const S=A.match(/URI="([^"]+)"/);if(S){const T=m++,I=rs(S[1],a);p.push({index:T,url:I}),h.push(A.replace(S[0],`URI="__CP_OFFLINE_RESOURCE_${T}__"`))}else h.push(A);continue}if(A.startsWith("#"))h.push(A);else{const S=m++,T=rs(A.trim(),a);p.push({index:S,url:T}),h.push(`__CP_OFFLINE_RESOURCE_${S}__`)}}const b=p.length;if(!b)throw new Error("Bu bölümde indirilebilir video parçası bulunamadı.");const y={done:0,count:b,loaded:0},w=p.map(A=>A.index),k=5;let f=0;async function v(){for(;f<p.length;){const A=p[f++];if(!A)break;await hf(e,t,A.index,A.url,r,y)}}const x=Array.from({length:Math.min(k,p.length)},()=>v());return await Promise.all(x),{playlistTemplate:h.join(`
`),resourceKeys:w,sizeBytes:y.loaded}}function ji(){return Fn?Promise.resolve(Fn):new Promise((e,t)=>{const i=indexedDB.open(uf,pf);i.onupgradeneeded=n=>{const r=n.target.result;if(!r.objectStoreNames.contains(rt)){const a=r.createObjectStore(rt,{keyPath:"key"});a.createIndex("tmdbId","tmdbId",{unique:!1}),a.createIndex("downloadedAt","downloadedAt",{unique:!1})}},i.onsuccess=()=>{Fn=i.result,e(Fn)},i.onerror=()=>t(i.error)})}function Wr(e,t=null,i=null){return t!==null&&i!==null&&t!==void 0&&i!==void 0?`${e}_s${t}_e${i}`:String(e)}async function Wc(){try{const e=await ji();return new Promise((t,i)=>{const a=e.transaction(rt,"readonly").objectStore(rt).getAll();a.onsuccess=()=>{const o=a.result||[];o.sort((s,l)=>(l.downloadedAt||0)-(s.downloadedAt||0)),t(o)},a.onerror=()=>i(a.error)})}catch{return[]}}async function Rm(e,t=null,i=null){try{const n=await ji(),r=Wr(e,t,i);return new Promise(a=>{const l=n.transaction(rt,"readonly").objectStore(rt).get(r);l.onsuccess=()=>a(!!l.result),l.onerror=()=>a(!1)})}catch{return!1}}async function Yc(e,t=null,i=null){try{const n=Wr(e,t,i),r=await Kc(n);if(!r||!("caches"in window))return null;const a=await caches.open(mn);if(r.mediaKind==="hls"){let s=r.playlistTemplate||"";for(const d of r.resourceKeys||[]){const p=await a.match(zs(n,d));if(!p)throw new Error("İndirilen bölüm dosyası eksik.");const h=URL.createObjectURL(await p.blob());gn.push(h),s=s.replaceAll(`__CP_OFFLINE_RESOURCE_${d}__`,h)}const l=URL.createObjectURL(new Blob([s],{type:"application/vnd.apple.mpegurl"}));return gn.push(l),l}const o=await a.match(`/offline/${n}`);if(o){const s=URL.createObjectURL(await o.blob());return gn.push(s),s}return null}catch{return null}}function $m(){gn.forEach(e=>{try{URL.revokeObjectURL(e)}catch{}}),gn=[]}async function Mm(e,t=()=>{}){const{tmdbId:i,type:n,title:r,poster:a,backdrop:o,season:s,episode:l,streamUrl:d}=e;if(!d)throw new Error("İndirilecek medya bağlantısı bulunamadı.");if(!("caches"in window))throw new Error("Bu cihaz çevrimdışı depolamayı desteklemiyor.");const p=Wr(i,s,l),h=`/offline/${p}`,m=typeof d=="string"&&d.startsWith("/api/")?Di(d):d;t({percent:5,loaded:0,total:0,status:"Başlatılıyor..."});try{const b=await fetch(m,{cache:"no-store"});if(!b.ok)throw new Error(`İndirme başarısız (${b.status})`);const y=b.headers.get("content-type")||"";if(/mpegurl|vnd\.apple\.mpegurl/i.test(y)||/\.m3u8(?:[?#]|$)/i.test(d)){const T=await b.text();if(!T.includes("#EXTM3U"))throw new Error("Kaynak HLS bölüm akışı döndürmedi.");const I=await caches.open(mn),L=await ff(I,p,b,T,t),z=await ji(),O={key:p,tmdbId:String(i),type:n||"tv",title:r||"İsimsiz İçerik",poster:a||"",backdrop:o||"",season:s!==null?Number(s):null,episode:l!==null?Number(l):null,sizeBytes:L.sizeBytes,downloadedAt:Date.now(),mediaKind:"hls",playlistTemplate:L.playlistTemplate,resourceKeys:L.resourceKeys};return await new Promise((Y,j)=>{const D=z.transaction(rt,"readwrite").objectStore(rt).put(O);D.onsuccess=Y,D.onerror=()=>j(D.error)}),t({percent:100,loaded:L.sizeBytes,total:L.sizeBytes,status:"Tamamlandı"}),window.dispatchEvent(new CustomEvent("cinepulse_offline_changed",{detail:{action:"add",key:p}})),!0}const k=b.headers.get("content-length"),f=k?parseInt(k,10):0;let v=0,x;if(b.body&&f>0){const T=b.body.getReader(),I=[];for(;;){const{done:L,value:z}=await T.read();if(L)break;I.push(z),v+=z.length;const O=Math.min(99,Math.round(v/f*100));t({percent:O,loaded:v,total:f,status:`%${O} indiriliyor...`})}x=new Blob(I,{type:b.headers.get("content-type")||"video/mp4"})}else t({percent:50,loaded:0,total:0,status:"Veri alınıyor..."}),x=await b.blob();"caches"in window&&await(await caches.open(mn)).put(h,new Response(x,{headers:{"Content-Type":x.type||"video/mp4","Content-Length":String(x.size)}}));const A=await ji(),S={key:p,tmdbId:String(i),type:n||"movie",title:r||"İsimsiz İçerik",poster:a||"",backdrop:o||"",season:s!==null?Number(s):null,episode:l!==null?Number(l):null,sizeBytes:x.size,downloadedAt:Date.now(),mimeType:x.type||"video/mp4",mediaKind:"file"};return await new Promise((T,I)=>{const O=A.transaction(rt,"readwrite").objectStore(rt).put(S);O.onsuccess=()=>T(),O.onerror=()=>I(O.error)}),t({percent:100,loaded:x.size,total:x.size,status:"Tamamlandı"}),window.dispatchEvent(new CustomEvent("cinepulse_offline_changed",{detail:{action:"add",key:p}})),!0}catch(b){try{const y=await caches.open(mn),w=new URL(`/__cinepulse_offline__/${encodeURIComponent(p)}/`,location.origin).href;await Promise.all((await y.keys()).filter(k=>k.url.startsWith(w)).map(k=>y.delete(k)))}catch{}throw b}}async function as(e,t=null,i=null){try{const n=Wr(e,t,i),r=await ji(),a=await Kc(n);if(await new Promise((o,s)=>{const p=r.transaction(rt,"readwrite").objectStore(rt).delete(n);p.onsuccess=()=>o(),p.onerror=()=>s(p.error)}),"caches"in window){const o=await caches.open(mn);await o.delete(`/offline/${n}`);for(const s of a?.resourceKeys||[])await o.delete(zs(n,s))}return window.dispatchEvent(new CustomEvent("cinepulse_offline_changed",{detail:{action:"delete",key:n}})),!0}catch{return!1}}function cn(e){if(!e||e<=0)return"0 B";const t=1024,i=["B","KB","MB","GB","TB"],n=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,n)).toFixed(1))+" "+i[n]}function sl(e,t){const i=Ps(e);return`
  ...
  `}function mf(){const e=Ni();Be();const t=eo(),i=Vt(),n=Gt(),r=Qs(),a=Gn().length,o=sa().length;let s="continue";if(typeof window<"u"&&window.sessionStorage)try{const d=window.sessionStorage.getItem("cp_lib_active_tab");d&&["continue","completed","favorites","watchlist","all-episodes",...e?["downloads"]:[]].includes(d)&&(s=d)}catch{}return{html:`
  ...
  `,init:d=>{if(!d)return;let p=s,h="all",m="recent",b="";const y=d.querySelector("#lib-search-input"),w=d.querySelector("#lib-search-clear"),k=d.querySelector("#lib-sort-select"),f=d.querySelector("#lib-batch-clear-btn");let v=[];const x=async()=>{try{v=(await Wc()).map(J=>({id:J.tmdbId,title:J.title,poster_path:J.poster,backdrop_path:J.backdrop,type:J.type,isSeries:J.type==="tv"||J.season!==null&&J.episode!==null,season:J.season??null,episode:J.episode??null,sizeBytes:J.sizeBytes,mediaKind:J.mediaKind||"file",isDownloaded:!0,key:J.key}));const ae=d.querySelector("#tab-count-downloads");ae&&(ae.textContent=v.length),p==="downloads"&&I()}catch{}};e&&x();const A=N=>N==="continue"?Gn():N==="completed"?sa():N==="favorites"?Vt():N==="watchlist"?Gt():N==="all-episodes"?eo():N==="downloads"?v:[],S=N=>N==="downloads"?`
          ...
          `;let T=36;const I=()=>{const N=d.querySelector(`#tab-${p}`);if(!N)return;let J=A(p).filter(K=>{const ne=(K.title||K.name||"").toLowerCase(),de=Ps(K);return(!b||ne.includes(b.toLowerCase()))&&(h==="all"||de===h)});if(m==="rating-desc"?J.sort((K,ne)=>{const de=parseFloat(K.vote_average||K.voteAverage||K.rating||0);return parseFloat(ne.vote_average||ne.voteAverage||ne.rating||0)-de}):m==="title-asc"?J.sort((K,ne)=>{const de=K.title||K.name||"",G=ne.title||ne.name||"";return de.localeCompare(G,"tr")}):m==="year-desc"&&J.sort((K,ne)=>{const de=parseInt((K.release_date||K.first_air_date||K.year||"0").substring(0,4),10);return parseInt((ne.release_date||ne.first_air_date||ne.year||"0").substring(0,4),10)-de}),J.length===0)N.innerHTML=S(p);else if(p==="downloads")N.innerHTML=`
            <div class="offline-download-list">
              ${J.map(K=>`
                <article class="offline-download-card" data-offline-id="${K.id}" data-season="${K.season??""}" data-episode="${K.episode??""}">
                  ...
                  <div class="offline-download-info"><strong>${K.title}</strong><span>${K.isSeries?`S${K.season} · B${K.episode}`:"Film"} · ${cn(K.sizeBytes)}</span><small>Bu cihaza kaydedildi · İnternetsiz izlenebilir</small></div>
            ...
            </div>`,N.querySelectorAll(".offline-play-btn").forEach(K=>{K.addEventListener("click",async()=>{const ne=K.closest(".offline-download-card"),de=ne?.dataset.offlineId,G=ne?.dataset.season?Number(ne.dataset.season):null,$=ne?.dataset.episode?Number(ne.dataset.episode):null,M=v.find(H=>String(H.id)===String(de)&&H.season===G&&H.episode===$);if(M){K.disabled=!0;try{const H=await Yc(de,G,$);if(!H)throw new Error("İndirilen video dosyası bulunamadı.");Qt({type:M.type==="movie"?"movie":"tv",tmdbId:de,title:M.title,seriesTitle:M.title,season:G||1,episode:$||1,posterPath:M.poster_path||"",backdropPath:M.backdrop_path||"",offlinePlaybackUrl:H,offlineMediaKind:M.mediaKind})}catch(H){Z(H?.message||"İndirilen içerik açılamadı.","error")}finally{K.disabled=!1}}})}),N.querySelectorAll(".offline-download-card .btn-lib-delete").forEach(K=>{K.addEventListener("click",async()=>{const ne=K.closest(".offline-download-card"),de=ne?.dataset.offlineId,G=ne?.dataset.season?Number(ne.dataset.season):null,$=ne?.dataset.episode?Number(ne.dataset.episode):null;if(!de||!window.confirm("Bu indirilen içerik cihazdan silinsin mi?"))return;await as(de,G,$),v=v.filter(H=>!(String(H.id)===String(de)&&H.season===G&&H.episode===$));const M=d.querySelector("#tab-count-downloads");M&&(M.textContent=String(v.length)),I(),Z("İndirilen içerik cihazdan silindi.","success")})});else{const K=J.slice(0,T),ne=J.length>T;N.innerHTML=`
      ...
      <section class="downloads-page" id="downloads-page">
        ...
        <div class="downloads-list" id="downloads-list"><div class="downloads-loading"><i data-lucide="loader-circle"></i><span>İndirilenler yükleniyor…</span></div></div>
          ...
          <article class="download-item" data-index="${l}">
            ...
            <div class="download-item-main"><h3>${s.title}</h3><p>${s.season!==null&&s.episode!==null?`Sezon ${s.season} · Bölüm ${s.episode}`:"Film"} <b>·</b> ${cn(s.sizeBytes)}</p><small>${new Date(s.downloadedAt||Date.now()).toLocaleDateString("tr-TR")} · İnternetsiz oynatılabilir</small></div>
  ...
  `,init:y=>{if(!y)return;const w=y.querySelector("#discover-type-tv"),k=y.querySelector("#discover-type-movie"),f=y.querySelector("#discover-type-anime"),v=y.querySelector("#discover-type-doc"),x=y.querySelector("#discover-platform-select"),A=y.querySelector("#discover-year-select"),S=y.querySelector("#discover-sort-select"),T=y.querySelector("#discover-rating-select"),I=y.querySelector("#discover-genre-bar"),L=y.querySelector("#discover-media-grid"),z=y.querySelector("#discover-sentinel"),O=z?z.querySelector(".spin-loader"):null;x&&x.addEventListener("change",()=>{a=x.value||null,Te.currentPlatform=a,B()}),A&&A.addEventListener("change",()=>{o=A.value||"all",Te.currentYearRange=o,B()});const Y=()=>{const re=p();I.innerHTML=re.map(N=>`
        ...
        `,O&&(O.style.display="none"),D(re)};Y(),h||D();let W=null;z&&"IntersectionObserver"in window&&(W=new IntersectionObserver(re=>{re[0].isIntersecting&&D()},{rootMargin:"0px 0px 600px 0px"}),W.observe(z));const ie=()=>{if(s||Te.isExhausted)return;const re=window.scrollY||document.documentElement.scrollTop||document.body.scrollTop||0,N=window.innerHeight,ae=Math.max(document.body.scrollHeight,document.documentElement.scrollHeight);re+N>=ae-700&&D()};window.addEventListener("scroll",ie,{passive:!0}),window.__discoverCleanup=()=>{W?.disconnect(),window.removeEventListener("scroll",ie)};const te=re=>{t!==re&&(t=re,i=null,[w,k,f,v].forEach(N=>N?.classList.remove("active")),re==="tv"&&w?.classList.add("active"),re==="movie"&&k?.classList.add("active"),re==="anime"&&f?.classList.add("active"),re==="documentary"&&v?.classList.add("active"),Y(),B())};w&&w.addEventListener("click",()=>te("tv")),k&&k.addEventListener("click",()=>te("movie")),f&&f.addEventListener("click",()=>te("anime")),v&&v.addEventListener("click",()=>te("documentary")),S&&S.addEventListener("change",re=>{n=re.target.value,B()}),T&&T.addEventListener("change",re=>{r=parseFloat(re.target.value),B()})}}}const Ii={};function vf(e){const i=Ct()?`${e}_kids`:e;return(!Ii[i]||Ii[i].stale)&&(Ii[i]={allItems:[],seenIds:new Set,nextPage:1,isExhausted:!1,stale:!1}),Ii[i]}function bf(e){if(Ct())switch(e){case"movie":return qa;case"anime":return Fa;case"documentary":return Yd;case"cartoon":return Na;default:return Na}switch(e){case"movie":return pr;case"anime":return hr;case"documentary":return fr;case"cartoon":return dr;default:return ur}}async function tn(e="tv"){const t=Ct(),i=t?`${e}_kids`:e;Ii[i]&&(Ii[i].stale=!0);const n=vf(e),r=t?{tv:["Türkiye’de Popüler Çizgi ve Gençlik Dizileri","monitor-play"],movie:["🎈 Animasyon & Çocuk Filmleri","popcorn"],anime:["Türkiye’de Popüler Çocuk ve Genç Animeleri","cat"],documentary:["🐾 Doğa & Hayvan Belgeselleri","globe"]}:{tv:["Tüm Zamanların En Popüler Dizileri","monitor-play"],cartoon:["Çizgi Dizi Dünyası & Unutulmaz Klasikler","wand-2"],movie:["Tüm Zamanların En Popüler Filmleri","popcorn"],anime:["Türkiye’de En Popüler Animeler","cat"],documentary:["Tüm Zamanların En Çok İzlenen Belgeselleri","globe"]},[a,o]=r[e]||r.tv;return{html:`
  ...
  `,init:d=>{if(!d)return;const p=d.querySelector("#popular-media-grid"),h=d.querySelector("#popular-sentinel");if(!p)return;mt(p);let m=!1;const b=bf(e),y=()=>{h&&(n.isExhausted?h.innerHTML='<p style="color: var(--text-muted); font-size: 0.9rem;">Tüm popüler içerikler listelendi.</p>':h.innerHTML=`
...
${a}`,s=await Pf(Ef,o);return{"user-agent":"okhttp/4.12.0","X-Timestamp":n,"X-Nonce":r,"X-Signature":s,"X-App-Version":"110","X-Client-Id":"rectv-android"}}let Un=null;async function Bf(){if(Un)return Un;const e=atob(Cf),t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return Un=await crypto.subtle.importKey("pkcs8",t,{name:"RSASSA-PKCS1-v1_5",hash:"SHA-256"},!1,["sign"]),Un}let xi=null,jn=0;const Df=typeof window>"u";function ls(e){return Df?`https://a.prectv70.lol/api${e}`:`/api/rtv${e}`}let ll=0;async function zf(){const e=Math.floor(Date.now()/1e3);if(xi&&jn>e+120)return xi;if(typeof localStorage<"u"){const t=localStorage.getItem("rectv_jwt_token"),i=parseInt(localStorage.getItem("rectv_jwt_exp")||"0",10);if(t&&i>e+120)return xi=t,jn=i,t}if(Date.now()-ll<3e5)return null;try{const i={...await os("GET","/api/attest/nonce",""),"x-rtv-path":"/attest/nonce"},n=await fetch(ls("/attest/nonce"),{method:"GET",headers:i});if(!n.ok)throw new Error(`Nonce request failed with status ${n.status}`);const a=(await n.json()).nonce;if(!a)throw new Error("Empty nonce returned");const o=Rf(a),s=await Bf(),l=await crypto.subtle.sign("RSASSA-PKCS1-v1_5",s,o),d=If(new Uint8Array(l)),p="/api/attest/verify",h=JSON.stringify({certChain:[Lf],nonce:a,pkg:"com.rectv.shot",proof:d,sig:Af}),m={...await os("POST",p,h),"x-rtv-path":"/attest/verify","Content-Type":"application/json"},b=await fetch(ls("/attest/verify"),{method:"POST",headers:m,body:h});if(!b.ok)throw new Error(`Verify attestation failed with status ${b.status}`);const y=await b.json();if(!y.jwt)throw new Error("Verify did not return JWT");if(xi=y.jwt,jn=y.exp||e+7200,typeof localStorage<"u")try{localStorage.setItem("rectv_jwt_token",xi),localStorage.setItem("rectv_jwt_exp",jn.toString())}catch{}return xi}catch{return ll=Date.now(),null}}let Kn=null;async function Of(){if(Kn)return Kn;const e=$f(Tf);return Kn=await crypto.subtle.importKey("raw",e,{name:"AES-GCM"},!1,["decrypt"]),Kn}async function cs(e){if(!e)return"";if(e.startsWith("http://")||e.startsWith("https://"))return e;try{const t=atob(e),i=new Uint8Array(t.length);for(let l=0;l<t.length;l++)i[l]=t.charCodeAt(l);const n=i.slice(0,12),r=i.slice(12),a=await Of(),o=await crypto.subtle.decrypt({name:"AES-GCM",iv:n,tagLength:128},a,r);return new TextDecoder("utf-8").decode(o)}catch{return""}}async function di(e,t="GET",i=""){let n=null;try{n=await zf()}catch{}const r=`/api${e}`,o={...await os(t,r,i),"x-rtv-path":e,...n?{Authorization:`Bearer ${n}`}:{},...i?{"Content-Type":"application/json"}:{}};try{const s=await fetch(ls(e),{method:t,headers:o,signal:AbortSignal.timeout(6e3),...i?{body:i}:{}});if(s.ok)return await s.json()}catch{}return null}async function Dm({type:e="movie",title:t="",originalTitle:i="",season:n=1,episode:r=1,year:a=null}){const o=(t||i||"").trim();if(!o)return[];const s=parseInt(n,10)||1,l=parseInt(r,10)||1;try{let d=await di(`/search/${encodeURIComponent(o)}/${ci}/`);if((!d||!Array.isArray(d.posters)||d.posters.length===0)&&i&&i.toLowerCase()!==o.toLowerCase()&&(d=await di(`/search/${encodeURIComponent(i.trim())}/${ci}/`)),!d||!Array.isArray(d.posters)||d.posters.length===0)return[];const p=[o,i].filter(Boolean),h=e==="movie";let m=null;const b=w=>{if(!w)return!1;if(ss(w,p))return!0;const k=w.split(/\s*[-/:]\s*/).filter(Boolean);for(const f of k)if(ss(f,p))return!0;return!1};for(const w of d.posters)if((h?w.type==="movie":w.type==="serie")&&b(w.title||w.name||"")){m=w;break}if(!m)return[];const y=[];if(h){if(Array.isArray(m.sources))for(const w of m.sources){if(!w.enc_url&&!w.url)continue;const k=w.enc_url?await cs(w.enc_url):w.url;if(!k||!k.startsWith("http"))continue;const f=`/api/hls_proxy?url=${encodeURIComponent(k)}&ref=https://a.prectv70.lol/`,x=(w.title||"").toLowerCase().includes("dublaj")||(m.label||"").toLowerCase().includes("dublaj")?"🇹🇷 TVR VIP (TR Dublaj)":"⚡ TVR VIP (TR Altyazı)";y.push({id:`tvr_movie_${m.id}_${w.id}`,name:x,displayName:x,badge:"⚡ TVR VIP",source:"TVR VIP",url:f,streamUrl:f,rawStreamUrl:k,quality:"1080p HD",isHls:!0,isDirectVideo:!0,priority:0,getUrl:()=>f})}}else{const w=await di(`/season/by/serie/${m.id}/${ci}/`);if(Array.isArray(w))for(const k of w){const f=(k.title||k.name||"").toLowerCase(),v=f.match(/(\d+)/)||[];if((v[1]?parseInt(v[1],10):parseInt(k.number||k.season_number||k.num||"0",10)||1)!==s)continue;const A=f.includes("dublaj")||(k.label||"").toLowerCase().includes("dublaj");let S=Array.isArray(k.episodes)?k.episodes:null;if(!S||S.length===0){const T=await di(`/episode/by/season/${k.id}/${ci}/`);Array.isArray(T)?S=T:T&&Array.isArray(T.episodes)&&(S=T.episodes)}if(!(!Array.isArray(S)||S.length===0))for(const T of S){const L=(T.title||T.name||"").toLowerCase().match(/(\d+)/)||[];if((L[1]?parseInt(L[1],10):parseInt(T.number||T.episode_number||T.num||"0",10)||1)!==l)continue;let O=Array.isArray(T.sources)?T.sources:Array.isArray(T.videos)?T.videos:Array.isArray(T.streams)?T.streams:[];if(O.length===0&&T.id){const Y=await di(`/source/by/episode/${T.id}/${ci}/`);Array.isArray(Y)?O=Y:Y&&Array.isArray(Y.sources)&&(O=Y.sources)}for(const Y of O){const j=Y.enc_url||Y.encUrl||Y.encrypted_url,D=Y.url||Y.stream_url||Y.video||Y.link||Y.source;if(!j&&!D)continue;const B=j?await cs(j):D;if(!B||!B.startsWith("http"))continue;const W=`/api/hls_proxy?url=${encodeURIComponent(B)}&ref=https://a.prectv70.lol/`,te=A||(Y.title||Y.name||"").toLowerCase().includes("dublaj")?`🇹🇷 TVR S${s}E${l} (TR Dublaj)`:`⚡ TVR S${s}E${l} (TR Altyazı)`;y.push({id:`tvr_ep_${m.id}_${T.id||T.number}_${Y.id||B.slice(-8)}`,name:te,displayName:te,badge:"⚡ TVR VIP",source:"TVR VIP",url:W,streamUrl:W,rawStreamUrl:B,quality:"1080p HD",isHls:!0,isDirectVideo:!0,priority:0,getUrl:()=>W})}}}}return y}catch{return[]}}const Ia=[{id:"tvr_ch_dmax",tvrId:"dmax",isDaion:!0,name:"DMAX",category:"national",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/DMAX_Logo_2019.svg/200px-DMAX_Logo_2019.svg.png",quality:"HD Canlı",streamUrl:""},{id:"tvr_ch_tlc",tvrId:"tlc",isDaion:!0,name:"TLC",category:"national",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/TLC_Logo.svg/200px-TLC_Logo.svg.png",quality:"HD Canlı",streamUrl:""}];async function Nf(){try{const e=await di(`/channel/by/filtres/0/0/0/${ci}/`);if(!Array.isArray(e))return[...Ia];const t=new Map([[1,"sports"],[2,"doc"],[3,"national"],[4,"news"],[5,"music"],[6,"national"],[7,"kids"],[8,"national"]]),i=new Set,n=[];for(const r of e){const a=String(r.id||"").trim();if(!a||i.has(a)||String(r.playas||"1")==="0")continue;i.add(a);const o=Number(r.categories?.[0]?.id||0);n.push({id:`tvr_ch_${a}`,tvrId:a,isTvr:!0,name:r.title||r.name||`TVR ${a}`,category:t.get(o)||"national",logo:r.image||r.poster||"",quality:"1080p TVR",streamUrl:""})}for(const r of Ia)n.some(o=>{const s=(o.name||"").toLowerCase();return s===r.name.toLowerCase()||s.includes(r.tvrId)})||n.push(r);return n}catch{return[...Ia]}}const nn=new Map,Wn=new Map,cl=2*60*1e3;async function Yn(e,{forceRefresh:t=!1}={}){if(!e)return null;const i=String(e).replace(/^tvr_ch_/,"");if(i==="dmax"||i==="tlc"||i==="81"||i==="83"){const a=i==="81"||i==="dmax"?"dmax":"tlc",o=`daion_${a}`,s=nn.get(o);if(!t&&s&&s.expiresAt>Date.now())return s.url;try{const l=await fetch(`/api/live_tv_stream?channel=${a}&json=1`);if(l.ok){const d=await l.json(),p=d?.proxiedUrl||d?.url||d?.raw;if(p)return nn.set(o,{url:p,expiresAt:Date.now()+cl}),p}}catch{}if(i!=="81"&&i!=="83")return`/api/live_tv_stream?channel=${a}`}const n=nn.get(i);if(!t&&n&&n.expiresAt>Date.now())return n.url;if(Wn.has(i))return Wn.get(i);t&&nn.delete(i);const r=(async()=>{try{const a=await di(`/channel/by/${i}/${ci}/`);if(!a||!Array.isArray(a.sources))return null;const o=a.sources.find(d=>!d.locked&&(d.enc_url||d.url));if(!o)return null;const s=o.enc_url?await cs(o.enc_url):o.url;if(!s||!s.startsWith("http"))return null;const l=`/api/hls_proxy?url=${encodeURIComponent(s)}&ref=https://a.prectv70.lol/`;return nn.set(i,{url:l,expiresAt:Date.now()+cl}),l}catch{return null}})();Wn.set(i,r);try{return await r}finally{Wn.delete(i)}}const Ar="cinepulse_epg_live_cache",Gc=30*60*1e3;let _t=null,dl=0,Ra=!1,yn=null;const Hf={ch_cnbce:[{start:"07:00",end:"10:00",title:"Sabah Piyasaları & Finans"},{start:"10:00",end:"14:00",title:"Piyasa Ekranı & Global Trendler"},{start:"14:00",end:"18:00",title:"Kapanışa Doğru"},{start:"18:00",end:"20:00",title:"The Simpsons"},{start:"20:00",end:"21:00",title:"Mad Men"},{start:"21:00",end:"23:00",title:"Game of Thrones Kuşağı"},{start:"23:00",end:"01:00",title:"Late Night Show"},{start:"01:00",end:"07:00",title:"Gece Finans & Belgesel"}],tvr_ch_141:[{start:"08:00",end:"11:00",title:"İtalya Serie A Goller"},{start:"11:00",end:"14:00",title:"EuroLeague Özel Kuşağı"},{start:"14:00",end:"17:00",title:"La Liga Günlüğü & Özetler"},{start:"17:00",end:"20:00",title:"Maç Önü & Canlı Stüdyo"},{start:"20:00",end:"23:00",title:"Canlı Futbol / Basketbol Karşılaşması"},{start:"23:00",end:"02:00",title:"Günün Analizi & Tartışma"},{start:"02:00",end:"08:00",title:"Premier Maç Tekrarları"}],tvr_ch_140:[{start:"08:00",end:"12:00",title:"Formula 1 Özel Kuşağı"},{start:"12:00",end:"15:00",title:"NBA Action & En İyi Hareketler"},{start:"15:00",end:"19:00",title:"Uluslararası Voleybol Ligi"},{start:"19:00",end:"22:00",title:"Canlı Basketbol / Tenis Karşılaşması"},{start:"22:00",end:"01:00",title:"Motorsporları Kuşağı"},{start:"01:00",end:"08:00",title:"Gecenin Tekrarları"}]},ul={sports:[{start:"06:00",end:"09:00",title:"Spor Bülteni & Günün Manşetleri"},{start:"09:00",end:"12:00",title:"Maç Özetleri & Goller Kuşağı"},{start:"12:00",end:"14:00",title:"Öğle Sporu & Transfer Raporu"},{start:"14:00",end:"17:00",title:"Uluslararası Ligler & Analiz"},{start:"17:00",end:"19:00",title:"Maç Önü & Stüdyo Analizi"},{start:"19:00",end:"21:30",title:"Canlı Karşılaşma / Canlı Yayın"},{start:"21:30",end:"23:45",title:"Dev Maç Özel Yayını"},{start:"23:45",end:"02:00",title:"Son Sayfa & Tartışma Programı"},{start:"02:00",end:"06:00",title:"Gecenin Maçları (Tekrar)"}],news:[{start:"06:00",end:"09:00",title:"Güne Başlarken & Sabah Raporu"},{start:"09:00",end:"12:00",title:"Ekonomi ve Politika Gündemi"},{start:"12:00",end:"14:00",title:"Gün Ortası Bülteni"},{start:"14:00",end:"17:00",title:"Sıcak Gelişmeler & Canlı Bağlantılar"},{start:"17:00",end:"19:00",title:"Akşam Bülteni & Manşetler"},{start:"19:00",end:"20:30",title:"Ana Haber Bülteni"},{start:"20:30",end:"23:30",title:"Türkiye'nin Nabzı & Açık Oturum"},{start:"23:30",end:"01:30",title:"Gece Raporu & Dünya Basını"},{start:"01:30",end:"06:00",title:"Gece Bülteni"}],doc:[{start:"06:00",end:"09:00",title:"Vahşi Yaşamın İzinde"},{start:"09:00",end:"12:00",title:"Evrenin Gizemleri ve Uzay"},{start:"12:00",end:"15:00",title:"Mega Yapılar & Mühendislik"},{start:"15:00",end:"18:00",title:"Tarihin Bilinmeyen Sayfaları"},{start:"18:00",end:"20:00",title:"Okyanusların Derinlikleri"},{start:"20:00",end:"22:00",title:"Büyük Kediler: Hayatta Kalma"},{start:"22:00",end:"00:30",title:"Dünyanın En Gizemli Keşifleri"},{start:"00:30",end:"06:00",title:"Gece Belgesel Kuşağı"}],kids:[{start:"06:00",end:"09:00",title:"Sabah Neşesi Çizgi Filmler"},{start:"09:00",end:"12:00",title:"Eğlenceli Maceralar & Kahramanlar"},{start:"12:00",end:"15:00",title:"Sevimli Dostlar & Bilim Zamanı"},{start:"15:00",end:"18:00",title:"Süper Kahramanlar Kuşağı"},{start:"18:00",end:"20:30",title:"Akşam Aile Sineması"},{start:"20:30",end:"22:30",title:"Fantastik Çizgi Dizi"},{start:"22:30",end:"06:00",title:"Gece Masalları"}],music:[{start:"06:00",end:"10:00",title:"Güne Enerjik Başla (Top 20 Pop)"},{start:"10:00",end:"14:00",title:"Hit Müzik & Radyo Şarkıları"},{start:"14:00",end:"18:00",title:"Trendler & En Çok Dinlenenler"},{start:"18:00",end:"21:00",title:"Akşam Ritimleri & Klip Kuşağı"},{start:"21:00",end:"23:30",title:"Canlı Akustik & Popüler Klipler"},{start:"23:30",end:"02:00",title:"Gece Chill & Deep House"},{start:"02:00",end:"06:00",title:"Kesintisiz Gece Müziği"}],national:[{start:"06:00",end:"09:00",title:"Sabah Programı & Magazin"},{start:"09:00",end:"12:00",title:"Gündüz Kuşağı Programı"},{start:"12:00",end:"14:00",title:"Gün Ortası & Yemek Programı"},{start:"14:00",end:"17:00",title:"Popüler Dizi Tekrar Kuşağı"},{start:"17:00",end:"19:00",title:"Yarışma Kuşağı"},{start:"19:00",end:"20:00",title:"Akşam Ana Haber"},{start:"20:00",end:"23:30",title:"Prime Time Sinema / Dizi"},{start:"23:30",end:"02:00",title:"Gece Sineması"},{start:"02:00",end:"06:00",title:"Gece Kuşağı"}]};function pl(e){if(!e||!e.includes(":"))return 0;const[t,i]=e.split(":").map(Number);return(t||0)*60+(i||0)}function qf(){try{const e=(typeof window<"u"&&window.sessionStorage?sessionStorage.getItem(Ar):null)||(typeof window<"u"&&window.localStorage?localStorage.getItem(Ar):null);if(!e)return null;const t=JSON.parse(e);if(t&&t.channels&&Date.now()-(t.updatedAt||0)<12*3600*1e3)return t.channels}catch{}return null}function Ff(e){try{typeof window<"u"&&window.sessionStorage&&sessionStorage.setItem(Ar,JSON.stringify({updatedAt:Date.now(),channels:e})),typeof window<"u"&&window.localStorage&&localStorage.removeItem(Ar)}catch{}}async function hl(e=!1){const t=Date.now();if(!e&&_t&&t-dl<Gc||Ra)return _t;Ra=!0;try{let i=null;try{i=await fetch("/api/epg")}catch{}if((!i||!i.ok)&&(i=await fetch("/epg-data.json")),i&&i.ok){const n=await i.json();n&&n.channels&&Object.keys(n.channels).length>0&&(_t=n.channels,dl=t,Ff(n.channels),window.dispatchEvent(new CustomEvent("epg-updated",{detail:{count:Object.keys(n.channels).length}})))}}catch{}finally{Ra=!1}return _t}function Uf(){if(!_t){const e=qf();e&&(_t=e)}hl(),yn===null&&(yn=setInterval(()=>{hl(!0)},Gc))}function jf(){yn!==null&&(clearInterval(yn),yn=null)}function Vn(e){if(!e)return{title:"Canlı Yayın",timeRange:"Canlı Akış",start:"00:00",end:"23:59",progress:50,remainingMin:30,nextTitle:"Yayın Akışı"};const t=Date.now();if(_t&&_t[e.id]&&_t[e.id].length>0){const a=_t[e.id];for(let s=0;s<a.length;s++){const l=a[s];if(t>=l.startTs&&t<l.endTs){const d=Math.max(1,(l.endTs-l.startTs)/6e4),p=Math.max(0,(t-l.startTs)/6e4),h=Math.min(100,Math.max(0,Math.round(p/d*100))),m=Math.max(1,Math.round((l.endTs-t)/6e4)),b=a[s+1];return{title:l.title,timeRange:`${l.start} - ${l.end}`,start:l.start,end:l.end,progress:h,remainingMin:m,nextTitle:b?b.title:"Sonraki Program"}}}const o=a.find(s=>s.startTs>t);if(o)return{title:o.title,timeRange:`${o.start} - ${o.end}`,start:o.start,end:o.end,progress:5,remainingMin:Math.max(1,Math.round((o.endTs-t)/6e4)),nextTitle:"Yayın Başlamak Üzere"}}const i=new Date,n=i.getHours()*60+i.getMinutes();let r=Hf[e.id];r||(r=ul[e.category]||ul.national);for(let a=0;a<r.length;a++){const o=r[a],s=pl(o.start);let l=pl(o.end);l<=s&&(l+=24*60);let d=n;if(s>l-24*60&&n<s&&n<l%(24*60)&&(d+=24*60),d>=s&&d<l){const p=l-s,h=d-s,m=Math.min(100,Math.max(0,Math.round(h/p*100))),b=Math.max(1,l-d),y=r[(a+1)%r.length];return{title:o.title,timeRange:`${o.start} - ${o.end}`,start:o.start,end:o.end,progress:m,remainingMin:b,nextTitle:y?y.title:"Sonraki Program"}}}return{title:`${e.name} Canlı Yayın`,timeRange:"Canlı Akış",start:"00:00",end:"23:59",progress:50,remainingMin:30,nextTitle:"Yayın Akışı Devam Ediyor"}}const Jc="cinepulse_live_favs";function fl(){try{const e=localStorage.getItem(Jc);return e?JSON.parse(e):[]}catch{return[]}}function Kf(e){try{localStorage.setItem(Jc,JSON.stringify(e))}catch{}}function Wf(){const e=Ct(),t=v=>String(v||"").toLocaleUpperCase("tr-TR").replace(/\b(?:HD|FHD|4K|KANALI)\b/g,"").replace(/[^A-ZÇĞİÖŞÜ0-9]/g,""),i=[...La],n=e?i.filter(v=>v.category==="kids"):i;let r=e?"kids":"all",a=e?n.find(v=>v.id==="ch_trtcocuk")||n[0]:i.find(v=>v.id==="ch_trt1")||i[0],o="",s=null,l=!1,d=1,p=null,h=null;function m(v){return fl().includes(v)}function b(v){let x=fl();x.includes(v)?(x=x.filter(A=>A!==v),Z("Favorilerden çıkarıldı","info")):(x.push(v),Z("Favorilere eklendi ⭐","success")),Kf(x),k()}function y(){return n.filter(v=>{let x=!0;r==="favorites"?x=m(v.id):r!=="all"&&(x=v.category===r);const A=!o||v.name.toLowerCase().includes(o.toLowerCase());return x&&A})}function w(v){return n.findIndex(x=>x.id===v.id)}let k=()=>{};return{html:`
  ...
  `,init:v=>{if(!v)return;Uf();const x=wf(),{setTimeout:A,clearTimeout:S,setInterval:T,clearInterval:I}=x,L=v.querySelector("#tv-video"),z=v.querySelector("#tv-screen"),O=v.querySelector("#tv-hero-player-section"),Y=v.querySelector("#tv-screen-placeholder"),j=v.querySelector("#tv-screen-backdrop");v.querySelector("#tv-osd-topbar");const D=v.querySelector("#tv-top-logo"),B=v.querySelector("#tv-top-name"),W=v.querySelector("#tv-top-num"),ie=v.querySelector("#tv-top-epg-title"),te=v.querySelector("#tv-top-epg-prog");v.querySelector("#tv-pip-header");const re=v.querySelector("#tv-pip-logo"),N=v.querySelector("#tv-pip-name"),ae=v.querySelector("#tv-pip-epg"),J=v.querySelector("#tv-pip-expand"),K=v.querySelector("#tv-pip-close"),ne=v.querySelector("#tv-osd"),de=v.querySelector("#tv-osd-logo"),G=v.querySelector("#tv-osd-name"),$=v.querySelector("#tv-osd-quality"),M=v.querySelector("#tv-osd-chnum"),H=v.querySelector("#tv-osd-epg-sub"),Q=v.querySelector("#tv-loading"),se=v.querySelector("#tv-error"),E=v.querySelector("#tv-retry-btn"),C=v.querySelector("#tv-error-next-btn"),q=v.querySelector("#tv-btn-play-pause"),ee=v.querySelector("#tv-btn-prev-ch"),ke=v.querySelector("#tv-btn-next-ch"),le=v.querySelector("#tv-btn-sync"),fe=v.querySelector("#tv-btn-mute"),Xe=v.querySelector("#tv-volume-slider"),Ze=v.querySelector("#tv-btn-reload"),Ue=v.querySelector("#tv-btn-fullscreen"),Re=v.querySelector("#tv-btn-quality"),De=v.querySelector("#tv-quality-badge"),Ne=v.querySelector("#tv-quality-menu"),We=v.querySelector("#tv-quality-options"),je=v.querySelector("#tv-btn-numpad"),oe=v.querySelector("#tv-numpad-modal"),g=v.querySelector("#tv-numpad-modal-backdrop"),c=v.querySelector("#tv-numpad-close"),u=v.querySelector("#tv-pad-display-val"),_=v.querySelector("#tv-pad-display-sub"),R=v.querySelector("#tv-numpad-hud"),P=v.querySelector("#tv-numpad-hud-digits"),F=v.querySelector("#tv-numpad-hud-name"),pe=v.querySelector("#tv-channel-grid"),Ie=v.querySelector("#tv-search"),xe=v.querySelector("#tv-search-clear"),ge=v.querySelector("#tv-category-strip"),Ee=v.querySelector("#tv-cat-prev"),Ns=v.querySelector("#tv-cat-next"),Hs=v.querySelector("#tv-guide-count");function Ln(){const U=w(a)+1,X=Vn(a);B&&(B.textContent=a.name),W&&(W.textContent=`CH ${String(U).padStart(2,"0")}`),ie&&(ie.textContent=`${X.title} (${X.timeRange})`),te&&(te.textContent=`%${X.progress}`),D&&(D.src=a.logo,D.onerror=()=>{D.onerror=null,D.src=kt(a.name,a.category)}),N&&(N.textContent=a.name),ae&&(ae.textContent=`${X.title} (%${X.progress})`),re&&(re.src=a.logo,re.onerror=()=>{re.onerror=null,re.src=kt(a.name,a.category)})}function qs(){Ln(),pe&&pe.querySelectorAll(".tv-grid-card").forEach(X=>{const ye=X.getAttribute("data-id"),be=i.find($e=>$e.id===ye);if(!be)return;const ce=Vn(be),ze=X.querySelector(".tv-epg-title"),Ae=X.querySelector(".tv-epg-time"),at=X.querySelector(".tv-epg-bar-fill"),he=X.querySelector(".tv-epg-pct");ze&&ze.textContent!==ce.title&&(ze.textContent=ce.title,ze.title=ce.title),Ae&&Ae.textContent!==ce.timeRange&&(Ae.textContent=ce.timeRange),at&&(at.style.width=`${ce.progress}%`),he&&he.textContent!==`%${ce.progress}`&&(he.textContent=`%${ce.progress}`)})}const Gr=()=>{qs()};x.on(window,"epg-updated",Gr);let Fs=T(()=>{if(!document.body.contains(v)){I(Fs),window.removeEventListener("epg-updated",Gr);return}qs()},2e4);function id(){h&&S(h);const U=w(a),X=Vn(a);de&&(de.src=a.logo,de.onerror=()=>{de.onerror=null,de.src=kt(a.name,a.category)}),G&&(G.textContent=a.name),$&&($.textContent=a.quality),M&&(M.textContent=String(U+1).padStart(2,"0")),H&&(H.textContent=`📺 ${X.title} • %${X.progress} tamamlandı`),ne.classList.remove("hidden"),ne.classList.add("tv-osd-show"),h=A(()=>{ne.classList.remove("tv-osd-show"),ne.classList.add("tv-osd-hide"),A(()=>{ne.classList.add("hidden"),ne.classList.remove("tv-osd-hide")},350)},2500)}function In(){z.classList.add("user-active"),p&&S(p),p=A(()=>{z.classList.remove("user-active"),Ne&&Ne.classList.add("hidden")},3500)}z.addEventListener("mousemove",In),z.addEventListener("touchstart",In,{passive:!0}),j&&(j.addEventListener("click",U=>{U.stopPropagation(),z.classList.contains("user-active")?(z.classList.remove("user-active"),p&&S(p),Ne&&Ne.classList.add("hidden")):In()}),j.addEventListener("dblclick",U=>{U.stopPropagation(),Ue&&Ue.click()}));function Vi(U){U=Math.max(0,Math.min(1,U)),d=U,L.volume=U,Xe&&(Xe.value=U),U===0?(l=!0,L.muted=!0,fe&&(fe.innerHTML='<i data-lucide="volume-x" style="width:18px;height:18px;color:#ef4444;"></i>')):(l=!1,L.muted=!1,fe&&(fe.innerHTML='<i data-lucide="volume-2" style="width:18px;height:18px;"></i>')),V()}Xe&&Xe.addEventListener("input",U=>{Vi(parseFloat(U.target.value))}),fe&&fe.addEventListener("click",U=>{U.stopPropagation(),l?(Vi(d||.8),Z("Ses açıldı","info")):(L.muted=!0,l=!0,fe.innerHTML='<i data-lucide="volume-x" style="width:18px;height:18px;color:#ef4444;"></i>',V(),Z("Sessize alındı","info"))}),q&&q.addEventListener("click",U=>{U.stopPropagation(),L.paused?(L.play(),q.innerHTML='<i data-lucide="pause" style="width:18px;height:18px;"></i>'):(L.pause(),q.innerHTML='<i data-lucide="play" style="width:18px;height:18px;"></i>'),V()}),le&&le.addEventListener("click",U=>{U.stopPropagation(),s&&L.seekable&&L.seekable.length>0?(L.currentTime=L.seekable.end(L.seekable.length-1),L.play(),Z("Canlı yayına eşitlendi","info")):ti(a)});function Jr(U){if(!We||!De)return;if(!U||!U.levels||U.levels.length<=1){De.textContent=a.quality?a.quality.split(" ")[0]:"HD",We.innerHTML=`
            <button class="tv-quality-opt active" data-level="-1">
        ...
        `;if(X.forEach((ce,ze)=>{const Ae=ce.height||(ce.attrs&&ce.attrs.RESOLUTION?ce.attrs.RESOLUTION.height:720),at=Ae>=1080?"1080p FHD":Ae>=720?"720p HD":Ae>=480?"480p SD":`${Ae}p`,he=ye===ze;be+=`
          ...
          `}),We.innerHTML=be,ye===-1)De.textContent="AUTO";else if(X[ye]){const ce=X[ye].height;De.textContent=ce?`${ce}p`:"HD"}We.querySelectorAll(".tv-quality-opt").forEach(ce=>{ce.addEventListener("click",ze=>{ze.stopPropagation();const Ae=parseInt(ce.dataset.level,10);if(s){s.currentLevel=Ae,Jr(s),Ne&&Ne.classList.add("hidden");const at=ce.querySelector("span").textContent;Z(`Kalite ayarlandı: ${at}`,"success")}})}),V()}Re&&Ne&&(Re.addEventListener("click",U=>{U.stopPropagation(),Ne.classList.toggle("hidden"),In()}),x.on(document,"click",U=>{U.target.closest("#tv-quality-wrapper")||Ne.classList.add("hidden")}));let Rn=!1;function Us(){if(!O||!Y||!z||document.fullscreenElement)return;const X=O.getBoundingClientRect().bottom<80;X&&L&&!L.paused&&!Rn?z.classList.contains("is-floating-pip")||(z.classList.add("is-floating-pip"),Y.classList.add("is-active"),Ln()):X||z.classList.contains("is-floating-pip")&&(z.classList.remove("is-floating-pip"),Y.classList.remove("is-active"),Rn=!1)}x.on(window,"scroll",Us,{passive:!0}),J&&J.addEventListener("click",U=>{U.stopPropagation(),O&&O.scrollIntoView({behavior:"smooth",block:"start"})}),K&&K.addEventListener("click",U=>{U.stopPropagation(),Rn=!0,z.classList.remove("is-floating-pip"),Y.classList.remove("is-active")});let He="",Xr=null;function Zr(U){if(U>=0&&U<i.length){const X=i[U];Z(`Kanal ${U+1}: ${X.name}`,"info"),ti(X),O&&O.scrollIntoView({behavior:"smooth",block:"start"})}else Z(`Kanal ${U+1} bulunamadı`,"warning");He="",R&&R.classList.add("hidden"),oe&&oe.classList.add("hidden")}function js(){if(!R||!P||!F)return;const U=parseInt(He,10),X=i[U-1];P.textContent=He.padStart(2,"0"),F.textContent=X?X.name:"Geçersiz Kanal",R.classList.remove("hidden"),u&&(u.textContent=He.padStart(2,"0")),_&&(_.textContent=X?X.name:"Geçersiz Kanal"),Xr&&S(Xr),Xr=A(()=>{He&&Zr(U-1)},1300)}je&&oe&&je.addEventListener("click",U=>{U.stopPropagation(),He="",u&&(u.textContent="--"),_&&(_.textContent="Numara tuşlayın"),oe.classList.toggle("hidden")}),c&&c.addEventListener("click",()=>{oe.classList.add("hidden"),He=""}),g&&g.addEventListener("click",()=>{oe.classList.add("hidden"),He=""}),oe&&oe.querySelectorAll(".tv-num-key").forEach(U=>{U.addEventListener("click",X=>{X.stopPropagation();const ye=U.dataset.digit;if(ye==="clear")He="",u&&(u.textContent="--"),_&&(_.textContent="Numara tuşlayın");else if(ye==="ok"){if(He){const be=parseInt(He,10);Zr(be-1)}}else He.length>=2&&(He=""),He+=ye,js()})});let Ye=0;async function ti(U){const X=++Ye;if(a=U,Rn=!1,Ln(),id(),rd(),s){try{s.stopLoad(),s.detachMedia(),s.destroy()}catch{}s=null}if(L)try{L.pause(),L.removeAttribute("src"),L.load()}catch{}Q.classList.remove("hidden"),se.classList.add("hidden");const ye=()=>{Ye===X&&(Q.classList.add("hidden"),se.classList.add("hidden"))};L.addEventListener("loadeddata",ye,{once:!0}),A(()=>{L.removeEventListener("loadeddata",ye),Ye===X&&L.readyState<2&&Ve()},2e4);let be=!1,ce=0,ze=0,Ae=!1,at=!1;async function he(we,Ce=!0){if(!U.officialLiveId||Ce&&ce>=2)return!1;Ce&&(ce+=1),be=!0,Q.classList.remove("hidden"),se.classList.add("hidden");try{const Ht=Di(`/api/live_tv_stream?channel=${encodeURIComponent(U.officialLiveId)}&json=1&refresh=1&_=${Date.now()}`),ni=await fetch(Ht,{cache:"no-store",headers:{Accept:"application/json"}});if(!ni.ok)throw new Error(`Live resolver ${ni.status}`);const ri=await ni.json(),Vs=ri?.proxiedUrl||ri?.url||"",$n=Vs?Di(Vs):"";if(!$n)throw new Error("Live stream URL missing");if(U.streamUrl=$n,$n!==we||Ce)return It($n),!0}catch{}return!1}async function $e(we){if(U.officialLiveId)return he(we);if(be||!U.isTvr||!U.tvrId)return!1;be=!0,Q.classList.remove("hidden"),se.classList.add("hidden");try{const Ce=await Yn(U.tvrId,{forceRefresh:!0});if(Ye!==X)return!0;if(Ce&&Ce!==we)return U.streamUrl=Ce,It(Ce),!0}catch{}return!1}function Ve(){Ye===X&&(Q.classList.add("hidden"),se.classList.remove("hidden"))}function wi(we){if(Ae||!/^https?:\/\//i.test(we))return!1;Ae=!0;const Ce=`${new URL(we).origin}/`,Ht=`/api/hls_proxy?url=${encodeURIComponent(we)}&ref=${encodeURIComponent(Ce)}`;return U.streamUrl=Ht,It(Ht),!0}function It(we){if(Ye===X)if(we=Di(we),ii.isSupported()){if(s){try{s.stopLoad(),s.detachMedia(),s.destroy()}catch{}s=null}const Ce=new ii({enableWorker:!0,lowLatencyMode:!0,startLevel:0,capLevelToPlayerSize:!0,backBufferLength:10,maxBufferLength:8,maxMaxBufferLength:15,liveSyncDurationCount:2,liveMaxLatencyDurationCount:5,manifestLoadingTimeOut:12e3,manifestLoadingMaxRetry:1,manifestLoadingRetryDelay:350,levelLoadingTimeOut:14e3,levelLoadingMaxRetry:1,fragLoadingTimeOut:12e3});s=Ce,Ce.loadSource(we),Ce.attachMedia(L),Ce.on(ii.Events.MANIFEST_PARSED,()=>{if(Ye!==X){try{Ce.stopLoad(),Ce.detachMedia(),Ce.destroy()}catch{}return}Jr(Ce),L.play().catch(()=>{})}),Ce.on(ii.Events.ERROR,(Ht,ni)=>{if(!(Ye!==X||s!==Ce)&&ni.fatal)if(ni.type===ii.ErrorTypes.NETWORK_ERROR)U.officialLiveId?he(we).then(ri=>{ri||Ve()}):U.isTvr&&U.tvrId?$e(we).then(ri=>{!ri&&!wi(we)&&Ve()}):ze<1?(ze+=1,Q.classList.remove("hidden"),A(()=>{Ye===X&&s===Ce&&It(we)},700)):wi(we)||Ve();else if(ni.type===ii.ErrorTypes.MEDIA_ERROR)if(at)Ve();else{at=!0;try{Ce.recoverMediaError()}catch{Ve()}}else Ve()})}else L.canPlayType("application/vnd.apple.mpegurl")?(L.src=we,L.addEventListener("loadedmetadata",()=>{Ye===X&&(Jr(null),L.play().catch(()=>{}))},{once:!0}),L.addEventListener("error",()=>{Ye===X&&$e(we).then(Ce=>{!Ce&&!wi(we)&&Ve()})},{once:!0})):Ve()}let ii;try{ii=(await _s(async()=>{const{default:we}=await import("./hls-BuERnqCp.js");return{default:we}},[],import.meta.url)).default}catch{Ve();return}Ye===X&&(U.officialLiveId?he("",!0).then(we=>{we||Ye!==X||he("",!0).then(Ce=>{!Ce&&Ye===X&&Ve()})}):U.isTvr&&U.tvrId&&!U.streamUrl?Yn(U.tvrId).then(we=>{Ye===X&&(we?(U.streamUrl=we,It(we)):Ve())}).catch(()=>{Ye===X&&Ve()}):(It(U.streamUrl),U.isTvr&&U.tvrId&&Yn(U.tvrId).then(we=>{we&&(U.streamUrl=we)}).catch(()=>{})),L.muted=l,L.volume=d)}function Gi(U){const X=y();if(X.length===0)return;const ye=X.findIndex(ce=>ce.id===a.id);let be;U==="prev"||U==="up"?be=ye<=0?X.length-1:ye-1:be=ye>=X.length-1?0:ye+1,ti(X[be])}ee&&ee.addEventListener("click",U=>{U.stopPropagation(),Gi("prev")}),ke&&ke.addEventListener("click",U=>{U.stopPropagation(),Gi("next")}),C&&C.addEventListener("click",()=>Gi("next")),E&&E.addEventListener("click",()=>ti(a)),Ze&&Ze.addEventListener("click",()=>{Z("Yayın yeniden yükleniyor...","info"),ti(a)});function nd(){const U=y();if(Hs&&(Hs.textContent=`${U.length} KANAL`),U.length===0){pe.innerHTML=`
          ...
          `,V();return}pe.innerHTML=U.map(X=>{const ye=X.id===a.id,be=m(X.id),ce=w(X)+1,ze=kt(X.name,X.category),Ae=Vn(X);return`
          ...
          `}).join(""),pe.querySelectorAll(".tv-grid-card").forEach(X=>{X.addEventListener("click",ye=>{if(ye.target.closest(".tv-grid-fav-btn"))return;const be=i.find(ce=>ce.id===X.dataset.id);be&&be.id!==a.id&&(ti(be),O&&O.scrollIntoView({behavior:"smooth",block:"start"}))})}),pe.querySelectorAll(".tv-grid-fav-btn").forEach(X=>{X.addEventListener("click",ye=>{ye.stopPropagation(),b(X.dataset.favid)})}),V()}function rd(){pe&&pe.querySelectorAll(".tv-grid-card").forEach(U=>{const X=U.dataset.id===a.id;U.classList.toggle("active",X);const ye=U.querySelector(".tv-grid-live-indicator");if(!X&&ye&&ye.remove(),X&&!ye){const be=document.createElement("div");be.className="tv-grid-live-indicator",be.innerHTML='<span class="tv-live-dot"></span><span>ŞU AN İZLENİYOR</span>',U.appendChild(be)}})}if(k=()=>{nd(),Ln(),V()},Ie&&Ie.addEventListener("input",U=>{o=U.target.value.trim(),xe&&xe.classList.toggle("hidden",!o),k()}),xe&&xe.addEventListener("click",()=>{Ie.value="",o="",xe.classList.add("hidden"),k()}),ge){Ee&&Ee.addEventListener("click",ce=>{ce.stopPropagation(),ge.scrollBy({left:-220,behavior:"smooth"})}),Ns&&Ns.addEventListener("click",ce=>{ce.stopPropagation(),ge.scrollBy({left:220,behavior:"smooth"})}),ge.addEventListener("wheel",ce=>{Math.abs(ce.deltaY)>Math.abs(ce.deltaX)&&(ce.preventDefault(),ge.scrollLeft+=ce.deltaY)},{passive:!1});let U=!1,X=0,ye=0,be=!1;ge.addEventListener("mousedown",ce=>{ce.button===0&&(U=!0,be=!1,X=ce.pageX-ge.offsetLeft,ye=ge.scrollLeft)}),x.on(window,"mousemove",ce=>{if(!U)return;const Ae=(ce.pageX-ge.offsetLeft-X)*1.5;Math.abs(Ae)>6&&(be=!0,ge.classList.add("is-dragging")),ge.scrollLeft=ye-Ae}),x.on(window,"mouseup",()=>{U&&(U=!1,ge.classList.remove("is-dragging"),A(()=>{be=!1},50))}),ge.querySelectorAll(".tv-cat-filter-btn").forEach(ce=>{ce.addEventListener("click",ze=>{if(be){ze.preventDefault();return}ge.querySelectorAll(".tv-cat-filter-btn").forEach(Ae=>Ae.classList.remove("active")),ce.classList.add("active"),r=ce.dataset.cat,ce.scrollIntoView({behavior:"smooth",inline:"center",block:"nearest"}),k()})})}Ue&&Ue.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen().catch(()=>{}):z.requestFullscreen().catch(()=>{})}),x.on(document,"fullscreenchange",()=>{const U=!!document.fullscreenElement;z.classList.toggle("is-fullscreen",U),Ue&&(Ue.innerHTML=U?'<i data-lucide="minimize-2" style="width:18px;height:18px;"></i>':'<i data-lucide="maximize-2" style="width:18px;height:18px;"></i>',V())});function Ks(U){if(document.activeElement!==Ie){if(U.key>="0"&&U.key<="9"){He.length>=2&&(He=""),He+=U.key,js();return}if(U.key==="Enter"&&He){U.preventDefault();const X=parseInt(He,10);Zr(X-1);return}switch(U.key){case"ArrowUp":case"w":case"W":U.preventDefault(),Gi("prev");break;case"ArrowDown":case"s":case"S":U.preventDefault(),Gi("next");break;case"ArrowRight":U.preventDefault(),Vi(d+.05);break;case"ArrowLeft":U.preventDefault(),Vi(d-.05);break;case"m":case"M":fe&&fe.click();break;case"f":case"F":Ue&&Ue.click();break;case"r":case"R":Ze&&Ze.click();break;case" ":U.preventDefault(),q&&q.click();break}}}x.on(document,"keydown",Ks);let Qr=null,ea=!1;const Ws=()=>{if(x.dispose(),jf(),Ye++,I(Fs),Qr&&I(Qr),window.removeEventListener("epg-updated",Gr),window.removeEventListener("scroll",Us),s){try{s.stopLoad(),s.detachMedia(),s.destroy()}catch{}s=null}if(L)try{L.pause(),L.removeAttribute("src"),L.load()}catch{}document.removeEventListener("keydown",Ks)};window.__LiveTvController={cleanup:Ws};const ta=new MutationObserver(()=>{document.contains(v)||(Ws(),ta.disconnect())});ta.observe(document.body,{childList:!0,subtree:!0}),x.add(()=>ta.disconnect()),k(),ti(a),Vi(1);const Ys=async()=>{if(!(ea||!document.contains(v))){ea=!0;try{const U=await Nf();if(!document.contains(v)||!Array.isArray(U))return;const X=new Set(La.map(he=>t(he.name))),ye=new Set(La.filter(he=>he.tvrId).map(he=>String(he.tvrId))),be=U.filter(he=>{const $e=t(he.name);return $e&&!X.has($e)&&!ye.has(String(he.tvrId))}),ce=await Promise.all(be.map(async he=>{const $e=await Yn(he.tvrId,{forceRefresh:!0});if(!$e)return null;const Ve=i.find(It=>It.isDynamicTvr&&String(It.tvrId)===String(he.tvrId)),wi={...he,isDynamicTvr:!0,streamUrl:$e,logo:he.logo||kt(he.name,he.category)};return Ve?(Object.assign(Ve,wi),Ve):wi}));if(!document.contains(v))return;const ze=ce.filter(Boolean),Ae=new Set(ze.map(he=>he.id));let at=!1;for(let he=i.length-1;he>=0;he--){const $e=i[he];$e.isDynamicTvr&&!Ae.has($e.id)&&$e.id!==a.id&&(i.splice(he,1),at=!0)}for(const he of ze)i.some($e=>$e.id===he.id)||(i.push(he),at=!0);if(e){for(let he=n.length-1;he>=0;he--){const $e=n[he];$e.isDynamicTvr&&!Ae.has($e.id)&&$e.id!==a.id&&n.splice(he,1)}for(const he of ze.filter($e=>$e.category==="kids"))n.some($e=>$e.id===he.id)||n.push(he)}at&&k()}catch{}finally{ea=!1}}};Ys(),Qr=T(Ys,30*1e3)}}}const Yf=3e4,Vf=10*6e4,Gf=5,Jf=6e4;let Yr=0,vn=!1,Cr=0,ar=0,Lr=0;function Xf(){Yr=Date.now()+Yf}function Zf(){return Xc()||Yr>Date.now()}function Xc(){return vn&&Cr<=Date.now()&&(vn=!1,Cr=0),vn}function Qf(){vn=!0,Cr=Date.now()+Vf,Yr=0,ar=0,Lr=0}function em(){vn=!1,Cr=0,Yr=0}function ds(){return Math.max(0,Math.ceil((Lr-Date.now())/1e3))}function tm(){return Lr>Date.now()||(ar+=1,ar>=Gf&&(ar=0,Lr=Date.now()+Jf)),ds()}async function im(){if(!Xc())return{html:`
    ...
    `,init:n=>{const r=n.querySelector("#admin-lock-btn");r&&r.addEventListener("click",()=>{em(),window.location.hash="#home"});const a=n.querySelector("#admin-save-site-settings");a&&a.addEventListener("click",()=>{const h=n.querySelector("#admin-setting-landscape")?.checked===!0,m=n.querySelector("#admin-setting-hover")?.checked===!0,b=n.querySelector("#admin-setting-trailers")?.checked===!0,y=n.querySelector("#admin-setting-autoplay-next")?.checked===!0,w=n.querySelector("#admin-setting-subtitles")?.checked===!0,k=n.querySelector("#admin-setting-resolution")?.value||"1080p";Il({cardLayout:h?"landscape":"portrait",hoverPreviewsEnabled:m,trailersEnabled:b,autoplayNext:y,subtitlesEnabled:w,preferredResolution:k}),document.documentElement.classList.toggle("cards-landscape",h),alert("Tüm profil kontrolleri uygulandı.")});const o=n.querySelector("#admin-add-block-form"),s=n.querySelector("#admin-block-input");o&&s&&o.addEventListener("submit",h=>{h.preventDefault();const m=s.value.trim();m&&(ud(m),fn(),window.location.reload())}),n.querySelectorAll(".admin-tag-del-btn").forEach(h=>{h.addEventListener("click",()=>{const m=h.getAttribute("data-entry");m&&(pd(m),fn(),window.location.reload())})});const l=n.querySelector("#admin-change-pin-form"),d=n.querySelector("#admin-new-pin");l&&d&&l.addEventListener("submit",h=>{h.preventDefault();const m=d.value.trim();m.length>=4&&(cd(m),alert("Yönetici PIN kodu başarıyla güncellendi!"),d.value="")});const p=n.querySelector("#admin-clear-cache-btn");p&&p.addEventListener("click",()=>{sessionStorage.clear(),fn(),alert("Sistem önbelleği başarıyla temizlendi."),window.location.reload()}),V(n)}}}const mi="https://dramadizilerim.com";function nm(e){return e?e.toLowerCase().trim().replace(/ğ/g,"g").replace(/ü/g,"u").replace(/ş/g,"s").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ç/g,"c").replace(/[^a-z0-9\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-"):""}function ml(e){return e?e.toLowerCase().replace(/ğ/g,"g").replace(/ü/g,"u").replace(/ş/g,"s").replace(/ı/g,"i").replace(/ö/g,"o").replace(/ç/g,"c").replace(/[^a-z0-9]/g,""):""}async function fi(e,t={}){const i=typeof window<"u";let n=e;if(i)if(e.startsWith("http"))try{const r=new URL(e);n=`/api/ddz${r.pathname}${r.search}`}catch{n=e}else n=`/api/ddz${e.startsWith("/")?"":"/"}${e}`;else n.startsWith("http")||(n=`${mi}${n.startsWith("/")?"":"/"}${n}`);try{const r=await fetch(n,{...t,headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",Referer:mi,...t.headers||{}},signal:AbortSignal.timeout(t.timeout||6e3)}).catch(()=>null);if(r&&r.ok)return r}catch{}return null}function xn(e){if(!e)return"";try{if(e.includes("image_proxy.php?url=")){const t=e.match(/url=([^&]+)/);if(t)return decodeURIComponent(t[1])}}catch{}return e}async function Zc(e){if(!e||typeof e!="string"||e.trim().length<2)return[];const t=e.trim(),i=`/search?q=${encodeURIComponent(t)}`,n=await fi(i);if(!n)return[];const r=await n.text().catch(()=>"");if(!r)return[];const a=[],o=/<a[^>]+href=["'](?:https:\/\/dramadizilerim\.com)?\/dizi\/([a-zA-Z0-9_-]+)["'][^>]*>([\s\S]*?)<\/a>/gi;let s;for(;(s=o.exec(r))!==null;){const l=s[1],d=s[2],p=d.match(/alt=["']([^"']+)["']/i)||d.match(/<h[2-6][^>]*>(.*?)<\/h[2-6]>/i),h=p?p[1].replace(/<[^>]+>/g,"").replace(/&#039;/g,"'").trim():l,m=d.match(/src=["']([^"']+)["']/i),b=m?xn(m[1].replace(/&amp;/g,"&")):"",y=h.toLowerCase().includes("dublaj");a.some(w=>w.slug===l)||a.push({title:h,slug:l,poster:b,isDubbed:y,url:`${mi}/dizi/${l}`})}return a}async function rm(){const e=await fi("/");if(!e)return[];const t=await e.text().catch(()=>"");if(!t)return[];const i=[],n=/<a[^>]+href=["'](?:https:\/\/dramadizilerim\.com)?\/dizi\/([a-zA-Z0-9_-]+)["'][^>]*>([\s\S]*?)<\/a>/gi;let r;for(;(r=n.exec(t))!==null;){const a=r[1],o=r[2],s=o.match(/src=["']([^"']+)["']/i),l=o.match(/alt=["']([^"']+)["']/i)||o.match(/<h[2-6][^>]*>(.*?)<\/h[2-6]>/i),d=l?l[1].replace(/<[^>]+>/g,"").replace(/&#039;/g,"'").trim():a,p=s?xn(s[1].replace(/&amp;/g,"&")):"",h=d.toLowerCase().includes("dublaj");i.some(m=>m.slug===a)||i.push({slug:a,title:d,poster:p,isDubbed:h,badge:h?"🇹🇷 DUBLAJ":"TR ALTYAZI",url:`${mi}/dizi/${a}`})}return i}async function $a({page:e=1,query:t=""}={}){if(t&&t.trim().length>=2)return Zc(t);const i=e>1?`/dizi?page=${e}`:"/dizi",n=await fi(i);if(!n)return[];const r=await n.text().catch(()=>"");if(!r)return[];const a=[],o=/<a[^>]+href=["'](?:https:\/\/dramadizilerim\.com)?\/dizi\/([a-zA-Z0-9_-]+)["'][^>]*>([\s\S]*?)<\/a>/gi;let s;for(;(s=o.exec(r))!==null;){const l=s[1],d=s[2],p=d.match(/src=["']([^"']+)["']/i),h=d.match(/alt=["']([^"']+)["']/i)||d.match(/<h[2-6][^>]*>(.*?)<\/h[2-6]>/i),m=h?h[1].replace(/<[^>]+>/g,"").replace(/&#039;/g,"'").trim():l,b=p?xn(p[1].replace(/&amp;/g,"&")):"",y=m.toLowerCase().includes("dublaj");a.some(w=>w.slug===l)||a.push({slug:l,title:m,poster:b,isDubbed:y,badge:y?"🇹🇷 DUBLAJ":"TR ALTYAZI",url:`${mi}/dizi/${l}`})}return a}async function am(e){if(!e)return null;const t=await fi(`/dizi/${e}`);if(!t)return null;const i=await t.text().catch(()=>"");if(!i)return null;const n=i.match(/<h1[^>]*>(.*?)<\/h1>/i),r=n?n[1].replace(/<[^>]+>/g,"").replace(/&#039;/g,"'").trim():e;let a="";const s=[...i.matchAll(/<p[^>]*>([\s\S]*?)<\/p>/gi)].map(b=>b[1].replace(/<[^>]+>/g,"").replace(/&#039;/g,"'").replace(/&quot;/g,'"').replace(/&amp;/g,"&").trim()).filter(b=>{if(b.length<25)return!1;const y=b.toLowerCase();return!(y.includes("çerez")||y.includes("cookie")||y.includes("reklam")||y.includes("tüm hakları")||y.includes("bildirim")||y.includes("yapay zeka")||y.includes("bize bildirin")||y.includes("aradığınız dizi"))});if(s.length>0&&(s.sort((b,y)=>y.length-b.length),a=s[0]),!a||a.length<25){const b=i.match(/<meta\s+(?:property=["']og:description["']|name=["']description["'])\s+content=["']([^"']+)["']/i)||i.match(/<meta\s+content=["']([^"']+)["']\s+(?:property=["']og:description["']|name=["']description["'])/i);if(b&&b[1]&&b[1].trim().length>15){const y=b[1].replace(/<[^>]+>/g,"").replace(/&#039;/g,"'").replace(/&quot;/g,'"').replace(/&amp;/g,"&").trim();y.toLowerCase().includes("aradığınız dizi")||(a=y)}}(!a||a.includes("Bu dizi için konu özeti henüz eklenmedi"))&&(a=`${r} - Tüm bölümleri yüksek kalitede, kesintisiz ve donmadan Türkçe dublaj ve altyazı seçenekleriyle CinePulse Kısa Dizi Evreni'nde izleyin.`);const l=i.match(/<div class=["'][^"']*poster[^"']*["'][^>]*>[\s\S]*?<img[^>]+src=["']([^"']+)["']/i)||i.match(/<img[^>]+class=["'][^"']*spotlight[^"']*["'][^>]+src=["']([^"']+)["']/i),d=l?xn(l[1].replace(/&amp;/g,"&")):"",p=/<a[^>]+href=["'](?:\/izle\/|https:\/\/dramadizilerim\.com\/izle\/)([a-zA-Z0-9_-]+)\?s=(\d+)&e=(\d+)["'][^>]*>([\s\S]*?)<\/a>/gi,h=[];let m;for(;(m=p.exec(i))!==null;){const b=parseInt(m[2],10)||1,y=parseInt(m[3],10)||1,w=m[4],k=w.match(/class=["']wp-enum["']>([^<]+)</i)||w.match(/alt=["']([^"']+)["']/i),f=k?k[1].trim():`Bölüm ${y}`,v=w.match(/src=["']([^"']+)["']/i),x=v?xn(v[1].replace(/&amp;/g,"&")):"";h.some(A=>A.season===b&&A.episode===y)||h.push({season:b,episode:y,title:f,thumb:x})}return h.sort((b,y)=>b.season-y.season||b.episode-y.episode),{slug:e,title:r,poster:d,description:a,isDubbed:r.toLowerCase().includes("dublaj"),totalEpisodes:h.length,episodes:h}}async function zm({titles:e=[],seriesTitle:t="",season:i=1,episode:n=1,isDub:r=!0}){const a=[...new Set([...e,t])].filter(A=>A&&typeof A=="string"&&A.trim().length>1);if(a.length===0)return[];const o=parseInt(i,10)||1,s=parseInt(n,10)||1;let l=null,d=null;for(const A of a){const S=nm(A),T=`/izle/${S}?s=${o}&e=${s}`,I=await fi(T,{method:"HEAD",timeout:3500});if(I&&I.ok){l=S;break}}if(!l)for(const A of a){const S=await Zc(A);if(S.length>0){for(const L of S)if(ss(L.title,a,.75)){l=L.slug,d=L;break}if(l)break;const T=ml(A),I=S.find(L=>{const z=ml(L.title);return z===T||z.includes(T)||T.includes(z)});if(I){l=I.slug,d=I;break}}}if(!l)return[];const p=`/izle/${l}?s=${o}&e=${s}`,h=await fi(p);if(!h)return[];const m=await h.text().catch(()=>"");if(!m)return[];const b=m.match(/(?:data-src|src)=["']([^"']*embed\.php[^"']*)["']/i);if(!b)return[];let y=b[1].replace(/&amp;/g,"&");y.startsWith("http")||(y=`${mi}${y.startsWith("/")?"":"/"}${y}`);const w=await fi(y,{headers:{Referer:`${mi}${p}`}});if(!w)return[];const k=await w.text().catch(()=>"");if(!k)return[];const f=[],v=k.match(/let\s+source\s*=\s*["']([^"']+)["']/);let x=v&&v[1].startsWith("http")?v[1]:null;if(!x){const A=k.match(/https?:\/\/[^"'\s\\]+\.(?:m3u8|mp4)[^"'\s\\]*/);A&&(x=A[0])}if(x){const A=x.includes(".m3u8")||x.includes("mpegurl"),I=(d?.title||l).toLowerCase().includes("dublaj")||r===!0?`🇹🇷 DDZ VIP S${o}E${s} (TR Dublaj)`:`⚡ DDZ VIP S${o}E${s} (TR Altyazı)`;f.push({id:`ddz_ep_${l}_${o}_${s}`,name:I,displayName:I,badge:"🎭 DDZ VIP",source:"DDZ VIP",url:x,streamUrl:x,rawStreamUrl:x,quality:"1080p HD",isHls:A,isDirectVideo:!0,priority:2,getUrl:()=>x})}return f}async function sm(e=null,t=""){let i=t?"search":"trending",n=t||"",r=1,a=[],o=null,s="";const l=[{id:"trending",label:"Trendler",icon:"flame",query:""},{id:"all",label:"Tüm Katalog",icon:"layers",query:""},{id:"dubbed",label:"Türkçe Dublaj",icon:"sparkles",query:"dublaj"},{id:"patron",label:"CEO & Patron",icon:"briefcase",query:"patron"},{id:"kurt",label:"Kurt & Alfa",icon:"moon",query:"kurt"},{id:"intikam",label:"İntikam & Aşk",icon:"heart-crack",query:"intikam"},{id:"milyarder",label:"Milyarder",icon:"crown",query:"milyarder"},{id:"evlilik",label:"Yasak Aşk & Evlilik",icon:"ring",query:"evlilik"}];return{html:`
  ...
  `,init:async p=>{const h=p.querySelector("#drama-view-root");if(!h)return;const m=h.querySelector("#drama-search-input"),b=h.querySelector("#btn-drama-search-clear");h.querySelector("#drama-search-feedback");const y=h.querySelectorAll(".drama-chip"),w=h.querySelector("#drama-section-title"),k=h.querySelector("#drama-counter-badge"),f=h.querySelector("#drama-cards-grid"),v=h.querySelector("#drama-load-more-wrap"),x=h.querySelector("#btn-drama-load-more"),A=h.querySelector("#drama-detail-modal"),S=h.querySelector("#drama-modal-dialog");let T=null;async function I(D=!1){D||(f.innerHTML=Array.from({length:12}).map(()=>`
            <div class="drama-card-skeleton">
              <div class="skeleton-poster"></div>
              <div class="skeleton-title"></div>
            </div>
          `).join(""),k.textContent="Yükleniyor...");try{let B=[];if(n&&n.trim().length>=2)B=await $a({query:n.trim()}),w.innerHTML=`
              <i data-lucide="search" style="width: 20px; height: 20px; color: #a855f7;"></i>
              <span>"${n}" İçin Arama Sonuçları</span>
            `,v.classList.add("hidden");else{const W=l.find(ie=>ie.id===i)||l[0];i==="trending"?(B=await rm(),w.innerHTML=`
                <i data-lucide="flame" style="width: 20px; height: 20px; color: #f43f5e;"></i>
                <span>Trend Kısa Diziler</span>
              `,v.classList.add("hidden")):i==="all"?(B=await $a({page:r}),w.innerHTML=`
                <i data-lucide="layers" style="width: 20px; height: 20px; color: #3b82f6;"></i>
                <span>Tüm Kısa Diziler Kataloğu (Sayfa ${r})</span>
              `,v.classList.toggle("hidden",B.length===0)):W.query&&(B=await $a({query:W.query}),w.innerHTML=`
                <i data-lucide="${W.icon}" style="width: 20px; height: 20px; color: #c084fc;"></i>
                <span>${W.label} Serileri</span>
              `,v.classList.add("hidden"))}D?a=[...a,...B]:a=B,L()}catch{f.innerHTML=`
          ...
          `,k.textContent="0 Dizi",V(f);return}k.textContent=`${a.length} Dizi`,f.innerHTML=a.map((D,B)=>{const W=D.isDubbed||D.title.toLowerCase().includes("dublaj"),ie=D.poster||"";return`
            <article class="drama-card" data-slug="${D.slug}" tabindex="0" role="button" aria-label="${D.title}">
              ...
              <div class="drama-card-info">
                <h3 class="drama-card-title" title="${D.title}">${D.title}</h3>
          ...
          `}).join(""),V(f),f.querySelectorAll(".drama-card").forEach(D=>{D.addEventListener("click",()=>{const B=D.getAttribute("data-slug");B&&z(B)}),D.addEventListener("keydown",B=>{if(B.key==="Enter"||B.key===" "){B.preventDefault();const W=D.getAttribute("data-slug");W&&z(W)}})})}async function z(D){if(D){o=null,A.classList.remove("hidden"),document.body.style.overflow="hidden",S.innerHTML=`
          <div class="drama-detail-loading">
            <div class="spin-loader"></div>
            <span>Dizi bilgileri ve bölümler yükleniyor...</span>
          </div>
        `,V(S);try{const B=await am(D);if(!B){S.innerHTML=`
              <div class="drama-empty-state">
            ...
            `,h.querySelector("#btn-close-drama-modal")?.addEventListener("click",Y),V(S);return}o=B,O()}catch{Y(),Z("Dizi detayları yüklenemedi.","error")}}}function O(){if(!o)return;const{slug:D,title:B,poster:W,description:ie,episodes:te=[],isDubbed:re}=o,N=te.length,ae=s?te.filter(K=>K.title.toLowerCase().includes(s)||String(K.episode).includes(s)):te;S.innerHTML=`
          ...
          <div class="drama-episodes-explorer">
            ...
            <div class="drama-episodes-grid" id="drama-episodes-grid">
              ${ae.map(K=>{const ne=bn(`ddz_${D}`,K.season,K.episode);return`
                  <button 
        ...
        `,V(S),S.querySelector("#btn-close-drama-modal")?.addEventListener("click",Y),S.querySelector("#btn-play-drama-start")?.addEventListener("click",()=>{te.length>0&&j(te[0].season,te[0].episode)}),S.querySelector("#btn-share-drama")?.addEventListener("click",()=>{const K=`${window.location.origin}${window.location.pathname}#dramas?slug=${D}`;navigator.clipboard?.writeText(K).then(()=>{Z("Dizi bağlantısı panoya kopyalandı!","success")}).catch(()=>{Z(`Bağlantı: ${K}`,"info")})});const J=S.querySelector("#drama-ep-filter-input");J&&J.addEventListener("input",K=>{s=K.target.value.toLowerCase().trim(),O(),S.querySelector("#drama-ep-filter-input")?.focus()}),S.querySelectorAll(".drama-ep-card").forEach(K=>{K.addEventListener("click",()=>{const ne=parseInt(K.getAttribute("data-season"),10)||1,de=parseInt(K.getAttribute("data-episode"),10)||1;j(ne,de)})})}function Y(){A.classList.add("hidden"),document.body.style.overflow="",o=null,s=""}A.addEventListener("click",D=>{D.target===A&&Y()});function j(D=1,B=1){if(!o)return;const{slug:W,title:ie,poster:te,description:re,episodes:N=[]}=o,ae=N.find(J=>J.season===D&&J.episode===B)?.thumb||"";Qt({type:"tv",tmdbId:`ddz_${W}`,title:`${ie} - B${B}`,seriesTitle:ie,season:D,episode:B,posterPath:te,backdropPath:te,playerVariant:"short-drama",seriesOverview:re||"",episodeArtworkPath:ae||te,shortDramaEpisodes:N,maxEpisodes:N.length,seasonsList:[{season_number:D,episode_count:N.length}]})}m?.addEventListener("input",D=>{const B=D.target.value;b.classList.toggle("hidden",!B),clearTimeout(T),T=setTimeout(()=>{n=B.trim(),r=1,i=n?"search":"trending",y.forEach(W=>W.classList.toggle("active",!n&&W.getAttribute("data-tab-id")==="trending")),I(!1)},350)}),m?.addEventListener("keydown",D=>{D.key==="Enter"&&(D.preventDefault(),clearTimeout(T),n=m.value.trim(),r=1,I(!1))}),b?.addEventListener("click",()=>{m.value="",b.classList.add("hidden"),n="",i="trending",y.forEach(D=>D.classList.toggle("active",D.getAttribute("data-tab-id")==="trending")),I(!1)}),y.forEach(D=>{D.addEventListener("click",()=>{const B=D.getAttribute("data-tab-id");i===B&&!n||(i=B,n="",m&&(m.value=""),b?.classList.add("hidden"),r=1,y.forEach(W=>W.classList.toggle("active",W===D)),I(!1))})}),x?.addEventListener("click",()=>{r++,I(!0)}),await I(!1),e&&z(e)}}}const Ma=[{id:"user-circle",icon:"user",label:"Klasik",color:"#f59e0b"},{id:"clapperboard",icon:"clapperboard",label:"Sinema",color:"#ec4899"},{id:"film",icon:"film",label:"Yıldız",color:"#8b5cf6"},{id:"sparkles",icon:"sparkles",label:"Sihirli",color:"#10b981"},{id:"tv",icon:"tv",label:"Dizi Kolik",color:"#3b82f6"},{id:"baby",icon:"baby",label:"Çocuk",color:"#38bdf8"},{id:"smile",icon:"smile",label:"Neşeli",color:"#eab308"},{id:"flame",icon:"flame",label:"Ateşli",color:"#ef4444"}];function om(){if(_l()||document.getElementById("profile-onboarding-overlay"))return;const e=document.createElement("div");e.id="profile-onboarding-overlay",e.className="onboarding-overlay",e.innerHTML=`
  ...
  `,document.body.appendChild(e),window.lucide&&V(e);let t=Ma[0].id,i=Ma[0].color;e.querySelectorAll(".onboarding-avatar-btn").forEach(o=>{o.addEventListener("click",()=>{e.querySelectorAll(".onboarding-avatar-btn").forEach(s=>s.classList.remove("selected")),o.classList.add("selected"),t=o.getAttribute("data-avatar"),i=o.getAttribute("data-color")})});const n=e.querySelector("#onboarding-form"),r=e.querySelector("#onboarding-name-input"),a=e.querySelector("#onboarding-is-kid");n.addEventListener("submit",o=>{o.preventDefault();const s=r.value.trim();s&&(od({name:s,avatar:t,color:i,isKid:a.checked}),e.classList.add("animate-fade-out"),setTimeout(()=>{e.remove(),window.location.reload()},280))})}const rn=[{icon:"sparkles",eyebrow:"CinePulse rehberi",title:"İzlemeye hazır bir ana ekran",text:"Ana sayfadaki satırları yatay kaydırarak yapımları gez. Arama simgesinden dizi veya film adını yazdığında sonuçlar anında görünür.",hint:"Mobilde alt menüden Diziler, Filmler, Keşfet ve Listem’e geçebilirsin."},{icon:"clapperboard",eyebrow:"Fragman önizleme",title:"Karttan fragmana bak",text:"Telefonda bir içerik kartına kısa süre basılı tut; fragman ekranın alt kısmında açılır. Bilgisayarda kartın üzerine gelmen yeterli.",hint:"Önizlemeyi sağ üstteki çarpıdan kapatabilir, ses simgesinden sesi açabilirsin."},{icon:"list-plus",eyebrow:"Kişisel liste",title:"Listem senin kontrolünde",text:"İçerik detayındaki artı düğmesiyle yapımları Listem’e ekle. Listem sayfasından kaydettiğin yapımları açabilir veya kaldırabilirsin.",hint:"İzleme ilerlemen de aynı tarayıcıda otomatik hatırlanır."},{icon:"shield-check",eyebrow:"Spoilersız keşif",title:"Diziyi güvenle incele",text:"Dizi detayında “Spoilersız keşfet” seçeneğini açarsan, izleme ilerlemenin sonrasındaki bölüm başlıkları, görselleri ve özetleri gizlenir.",hint:"İzlediğin bölüme ve sıradaki bölüme kadar detay görürsün; ilerledikçe yeni bölümler açılır."},{icon:"users-round",eyebrow:"Birlikte Seç",title:"Arkadaşınla aynı odada izle",text:"Üstteki Birlikte Seç düğmesinden oda oluştur veya altı haneli kodla bir odaya katıl. Moderatör içerik ve kaynak seçer; odada emoji ve sohbet de kullanabilirsin.",hint:"Oynatıcıdaki “Odaya dön” düğmesindeki rozet yeni sohbet mesajlarını gösterir."},{icon:"monitor-play",eyebrow:"Oynatıcı",title:"Kontroller elinin altında",text:"İçeriği açınca ekrana bir kez dokunarak kontrolleri göster. Zaman çubuğundan sarabilir, kaynakları değiştirebilir, altyazı ve ses seçebilirsin.",hint:"Tam ekran, ses ve parlaklık ayarları her cihazda sana ait kalır."}];function lm(){if(!_l()||ad()||document.getElementById("cinepulse-product-tour"))return;let e=0;const t=document.body.style.overflow,i=document.createElement("section");i.id="cinepulse-product-tour",i.className="product-tour-overlay",i.setAttribute("role","dialog"),i.setAttribute("aria-modal","true"),i.setAttribute("aria-label","CinePulse kullanım rehberi");const n=()=>{sd(),document.body.style.overflow=t,i.classList.add("is-leaving"),window.setTimeout(()=>i.remove(),180)},r=()=>{const a=rn[e];i.innerHTML=`
      <div class="product-tour-card">
        ...
        <div class="product-tour-footer">
          <div class="product-tour-progress" aria-label="Adım ${e+1} / ${rn.length}">
            ${rn.map((o,s)=>`<span class="${s===e?"is-active":""}"></span>`).join("")}
          </div>
          <div class="product-tour-actions">
            ${e>0?'<button class="product-tour-back" type="button">Geri</button>':""}
            <button class="product-tour-next" type="button">${e===rn.length-1?"Hazırım":"Devam"} <i data-lucide="arrow-right"></i></button>
          </div>
        </div>
      </div>
    `,V(i),i.querySelector(".product-tour-skip")?.addEventListener("click",n),i.querySelector(".product-tour-back")?.addEventListener("click",()=>{e=Math.max(0,e-1),r()}),i.querySelector(".product-tour-next")?.addEventListener("click",()=>{e>=rn.length-1?n():(e+=1,r())})};document.body.appendChild(i),document.body.style.overflow="hidden",r()}function cm(e){const t=e==="landscape";document.querySelectorAll(".card-poster-img").forEach(n=>{const r=t?n.dataset.backdropSrc||n.src:n.dataset.posterSrc||n.src;!r||n.src===r||(n.src=r,n.dataset.activeLayout=e)})}function dm(){const e=Lt().cardLayout==="landscape"?"landscape":"portrait";return`
  ...
  `}function um(e=document){const t=e.querySelector("#card-layout-switcher");if(!t)return;const i=[...t.querySelectorAll(".card-layout-option")],n=()=>{t.isConnected&&Ui(document,!1)};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:1e3}):setTimeout(n,300),i.forEach(r=>{r.addEventListener("click",a=>{a.preventDefault();const o=r.dataset.layout==="landscape"?"landscape":"portrait",s=o==="landscape",l=document.documentElement.classList.contains("cards-landscape")?"landscape":"portrait";o!==l&&(document.documentElement.classList.toggle("cards-landscape",s),i.forEach(d=>{const p=d.dataset.layout===o;d.classList.toggle("active",p),d.setAttribute("aria-pressed",String(p))}),cm(o),Il({cardLayout:o}),s&&Ui(document,!0))})})}var Ki;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(Ki||(Ki={}));class Pa extends Error{constructor(t,i,n){super(t),this.message=t,this.code=i,this.data=n}}const pm=e=>{var t,i;return e?.androidBridge?"android":!((i=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||i===void 0)&&i.bridge?"ios":"web"},hm=e=>{const t=e.CapacitorCustomPlatform||null,i=e.Capacitor||{},n=i.Plugins=i.Plugins||{},r=()=>t!==null?t.name:pm(e),a=()=>r()!=="web",o=h=>{const m=d.get(h);return!!(m?.platforms.has(r())||s(h))},s=h=>{var m;return(m=i.PluginHeaders)===null||m===void 0?void 0:m.find(b=>b.name===h)},l=h=>e.console.error(h),d=new Map,p=(h,m={})=>{const b=d.get(h);if(b)return b.proxy;const y=r(),w=s(h);let k;const f=async()=>(!k&&y in m?k=typeof m[y]=="function"?k=await m[y]():k=m[y]:t!==null&&!k&&"web"in m&&(k=typeof m.web=="function"?k=await m.web():k=m.web),k),v=(L,z)=>{var O,Y;if(w){const j=w?.methods.find(D=>z===D.name);if(j)return j.rtype==="promise"?D=>i.nativePromise(h,z.toString(),D):(D,B)=>i.nativeCallback(h,z.toString(),D,B);if(L)return(O=L[z])===null||O===void 0?void 0:O.bind(L)}else{if(L)return(Y=L[z])===null||Y===void 0?void 0:Y.bind(L);throw new Pa(`"${h}" plugin is not implemented on ${y}`,Ki.Unimplemented)}},x=L=>{let z;const O=(...Y)=>{const j=f().then(D=>{const B=v(D,L);if(B){const W=B(...Y);return z=W?.remove,W}else throw new Pa(`"${h}.${L}()" is not implemented on ${y}`,Ki.Unimplemented)});return L==="addListener"&&(j.remove=async()=>z()),j};return O.toString=()=>`${L.toString()}() { [capacitor code] }`,Object.defineProperty(O,"name",{value:L,writable:!1,configurable:!1}),O},A=x("addListener"),S=x("removeListener"),T=(L,z)=>{const O=A({eventName:L},z),Y=async()=>{const D=await O;S({eventName:L,callbackId:D},z)},j=new Promise(D=>O.then(()=>D({remove:Y})));return j.remove=async()=>{await Y()},j},I=new Proxy({},{get(L,z){switch(z){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return w?T:A;case"removeListener":return S;default:return x(z)}}});return n[h]=I,d.set(h,{name:h,proxy:I,platforms:new Set([...Object.keys(m),...w?[y]:[]])}),I};return i.convertFileSrc||(i.convertFileSrc=h=>h),i.getPlatform=r,i.handleError=l,i.isNativePlatform=a,i.isPluginAvailable=o,i.registerPlugin=p,i.Exception=Pa,i.DEBUG=!!i.DEBUG,i.isLoggingEnabled=!!i.isLoggingEnabled,i},fm=e=>e.Capacitor=hm(e),us=fm(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof globalThis<"u"?globalThis:{}),Vr=us.registerPlugin;class Os{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,i){let n=!1;this.listeners[t]||(this.listeners[t]=[],n=!0),this.listeners[t].push(i);const a=this.windowListeners[t];a&&!a.registered&&this.addWindowListener(a),n&&this.sendRetainedArgumentsForEvent(t);const o=async()=>this.removeListener(t,i);return Promise.resolve({remove:o})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,i,n){const r=this.listeners[t];if(!r){if(n){let a=this.retainedEventArguments[t];a||(a=[]),a.push(i),this.retainedEventArguments[t]=a}return}r.forEach(a=>a(i))}hasListeners(t){var i;return!!(!((i=this.listeners[t])===null||i===void 0)&&i.length)}registerWindowListener(t,i){this.windowListeners[i]={registered:!1,windowEventName:t,pluginEventName:i,handler:n=>{this.notifyListeners(i,n)}}}unimplemented(t="not implemented"){return new us.Exception(t,Ki.Unimplemented)}unavailable(t="not available"){return new us.Exception(t,Ki.Unavailable)}async removeListener(t,i){const n=this.listeners[t];if(!n)return;const r=n.indexOf(i);r!==-1&&this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const i=this.retainedEventArguments[t];i&&(delete this.retainedEventArguments[t],i.forEach(n=>{this.notifyListeners(t,n)}))}}const gl=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),yl=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class mm extends Os{async getCookies(){const t=document.cookie,i={};return t.split(";").forEach(n=>{if(n.length<=0)return;let[r,a]=n.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=yl(r).trim(),a=yl(a).trim(),i[r]=a}),i}async setCookie(t){try{const i=gl(t.key),n=gl(t.value),r=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",a=(t.path||"/").replace("path=",""),o=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${i}=${n||""}${r}; path=${a}; ${o};`}catch(i){return Promise.reject(i)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(i){return Promise.reject(i)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const i of t)document.cookie=i.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Vr("CapacitorCookies",{web:()=>new mm});const gm=async e=>new Promise((t,i)=>{const n=new FileReader;n.onload=()=>{const r=n.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},n.onerror=r=>i(r),n.readAsDataURL(e)}),ym=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,a,o)=>(r[a]=e[t[o]],r),{})},vm=(e,t=!0)=>e?Object.entries(e).reduce((n,r)=>{const[a,o]=r;let s,l;return Array.isArray(o)?(l="",o.forEach(d=>{s=t?encodeURIComponent(d):d,l+=`${a}=${s}&`}),l.slice(0,-1)):(s=t?encodeURIComponent(o):o,l=`${a}=${s}`),`${n}&${l}`},"").substr(1):null,bm=(e,t={})=>{const i=Object.assign({method:e.method||"GET",headers:e.headers},t),r=ym(e.headers)["content-type"]||"";if(typeof e.data=="string")i.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const a=new URLSearchParams;for(const[o,s]of Object.entries(e.data||{}))a.set(o,s);i.body=a.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const a=new FormData;if(e.data instanceof FormData)e.data.forEach((s,l)=>{a.append(l,s)});else for(const s of Object.keys(e.data))a.append(s,e.data[s]);i.body=a;const o=new Headers(i.headers);o.delete("content-type"),i.headers=o}else(r.includes("application/json")||typeof e.data=="object")&&(i.body=JSON.stringify(e.data));return i};class wm extends Os{async request(t){const i=bm(t,t.webFetchExtra),n=vm(t.params,t.shouldEncodeUrlParams),r=n?`${t.url}?${n}`:t.url,a=await fetch(r,i),o=a.headers.get("content-type")||"";let{responseType:s="text"}=a.ok?t:{};o.includes("application/json")&&(s="json");let l,d;switch(s){case"arraybuffer":case"blob":d=await a.blob(),l=await gm(d);break;case"json":l=await a.json();break;case"document":case"text":default:l=await a.text()}const p={};return a.headers.forEach((h,m)=>{p[m]=h}),{data:l,headers:p,status:a.status,url:a.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Vr("CapacitorHttp",{web:()=>new wm});var vl;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(vl||(vl={}));var bl;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(bl||(bl={}));class km extends Os{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}Vr("SystemBars",{web:()=>new km});const wl=Vr("App",{web:()=>_s(()=>import("./web-BXTe6sDx.js"),[],import.meta.url).then(e=>new e.AppWeb)}),Cn=!!(window.Capacitor?.isNativePlatform?.()&&window.Capacitor?.getPlatform?.()==="android");document.documentElement.classList.toggle("native-android",Cn);const Qc=matchMedia("(max-width: 768px)");document.documentElement.classList.toggle("mobile-web",!Cn&&Qc.matches);Qc.addEventListener?.("change",e=>{document.documentElement.classList.toggle("mobile-web",!Cn&&e.matches)});if(Cn){const e=window.fetch.bind(window),t="https://cine-pulse-drab.vercel.app";window.fetch=(i,n)=>{if(typeof i=="string"&&i.startsWith("/api/"))i=`${t}${i}`;else if(i instanceof URL&&i.origin===window.location.origin&&i.pathname.startsWith("/api/"))i=`${t}${i.pathname}${i.search}${i.hash}`;else if(typeof Request<"u"&&i instanceof Request){const r=new URL(i.url);r.origin===window.location.origin&&r.pathname.startsWith("/api/")&&(i=new Request(`${t}${r.pathname}${r.search}${r.hash}`,i))}return e(i,n)}}if(typeof window<"u")try{wl.addListener("backButton",({canGoBack:e})=>{const t=document.getElementById("player-modal-container")||document.querySelector(".player-modal-overlay");if(t){const r=document.getElementById("player-close-btn");r?r.click():t.remove();return}const i=document.querySelector(".modal-overlay, .decision-modal-overlay, .profile-modal-overlay, .data-manager-modal");if(i){const r=i.querySelector('.modal-close, .btn-modal-close, [data-action="close"]');r?r.click():i.remove();return}const n=window.location.hash||"#home";if(n!=="#home"&&n!==""){e?window.history.back():window.location.hash="#home";return}wl.exitApp()})}catch{}"scrollRestoration"in history&&(history.scrollRestoration="manual");"serviceWorker"in navigator&&window.location.protocol.startsWith("http")&&window.addEventListener("load",()=>{const e="20260920-mobile-preview-2",t=`cinepulse-sw-reloaded-${e}`;navigator.serviceWorker.addEventListener("controllerchange",()=>{sessionStorage.getItem(t)||(sessionStorage.setItem(t,"1"),window.location.reload())}),navigator.serviceWorker.register(`/sw.js?build=${e}`,{updateViaCache:"none"}).then(i=>i.update()).catch(()=>{})});cu();window.addEventListener("keydown",e=>{e.ctrlKey&&e.altKey&&e.shiftKey&&e.key==="F10"&&(e.preventDefault(),e.stopImmediatePropagation(),Xf(),window.location.hash="#admin")},!0);const si=document.getElementById("app");document.documentElement.classList.toggle("cards-landscape",Lt().cardLayout==="landscape");window.addEventListener("scroll",()=>{Lh()},{passive:!0});window.addEventListener("pagehide",Kr);let Ba=0;async function Yi(){const e=++Ba;qh(),Kr();const t=window.location.hash||"#home";let i="home",n={};if(t.startsWith("#detail")){if(i="detail",t.includes("?")){const l=t.split("?")[1]||"",d=new URLSearchParams(l);n.type=d.get("type")||"tv",n.id=d.get("id")}else if(t.includes("/")){const l=t.split("/");l.length>=3?(n.type=l[1]||"tv",n.id=l[2]):l.length===2&&(n.type="tv",n.id=l[1])}}else if(t==="#series")i="series";else if(t==="#cartoons")i="cartoons";else if(t==="#movies")i="movies";else if(t==="#anime")i="anime";else if(t==="#documentary")i="documentary";else if(t==="#livetv")i="livetv";else if(t==="#discover")i="discover";else if(t==="#library")i="library";else if(t==="#downloads")Cn?i="downloads":(window.location.replace("#library"),i="library");else if(t.startsWith("#dramas")){if(i="dramas",t.includes("?")){const l=t.split("?")[1]||"",d=new URLSearchParams(l);n.slug=d.get("slug"),n.q=d.get("q")}}else if(t==="#admin"){if(!Zf()){window.location.replace("#home");return}i="admin"}if(window.__popularListCleanup?.(),window.__popularListCleanup=null,window.__discoverCleanup?.(),window.__discoverCleanup=null,window.__LiveTvController&&typeof window.__LiveTvController.cleanup=="function"&&window.__LiveTvController.cleanup(),document.querySelectorAll("video, audio").forEach(l=>{try{l.pause(),l.removeAttribute("src"),l.load()}catch{}}),i==="admin"){const l=await im();if(e!==Ba)return;si.innerHTML=`
      <div class="admin-standalone-wrapper" style="min-height: 100vh; background: #07090e; display: flex; flex-direction: column; width: 100%;">
        ${l?l.html:""}
      </div>
    `,l&&typeof l.init=="function"&&l.init(si),V();return}const r=Eh(i),o=new Set(["home","series","cartoons","movies","anime","documentary","discover","library"]).has(i)?dm():"";(i==="home"||i==="detail")&&(si.innerHTML=`${r}<main class="route-loading" aria-live="polite"><div class="spin-loader"></div><span>İçerikler yükleniyor...</span></main>`,Xo(),V(si));let s=null;i==="home"?s=await jh():i==="detail"?s=await df(n.type,n.id):i==="series"?s=await tn("tv"):i==="cartoons"?s=await tn("cartoon"):i==="movies"?s=await tn("movie"):i==="anime"?s=await tn("anime"):i==="documentary"?s=await tn("documentary"):i==="livetv"?s=Wf():i==="discover"?s=await yf("tv"):i==="library"?s=mf():i==="downloads"?s=gf():i==="dramas"&&(s=await sm(n.slug,n.q)),e===Ba&&(si.innerHTML=`
    ${r}
    ${o}
  ...
  `,Xo(),um(si),s&&s.init&&s.init(si),window.lucide&&V(),Ih(t))}window.addEventListener("hashchange",Yi);Yi();setTimeout(async()=>{try{const e=String(new URL(window.location.href).searchParams.get("oda")||"").replace(/\D/g,"");if(!/^\d{6}$/.test(e))return;kr({roomCode:e})}catch{}},700);setTimeout(()=>{om()},400);setTimeout(()=>{lm()},1200);const ed={getWatchHistory:Be,saveWatchProgress:fs,saveBatchWatchProgress:El};window.addEventListener("cinepulse_trakt_auth_changed",e=>{e.detail?.connected&&Nl(ed)});Nl(ed);gu();const td=e=>{e&&e.detail&&(e.detail.action==="import"||e.detail.cleared)&&Yi()};window.addEventListener("sineflix_data_changed",td);window.addEventListener("cinepulse_data_changed",td);window.addEventListener("sineflix_profile_changed",async()=>{fn(),await Yi()});window.addEventListener("cinepulse_admin_state_changed",Yi);window.addEventListener("storage",e=>{if(e.key!=="sineflix_user_settings_v1")return;const t=Lt();document.documentElement.classList.toggle("cards-landscape",t.cardLayout==="landscape"),fn(),Yi()});export{Sm as A,Os as W,Di as a,zm as b,Fe as c,dt as d,Bm as e,Dm as f,Xt as g,bn as h,ss as i,Pm as j,Rm as k,Mm as l,li as m,Ni as n,Im as o,Tl as p,$m as q,Se as r,Z as s,wf as t,Al as u,ys as v,_m as w,fs as x,Em as y,xm as z};
