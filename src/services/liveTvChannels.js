...
export const LIVE_TV_CHANNELS = [
  ...
  // ── BELGESEL & YAŞAM ──
  { id: 'ch_natgeo',     name: 'National Geographic HD', category: 'doc', logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/National_Geographic_Channel_logo.svg/300px-National_Geographic_Channel_logo.svg.png'), quality: '1080p HD', streamUrl: 'https://mariuannastluisborg.autos/hls/natgeo/index.m3u8', fallbackUrl: '/api/hls_proxy?url=' + encodeURIComponent('https://mariuannastluisborg.autos/hls/natgeo/index.m3u8') + '&ref=https://a.prectv70.lol/' },
  { id: 'ch_natgeowild', name: 'Nat Geo Wild HD', category: 'doc',      logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/National_Geographic_Channel_logo.svg/300px-National_Geographic_Channel_logo.svg.png'), quality: '1080p HD', streamUrl: 'https://mariuannastluisborg.autos/hls/natgeowild/index.m3u8', fallbackUrl: '/api/hls_proxy?url=' + encodeURIComponent('https://mariuannastluisborg.autos/hls/natgeowild/index.m3u8') + '&ref=https://a.prectv70.lol/' },
  { id: 'ch_bbcearth',   name: 'BBC Earth HD',    category: 'doc',      logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/BBC_Earth_logo.svg/300px-BBC_Earth_logo.svg.png'), quality: '1080p HD', streamUrl: 'https://lord.mariuannastluisborg.autos/bbc/index.m3u8', fallbackUrl: '/api/hls_proxy?url=' + encodeURIComponent('https://lord.mariuannastluisborg.autos/bbc/index.m3u8') + '&ref=https://a.prectv70.lol/' },
  { id: 'ch_history',    name: 'History Channel HD', category: 'doc',   logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/History_Logo.svg/300px-History_Logo.svg.png'), quality: '1080p HD', streamUrl: 'https://lord.mariuannastluisborg.autos/history/index.m3u8', fallbackUrl: '/api/hls_proxy?url=' + encodeURIComponent('https://lord.mariuannastluisborg.autos/history/index.m3u8') + '&ref=https://a.prectv70.lol/' },
  { id: 'ch_dmax',       name: 'DMAX HD',        category: 'doc',      logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/DMAX_Logo_2016.svg/300px-DMAX_Logo_2016.svg.png'), quality: '1080p HD', streamUrl: 'https://lord.mariuannastluisborg.autos/dmax/index.m3u8', fallbackUrl: '/api/hls_proxy?url=' + encodeURIComponent('https://lord.mariuannastluisborg.autos/dmax/index.m3u8') + '&ref=https://a.prectv70.lol/' },
  { id: 'ch_tlc',        name: 'TLC HD',         category: 'doc',      logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/TLC_Logo.svg/300px-TLC_Logo.svg.png'),             quality: '1080p HD', streamUrl: 'https://lord.mariuannastluisborg.autos/tlc/index.m3u8', fallbackUrl: '/api/hls_proxy?url=' + encodeURIComponent('https://lord.mariuannastluisborg.autos/tlc/index.m3u8') + '&ref=https://a.prectv70.lol/' },
