...
export const LIVE_TV_CHANNELS = [
  ...
  // ── BELGESEL & YAŞAM ──
  { id: 'ch_dmax',       name: 'DMAX HD',        category: 'doc',      logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/DMAX_Logo_2016.svg/300px-DMAX_Logo_2016.svg.png'), quality: '1080p HD', streamUrl: 'https://tv.ensonhaber.com/dmax/dmax.m3u8', fallbackUrl: 'https://dogus-live.daioncdn.net/dmax/dmax_720p.m3u8' },
  { id: 'ch_tlc',        name: 'TLC HD',         category: 'doc',      logo: getLogoUrl('https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/TLC_Logo.svg/300px-TLC_Logo.svg.png'),             quality: '1080p HD', streamUrl: 'https://tv.ensonhaber.com/tlc/tlc.m3u8', fallbackUrl: 'https://dogus-live.daioncdn.net/tlc/tlc_720p.m3u8' },
